var PS_SEARCHABLE_TABLE_TITLE_NAME = (typeof PRODUCTS_TABLE_TITLE_NAMES === "undefined") ? ['Code', 'Title', 'Alternative Code', 'Clubbing'] : PRODUCTS_TABLE_TITLE_NAMES;
...
// {{--nabeel reloader--}}
$('#refresh_product_name').click(function(){
    alert("js");
...
$(document).on(table_Keyevent, search_result_table,function (e) {
    ...
    if(e.keyCode === 13) { getProduct($(rows[selectedRow]).attr('data-index')); $(this).parent().css('display', 'none'); }
