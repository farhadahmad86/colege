...
$query = "SELECT 
                pd_id, pd_pro_code, pd_pro_name, pd_publisher, pd_author_ids, 
                pd_topic, pd_class, pd_currency, pd_language, pd_imprint, 
                pd_illustrated, pd_genre_ids, pd_remarks 
            FROM financials_product_detail 
            WHERE pd_delete_status = 0;";
