...
if (isset($_POST['title']) && isset($_POST['remarks'])) {
    ...
    if ($productId != 0) {
        $query = "UPDATE product
                    SET pro_title = '$title', pro_remarks = '$remarks', pro_category_id = $catId
                  WHERE pro_id = $productId;";
    } else {
        $query = "INSERT INTO product (pro_title, pro_remarks, pro_category_id) VALUE ('$title', '$remarks', $catId);";
    }
