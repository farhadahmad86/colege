...
if (isset($_REQUEST['username']) && isset($_REQUEST['password']) && isset($_REQUEST['uid'])) {
    $username = $database->escape_value($_REQUEST['username']);
    $password = $database->escape_value($_REQUEST['password']);
    $uid = $database->escape_value($_REQUEST['uid']);
