...
class SimplePurchaseTaxInvoiceController extends Controller
{
    public $invoice_total_value = 0;

    public function simple_purchase_tax_invoice()
    {
//        $user = Auth::user();
...
//        $posting_references = PostingReferenceModel::where('pr_disabled', '=', 0)->get();
        return view('Simple_Invoices/simple_purchase_sale_tax_invoice', compact('pro_code', 'pro_name'));
    }

    public function submit_simple_purchase_tax_invoice(Request $request)
    {
...
//            return redirect()->back()->with('success', 'Successfully Saved');
    ...
    public function simple_sale_tax_purchase_invoice_list(Request $request, $array = null, $str = null)
    {
...
//            $query->whereBetween('pi_day_end_date', [$start, $end]);
    ...
    public function simple_sale_tax_purchase_items_view_details_SH(Request $request, $id)
    {
    ...
    public function simple_sale_tax_purchase_items_view_details_pdf_SH(Request $request, $id)
    {
        $urdu_eng = ReportConfigModel::where('rc_id', '=', 1)->select('rc_invoice', 'rc_invoice_party')->first();
