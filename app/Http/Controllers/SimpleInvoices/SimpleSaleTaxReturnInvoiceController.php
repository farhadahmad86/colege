...
class SimpleSaleTaxReturnInvoiceController extends Controller
{
    //nabeel
    public function simple_sale_tax_return_invoice()
    {
...
//        $posting_references = PostingReferenceModel::where('pr_disabled','=',0)->get();
        return view('Simple_Invoices/simple_sale_tax_return_invoice', compact('pro_code', 'pro_name', 'accounts', 'products', 'packages', 'detail_remarks'));
    }
    ...
    public function submit_simple_sale_tax_return_invoice(Request $request)
    {
...
//            return redirect()->back()->with('success', 'Successfully Saved');
    ...
    public function simple_sale_return_saletax_items_view_details_SH(Request $request, $id)
    {
...
//            ->select('srsii_product_name as name', 'srsii_remarks as remarks', 'srsii_qty as qty', 'srsii_rate as rate', 'srsii_discount as discount', 'srsii_saletax as sale_tax', 'srsii_amount as amount')
    ...
    public function simple_sale_return_saletax_items_view_details_pdf_SH(Request $request, $id)
    {
        $urdu_eng = ReportConfigModel::where('rc_id', '=', 1)->select('rc_invoice','rc_invoice_party')->first();
        if ($urdu_eng->rc_invoice_party == 0){
...
//            ->select('srsii_product_name as name', 'srsii_remarks as remarks', 'srsii_qty as qty', 'srsii_rate as rate', 'srsii_discount as discount', 'srsii_saletax as sale_tax', 'srsii_amount as amount')
        ...
        $pdf = PDF::loadView('invoice_view.sale_return_sale_tax_invoice.sale_return_sale_tax_invoice_list_modal', compact('siims', 'sim', 'nbrOfWrds', 'accnts', 'type', 'pge_title', 'urdu_eng'));
