...
class TradeDeliverOrderSaleInvoiceController extends Controller
{

    public $actual_stock_price = 0;
    public $product_total_rate = 0;

    public function trade_delivery_order_sale_invoice()
    {
...
//        $posting_references = PostingReferenceModel::where('pr_disabled','=',0)->get();
        ...
        return view('Trade_Invoices/trade_delivery_order_sale_invoice', compact('pro_code', 'pro_name', 'accounts', 'products', 'packages'));

    }

    public function submit_trade_delivery_order_sale_invoice(Request $request)
    {
