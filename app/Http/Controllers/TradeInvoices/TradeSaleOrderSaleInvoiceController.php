...
class TradeSaleOrderSaleInvoiceController extends Controller
{
    public $actual_stock_price = 0;
    public $product_total_rate = 0;


    public function trade_sale_order_sale_invoice()
    {
...
//        $posting_references = PostingReferenceModel::where('pr_disabled','=',0)->get();
        return view('Trade_Invoices/trade_sale_order_sale_invoice', compact('pro_code', 'pro_name', 'accounts', 'products', 'packages'));

    }

    public function submit_trade_sale_order_sale_invoice(Request $request)
    {
...
//            }
        ...
        if ($rollBack) {
            ...
            DB::commit();
            return redirect()->back()->with(['dosi_id' => $sale_invoice_id]);
...
//                    $warehouse => $value['warehouse'],
    ...
    public function trade_sale_order_delivery_order_sale_invoice()
    {
        $accounts = $this->get_account_query('sale')[0];
...
//        $sale_persons = User::where('user_id', '!=', 1)->orderBy('user_role_id', 'DESC')->orderBy('user_name', 'ASC')->get();
        ...
        return view('Trade_Invoices/trade_sale_order_delivery_order_sale_invoice', compact('posting_references','pro_code', 'pro_name', 'accounts', 'products', 'packages', 'warehouses'));
