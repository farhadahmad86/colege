...
class TradeAddTransferProductStockController extends Controller
{
    public function add_trade_transfer_product_stock()
    {
        ...
        return view('Trade_Invoices/trade_add_transfer_product_stock', compact('products','warehouses'));
    }


    public function submit_trade_transfer_product_stock(Request $request)
    {

        $this->trade_transfer_product_stock_validation($request);
...
//                }
    ...
    public function trade_transfer_product_stock_validation($request)
    {
...
//        }
    ...
    public function trade_transfer_product_stock_list(Request $request, $array = null, $str = null)
    {
        ...
        $prnt_page_dir = 'print.trade_transfer_product_stock_list.trade_transfer_product_stock_list';
        $pge_title = 'Trade Transfer Product Stock List';
        $srch_fltr = [];
        ...
        $query = DB::table('financials_product_transfer_history')
            ...
            ->select('wh.wh_title AS to', 'wh1.wh_title AS from', 'financials_products.pro_title', 'financials_products.pro_p_code', 'financials_product_transfer_history.pth_scale_size','financials_product_transfer_history.pth_stock', 'financials_product_transfer_history.pth_remarks', 'financials_product_transfer_history.pth_datetime');
        ...
        if (isset($request->array) && !empty($request->array)) {
            ...
            return view('Trade_Invoices/trade_transfer_product_stock_list', compact('datas', 'search', 'warehouses', 'product_title', 'products', 'search_product', 'search_by_user','search_warehouse'));
        }
