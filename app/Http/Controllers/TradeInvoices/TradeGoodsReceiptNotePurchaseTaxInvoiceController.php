...
class TradeGoodsReceiptNotePurchaseTaxInvoiceController extends Controller
{
    public $grn_purchase_total_stock_amount=0;
    public function trade_grn_purchase_tax_invoice()
    {
...
//        $posting_references = PostingReferenceModel::where('pr_disabled', '=', 0)->get();
        ...
        return view('Trade_Invoices/trade_goods_receipt_note_purchase_tax_invoice', compact('pro_code', 'pro_name'));
    }

    public function submit_trade_grn_purchase_tax_invoice(Request $request)
    {
...
//            return redirect()->back()->with('success', 'Successfully Saved');
            return redirect()->back()->with(['grnstpi_id' => $purchase_invoice_id]);
        }
    }
