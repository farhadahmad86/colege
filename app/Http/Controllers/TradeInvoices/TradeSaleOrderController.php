...
class TradeSaleOrderController extends Controller
{
    public function trade_sale_order()
    {
...
//            ->get();
        ...
        return view('Trade_Invoices/trade_sale_order', compact('pro_code', 'pro_name', 'products', 'sale_persons', 'machines', 'service_code', 'service_name', 'packages'));
    }

    public function submit_trade_sale_order(Request $request)
    {
        ...
        $notes = 'TRADE_SALE_ORDER_INVOICE';

        $voucher_code = config('global_variables.TRADE_SALE_ORDER_VOUCHER_CODE');
...
//            }
    ...
    public function trade_sale_order_list(Request $request)
    {
        ...
        $pge_title = 'Trade Sale Order List';
        $srch_fltr = [];
...
//            $query->whereBetween('si_day_end_date', [$start, $end]);
    ...
    public function trade_sale_order_items_view_details_SH(Request $request, $id)
    {
...
//            ->select('soi_product_name as name', 'soi_remarks as remarks', 'soi_qty as qty', 'soi_rate as rate', 'soi_discount as discount', 'soi_saletax as sale_tax', 'soi_amount as amount')
    ...
    public function trade_sale_order_items_view_details_pdf_SH(Request $request, $id)
    {
...
//            ->select('soi_product_name as name', 'soi_remarks as remarks', 'soi_qty as qty', 'soi_rate as rate', 'soi_discount as discount', 'soi_saletax as sale_tax', 'soi_amount as amount')
        ...
        $pdf = PDF::loadView('invoice_view.sale_order.sale_order_list_modal', compact('soims', 'som', 'seim', 'nbrOfWrds', 'accnts', 'type', 'pge_title'));
        $pdf->setOptions($options);
