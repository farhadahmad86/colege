...
class DeliveryOrderSaleInvoice extends Controller
{
    public $actual_stock_price = 0;
    public $product_total_rate = 0;

    public function delivery_order_sale_invoice()
    {
//        $user = Auth::user();
...
//
        ...
        $productss = $query->groupBy('do_id')
            ->pluck('financials_delivery_order.do_id');

        return view('delivery_order_sale_invoice', compact('pro_code', 'pro_name', 'accounts', 'products', 'packages','productss'));
    }

    public function submit_delivery_order_sale_invoice(Request $request)
    {
...
//        }
        ...
        if ($invoice_type == 1) {
            ...
            $voucher_code = config('global_variables.DELIVERY_ORDER_SALE_VOUCHER_CODE');
            ...
            $voucher_code = config('global_variables.DELIVERY_ORDER_SALE_TAX_VOUCHER_CODE');
