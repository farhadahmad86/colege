        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Stock Inward Detail List</h4>
                        </div>
                ...
                <div class="search_form {{ ( !empty($search) || !empty($search_to) || !empty($search_from) || !empty($search_inward_type) ) ? '' : '' }}">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

                            <form class="prnt_lst_frm" action="{{ route('stock_inward_detail_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                                    <div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <select tabindex="1" required autofocus name="inward_type" class="inputs_up form-control js-example-basic-multiple"
                                                ...
                                                <option value="self_collection" {{ "self_collection" == $search_inward_type ? 'selected="selected"' : ''}}>Self Collection</option>
                                                <option value="company_delivery" {{ "company_delivery" == $search_inward_type ? 'selected="selected"' : ''}}>Vendor Delivery</option>
                                                <option value="courier_service" {{ "courier_service" == $search_inward_type ? 'selected="selected"' : ''}}>Courier Service</option>
                                                <option value="third_party" {{ "third_party" == $search_inward_type ? 'selected="selected"' : ''}}>Third Party</option>
                                    ...
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                        <div class="form_controls text-center text-lg-left">
                                            ...
                                            <a class="save_button form-control" href="{{ route('stock_inward') }}" role="button">
                                                <i class="fa fa-plus"></i> Stock Inward
                                            </a>
...
{{--                <span class="hide_column">  {{ $datas->appends(['segmentSr' => $countSeg, 'search'=>$search, 'to'=>$search_to, 'from'=>$search_from,'inward_type'=>$search_inward_type])->links() }}</span>--}}
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('stock_inward_detail_list') }}',
            url;
