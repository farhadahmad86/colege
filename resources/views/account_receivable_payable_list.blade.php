    ...
    <div class="row">
            <div class="container-fluid search-filter form-group form_manage">
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('account_receivable_payable_list') . ((isset($restore_list) && $restore_list == 1) ? '?restore_list=1' : '') }}" name="form1"
                        ...
                        <div class="row">
                            ...
                            @include('include.clear_search_button')
                                ...
                                <a tabindex="9" class="save_button btn btn-sm" href="{{ route('receivables_account_registration') }}" role="button">
                                    <l class="fa fa-plus"></l>
                                    Client
                                </a>
                                <a tabindex="10" class="save_button btn btn-sm" href="{{ route('payables_account_registration') }}" role="button">
                                    <l class="fa fa-plus"></l>
                                    Supplier
                                </a>
...
{{--                    </form>--}}
                        ...
                        @forelse($datas as $index=> $account)
                            ...
                            @else
                                <tr data-id="{{$account->account_id}}" data-account_type="Payable">
                                    ...
                                    <td class="usr_prfl" data-usr_prfl="{{ $account->user_id }}" data-user_info="{!! $ip_browser_info !!}"
    ...
    <div class="col-md-9 text-right"><span class="hide_column">{{ $datas->appends(['segmentSr' => $countSeg, 'search'=>$search,  'region'=>$search_region,  'area'=>$search_area,  'sector'=>$search_sector,  'group'=>$search_group,  'sale_person'=>$search_sale_persons, 'date'=>$search_date ])->links() }}</span>
