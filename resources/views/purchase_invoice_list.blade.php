    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage" id="">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text file_name">Purchase Invoice List</h4>
                    </div>
            ...
            <div class="search_form p-0 m-0">
                <form class="highlight prnt_lst_frm" action="{{ route('purchase_invoice_list') }}" name="form1"
