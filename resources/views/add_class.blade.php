    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <form name="f1" class="f1" id="f1" action="{{ route('submit_class') }}" method="post"
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <div class="input_bx">
                                        ...
                                        <input tabindex="1" autofocus type="text" name="name" id="name"
                                            class="inputs_up form-control" placeholder="Name" autofocus
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <div class="input_bx">
                                        ...
                                        <label class="">
                                            ...
                                            Remarks</label>
                                        <textarea tabindex="2" name="remarks" id="remarks" class="inputs_up remarks form-control" placeholder="Remarks">{{ old('remarks') }}</textarea>
