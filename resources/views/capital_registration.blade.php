    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Capital Registration</h4>
                    </div>
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('capital_registration_list') }}" role="button">
            ...
            <form action="{{ route('submit_capital_registration') }}" id="f1" onsubmit="return checkForm()" method="post" autocomplete="off">
                @csrf
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="input_bx"><!-- start input box -->
                                    ...
                                    <select tabindex=1 autofocus name="second_head" id="second_head" class="inputs_up form-control cstm_clm_srch"
                                    ...
                                    >
                                        ...
                                        @foreach($equity_second_accounts as $equity_second_account)
                                            <option value="{{$equity_second_account->coa_code}}"{{$equity_second_account->coa_code == old('second_head') ? 'selected' : ''}}>
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="input_bx"><!-- start input box -->
                                    <label class="required">Name
                                        ...
                                        <a id="refresh_user_name" class="add_btn" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true"
                                            data-content="{{config('fields_info.about_form_fields.refresh.description')}}">
                                            <l class="fa fa-refresh"></l>
                                        </a>

                                    </label>
                                    <select tabindex="2" name="user_name" id="user_name" class="inputs_up form-control cstm_clm_srch" data-rule-required="true"
                                            data-msg-required="Please Enter Name">
                                        <option value="">Select Name</option>
                                        @foreach($users as $user)
                                            <option value="{{$user->user_id}}" {{$user->user_id == old('user_name') ? 'selected' : ''}}>{{$user->user_name}}</option>
                                        @endforeach
                                    </select>

                                    <input type="hidden" name="account_name" id="account_name" value="{{old('account_name')}}" class="inputs_up form-control">
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="input_bx"><!-- start input box -->
                                    ...
                                    <input tabindex="3" type="text" name="relation" id="relation" value="{{old('relation')}}" class="inputs_up form-control" placeholder="Relation With Director">
                            ...
                            <div class="form-group col-lg-2 col-md-3 col-sm-12">
                                <div class="input_bx"><!-- start input box -->
                                    ...
                                    <div class="custom-control custom-radio mb-5 mt-1">
                                        <input tabindex="4" type="radio" id="acting" name="nature" value="1" {{ old('nature')== 1  ? 'checked' : '' }} class="custom-control-input" checked>
                                        <label class="custom-control-label" for="acting">Acting</label>
                                    </div>
                                    <div class="custom-control custom-radio mb-5 mt-1">
                                        <input type="radio" id="sleeping" name="nature" value="2" {{ old('nature')== 2  ? 'checked' : '' }} class="custom-control-input">
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="input_bx"><!-- start input box -->
                                    ...
                                    <input tabindex="5" type="text" name="initial_capital" id="initial_capital" data-rule-required="true" data-msg-required="Please Enter Initial Capital"
                                            value="{{old('initial_capital')}}" class="inputs_up form-control" placeholder="Initial Capital"
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="input_bx"><!-- start input box -->
                                    ...
                                    <input tabindex="6" type="text" name="system_calculated" id="system_calculated" data-rule-required="true" data-msg-required="Please Enter System Calculated"
                                            value="{{old('system_calculated')}}" class="inputs_up form-control" placeholder="System Calculated" readonly/>
                            ...
                            <div class="row">
                                    ...
                                    <fieldset class="cstm_ratio_fldset">
                                        <legend>
                                            <div class="custom-control custom-checkbox cstm_ratio">
                                                <input type="checkbox" name="custom_profit_ratio" class="custom-control-input" id="custom_profit_ratio" data-cstm-ratio="prft_" value="1"/>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                ...
                                                <ul class="list-group cptl_invst">
                                                    <li class="list-group-item border-0">
                                                        ...
                                                        <input type="text" placeholder="Add Ratio" name="prft_fxd_prft_actl_ratio"
                                                                id="prft_fxd_prft_actl_ratio" class="inputs_up form-control cptl_rtio disabled"
                                                                disabled="disabled" data-cstm-ratio="prft_"
                                                                onkeypress="return allow_only_number_and_decimals(this,event);"/>
                                                        <p class="mb-0 mt-1">
                                                            Current Ratio is =
                                                            <input class="inputs_up form-control cptl_rtio disabled" type="text" placeholder="Add Ratio" name="prft_crnt_ratio"
                                                                    id="prft_crnt_ratio" disabled="disabled" readonly/>
                                                        </p>
                                                    </li>
                                                    <li class="list-group-item border-0">
                                                        Remaining
                                                        <input type="text" placeholder="Add Ratio" name="prft_remaining_ratio" id="prft_remaining_ratio"
                                                                class="inputs_up form-control cptl_rtio disabled" disabled="disabled" readonly/> Ratio

                                                        <div class="d-block">
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="prft_equal_devide" name="prft_stck_hldrs" class="custom-control-input disabled" disabled="disabled"
                                                                        value="1"
                                                                        checked>
                                                            ...
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="prft_owner_equity" name="prft_stck_hldrs" class="custom-control-input disabled" disabled="disabled"
                                                                        value="2">
                                                            ...
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="prft_investors" name="prft_stck_hldrs" class="custom-control-input disabled" disabled="disabled"
                                                                        value="3">
                                                            ...
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="prft_active_equal_devide" name="prft_stck_hldrs" class="custom-control-input disabled"
                                                            ...
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="prft_sleep_equal_devide" name="prft_stck_hldrs" class="custom-control-input disabled" disabled="disabled"
                                                                        value="5">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6"><!-- col start -->
                                    <fieldset class="cstm_ratio_fldset">
                                        <legend>
                                            <div class="custom-control custom-checkbox cstm_ratio">
                                                <input type="checkbox" name="custom_loss_ratio" class="custom-control-input" id="custom_loss_ratio" data-cstm-ratio="loss_" value="1"/>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                ...
                                                <ul class="list-group cptl_invst">
                                                    <li class="list-group-item border-0">
                                                        ...
                                                        <input type="text" placeholder="Add Ratio" name="loss_fxd_prft_actl_ratio"
                                                                id="loss_fxd_prft_actl_ratio" class="inputs_up form-control cptl_rtio disabled"
                                                                disabled="disabled" data-cstm-ratio="loss_"
                                                                onkeypress="return allow_only_number_and_decimals(this,event);"/>
                                                        <p class="mb-0 mt-1">
                                                            Current Ratio is =
                                                            <input type="text" placeholder="Add Ratio" name="loss_crnt_ratio" id="loss_crnt_ratio"
                                                                    class="inputs_up form-control cptl_rtio disabled" disabled="disabled" readonly/>
                                                        </p>
                                                    </li>
                                                    <li class="list-group-item border-0">
                                                        Remaining
                                                        <input type="text" placeholder="Add Ratio" name="loss_remaining_ratio" id="loss_remaining_ratio"
                                                                class="inputs_up form-control cptl_rtio disabled" disabled="disabled" readonly/> Ratio

                                                        <div class="d-block">
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="loss_equal_devide" name="loss_stck_hldrs" class="custom-control-input disabled" disabled="disabled"
                                                                        value="1" checked>
                                                            ...
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="loss_owner_equity" name="loss_stck_hldrs" class="custom-control-input disabled" disabled="disabled"
                                                                        value="2">
                                                            ...
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="divide_equal_to_investor" name="loss_stck_hldrs" class="custom-control-input disabled" disabled="disabled"
                                                                        value="3">
                                                            ...
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="loss_active_equal_devide" name="loss_stck_hldrs" class="custom-control-input disabled"
                                                                        disabled="disabled" value="4">
                                                            ...
                                                            <div class="custom-control custom-radio mb-5">
                                                                <input type="radio" id="loss_sleep_equal_devide" name="loss_stck_hldrs" class="custom-control-input disabled" disabled="disabled"
                                                                        value="5">
...
@section('scripts')
    ...
    <script>
        ...
        jQuery("#refresh_user_name").click(function () {
            jQuery.ajaxSetup({
                headers: {
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            var software_package = {!! $software_package !!};

            if (software_package == 'Basic') {
                $('#custom_profit_ratio').prop("disabled", true);
                $('#custom_loss_ratio').prop("disabled", true);
                // $('#initial_capital').prop("disabled", true);
                // $('#system_calculated').prop("disabled", true);
                // $("input[name='nature']").prop("disabled", true);
            }
        });
