    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex=-1 class="text-white get-heading-text">Bank Payment Voucher</h4>
                    </div>

                    @php
                        $route_name = Route::current()->getName();

                        if ($route_name == 'bank_payment_voucher') {
                            $route_to = 'bank_payment_voucher_list';
                        } else {
                            $route_to = 'online_payment_paid_list';
                        }
                    @endphp
                    <div class="list_btn">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                ...
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    ...
                    <form id="f1" action="{{ route('submit_bank_payment_voucher') }}" method="post"
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="required invoice_col_ttl">
                                                ...
                                                <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                   ...
                                                   data-content="<h6>Descriptions</h6><p>{{ config('fields_info.about_form_fields.bank_voucher.bank_payment_voucher.amount.description') }}</p>">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Bank Payment Voucher Detail</h4>
