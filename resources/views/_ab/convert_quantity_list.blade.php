        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Convert Quantity List</h4>
                        </div>
...
{{--                {{ ( !empty($search) || !empty($search_region) ) ? '' : 'search_form_hidden' }}--}}
                <div class="search_form m-0 p-0 ">
                    <form class="highlight prnt_lst_frm" action="{{ route('convert_quantity_list') }}" name="form1" id="form1" method="post">
                        <div class="row">
                            @csrf
                                ...
                                <div class="input_bx">
                                    <select name="product_code" class="inputs_up form-control" id="product_code">
                                        ...
                                        @foreach ($products as $product)
                                            ...
                                            // @endif
                                            //     $selected = isset($searchData['product_code']) ? $searchData['product_code'] : '' === $product->pro_p_code ? 'selected' : '';
                                            // @endphp --}}
                                            <option value='{{ $product->pro_p_code }}' {{$search_product_code==$product->pro_p_code ? 'selected' : ''}}>{{ $product->pro_p_code }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                        <div class="input_bx">
                                            <select name="product_title" class="inputs_up form-control" id="product_title">
                                                ...
                                                @foreach ($products as $product)
                                                    {{--                                                    @php--}}
                                                    {{--                                                        $selected = (isset($searchData['product_title']) ? $searchData['product_title'] : '' === $product->pro_title) ? 'selected' : '';--}}
                                                    {{--                                                    @endphp--}}
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 text-right">
                                        ...
                                        <!-- Call add button component -->
                                            <x-add-button tabindex="9" href="{{ route('convert_quantity') }}"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('convert_quantity_list') }}',
            url;
