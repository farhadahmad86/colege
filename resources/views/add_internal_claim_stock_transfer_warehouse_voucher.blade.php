    ...
    <div class="row">
            <div class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Claim Stock Receive </h4>
                        </div>
                        <div class="list_btn">
                            <a class="btn list_link add_more_button" href="{{ route('claim_stock_receive_list') }}"
                               role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_claim_stock_receive') }}"
                                ...
                                <div class="invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12">
                                            <x-account-name-component tabindex="1" name="party_claim_account" class="claim_account" id="party_claim_account" title="Party Claim Account"
                                        ...
                                        <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="2" type="text" name="claim_issue_voucher"
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    ...
                                                    <select tabindex="5" name="product_code" class="inputs_up form-control"
                                                            id="product_code">
                                        ...
                                        <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    ...
                                                    <select tabindex="6" name="product_name" class="inputs_up form-control"
                                                            id="product_name">
                                        ...
                                        <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12">
                                            ...
                                            <x-remarks-component tabindex="7" name="product_remarks" id="product_remarks" title="Product Remarks"/>
                                        </div>
                                        <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12"><!-- invoice column start -->
                                            <x-warehouse-component tabindex="8" name="warehouse" id="warehouse" class="refresh_warehouse" title="Warehouse"/>
                                        </div>

                                        <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="required invoice_col_ttl">
                                                    <!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="9" type="text" name="quantity"
                                                           class="inputs_up form-control"
                                                           value="{{old('quantity')}}" id="quantity" placeholder="Qty"
                                                           onfocus="this.select();"
                                        ...
                                        <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12" hidden><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="required invoice_col_ttl">
                                                    <!-- invoice column title start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="10" type="text" name="scale_size"
                                                           class="inputs_up form-control"
                                                           value="{{old('scale_size')}}" id="scale_size" placeholder="Scale Size"
                                                           onfocus="this.select();"
                                                           onkeypress="return allow_only_number_and_decimals(this,event);">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        ...
                                        <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12" hidden><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="10" type="text" name="uom"
                                                           class="inputs_up form-control"
                                                           value="{{old('uom')}}" id="uom" placeholder="UOM"
                                                           onfocus="this.select();"
                                                           onkeypress="return allow_only_number_and_decimals(this,event);">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        ...
                                        <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="10" type="text" name="rate"
                                        ...
                                        <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12"><!-- invoice column start -->
                                            <div class="invoice_col_txt for_voucher_col_bx">
                                                ...
                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                        <button style="display: none;" id="cancel_button" class="invoice_frm_btn btn btn-sm btn-secondary" onclick="cancel_all()"
                                                                type="button">
                                                            <i class="fa fa-times"></i> Cancel
                                                        </button>
                                                    </div>
                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                        <button tabindex="12" id="first_add_more" class="invoice_frm_btn btn btn-sm btn-info"
                                                                onclick="add_product()" type="button">
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                            <div class="invoice_col_txt with_cntr_jstfy for_voucher_btns">
                                                <!-- invoice column box start -->
                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                    <button tabindex="13" type="submit" name="save" id="save" class="invoice_frm_btn btn btn-sm btn-success">
...
@section('scripts')
    ...
    <script>
        ...
        function edit_product(current_item) {
            ...
            jQuery("#quantity").val(temp_products['product_scale_size']);
            jQuery("#scale_size").val(temp_products['product_uom']);
            jQuery("#uom").val(temp_products['product_qty']);
