            ...
            <ul id="accordion-menu" class="accordion-menu">
                ...
                <li>
                 ...
                 <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="{{route("teller/sale_invoice_on_net")}}">Cash Invoice</a></li>
                        <li><a href="{{route("teller/sale_return_full_invoice")}}"> Return Full Invoice</a></li>
                        <li><a href="{{route("teller/sale_return_partial_invoice")}}"> Return Partial Invoice</a></li>
                        <li><a href="{{route("teller/sale_return_without_invoice")}}"> Return Without Invoice</a></li>
