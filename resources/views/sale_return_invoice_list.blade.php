    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage" id="">
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm" action="{{ route('sale_return_invoice_list') }}" name="form1"
                    ...
                    <div class="row">
                        <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                            <div class="input_bx">
                                ...
                                <input type="checkbox" name="check_desktop" id="check_desktop" value="1"
                                    {{ $check_desktop == 1 ? 'checked' : '' }}>
                    ...
                    <tbody>
                        ...
                        @forelse($datas as $invoice)
                            <tr>
                                ...
                                <td class="view" data-id="{{ $invoice->sri_id }}">
                                    SRI-{{ $invoice->sri_id }}
                                </td>

                                @php
                                    $party_name = $invoice->sri_party_name;
                                ...
                                <td class="fonti">
                                    ...
                                    {!! str_replace('&oS;', '<br />', $invoice->sri_detail_remarks) !!}
                                </td>
                                @php
                                ...
                                <td class="usr_prfl" data-usr_prfl="{{ $invoice->user_id }}"
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('sale_return_invoice_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function() {
            ...
            $('.modal-body').load('{{ url('simple_sale_return_invoice_list/view/') }}' + '/' + id, function() {
                $("#myModal").modal({
                    show: true
                });
            });
