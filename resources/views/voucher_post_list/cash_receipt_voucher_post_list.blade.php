        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Cash Receipt Post Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('cash_receipt_post_voucher_list') }}" name="form1" id="form1" method="post">
                        @csrf
                        <div class="row">
...
<x-add-button tabindex="9" href="{{ route('cash_receipt_voucher') }}"/>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        <tr>
                            ...
                            <th tabindex="-1" scope="col" class="tbl_txt_17">
                                Remarks
                            </th>
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr>
                                ...
                                <td class="text-center"
                                    title="Click To See User Detail">
                                    <form method="post" action="{{ route('post_cash_receipt_voucher') }}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $voucher->cr_id }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <span class="hide_column float-right">{{ $datas->appends(['segmentSr' => $countSeg, 'search' => $search, 'to' => $search_to, 'from' => $search_from])->links() }}</span>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('cash_receipt_post_voucher_list') }}',
            url;
