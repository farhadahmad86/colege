        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Post Cash Payment Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('cash_payment_post_voucher_list') }}" name="form1"
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-center  tbl_txt_5">
                                Action
                            </th>
                        </tr>
                        </thead>
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr>
                                ...
                                <td class="view tbl_amnt_6" data-id="{{ $voucher->cp_id }}">
                                    CPV-{{ $voucher->cp_id }}
                                </td>
                                <td>
                                    {{ $voucher->cp_remarks }}
                                ...
                                <td class="usr_prfl text-center"
                                    title="Click To Post Voucher">
                                    <form method="post" action="{{ route('post_cash_payment_voucher',$voucher->cp_id) }}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $voucher->cp_id }}">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('cash_payment_post_voucher_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            {{-- jQuery.ajax({ --}}
            {{--    url: "{{ route('cash_payment_items_view_details') }}", --}}
            {{--    data: {id: id}, --}}
            {{--    type: "POST", --}}
            {{--    cache: false, --}}
            {{--    dataType: 'json', --}}
            ...
            {{--            var amnt = (value['cpi_amount'] !== "") ? value['cpi_amount'] : 0; --}}
            {{--            ttlAmnt = ttlAmnt + amnt; --}}


            {{--            jQuery("#table_body").append( --}}
            {{--            '<tr>' + --}}
            {{--            '<td class="align_left wdth_5">' + value['cpi_account_id'] + '</td>' + --}}
            {{--            '<td class="align_left wdth_2"> <div class="max_txt"> ' + value['cpi_account_name'] + '</div> </td>' + --}}
            {{--            '<td class="align_left text-right wdth_5">' + value['cpi_amount'] + '</td>' + --}}
            {{--            '</tr>'); --}}
