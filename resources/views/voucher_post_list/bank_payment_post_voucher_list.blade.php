        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Post Bank Payment Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('bank_payment_post_voucher_list') }}" name="form1"
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr data-toggle="tooltip" data-placement="top" title="" data-original-title="View Journal Voucher">
                                ...
                                <td class="text-center"
                                    title="Click To See User Detail">
                                    <form method="post" action="{{ route('post_bank_payment_voucher', $voucher->bp_id) }}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $voucher->bp_id }}">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('bank_payment_post_voucher_list') }}',
            url;
    ...
    <script>
        ...
        // {{-- jQuery.ajax({ --}}
        // {{--    url: "{{ route('bank_payment_items_view_details') }}", --}}
        // {{--    data: {id: id}, --}}
        // {{--    type: "POST", --}}
        // {{--    cache: false, --}}
        // {{--    dataType: 'json', --}}
        ...
        // {{--            var amnt = (value['bpi_amount'] !== "") ? value['bpi_amount'] : 0; --}}
        // {{--            ttlAmnt = ttlAmnt + amnt; --}}


        // {{--            jQuery("#table_body").append( --}}
        // {{--            '<tr>' + --}}
        // {{--            '<td class="align_left wdth_5">' + value['bpi_account_id'] + '</td>' + --}}
        // {{--            '<td class="align_left wdth_2"> <div class="max_txt"> ' + value['bpi_account_name'] + '</div> </td>' + --}}
        // {{--            '<td class="align_left text-right wdth_5">' + value['bpi_amount'] + '</td>' + --}}
        // {{--            '</tr>'); --}}
