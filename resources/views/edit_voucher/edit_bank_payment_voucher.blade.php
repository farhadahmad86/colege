        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex=-1 class="text-white get-heading-text">Edit Bank Payment Voucher</h4>
                        </div>
                        ...
                        <div class="list_btn">
                            <a tabindex=-1 class="btn list_link add_more_button"
                               href="{{ route('bank_payment_voucher_list') }}" role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                    ...
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                        ...
                        <form id="f1" action="{{ route('update_bank_payment_voucher', $voucher->bp_id) }}"
                                ...
                                <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                    ...
                                    <div class="invoice_row">
                                        ...
                                        <div class="invoice_col basis_col_23">
                                            <x-edit-account-component tabindex="1" name="account" class="bank_voucher"
                                                                      id="account" title="Bank"
                                                                      href="bank_account_registration"
                                                                      body="1" value="{{ $voucher->bp_account_id }}"/>
                                        </div>
                                        ...
                                        <div class="invoice_col basis_col_23">
                                            ...
                                            <x-edit-remarks-component tabindex="2" name="remarks" id="remarks"
                                                                      ...
                                                                      value="{{ $voucher->bp_remarks }}"/>
                                        </div>
                                        <div class="invoice_col basis_col_12">
                                            <!-- invoice column start -->
                                            <x-voucher-status-component value="{{ $voucher->bp_status }}"/>
                                        </div>
                                    </div><!-- invoice row end -->
                                    ...
                                    <div class="invoice_row">
                                        ...
                                        <div class="invoice_col basis_col_12">
                                            <x-account-name-component tabindex="3" name="account_code"
                                                                      class="bank_voucher" id="account_code"
                                                                      title="Account Code"
                                                                      href="bank_account_registration" body="0"/>
                                        </div>
                                        ...
                                        <div class="invoice_col basis_col_20">
                                            ...
                                            <x-account-name-component tabindex="4" name="account_name"
                                                                      class="bank_voucher" id="account_name"
                                                                      title="Account Title"
                                                                      href="bank_account_registration" body="0"/>
                                        </div>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $.each(array, function (index, value) {
                ...
                var account_code = value.bpi_account_id;
                var account_name = value.bpi_account_id;
                var account_name_text = value.bpi_account_name;
                var amount = value.bpi_amount;
                var account_remarks = value.bpi_remarks;
                var posting_reference = value.bpi_pr_id;
        ...
        function edit_account(current_item) {
            ...
            jQuery('#account_code option[value="' + temp_accounts['account_code'] + '"]').prop('selected',
                true);
            jQuery('#account_name option[value="' + temp_accounts['account_code'] + '"]').prop('selected',
                true);
            jQuery('#posting_reference option[value="' + temp_accounts['posting_reference'] + '"]').prop(
                'selected', true);
