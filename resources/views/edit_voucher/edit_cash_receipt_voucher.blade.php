        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Edit Cash Receipt Voucher</h4>
                        </div>
                        <div class="list_btn">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                    ...
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                        <!-- invoice box start -->
                        <form id="f1" action="{{ route('update_cash_receipt_voucher', $voucher->cr_id) }}"
                                    ...
                                    <div class="invoice_row">
                                        ...
                                        <div class="invoice_col basis_col_23">
                                            <x-edit-account-component tabindex="1" name="account" class="cash_voucher"
                                                                      ...
                                                                      body="1" value="{{ $voucher->cr_account_id }}"/>
                                        </div>
                                        ...
                                        <div class="invoice_col basis_col_23">
                                            ...
                                            <x-edit-remarks-component tabindex="2" name="remarks" id="remarks"
                                                                      ...
                                                                      value="{{ $voucher->cr_remarks }}"/>
                                        </div>
                                        <div class="invoice_col basis_col_12">
                                            <!-- invoice column start -->
                                            <x-voucher-status-component value="{{ $voucher->cr_status }}"/>
                                        </div>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $.each(array, function (index, value) {
                ...
                var account_code = value.cri_account_id; //document.getElementById("account_code").value;
                var account_name = value.cri_account_name; //document.getElementById("account_name").value;
                var account_name_text = value
                    .cri_account_name; ////jQuery("#account_name option:selected").text();
                var amount = value.cri_amount; //document.getElementById("amount").value;
                var account_remarks = value.cri_remarks; //document.getElementById("account_remarks").value;
                var posting_reference = value
                    .cri_pr_id; //document.getElementById("posting_reference").value;
                var posting_reference_text = value
                    .name; //jQuery("#posting_reference option:selected").text();
