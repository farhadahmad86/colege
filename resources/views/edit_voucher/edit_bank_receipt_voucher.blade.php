        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Edit Bank Receipt Voucher</h4>
                        </div>
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                    ...
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                        ...
                        <form id="f1" action="{{ route('update_bank_receipt_voucher', $voucher->br_id) }}"
                                ...
                                <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                    ...
                                    <div class="invoice_row">
                                        ...
                                        <div class="invoice_col basis_col_20">
                                            <!-- invoice column -->
                                            <x-edit-account-component tabindex="4" name="account" class="bank_voucher"
                                                                      id="account" title="Bank"
                                                                      href="bank_account_registration"
                                                                      body="1" value="{{ $voucher->br_account_id }}"/>
                                        </div>
                                        ...
                                        <div class="invoice_col basis_col_23">
                                            ...
                                            <x-edit-remarks-component tabindex="2" name="remarks" id="remarks"
                                                                      ...
                                                                      value="{{ $voucher->br_remarks }}"/>
                                        </div>
                                        <div class="invoice_col basis_col_12">
                                            <!-- invoice column start -->
                                            <x-voucher-status-component value="{{ $voucher->br_status }}"/>
                                        </div>
                                    </div><!-- invoice row end -->
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $.each(array, function (index, value) {
                ...
                var account_code = value.bri_account_id
                var account_name = value.bri_account_id
                var account_name_text = value.bri_account_name
                var amount = value.bri_amount
                var account_remarks = value.bri_remarks
                var posting_reference = value.bri_pr_id
