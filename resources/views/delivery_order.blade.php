    ...
    <div class="row">
            <div class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Delivery Order</h4>
                        </div>
                        <div class="list_btn list_mul">
                            <a class="add_btn list_link add_more_button" href="{{ route('delivery_order_invoice_list') }}"
                               role="button">
                ...
                <div id="invoice_con" class="invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="invoice_bx"><!-- invoice box start -->
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_delivery_order') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                            @csrf
                            <div class="col-lg-12 invoice_bx_scrl"><!-- invoice scroll box start -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="pro_tbl_con col-lg-12"><!-- product table container start -->
                                            <div class="table-responsive pro_tbl_bx"><!-- product table box start -->
                                                <table class="table table table-bordered table-sm" id="category_dynamic_table">
                                                    <thead>
                                                    <tr>
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    <div class="invoice_inline_input_txt">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="total_items" class="inputs_up form-control text-right total-items-field" data-rule-required="true" data-msg-required="Please Select Party" id="total_items" readonly>
                                                        </div>
                                                    </div><!-- invoice inline input text end -->
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
