        ...
        <div
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Create Table</h4>
                        </div>
                        <div class="list_btn">
                            <a class="btn list_link add_more_button" href="{{route('table_list')}}" role="button">
                ...
                <form name="f1" class="f1" id="f1" action="{{route('submit_table')}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input type="text" name="table_name" id="table_name" class="inputs_up form-control" placeholder="Table Title" autofocus   data-rule-required="true" data-msg-required="Please Enter Table Title" autocomplete="off" value="{{ old('table_name') }}"/>
