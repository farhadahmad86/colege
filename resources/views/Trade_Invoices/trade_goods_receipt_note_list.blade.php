        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Goods Receipt Note List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ ( !empty($search) || !empty($search_account) || !empty($search_product) || !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('trade_goods_receipt_note_list') }}" name="form1" id="form1" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 srch_brdr_left">
                                <div class="row">
                                    ...
                                    <!-- Call add button component -->
                                        <x-add-button tabindex="9" href="{{ route('trade_goods_receipt_note') }}"/>
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $invoice)
                            ...
                            <tr>
                                ...
                                <td nowrap>
                                    {{date('d-M-y', strtotime(str_replace('/', '-', $invoice->grn_day_end_date)))}}
                                </td>
                                <td class=" view" data-id="{{$invoice->grn_id}}">
                                    TGRN-{{$invoice->grn_id}}
                                </td>
                                <td>
                                    {{$invoice->po_title}}
                                ...
                                <td>
                                    ...
                                    {!! str_replace("&oS;",'<br />', $invoice->grn_detail_remarks) !!}
                                </td>
                                @php
                                ...
                                @php
                                    $ip_browser_info= ''.$invoice->grn_ip_adrs.','.str_replace(' ','-',$invoice->grn_brwsr_info).'';
                                @endphp
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Trade Goods Receipt Note Detail</h4>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_goods_receipt_note_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            $('.modal-body').load('{{url("trade_goods_receipt_note_items_view_details/view/") }}' + '/' + id, function () {
