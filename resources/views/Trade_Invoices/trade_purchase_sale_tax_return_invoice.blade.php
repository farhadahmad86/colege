    ...
    <div class="row">
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Trade Purchase Tax Return Invoice</h4>
                    </div>
                    <div class="list_btn list_mul">
                        <a class="add_btn list_link add_more_button" href="{{ route('trade_sale_tax_purchase_return_invoice_list') }}" role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk"><!-- invoice box start -->
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_purchase_tax_return_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                        @csrf
                        <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                            <div class="invoice_cntnt"><!-- invoice content start -->
                                            ...
                                            <div class="invoice_col form-group col-lg-12 col-md-12 col-sm-12"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                        <a data-container="body" data-toggle="popover" data-trigger="hover" data-placement="left" data-html="true"
                                ...
                                <div class="invoice_row row"><!-- invoice row start -->
                                    <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12 hide_sale_tax">
                                        <!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                Product Tax
                                            ...
                                            <div class="invoice_col_txt"><!-- invoice column input start -->
                                                ...
                                                <div class="invoice_inline_input_txt hide_sale_tax"><!-- invoice inline input text start -->
                                                    ...
                                                    <div class="invoice_col_input lower_style lower_inputs">
                                                        <input type="text" name="total_tax" class="inputs_up form-control text-right lower_style lower_inputs" id="total_tax" readonly>
                                    ...
                                    <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12 hidden" hidden><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                        ...
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_txt"><!-- invoice column input start -->
                                                ...
                                                <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                    ...
                                                    <div class="invoice_col_input">
                                                        <input type="text" name="disc_percentage" class="inputs_up form-control text-right percentage_textbox lower_style lower_inputs"
                                                               id="disc_percentage"
                                                ...
                                                <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                    ...
                                                    <div class="invoice_col_input">
                                                        <input type="text" name="total_discount" class="inputs_up form-control text-right lower_style lower_inputs" id="total_discount" readonly>
                                                    </div>
                                                </div><!-- invoice inline input text end -->
                                        ...
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_txt"><!-- invoice column input start -->
                                                ...
                                                <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                    ...
                                                    <div class="invoice_col_input">
                                                        <input type="text" name="total_price" class="inputs_up form-control text-right lower_style lower_inputs" id="total_price"
                                                               data-rule-required="true" data-msg-required="Please Add"
                                                               readonly>
                                                ...
                                                <div class="invoice_inline_input_txt">
                                                    ...
                                                    <div class="invoice_col_input">
                                                        <input type="text" name="total_product_discount" class="inputs_up form-control text-right lower_style lower_inputs" id="total_product_discount"
                                                               readonly>
                                                    </div>
                                                </div><!-- invoice inline input text end -->
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Trade Sale Tax Purchase Return Invoice Detail</h4>
...
@section('scripts')
    ...
    @if (Session::get('ptri_id'))
        ...
        <script>
            ...
            var id = '{{ Session::get("ptri_id") }}';

            $('.modal-body').load('{{url("trade_return_purchase_items_sale_tax_view_details/view/")}}' + '/' + id, function () {
    ...
    <script>
        ...
        function product_amount_calculation_with_dis_amount(id, newRate = 0) {
            ...
            if ($("#inclusive_exclusive" + id).prop("checked") == true) {
                ...
                product_sale_tax_amount = product_sale_tax_amount.toFixed(2);
                ...
                var amount = gross_amount - trade_offer - product_discount_amount + +product_sale_tax_amount; //nabeel
        ...
        function product_amount_calculation(id, newRate = 0) {
            ...
            if ($("#inclusive_exclusive" + id).prop("checked") == true) {
                ...
                var amount = gross_amount - trade_offer - product_discount_amount; //nabeel
        ...
        function productChanged(product) {
            ...
            add_sale(parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                counter, 0, 0, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount, pack_qty, unit_qty, "", bottom, lastPR);
        ...
        jQuery("#product_code").change(function () {
            ...
            add_sale(parent_code, name, display_quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                counter, 0, 0, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount, 1, "", "", 0, 0);
        ...
        function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="tbl_srl_9">' +
                '<input type="text" name="gross_amount[]" tabindex="-1" ' +
                'class="lower_inputs inputs_up_tbl text-right" id="gross_amount' + counter + '" placeholder="Scale Size" value="' + gross_amount + '" readonly/>' +
                '</td>' +
                ...
                '<input type="text" tabindex="-1" readonly onkeyup="product_amount_calculation_with_dis_amount(' + counter + '),tab_within_table(event,' + counter + ')"  ' +
                'name="product_discount_amount[]" ' +
                'id="product_discount_amount' + counter + '" placeholder="Dis Amount" value="' + discount_amount + '" class="lower_inputs inputs_up_tbl text-right" ' +
                '/> ' +
                ...
                'onkeyup="product_amount_calculation(' + counter + '),tab_within_table(event,' + counter + ')" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/> ' +
                '</td> ' +
                '<td class="text-right tbl_srl_7" > ' +
                '<input type="text" tabindex="-1" name="product_sale_tax_amount[]" id="product_sale_tax_amount' + counter + '" placeholder="Tax Amount" value="' + sale_tax_amount + '" ' +
                'class="inputs_up_tbl ' +
                'text-right" readonly/> ' +
                '</td> ' +
                '<td hidden class="tbl_srl_4" > ' +
                '<input type="checkbox" name="inclusive_exclusive[]" id="inclusive_exclusive' + counter + '" onclick="product_amount_calculation(' + counter + ');' + '"' + inclusive_exclusive_status + 'onkeyup="tab_within_table(event,' + counter + ')" value="1"/> ' +
                ...
                success: function (data) {
                    ...
                    if (data.length !== 0) {
                        ...
                        $.each(data[1], function (index, value) {
                            ...
                            var sale_tax_amount = 0;
                            sale_tax_amount = value[item_prefix + '_saletax_amount'];
                            // var amount = 0;
                            ...
                            var gross_amount = display_quantity * rate;
                            if (inclusive_exclusive == 0) {
                                var trade_offer_val = +(gross_amount - amount - discount_amount) + +sale_tax_amount;
                            } else {
                            ...
                            add_sale(parent_code, name, display_quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                                inclusive_exclusive, counter, 0, warehouse_id, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount, pack_qty, unit_qty, trade_offer, 0, 0);
