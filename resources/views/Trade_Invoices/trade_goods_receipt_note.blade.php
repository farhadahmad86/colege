    ...
    <div class="row">
            <div id="main_bg" class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Trade Goods Receipt Note</h4>
                        </div>
                        <div class="list_btn list_mul">
                            <a class="add_btn list_link add_more_button" href="{{ route('trade_goods_receipt_note_list') }}"
                               role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-blk invoice_bx"><!-- invoice box start -->
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_goods_receipt_note') }}"
                            ...
                            <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="invoice_cntnt"><!-- invoice content start -->
                                    <div class="invoice_row"><!-- invoice row start -->
                                                    ...
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="invoice_nbr_chk"
                                                                ...
                                                                class="inputs_up form-control" id="invoice_nbr_chk" placeholder="Check Invoice Number">
                                        ...
                                        <div class="form-group col-lg-2 col-md-3 col-sm-12" id="filters">
                                            ...
                                            <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                        <a data-container="body" data-toggle="popover" data-trigger="hover" data-placement="left" data-html="true" data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.invoice.round_off_discount.description')}}</p>
                                                    ...
                                                    <!-- add start -->
                                                    <div class="custom-checkbox float-left mr-2 form-group">
                                                        <input type="checkbox" value="1" name="check_multi_warehouse" class="custom-control-input company_info_check_box" id="check_multi_warehouse">
                                                        <label class="custom-control-label chck_pdng" for="check_multi_warehouse"> Multi Warehouse </label>
                                                    </div>
                                                    {{--auto add--}}
                                                    {{--Quick print start--}}
                                                    <div class="custom-checkbox float-left">
                                                        ...
                                                        <label class="custom-control-label chck_pdng" for="quick_print"> Quick Print
                                                        </label>
                                                    </div>
                                                </div><!-- invoice column box end -->
                                            </div><!-- invoice column end -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        <div class="pro_tbl_con col-lg-12"><!-- product table container start -->
                                                    ...
                                                    <div class="invoice_inline_input_txt mb-0">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="total_items"
                                                                   class="inputs_up form-control text-right total-items-field lower_inputs lower_style" data-rule-required="true" data-msg-required="Please Select Party"
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Goods Receipt Note Detail</h4>
...
@section('scripts')
    ...
    @if (Session::get('grni_id'))
        <script>


            jQuery("#table_body").html("");

            var id = '{{ Session::get("grni_id") }}';

            $('.modal-body').load('{{url("goods_receipt_note_items_view_details/view/")}}' + '/' + id, function () {
...
// alert('warehouse');
    ...
    <script>
        ...
        function productChanged(product)
        {
            ...
            // rate, gross_amount,
            add_sale(parent_code, name, quantity, bonus_qty, rate, remarks, counter, 0, unit_measurement, unit_measurement_scale_size, main_unit, pack_qty, unit_qty);
        ...
        // rate, gross_amount,
        function add_sale(code, name, quantity, bonus_qty, rate, remarks, counter,
                          product_or_service_status, unit_measurement, unit_measurement_scale_size, main_unit_measurement, pack_qty, unit_qty) {
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="text-right tbl_srl_3 edit_update_bx-main"> ' +
                '<div class="edit_update_bx"> <div class="inc_dec_con">' +
                    '<div class="inc_dec_bx for_inc btn btn-sm btn-primary"><i class="fa fa-plus" onclick=increase_quantity(' + counter + ')></i></div>' +
                    // '<div class="inc_dec_bx for_val">1</div>' +
                    '<div class="inc_dec_bx for_dec btn btn-sm btn-primary"><i class="fa fa-minus" onclick=decrease_quantity(' + counter + ')></i></div>' +
                '</div> ' +
