                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_80 upper">
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_23 pl-3 hidden"><!-- invoice column start -->
                                                    <x-party-name-component tabindex="1" name="account_code" id="account_code" class="purchase"/>
                                                </div>

                                                <div class="invoice_col basis_col_23 pl-3"><!-- invoice column start -->
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_32 pl-3">
                                                ...
                                                <div class="invoice_col basis_col_32 pl-3"><!-- invoice column start -->
