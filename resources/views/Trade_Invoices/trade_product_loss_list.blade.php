        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Product Lost List</h4>
                        </div>
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('trade_product_loss_list') }}" name="form1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12 text-right mt-4">
                                        ...
                                        <!-- Call add button component -->
                                            <x-add-button tabindex="9" href="{{ route('trade_product_loss') }}"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_product_loss_list') }}',
            url;
