    ...
    <div class="row">
        ...
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            ...
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Trade Sale Tax Invoice</h4>
                    </div>
                    <div class="list_btn list_mul">

                        <a class="add_btn list_link add_more_button"
                            href="{{ route('trade_sale_tax_sale_invoice_list') }}" role="button">
            ...
            <div id="invoice_con"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    ...
                    {{--form start--}}
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_sale_tax_invoice') }}"
                        ...
                        <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                            ...
                            <div class="invoice_row row">
                                <div class="invoice_col col-lg-4 col-md-4 col-sm-12"><!-- invoice column start -->
                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                        <div class="invoice_col_ttl"><!-- invoice column title start -->
                                            <a data-container="body" data-toggle="popover"
                                                data-trigger="hover"
                            ...
                            <div class="invoice_row row"><!-- invoice row start -->
                                ...
                                {{--Lower section col 5 --}}
                                <div class="col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                    <div class="invoice_row row"><!-- invoice row start -->
                                        <div class="invoice_col col-lg-12 col-md-12 col-sm-12" id="zero_marg">
                                            <!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class=" invoice_col_ttl">
                                                    <!-- invoice column title start -->
...
@section('scripts')
    ...
    @if (Session::get('ssi_id'))
        <script>
            ...
            $('.modal-body').load('{{url("trade_sale_tax_sale_invoice_list/view/") }}' + '/' + id, function () {
    ...
    <script>
        ...
        function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                // Hamad set tab index
                '<input type="text" tabindex="-1" name="product_discount_amount[]" id="product_discount_amount' + counter + '" placeholder="Dis Amount" value="' + discount_amount +
                '"onfocus="this' +
                '.select' +
                '();"' +
...
<script>
    ...
    document.addEventListener('keyup', function (event) {
        ...
        if (event.keyCode === 9) {  // means tab
            if ($("#product_sale_tax_amount" + counter)[0] == $(document.activeElement)[0]) {
                $("#product").focus();
            }
            event.preventDefault();
        }
