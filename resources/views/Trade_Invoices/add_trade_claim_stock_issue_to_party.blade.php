    ...
    <div class="row">
        ...
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            ...
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Trade Claim Stock Issue To Party</h4>
                    </div>
                    <div class="list_btn list_mul">
                        <a class="add_btn list_link add_more_button" href="{{ route('trade_claim_stock_issue_to_party_list') }}"
                            role="button">
            ...
            <div id="invoice_con"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    {{--form start--}}
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_claim_stock_issue_to_party') }}"
                                ...
                                <div class="invoice_row"><!-- invoice row start -->
                                    ...
                                    <div class="invoice_col form-group col-lg-10 col-md-9 col-sm-12 upper">
                                        ...
                                        <div class="invoice_row"> <!--row1 start -->
                                            ...
                                            <div class="form-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input">
                                                        ...
                                                        <input tabindex="2" type="text" name="purchase_invoice"
                                                                class="inputs_up form-control" id="purchase_invoice"
                                            ...
                                            <div class="orm-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                            ...
                                            <div class="orm-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input">
                                                        <!-- invoice column input start -->
                                                        {{--Hamad set tab index--}}
                                                        <input tabindex="4" type="text" name="sale_return_invoice"
                                                                class="inputs_up form-control" id="sale_return_invoice"
                                                                placeholder="Sale Return Invoice"
                                           ...
                                           <!-- invoice row start -->
                                            ...
                                            <div class="form-group col-lg-4 col-md-4 col-sm-12"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input">
                                                        {{--Hamad set tab index--}}
                                                        <input tabindex="7" type="text" name="remarks" class="inputs_up form-control"
    ...
    document.addEventListener('keyup', function (event) {
        ...
        if (event.keyCode === 107) {     // means plus(+)
            ...
            if ($(document.activeElement)[0].parentElement.parentElement.previousElementSibling == $("#party_claim_account")[0]) {
                $("#purchase_invoice").focus();
            } else if ($("#purchase_invoice")[0] == $(document.activeElement)[0]) {
                $("#sale_return_invoice").focus();
            } else if ($("#sale_return_invoice")[0] == $(document.activeElement)[0]) {
                $("#product").focus();
            }
