    ...
    <div class="row">
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Trade Delivery Order Sale Invoice</h4>
                    </div>
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng"><!-- invoice container start -->
                <div id="invoice_bx" class="invoice_bx"><!-- invoice box start -->
                    ...
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_delivery_order_sale_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                        @csrf
                        <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                            <div class="invoice_cntnt"><!-- invoice content start -->
                                ...
                                <div class="invoice_row"><!-- invoice row start -->
                                    <!-- add start -->
                                    <div class="invoice_col form-group col-lg-10 col-md-9 col-sm-12">
                                        <div class="invoice_row"><!-- invoice row start -->
                                                    ...
                                                    <div class="invoice_col_input">
                                                        ...
                                                        <div class="invoice_col_short">
                                                            <!-- invoice column short start -->
                                                                {{--<a href="{{ route('trade_delivery_order') }}" target="_blank"--}}
                                        ...
                                        <div hidden class="invoice_col form-group col-lg-12 col-md-12 col-sm-12"><!-- invoice column start -->
                                            ...
                                            <div class="invoice_col form-group col-lg-12 col-md-12 col-sm-12"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_txt mt-0" style="line-height: 1">
                                                        <!-- invoice column input start -->
                                                        <div class="form-group custom-checkbox float-left mr-3">
                                                            <input tabindex="-1" type="checkbox" name="round_off" class="custom-control-input company_info_check_box" id="round_off" value="1" onchange="grand_total_calculation_with_disc_amount();">
                                                            <label class="custom-control-label chck_pdng" style="padding-top: 5px" for="round_off"> Auto Round OFF </label>
                                                            <input tabindex="-1" type="hidden" name="round_off_discount" id="round_off_discount">
                                                        </div>
                                                        <div class="custom-checkbox float-left pb-1">
                                                            <input type="checkbox" value="1" name="quick_print" class="custom-control-input company_info_check_box" id="quick_print" onclick="store_print_checkbox()">
                                                            <label class="custom-control-label chck_pdng" style="padding-top: 5px" for="quick_print"> Quick Print</label>
                                                        </div>
                                                    </div><!-- invoice column input end -->
                                                    {{--                                                        Quick print start--}}
                                                </div><!-- invoice column box end -->
                                ...
                                <div class="invoice_row"><!-- invoice row start -->
                                    <div class="invoice_col col-lg-3 col-md-3 col-sm-12 payment_div"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                    data-placement="bottom" data-html="true"
                                    ...
                                    <div class="invoice_col col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                    data-placement="bottom" data-html="true"
                                    ...
                                    <div class="invoice_col col-lg-3 col-md-3 col-sm-12payment_div"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                    data-placement="bottom" data-html="true"
...
@section('scripts')
    ...
    <script>
        ...
        var GET_PRODUCTS_ROUTE = '{{ route('ajax_get_json_trade_delivery_order_sale_invoice') }}';
    </script>
    ...
    <script>
        ...
        function add_sale(delivery_order_id, code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
            ...
            // add_sale(code, name, display_quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
    ...
    <script>
        ...
        jQuery("#check_return_invoice").click(function () {
            ...
            if (n == false) {
                ...
                jQuery.ajax({
                    url: "{{route('get_delivery_order_items_for_sale')}}",
                    ...
                    success: function (data) {
                        ...
                        if (data.message != "not eligible") {
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                        ...
                                                        $.each(data[1], function (index, value) {
                                                            ...
                                                            add_sale(do_code, parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks,
                                                                rate_after_discount,
                                                                inclusive_exclusive, counter, 0, warehouse_id, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount,
                                                                pack_qty, unit_qty, "");
                            ...
                            var d = new Date(data.deliveryDate);
                            var delivery_Date = d.getDate() + "-" + (d.getMonth() + 1) + "-" + d.getFullYear();
                            var dayEnd = new Date(data.dayEndDate);
                            var dayEnd_Date = dayEnd.getDate() + "-" + (dayEnd.getMonth() + 1) + "-" + dayEnd.getFullYear();
                            var Meldungstext = "";
                            Meldungstext = Meldungstext + '<p align="left"> Your System Financial Date is  <strong>' + dayEnd_Date + '</strong> <br>'
                            Meldungstext = Meldungstext + '<p align="left"> Invoice from Delivery Order can be generated from Delivery Order Date <strong>' + delivery_Date + '</strong>';
                            swal.fire({
                                type: 'error',
                                // title: 'Oops...',
                                html: Meldungstext,
