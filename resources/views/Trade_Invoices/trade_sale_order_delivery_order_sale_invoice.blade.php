    ...
    <div class="row">
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Trade Sale Order Delivery Order Sale Invoice</h4>
                    </div>
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_sale_order_sale_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                        @csrf
                        <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt"><!-- invoice content start -->
                                <div class="invoice_row"><!-- invoice row start -->
                                    ...
                                    <div class="invoice_col form-group col-lg-10 col-md-9 col-sm-12 upper">
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="invoice_col form-group col-lg-4 col-md-5 col-sm-12"><!-- invoice column start -->
                                                <x-remarks-component tabindex="5" name="remarks" title="Remarks" id="remarks"/>
                                            </div>

                                        </div><!-- invoice row end -->

                                        <div hidden class="invoice_col basis_col_100"><!-- invoice column start -->
                                                    ...
                                                    <div class="table-responsive pro_tbl_bx"><!-- product table box start -->
                                                        <table class="table table-bordered table-sm" id="category_dynamic_table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="tbl_srl_4"> Order ID</th>
                                                                ...
                                                                <th class="tbl_srl_6">Pack Size</th>
                                ...
                                <div class="invoice_row"><!-- invoice row start -->
                                    ...
                                    <div class="invoice_col form-group col-lg-3 col-md-4 col-sm-12 payment_div"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                    data-placement="bottom" data-html="true"
...
@section('scripts')
    ...
    @if (Session::get('dosi_id'))
        <script>


            jQuery("#table_body").html("");

            var id = '{{ Session::get("dosi_id") }}';
