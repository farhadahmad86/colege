...
@section('content')
    <div class="row">
            <div class="container-fluid search-filter form-group form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Purchase Return Invoice List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ ( !empty($search) || !empty($search_account) || !empty($search_product) || !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}"> -->
                <div class="search_form m-0 p-0">
                            <form class="highlight prnt_lst_frm" action="{{ route('trade_purchase_return_invoice_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
    ...
    <x-add-button tabindex="9" href="{{ route('trade_purchase_return_invoice') }}"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_purchase_return_invoice_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            {{--            '<td class="align_left text-right">0.00</td>' +--}}
            {{--            '</tr>' +--}}
            {{--            '</tbody>' +--}}
