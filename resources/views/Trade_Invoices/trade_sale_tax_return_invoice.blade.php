    ...
    <div class="row">
            <div id="main_bg" class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Trade Sale Tax Return Invoice</h4>
                        </div>
                        <div class="list_btn list_mul">

                            <a class="add_btn list_link add_more_button"
                               href="{{ route('trade_sale_tax_sale_return_invoice_list') }}" role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_sale_tax_return_invoice') }}"
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="invoice_cntnt">
                                                ...
                                                <div class="form-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            {{--                                                            Hamad set tab index--}}
                                                            <select tabindex="1" autofocus name="account_name"
                                                                ...
                                                                @foreach($accounts as $account)
                                                                    <option value="{{$account->account_uid}}"
                                                                            {{ $account->account_uid == 110161 ? 'selected':'' }}
                                    ...
                                    <!-- Taxes ki row added start -->
                                    <div class="invoice_row row">
                                        <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12 payment_div " style="display: none"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover"
                                                       data-trigger="hover"
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    <div class="invoice_row row mt-1">

                                                        <div class="invoice_inline_input_txt basis_col_50 px-2">
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Trade Sales Tax Return Invoice Detail</h4>
...
@section('scripts')
    ...
    @if (Session::get('srsi_id'))
        <script>
            jQuery("#table_body").html("");

            var id = '{{ Session::get("srsi_id") }}';

            $('.modal-body').load('{{ url("trade_sale_tax_sale_return_invoice_list/view/") }}' + '/' + id, function () {
...
// alert('warehouse');
    ...
    <script>
        ...
        function popvalidation() {
            ...
            $('input[name="pro_code[]"]').each(function (pro_index) {
                ...
                display_quantity = +jQuery("#display_quantity" + pro_field_id).val();
    ...
    <script>
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        add_sale(parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                            inclusive_exclusive, counter, 0, 0, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount, pack_qty, unit_qty, "", 0, 0);
        ...
        function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="tbl_srl_9">' +
                '<input type="text" tabindex="-1" name="gross_amount[]" ' +
                ...
                'onkeyup="product_amount_calculation_with_dis_amount(' + counter + '),tab_within_table(event,' + counter + ')"  name="product_discount_amount[]" id="product_discount_amount' + counter + '" placeholder="Dis Amount" value="' + discount_amount + '" class="lower_inputs inputs_up_tbl text-right" ' +
                '/> ' +
                ...
                '<input type="text" tabindex="-1" name="product_sale_tax_amount[]" ' +
                'id="product_sale_tax_amount' + counter + '" placeholder="Tax Amount" value="' + sale_tax_amount + '" class="inputs_up_tbl text-right" readonly/> ' +
                '</td> ' +
                '<td hidden class="tbl_srl_4"> <input type="checkbox" name="inclusive_exclusive[]" id="inclusive_exclusive' + counter + '" onclick="product_amount_calculation(' + counter + ')" onkeyup="tab_within_table(event,' + counter + ')"'
    ...
    <script>
        jQuery("#check_return_invoice").click(function () {
            ...
            jQuery.ajax({
                url: "get_trade_sale_items_for_return",
