...
@section('content')
   ...
   {{--                form header --}}
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Trade Sale Order</h4>
                    </div>
                    <div class="list_btn list_mul">
                        <a class="add_btn list_link add_more_button" href="{{ route('trade_sale_order_list') }}"
                            role="button">
            ...
            <div id="invoice_con"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    ...
                    {{--form start--}}
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_sale_order') }}"
                                ...
                                <div class="invoice_row"><!-- invoice row start -->
                                    ...
                                    <div class="invoice_col form-group col-lg-10 col-md-9 col-sm-12 upper">
                                        ...
                                        <div class="invoice_row"> <!--row1 start -->
                                            ...
                                            <!-- changed -->
                                            <div class="invoice_col form-group col-lg-3 col-md-4 col-sm-12"><!-- invoice column -->
                                        ...
                                        <div class="invoice_row"><!--row2 start -->
                                            ...
                                            <!-- changed -->
                                            <div class="invoice_col form-group col-lg-3 col-md-4 col-sm-12">
                        ...
                        {{--Lower section start--}}
                        <div class="invoice_row justify-content-end mt-1 mr-2"><!-- invoice row start -->

                            {{--Lower section col 1 --}}
                            <div hidden class="invoice_col basis_col_18 pl-3"><!-- invoice column start -->
                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                    <div class="invoice_col_ttl"><!-- invoice column title start -->
                                        <a data-container="body" data-toggle="popover"
                                            data-trigger="hover"
                            ...
                            {{--Lower section col 5 --}}
                            <div hidden class="invoice_col basis_col_24 pl-3"><!-- invoice column start -->
