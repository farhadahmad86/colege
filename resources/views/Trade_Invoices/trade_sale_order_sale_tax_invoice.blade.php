        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Trade Sale Order Sale Tax Invoice</h4>
                        </div>
                        <div class="list_btn list_mul">
                            <a class="add_btn list_link add_more_button" href="{{ route('trade_sale_invoice_list') }}" role="button">
                                <i class="fa fa-list"></i> Sale Order Sale Invoice
                            </a>
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_sale_order_sale_tax_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                            @csrf
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        <!-- add start -->
                                        <div class="invoice_col basis_col_80 upper">
                                            <!-- add start -->
                                            <div class="invoice_row"><!-- invoice row start -->
                                                <div class="invoice_col basis_col_24 pl-2">
                                                ...
                                                <div class="invoice_col basis_col_24 pl-2"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                            <!-- invoice column title start -->
                                                            Party
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <select name="account_name"
                                                                    ...
                                                                    onkeydown="return not_plus_minus(event)"
                                                                    data-msg-required="Please Enter Party"
                                                ...
                                                <div class="invoice_col basis_col_14 pl-2"><!-- invoice column start -->
                                            ...
                                            <div hidden class="invoice_col basis_col_100 gnrl-mrgn-pdng"><!-- invoice column start -->
                                                <div class="invoice_col_bx for_tabs"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_txt for_invoice_nbr" hidden><!-- invoice column input start -->
                                                        <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                            ...
                                                            <div class="inline_input_txt_lbl" for="service_total_inclusive_tax">
                                                                <input type="button" class="invoice_chk_btn" value="check" id="check_return_invoice" autofocus tabindex="1"/>
                                                            </div>
                                            ...
                                            <div class="invoice_row" hidden><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_25_2"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            ...
                                                            <div class="invoice_col_short"><!-- invoice column short start -->
                                                                <a href="{{ url('product_packages') }}" class="col_short_btn" target="_blank" data-container="body" data-toggle="popover"
                                                                   data-trigger="hover"
                                                                   data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                ...
                                                <div class="invoice_col basis_col_25_5"><!-- invoice column start -->
                                                    <x-warehouse-component tabindex="7" name="warehaouse" id="warehouse" class="refresh_warehouse"/>
                                                </div>
                                        ...
                                        <div class="invoice_col basis_col_18" id="filters">
                                            <!-- invoice column start -->
                                    ...
                                    <div hidden class="invoice_row"><!-- invoice row start -->
                                        <div class="invoice_col basis_col_50 upper">
                                            ...
                                            <h6>Example</h6><p>{{config('fields_info.about_form_fields.general_registration.warehouse.warehouse_title.example')}}</p>">
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            ...
                                                            <div class="invoice_col_short"><!-- invoice column short start -->
                                                                <a href="{{ url('add_warehouse') }}" class="col_short_btn" target="_blank" data-container="body" data-toggle="popover"
                                                                   data-trigger="hover"
                                                                   data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                                    <l class="fa fa-plus"></l>
                                                                </a>
                                                                <a id="refresh_warehouse" class="col_short_btn" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom"
                                                                   data-html="true" data-content="{{config('fields_info.about_form_fields.refresh.description')}}">
                                                                    <l class="fa fa-refresh"></l>
                                                                </a>
                                                            </div><!-- invoice column short end -->
                                                            <select tabindex="7" name="warehouse" class="inputs_up form-control js-example-basic-multiple" id="warehouse">
                                        ...
                                        <div class="invoice_col basis_col_22 mt-3"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class=" invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                       data-placement="bottom" data-html="true"
                                                    ...
                                                    <div class="invoice_row"><!-- invoice row start -->
                                                        ...
                                                        <div class="radio ml-3">
                                                            <label>
                                                                ...
                                                                <input type="radio" name="order_sale_type" class="invoice_type" id="order_sale_type1" value="0" checked>
                                                                Sale Order
                                                            </label>
                                                        </div>
                                                        <div class="radio ml-3">
                                                            <label>
                                                                <input type="radio" name="order_sale_type" class="invoice_type" id="order_sale_type2" value="1">
                                                        ...
                                                        <div class="pro_tbl_bx"><!-- product table box start -->
                                                            <table class="table table-bordered table-sm gnrl-mrgn-pdng" id="category_dynamic_table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center tbl_srl_4"> Order ID</th>
                                                                    ...
                                                                    <th class="text-center tbl_srl_4">DB Qty</th>
                                                                    <th class="text-center tbl_srl_4">Pack Qty</th>
                                                                    <th class="text-center tbl_srl_4">Pack Rate</th>
                                                                    <th class="text-center tbl_srl_4">Loose Qty</th>

                                                                    <th class="text-center tbl_srl_6">Loose Rate</th>
                                                                    <th class="text-center tbl_srl_9">Gross Amount</th>
                                                                    <th class="text-center tbl_srl_5">Bonus</th>
                                                                    <th class="text-center tbl_srl_4">UOM</th>
                                                                    ...
                                                                    <th class="text-center tbl_srl_4" >Inclu</th>
                                                                    <th class="text-center tbl_srl_9"> Net Amount</th>
                                                                    <th class="text-center tbl_srl_3"> Del</th>
                                                ...
                                                <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_txt"><!-- invoice column input start -->
                                                            ...
                                                            <div class="radio">
                                                                <label>
                                                                    <input checked type="radio" name="invoice_type" class="invoice_type" id="invoice_type2" value="2">
                                                                    Tax Invoice
                                                                </label>
                                                            </div>
                                                        </div><!-- invoice column input end -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_txt"><!-- invoice column input start -->
                                                        <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                            ...
                                                            <div class="invoice_col_input">
                                                                <input type="text" name="total_inclusive_tax" class="inputs_up form-control text-right lower_inputs lower_style" id="total_inclusive_tax" readonly>
                                                            </div>
                                                        </div><!-- invoice inline input text end -->
                                                        <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                            ...
                                                            <div class="invoice_col_input">
                                                                <input type="text" name="total_exclusive_tax" class="inputs_up form-control text-right lower_inputs lower_style" id="total_exclusive_tax" readonly>
                                                            </div>
                                                        </div><!-- invoice inline input text end -->
                                        ...
                                        <div class="invoice_col basis_col_18 payment_div"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                       data-placement="bottom" data-html="true"
                                        ...
                                        <div class="invoice_col basis_col_18"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    ...
                                                    <div class="invoice_inline_input_txt" hidden><!-- invoice inline input text start -->
                                        ...
                                        <div class="invoice_col basis_col_18"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt payment_div"><!-- invoice column input start -->
                                                    ...
                                                    <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="credit_card_amount_view" class="inputs_up form-control text-right lower_inputs lower_style"
                                                                   id="credit_card_amount_view"
                                                                   onkeypress="return allow_only_number_and_decimals(this,event);" onfocus="this.select();" readonly>
                                                        </div>
                                                    </div><!-- invoice inline input text end -->
...
@section('scripts')
    ...
    @if (Session::get('dosti_id'))
        <script>


            jQuery("#table_body").html("");

            var id = '{{ Session::get("dosti_id") }}';

            $('.modal-body').load('{{url("sale_tax_sale_invoice_list/view/")}}' + '/' + id, function () {
    ...
    <script>
        ...
        var GET_PRODUCTS_ROUTE = '{{ route('ajax_get_json_trade_sale_order_sale_invoice') }}';
    </script>
    ...
    <script>
        ...
        function unit_rate_changed_live(id) {
            ...
            var pack_rate = (jQuery("#rate_per_pack" + id).val() !== 0 || jQuery("#rate_per_pack" + id).val() !== "NaN" || jQuery("#rate_per_pack" + id).val() !== "") ? jQuery
            ("#rate_per_pack" + id).val() : 1;
        ...
        function check_qty(e) {
            var qty_id = e.getAttribute('id');
            var data_atte = e.getAttribute('data-max_qty');

            if (parseFloat(e.value) > parseFloat(data_atte)) {
                e.value = 0;
            }
        }
        ...
        function product_amount_calculation(id, newRate = 0) {
            ...
            var db_get_qty = jQuery("#db_get_qty" + id).val();
            ...
            if (unit_measurement_scale_size == "") {   //if service is entered
                ...
                if (parseInt(db_get_qty) < parseInt(quantity)) {
        ...
        jQuery("#product_code").change(function () {
            ...
            add_sale(do_code, parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                inclusive_exclusive,
                counter, 0, 0, unit_measurement, unit_measurement_scale_size, rate_per_pack, gross_amount);
        ...
        function add_sale(delivery_order_id, code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                          inclusive_exclusive,
                          counter, product_or_service_status, select_return_warehouse, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount, pack_qty, unit_qty, trade_offer) {
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<input type="text" name="delivery_order_id[]" id="delivery_order_id' + counter + '" placeholder="Name" ' + 'class="inputs_up_tbl" value="' + delivery_order_id + '" readonly/>' +
                '</td> ' +
                ...
                '<td class="text-center tbl_srl_4">' +
                '<input type="text" name="quantity[]" id="quantity' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + '), check_qty(this,' + counter + ')' +
                '"' +
                'value="' +
                quantity + '" data-max_qty="' + quantity + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/>' +

                '<input type="hidden" name="db_get_qty[]" id="db_get_qty' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + ')" value="' +
                quantity + '" data-max_qty="' + quantity + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/>' +
                '</td>' +

                '<td class="text-center tbl_srl_4">' +
                '<input type="text" name="display_quantity[]" id="display_quantity' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + '),' +
                'tab_within_table(event,' + counter + ')" value="' +
                pack_qty + '" data-max_qty="' + quantity + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);" onfocusout="checkQty(' + counter + ')"/>' +
                '</td>' +

                '<td class="text-center tbl_srl_4">' +
                '<input type="text" name="rate_per_pack[]" onkeyup="unit_rate_changed_live(' + counter + '),tab_within_table(event,' + counter + ')" class="inputs_up_tbl" id="rate_per_pack' + counter + '" placeholder="Rate Per Price" ' +
                'value="' + rate_per_pack + '" onkeypress="return allow_only_number_and_decimals(this,event);"/>' +
                '</td>' +

                // new empty
                '<td class="text-center tbl_srl_4">' +

                '<input type="text"  name="unit_qty" id="unit_qty' + counter + '" ' + ' placeholder="0" value="' + unit_qty + '" class="inputs_up_tbl"   ' +
                'onkeyup="product_amount_calculation(' + counter + '),tab_within_table(event,' + counter + ')"' +
                '" onfocus="this.select();" data-max_qty="' + quantity + '" onkeypress="return allow_only_number_and_decimals(this,event);" onfocusout="checkQty(' + counter + ')"/> ' +
                '</td>' +
                ...
                '<div class="edit_update_bx">' +
                /*'<div class="inc_dec_con">' +
    ...
    <script>
        ...
        jQuery("#check_return_invoice").click(function () {
            ...
            if (n == false) {
                ...
                jQuery.ajax({
                    url: "{{route('get_sale_order_items_for_sale')}}",
                    ...
                    success: function (data) {
                                ...
                                if (data.length !== 0) {
                                    if (table_data == '') {
                                        ...
                                        $.each(data[1], function (index, value) {
                                            ...
                                            var product_or_service_status = value[item_prefix + '_pro_ser_status'];
                                            var do_code = value[item_prefix + '_invoice_id'];
                                            var parent_code = value[item_prefix + '_product_code'];
                                            var name = value[item_prefix + '_product_name'];
                                            jQuery('#product_name option[value="' + parent_code + '"]').prop('selected', true);
                                            $("#product_name option:selected").text();
                                            var quantity = value[item_prefix + '_due_qty'];
                                            $("#product_name option:selected").attr('data-unit');
                                            var unit_measurement_scale_size = value[item_prefix + '_scale_size'];
                                            $("#product_name option:selected").attr('data-unit_scale_size');
                                            ...
                                            if (product_or_service_status == 1) {
                                                var rate = value[item_prefix + '_service_rate'];
                                                var unit_measurement = "";
                                                var main_unit = "";
                                            } else {
                                                var main_unit = $("#product_name option:selected").attr('data-main_unit');
                                                var unit_measurement = value[item_prefix + '_uom'];
                                            ...
                                            add_sale(do_code, parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks,
                                                rate_after_discount,
                                                inclusive_exclusive, counter, product_or_service_status, warehouse_id, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount, pack_qty, unit_qty, "");
                                            ...
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    ...
                                                    $.each(data[1], function (index, value) {
                                                        ...
                                                        add_sale(do_code, parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks,
                                                            rate_after_discount,
                                                            inclusive_exclusive, counter, product_or_service_status, warehouse_id, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount,
                                                            pack_qty, unit_qty, "");
                                        ...
                                        if (data[0][prefix + '_party_code'] == account) {
                                            ...
                                            $.each(data[1], function (index, value) {
                                                ...
                                                var warehouse_id = value[item_prefix + '_warehouse_id'];
                                                if (product_or_service_status == 1) {
                                                    var rate = value[item_prefix + '_service_rate']; // sale order rate
                                                    var unit_measurement = "";
                                                    var main_unit = "";
                                                } else {
                                                    var main_unit = $("#product_name option:selected").attr('data-main_unit');
                                                    var unit_measurement = value[item_prefix + '_uom'];
                                                    var rate = value[item_prefix + '_rate'];// product sale rate
                        ...
                        //         type: 'error',
                        //         title: 'Oops...',
                        //         text: 'You are not eligible for generate sale invoice against the delivery order',
                        //         showCancelButton: false,
                        //         confirmButtonClass: 'btn btn-success',
                        //         timer: 4000
                        //     });
    ...
    <script>
        ...
        document.addEventListener('keyup', function (event) {
            ...
            if (event.keyCode === 9) {  // means tab
                ...
                if ($("#save")[0] == $(document.activeElement)[0]) {
                    $("#product").focus();
                }
