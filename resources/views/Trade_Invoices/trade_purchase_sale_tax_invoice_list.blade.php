    ...
    <div class="row">
            <div class="container-fluid search-filter form-group form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name"> Trade Sale Tax Purchase Invoice List</h4>
                        </div>
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('trade_sale_tax_purchase_invoice_list') }}"
...
<x-add-button tabindex="9" href="{{ route('trade_purchase_tax_invoice') }}"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_sale_tax_purchase_invoice_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function() {
            ...
            $('.modal-body').load('{{ url('trade_purchase_items_sale_tax_view_details/view/') }}' + '/' + id,
                function() {
                    $('#myModal').modal({
                        show: true
                    });
