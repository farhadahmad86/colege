    ...
    <div class="row">
            <div class="container-fluid search-filter form-group form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Sale Tax Purchase Return Invoice List
                            </h4>
                        </div>
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('trade_sale_tax_purchase_return_invoice_list') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                                ...
                                <x-add-button tabindex="9" href="{{ route('trade_purchase_tax_return_invoice') }}"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_sale_tax_purchase_return_invoice_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function() {
            ...
            $('.modal-body').load('{{ url('trade_return_purchase_items_sale_tax_view_details/view/') }}' + '/' +
                id,
                function() {
                    $('#myModal').modal({
                        show: true
