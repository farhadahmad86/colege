    ...
    <div class="row">
            <div class="container-fluid search-filter form-group form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Purchase Invoice List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ ( !empty($search) || !empty($search_account) || !empty($search_product) || !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}"> -->
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('trade_purchase_invoice_list') }}" name="form1" id="form1" method="post">
                        @csrf
                        <div class="row">
...
<x-add-button tabindex="9" href="{{ route('trade_purchase_invoice') }}"/>
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $invoice)
                            ...
                            <tr>
                                ...
                                <td class="view tbl_amnt_6" data-id="{{$invoice->pi_id}}">
                                    TPI-{{$invoice->pi_id}}
                                </td>
                                ...
                                <td class="tbl_txt_15 fonti">
                                    {{$invoice->pi_remarks}}
                                </td>
                                <td class="tbl_txt_25">

                                    {!! str_replace("&oS;",'<br />', $invoice->pi_detail_remarks) !!}
                                </td>
                                @php
                                ...
                                @endphp
                                <td class="text-right tbl_amnt_5">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_purchase_invoice_list') }}',
            url;
