...
{{--                                    nabeel added design upper structure--}}
{{--                                    nabeel added add not_plus_minus with every field--}}
{{--  nabeel added add (onfocus="this.select();" onkeydown="return not_plus_minus(event), focus_stay_on_product(event)"  onfocusout="hideproducts(); ) to product search--}}
                                    <div class="invoice_row"><!-- invoice row start -->
                                        <div class="invoice_col basis_col_80 upper">
                                            <div class="invoice_row"> <!--row1 start -->
                                                <div class="invoice_col basis_col_23 ml-2"><!-- invoice column start -->
...
{{--                                                     nabeel added set default accunt name to walk in customer--}}
                                                            <select name="account_name" tabindex="1"
                                ...
                                config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <!-- invoice column input start -->
                                                            <input tabindex="2" type="text" name="remarks"
                                                    ...
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <div class="invoice_col_short">
                                                                ...
                                                                <a id="refresh_sale_person" class="col_short_btn">
                                                                    <l class="fa fa-refresh"></l>
                                                                </a>
                                                            </div><!-- invoice column short end -->
...
{{--  nabeel added add (onfocus="this.select();" onkeydown="return not_plus_minus(event), focus_stay_on_product(event)"  onfocusout="hideproducts(); ) to product search--}}
                                                <div class="invoice_col basis_col_23 ml-2">
                                            ...
                                            <h6>Example</h6><p>{{config('fields_info.about_form_fields.general_registration.warehouse.warehouse_title.example')}}</p>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <select tabindex="5" name="warehouse"
                                                                    class="inputs_up form-control js-example-basic-multiple"
                                                                    id="warehouse">
                                                ...
                                                <div class="invoice_col basis_col_23 ml-3"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <select tabindex="6" name="service_name"
                                                                    class="inputs_up form-control"
                                                                    id="service_name">
                                                ...
                                                <div class="invoice_col basis_col_23 ml-3"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <select tabindex="7" name="package"
                                                                    class="inputs_up form-control js-example-basic-multiple"
                                                                    id="package">
...
{{--                                nabeel added checked tax or non tax invoice--}}
                                <div class="invoice_row"><!-- invoice row start -->
...
{{--                            nabeel added lower section add lower_inputs lower_style in class--}}
                            {{--Lower section start--}}
                            <div class="invoice_row mt-1"><!-- invoice row start -->

                                {{--Lower section col 1 --}}
                                <div class="invoice_col basis_col_18 pl-3"><!-- invoice column start -->
                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                        <div class="invoice_col_ttl"><!-- invoice column title start -->
                                            <a data-container="body" data-toggle="popover"
                                               data-trigger="hover"
                                ...
                                {{--Lower section col 5 --}}
                                <div class="invoice_col basis_col_24 pl-3"><!-- invoice column start -->


                                    <div class="invoice_row"><!-- invoice row start -->


                                        <div class="invoice_col basis_col_100" id="zero_marg">
                                            <!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class=" invoice_col_ttl">
                                                    <!-- invoice column title start -->
...
{{--                                        nabeel added if you want big font then add class="grand_font" and mt-3 mb-2--}}
                                        <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
...
{{--                nabeel added gotoParty() so when cancel is clicked user focus move to party dropdown--}}
    ...
    @if (Session::get('si_id'))
        <script>
            ...
            $('.modal-body').load('{{url("sale_items_view_details/view/") }}' + '/' + id, function () {
                ...
                // nabeel added to print and for print preview to not remain on screen
...
{{--    nabeel added search end--}}
    ...
    <script>
        ...
        // nabeel added change accordingly start
        ...
        function productChanged(product) {
            ...
            add_sale(parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                counter, 0, unit_measurement, main_unit_measurement, unit_measurement_scale_size, rate_per_pack, gross_amount);

            product_amount_calculation(counter);

        }

        // nabeel added change accordingly end
        ...
        // nabeel added handle btn click start
        ...
        // nabeel added handle btn click end
        ...
        // nabeel added change accordingly
        function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive, counter, product_or_service_status, unit_measurement, main_unit_measurement, unit_measurement_scale_size, rate_per_pack, gross_amount) {
...
{{--    nabeel added focus lines in end--}}
    <script type="text/javascript">
        var $ = $.noConflict();
        $.Shortcuts.add({
