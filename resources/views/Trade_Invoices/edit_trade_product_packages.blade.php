        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Edit Trade Product Packages</h4>
                        </div>
                ...
                <div id="invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        ...
                        {{--form start--}}
                        <form name="f1" class="f1" id="f1" action="{{ route('update_trade_product_packages') }}"
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_80 upper">
                                            ...
                                            <div class="invoice_row"> <!--row1 start -->
                                                ...
                                                <div class="invoice_col basis_col_30 ml-2">
                                                ...
                                                <div class="invoice_col basis_col_30 ml-3"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                ...
                                config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <input tabindex="1" autofocus type="text" name="package_name" data-rule-required="true" data-msg-required="Please Enter Package Name"
                                                                   ...
                                                                   value="{{$product_package->pp_name}}" placeholder="Package Name">
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                ...
                                config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <input tabindex="2" type="text" name="remarks"
                                                                   ...
                                                                   value="{{$product_package->pp_remarks}}">
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                </div><!-- invoice column end -->
                                                <!-- add start -->
    ...
    document.addEventListener('keyup', function (event) {
        ...
        if (event.keyCode === 107) {     // means plus(+)
            ...
            if ($(document.activeElement)[0] == $("#product")[0]) {
                $("#package_name").focus();
            } else if ($("#package_name")[0] == $(document.activeElement)[0]) {
                $("#remarks").focus();
