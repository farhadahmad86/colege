    ...
    <div class="row">
            <div id="main_bg" class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Trade Sale Return Invoice</h4>
                        </div>
                        <div class="list_btn list_mul">
                            <a class="add_btn list_link add_more_button" href="{{ route('trade_sale_return_invoice_list') }}"
                               role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_sale_return_invoice') }}"
                            ...
                            <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                                ...
                                <div class="invoice_row justify-content-center"><!-- invoice row start -->
                                    ...
                                    <div class="invoice_col basis_col_23 payment_div pr-4" style="display: none">
                                        <!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                    ...
                                    <div class="invoice_col basis_col_23 payment_div pr-4" style="display: none"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                   data-placement="bottom" data-html="true"
    ...
    <script>
        ...
        function add_sale(code, name, display_quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                {{--                                                        new empty--}}
                    '<td class="tbl_srl_4 hidden" hidden> ' +
                '<input hidden type="text" id="trade_offer' + counter + '" name="" placeholder="" class="inputs_up_tbl"' +
