        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Transfer Product Stock List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_product) || !empty($search_warehouse) ? '' : 'search_form_hidden' }}"> -->
                <div class="search_form  m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('trade_transfer_product_stock_list') }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                        <div class="input_bx">
                                            ...
                                            <select tabindex="2" class="inputs_up form-control" name="product"
                                                    id="product">
                                    ...
                                    <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                        <div class="input_bx">
                                            ...
                                            <select tabindex="3" class="inputs_up form-control" name="product_name"
                                                    id="product_name">
                                    ...
                                    <div class="form-group col-lg-2 col-md-12 col-sm-12 col-xs-12">
                                        <div class="input_bx">
                                            ...
                                            <select tabindex="4" class="inputs_up form-control" name="warehouse"
                                                    id="warehouse">
                                                <option value="0">Select Warehouse</option>
                                                @foreach ($warehouses as $warehouse)
                                                    <option value="{{ $warehouse->wh_id }}"
                                                        {{ $warehouse->wh_id == $search_product ? 'selected="selected"' : '' }}>
                                    ...
                                    <!-- Call add button component -->
                                        <x-add-button tabindex="9" href="{{ route('add_trade_transfer_product_stock') }}"/>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        <tr>
                            ...
                            <th scope="col">Loose Quantity</th>
                        ...
                        @forelse($datas as $product)
                            @php
                                ...
                                $db_qty = $product->pth_stock;
                                $scale_size = $product->pth_scale_size;
                            ...
                            <tr>
                                ...
                                <td class="align_right">{{ $pack_qty }}</td>
                                <td class="align_right">{{ $loose_qty }}</td>
                                <td>{{ $product->to }}</td>
                                <td>{{ $product->from }}</td>
                ...
                <span
                    class="hide_column">{{ $datas->appends(['segmentSr' => $countSeg, 'search' => $search, 'product' => $search_product, 'warehouse' => $search_warehouse])->links() }}</span>
                    </div>
                </div>
...
@section('scripts')
    <script type="text/javascript">
        var base = '{{ route('trade_transfer_product_stock_list') }}',
            url;
