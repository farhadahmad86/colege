        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Product Recover List</h4>
                        </div>
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('trade_product_recover_list') }}" name="form1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12 text-right mt-4">
                                        ...
                                        <!-- Call add button component -->
                                            <x-add-button tabindex="9" href="{{ route('trade_product_recover') }}"/>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                            ...
                            @forelse($datas as $product)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! str_replace('&oS;', '<br />', $product->plr_detail_remarks) !!}
                                    </td>
                                    @php
                        ...
                        <tfoot>
                            <tr>
                                <th align="right" colspan="6" class="align_right text-right border-0">
                                    Page Total:-
                                </th>
                ...
                <span class="hide_column">
                    {{ $datas->appends(['segmentSr' => $countSeg, 'search' => $search, 'product' => $search_product, 'to' => $search_to, 'from' => $search_from])->links() }}</span>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_product_recover_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function() {
            ...
            $('.modal-body').load('{{ url('trade_product_loss_recover_items_view_details/view/') }}' + '/' + id,
                function() {
            ...
            //
            //             jQuery("#table_body").append('<div class="itm_vchr form_manage m-0"><div class="form_header mb-0"><h4 class="text-white file_name"><span class="db sml_txt"> Product Name: </span>' + value['plri_pro_name'] + '</h4></div><div class="table-responsive"><table class="table table-bordered"><thead><tr><th scope="col">Qty</th><th scope="col">Rate</th><th scope="col">Total</th></tr></thead><tbody><tr><td class="align_left">' + value['plri_pro_qty'] + '</td><td class="align_left">' + value['plri_pro_purchase_price'] + '</td><td class="align_left">' + value['plri_pro_total_amount'] + '</td></tr></tbody></table></div><div class="itm_vchr_rmrks"><h5 class="title_cus bold"> Remarks: </h5><p class="m-0 p-0">' + value['plri_remarks'] + '</p></div></div>');
            //
            //         });
            //     },
