        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Trade Sale Order Delivery Order Sale Tax Invoice</h4>
                        </div>
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_80 upper">
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                    ...
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <div class="invoice_col_short">
                                                                ...
                                                                <a href="{{ route('trade_sale_order') }}" target="_blank"
                                                ...
                                                <div class="invoice_col basis_col_24 ml-2"><!-- invoice column start -->
                                                    <x-remarks-component tabindex="4" name="remarks" title="Remarks" id="remarks"/>
                                                </div>
                                                    ...
                                                    <div class="invoice_row"><!-- invoice row start -->
                                                        ...
                                                        <div class="radio ml-3">
                                                            <label>
                                                                ...
                                                                <input type="radio" name="order_sale_type" class="invoice_type" id="order_sale_type1" value="0">
                                                                Sale Order
                                                            </label>
                                                        </div>
                                                        <div class="radio ml-3">
                                                            <label>
                                                                <input type="radio" name="order_sale_type" class="invoice_type" id="order_sale_type2" value="1" checked>
                                                    ...
                                                    <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="cash_paid" class="inputs_up form-control text-right lower_style" id="cash_paid"
                                                                   onkeyup="grand_total_calculation_with_disc_amount();" onkeypress="return allow_only_number_and_decimals(this,event);"
                                                                   onfocus="this.select();">
                                                        </div>
                                                    </div><!-- invoice inline input text end -->
...
@section('scripts')
    ...
    <script>
        ...
        var GET_PRODUCTS_ROUTE = '{{ route('ajax_get_json_trade_sale_order_delivery_order_sale_invoice') }}';
    </script>
    ...
    <script>
        ...
        jQuery("#check_return_invoice").click(function () {
            ...
            if (n == false) {
                ...
                jQuery.ajax({
                    url: "{{route('get_sale_order_delivery_order_items_for_sale')}}",
