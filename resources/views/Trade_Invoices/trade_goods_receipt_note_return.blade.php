    ...
    <div class="row">
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Trade Goods Receipt Note Return</h4>
                    </div>
                    <div class="list_btn list_mul">
                        <a class="add_btn list_link add_more_button" href="{{ route('trade_goods_receipt_note_return_list') }}" role="button">
                            <i class="fa fa-list"></i>Trade Goods Receipt Note Return List
                        </a>
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    ...
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_goods_receipt_note_return') }}"
                                                ...
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input">
                                                        ...
                                                        <div class="ps__search">
                                                            <input tabindex="1" type="text" name="product" id="product" class="inputs_up form-control ps__search__input" placeholder="Search Invoice Number" onkeydown="return not_plus_minus(event)" onfocusout="hideproducts();" onfocus="this.select();" />
                                                        </div>
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12" id="filters">
                                        <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt " style="line-height: 1">
                                                    <!-- invoice column input start -->
                                                    <div class="custom-checkbox float-left form-group">
                                        ...
                                        <div class="table-responsive pro_tbl_bx"><!-- product table box start -->
                                            <table class="table table-bordered table-sm" id="category_dynamic_table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="tbl_srl_5" hidden> Bonus</th>
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Trade Goods Receipt Note Return Detail</h4>
...
@section('scripts')
    ...
    @if (Session::get('grnr_id'))
        <script>
            jQuery("#table_body").html("");

            var id = '{{ Session::get("grnr_id") }}';

            $('.modal-body').load('{{url("trade_goods_receipt_note_return_items_view_details/view/")}}' + '/' + id, function () {
    ...
    <script>
        ...
        jQuery("#check_return_invoice").click(function () {
            ...
            if (n == false) {
                ...
                jQuery.ajax({
                    url: "{{route('get_goods_receipt_note_items_for_return')}}",
    ...
    <script>
        ...
        function add_sale(grn_id, code, name, quantity, bonus_qty, rate, sale_price, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td hidden class="tbl_srl_4 " hidden> ' +
