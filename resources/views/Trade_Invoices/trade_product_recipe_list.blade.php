        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Product Recipe List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('trade_product_recipe_list') . ((isset($restore_list) && $restore_list == 1) ? '?restore_list=1' : '') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form_controls text-center">
                                            ...
                                            <a tabindex="8" class="save_button form-control" href="{{ route('product_recipe') }}" role="button">
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        <tr>
                            ...
                            <th scope="col"class="text-center hide_column tbl_srl_8">
                                Enable
                            </th>
                        ...
                        @forelse($datas as $product_recipe)
                            ...
                            <tr data-recipe_id="{{$product_recipe->pr_id}}">
                                ...
                                <td class="text-center edit tbl_txt_6">
                                    KG
                                </td>
                                @php
                                ...
                                <td class="text-center hide_column tbl_srl_8">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_product_recipe_list') }}',
            url;
