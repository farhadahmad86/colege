    ...
    <div class="row">
            <div id="main_bg" class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Trade Purchase Return Invoice</h4>
                        </div>
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk"><!-- invoice box start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_purchase_return_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                            @csrf
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <div class="ps__search">
                                                                <input tabindex="4" type="text" name="product"
                                                                       ...
                                                                       onfocus="this.select();"
                                                                       {{--onfocus=""--}}
                                                                       onkeydown="return not_plus_minus(event), focus_stay_on_product(event)"onfocusout="hideproducts();"/>
                                                            </div>
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    ...
                                                    <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="disc_percentage" class="inputs_up form-control text-right percentage_textbox lower_style lower_inputs" id="disc_percentage"
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    ...
                                                    <div class="invoice_inline_input_txt">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="total_product_discount" class="inputs_up form-control text-right lower_style lower_inputs" id="total_product_discount" readonly>
                                                        </div>
                                                    </div><!-- invoice inline input text end -->
    ...
    <script>
        ...
        function add_sale(code, name, display_quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="tbl_srl_9">' +
                '<input tabindex="-1" type="text" name="gross_amount[]" class="lower_inputs inputs_up_tbl text-right" ' +
                'id="gross_amount' + counter + '" placeholder="Scale Size" value="' + gross_amount + '" ' +
                'readonly/>' +
                '</td>' +
