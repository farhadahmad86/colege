    ...
    <div class="row">
            <div class="container-fluid search-filter form-group form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Trade Sale Return Sale Tax Invoice List</h4>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                        <div class="form_controls">
                                            ...
                                            <x-add-button tabindex="9" href="{{ route('sale_return_invoice') }}"/>
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $invoice)
                            ...
                            <tr>
                                ...
                                <td class=" view tbl_amnt_6" data-id="{{$invoice->srsi_id}}">
                                    TSTSRI-{{$invoice->srsi_id}}
                                </td>
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Trade Sale Tax Return Invoice Detail</h4>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('trade_sale_tax_sale_return_invoice_list') }}',
            url;
