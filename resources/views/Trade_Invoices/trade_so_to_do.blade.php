    ...
    <div class="row">
            <div id="main_bg" class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Trade Sale Order To Delivery Order</h4>
                        </div>
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_so_to_do_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                            @csrf
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt"><!-- invoice content start -->
                                                ...
                                                <div class="table-responsive pro_tbl_bx"><!-- product table box start -->
                                                    <table class="table table-bordered table-sm" id="category_dynamic_table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="tbl_srl_4" hidden>Pack Rate</th>
                                                            <th class="tbl_srl_4">Loose Qty</th>

                                                            <th class="tbl_srl_6" hidden>Loose Rate</th>
                                                            <th class="tbl_srl_9" hidden>Gross Amount</th>
                                                            <th class="tbl_srl_5">Bonus</th>
                                                            <th class="tbl_srl_4">UOM</th>
                                                            <th class="tbl_srl_4" hidden>Trade Offer</th>
                                                            <th class="tbl_srl_4" hidden>Dis%</th>
                                                            <th class="tbl_srl_7" hidden> Dis Amount</th>
                                                            <th class="tbl_srl_4" hidden> Tax%</th>
                                                            <th class="tbl_srl_7" hidden> Tax Amount</th>
                                                            <th class="tbl_srl_4" hidden>Inclu</th>
                                                            <th class="tbl_srl_9" hidden> Net Amount</th>
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12 payment_div"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                       data-placement="bottom" data-html="true"
    ...
    <script>
        ...
        function add_sale(delivery_order_id, code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="text-right tbl_srl_9" hidden> ' +
