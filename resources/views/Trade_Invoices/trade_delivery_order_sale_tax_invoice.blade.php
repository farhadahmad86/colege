    ...
    <div class="row">
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Trade Delivery Order Sale Tax Invoice</h4>
                    </div>
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_trade_delivery_order_sale_tax_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                        @csrf
...
{{--                                                </div><!-- invoice column box end -->--}}
                                        ...
                                        <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt mt-0" style="line-height: 1">
                                                    <!-- invoice column input start -->
                                                    <div class="custom-checkbox float-left mr-3 form-group">
                                ...
                                <div class="invoice_row"><!-- invoice row start -->
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12 payment_div"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                    data-placement="bottom" data-html="true"
                                    ...
                                    <div class="invoice_col form-group col-lg-4 col-md-3 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class=" invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
...
@section('scripts')
    ...
    @if (Session::get('dostsi_id'))
        <script>


            jQuery("#table_body").html("");

            var id = '{{ Session::get("dostsi_id") }}';
