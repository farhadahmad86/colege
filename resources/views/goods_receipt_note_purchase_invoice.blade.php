        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">GRN Purchase Invoice</h4>
                        </div>
                ...
                <div id="invoice_con" class="invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="invoice_bx"><!-- invoice box start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_grn_purchase_invoice') }}"
                            ...
                            <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12 hidden"><!-- invoice column -->
                                    ...
                                    <div class="invoice_row" ><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_33 " hidden><!-- invoice column start -->
                                            <x-warehouse-component tabindex="6" name="warehouse" id="warehouse" class="refresh_warehouse" title="Warehouse"/>
                                                ...
                                                <div class="invoice_col form-group col-lg-12 col-md-12 col-sm-12"><!-- invoice column start -->
                                                    <div class="invoice_col_bx for_tabs col-lg-4"><!-- invoice column box start -->
                                                        ...
                                                        <div class="table-responsive pro_tbl_bx"><!-- product table box start -->
                                                            <table class="table table-bordered table-sm" id="category_dynamic_table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th class="tbl_srl_4 hide_sale_tax"> Tax%</th>
                                                                    <th class="tbl_srl_7 hide_sale_tax"> Tax Amount</th>
                                                                    <th class="tbl_srl_4 hide_sale_tax"> Inclu</th>
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col form-group col-lg-4 col-md-4 col-sm-12 hide_sale_tax"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                            Product Tax
                                                        </div><!-- invoice column title end -->
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    ...
                                                    <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="total_items" class="inputs_up form-control text-right total-items-field" id="total_items" readonly
                                    ...
                                    <div class="invoice_col form-group col-lg-12 col-md-12 col-sm-12"><!-- invoice row start -->
                                        <div class="invoice_row"><!-- invoice column start -->
                ...
                jQuery.ajax({
                        ...
                        if (data.message != "not eligible") {
                            if (data[1] != '') {
                                        ...
                                        if (table_data == '') {
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                        ...
                                                        $.each(data[1], function (index, value) {
                                                            ...
                                                            add_sale(grn_code, parent_code, name, quantity, bonus_qty, rate, sale_price, inclusive_rate, discount, discount_amount, sales_tax,
                                                                sale_tax_amount,
                                                                amount, remarks,
                                                                rate_after_discount,
                                                                inclusive_exclusive, counter, 0, warehouse_id, unit_measurement, unit_measurement_scale_size, rate_per_pack, gross_amount);
                                            ...
                                            if (data[0][prefix + '_party_code'] == account) {
                                                ...
                                                $.each(data[1], function (index, value) {
                                                    ...
                                                    add_sale(grn_code, parent_code, name, quantity, bonus_qty, rate, sale_price, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount,
                                ...
                                swal.fire({
                                    type: 'error',
                                    title: 'Oops...',
                                    text: 'You have Already generated Purchase Invoice Against this Goods Receipt Note',
                                    showCancelButton: false,
                                    confirmButtonClass: 'btn btn-success',
                                    timer: 4000
                                });
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        swal.fire({
                            type: 'error',
                            title: 'Oops...',
                            text: 'You are not generate GRN against this Goods Receipt Note',
                            showCancelButton: false,
                            confirmButtonClass: 'btn btn-success',
                            timer: 4000
                        });
...
//         });
    ...
    <script>
        ...
        function add_sale(grn_id, code, name, quantity, bonus_qty, rate, sale_price, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                          inclusive_exclusive,
                          counter, product_or_service_status, select_return_warehouse, unit_measurement, unit_scale_size, rate_per_pack, gross_amount) {
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                'readonly/> ' +
                '</td> <td class="tbl_srl_4 hide_sale_tax"> ' +
                ...
                '</div> ' +
                '<a href="#" class="btn btn-sm btn-success price_mdl" onclick=change_price(' + counter + ')><i class="fa fa-edit"></i> </a> ' +
