            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white get-heading-text">Edit Group</h4>
                            </div>
                        </div>
                    </div><!-- form header close -->

                    <form name="f1" class="f1" id="f1" action="{{ route('update_group') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <input type="text" name="group_name" id="group_name" class="inputs_up form-control"
                                                   ...
                                                   placeholder="Product Group Title" value="{{$group->grp_title}}">
                                            <input value="{{$group->grp_id}}" name="group_id" type="hidden">
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                ...
                                                Remarks</label>
                                            <textarea name="remarks" id="remarks" class="remarks inputs_up form-control" placeholder="Remarks">{{$group->grp_remarks}}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <h6>Benefits</h6><p>{{config('fields_info.about_form_fields.product_registration.group.Tax_%.benefits')}}</p>">
                                                ...
                                                Tax %</label>
                                            <input type="text" name="tax" id="tax" value="{{$group->grp_tax ==0 ? '':$group->grp_tax}}" class="inputs_up form-control" placeholder="Tax %" onkeypress="return
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <input type="text" name="retailer" id="retailer" value="{{$group->grp_retailer_discount ==0 ? '':$group->grp_retailer_discount}}" class="inputs_up form-control" placeholder="Retailer Discount %" onkeypress="return
                                            allow_only_number_and_decimals(this,event);">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <input type="text" name="wholesaler" id="wholesaler" value="{{$group->grp_whole_seller_discount ==0 ? '':$group->grp_whole_seller_discount}}" class="inputs_up form-control" placeholder="Whole Saler %" onkeypress="return
                                            allow_only_number_and_decimals(this,event);">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <h6>Benefits</h6><p>{{config('fields_info.about_form_fields.product_registration.group.loyalty_card_%.benefits')}}</p>">
                                                ...
                                                Loyalty Card %</label>
                                            <input type="text" name="loyalty_card" id="loyalty_card" value="{{$group->grp_loyalty_card_discount ==0 ? '':$group->grp_loyalty_card_discount}}" class="inputs_up form-control" placeholder="Loyalty Card %" onkeypress="return
                                            allow_only_number_and_decimals(this,event);">
