    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Create Main Unit</h4>
                    </div>
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('main_unit_list') }}" role="button">
            ...
            <div class="excel_con gnrl-mrgn-pdng gnrl-blk">
                <div class="excel_box gnrl-mrgn-pdng gnrl-blk">
                    <div class="excel_box_hdng gnrl-mrgn-pdng gnrl-blk">
                        <h2 class="gnrl-blk gnrl-mrgn-pdng gnrl-font-bold">Upload Excel File </h2>
                    </div>
                    <div class="excel_box_content gnrl-mrgn-pdng gnrl-blk">
                        <form action="{{ route('submit_main_unit_excel') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input tabindex="100" type="file" name="add_main_unit_excel" id="add_main_unit_excel" class="inputs_up form-control-file form-control height-auto"
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                                    <a href="{{ url('public/sample/main_unit/add_main_unit_pattern.xlsx') }}" tabindex="-1" type="reset" class="cancel_button  btn btn-info btn-sm">
            ...
            <form name="f1" class="f1 mx-auto col-lg-7 col-md-7 col-sm-12 col-xs-12" id="f1" action="{{ route('submit_main_unit') }}" onsubmit="return checkForm()" method="post">
                @csrf
                <div class="row">
                    <div class="input_bx form-group col-lg-12 col-md-12 col-sm-12"><!-- start input box -->
                        <label class="required">
                            <a data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.product_registration.main_unit.title.description')}}</p>
                                <h6>Benefits</h6><p>{{config('fields_info.about_form_fields.product_registration.main_unit.title.benefits')}}</p>">
                                <i class="fa fa-info-circle"></i>
                            </a> Title</label>
                        <input tabindex=1 autofocus type="text" name="name" id="name" class="inputs_up form-control" placeholder="Title" data-rule-required="true" data-msg-required="Please Enter Title" value="{{ old('name') }}" autofocus autocomplete="off"/>
