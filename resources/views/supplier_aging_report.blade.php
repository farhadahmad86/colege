        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="printTable">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white file_name get-heading-text"> Supplier Aging Report </h4>
                        </div>
            ...
            <!-- <div class="search_form {{ ( !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('supplier_aging_report') }}" name="form1" id="f1" method="post" class="accountLedger w-80p d-inline" autocomplete="off">
                        @csrf
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('supplier_aging_report') }}',
            url;
