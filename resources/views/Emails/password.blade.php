...
{{--<body>--}}
{{--<h2>Welcome to the site {{$user['jb_user_name']}}</h2>--}}
{{--<br/>--}}
{{--Your registered email-id is {{$user['jb_user_email']}} , Please click on the below link to verify your email account--}}
{{--<br/>--}}
{{--<a href="{{url('user/verify', $user->jb_user_activation_key)}}">Verify Email</a>--}}
{{--</body>--}}
                                                    ...
                                                    <table role="presentation" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="width:150px;">
                                                                <a href="{{config('global_variables.website_path')}}"><img
                                                                        alt="Logo" title="" height="auto"
                                                                        src="{{asset("public/vendors/images/my_logo.png" )}}"
                                ...
                                <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:0px;">
                                    ...
                                    <div class="mj-column-per-100 outlook-group-fix"
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                            ...
                                            <tr>
                                                <td style="word-wrap:break-word;font-size:0px;padding:0px;">
                                                    <div style="font-size:1px;line-height:48px;white-space:nowrap;"> 
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                            ...
                                            <tr>
                                                <td style="word-wrap:break-word;font-size:0px;padding:0px;"
                                                    align="left">
                                                    <div
                                                        style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
                                                        <p>Hello,</p>
                                                        <p class="hero">It’s time to Login.</p>
                                                        <p>User-Name and Password is given below.</p>
                                                        <p>
                                                            User-Name: {{$username}}
                                                        </p>
                                                        <p>
                                                        ...
                                                        <p>
                                                            <a href="{{config('global_variables.website_path')}}">Go to
                                                                Website</a>
                                                        </p>
                                                        <p>If you don’t know why you got this email, please tell us
                                                            straight away so we can
                                                            fix this for you.</p>
                                                        <hr style="margin-top: 56px">
                                                        <p class="mb-0">Thanks,</p><br/>
                                                        {{--                                                        <a href="https://www.softagics.com" class="mb-0">Fananctics</a>--}}
                                                        <a href="https://www.softagics.com" class="mb-0">
                                                            <img
                                                                src="https://softagics.com/wp-content/uploads/2022/10/softagics-logo.png"
                                                                alt="">
                                                        </a>

                                                        {{--                                                        <img src="https://softagics.com/wp-content/uploads/2022/10/softagics-footer-logo.png"--}}
                                                        {{--                                                             alt="">--}}
                                                    </div>
                                                </td>
                                            </tr>
                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="center">
                                    <table role="presentation" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="width:1px;">
                                                <img alt="" title="" height="1"
                                                     src="https://api.transferwise.com/v1/notification-flow/messages/c6180a31-5cdb-477a-8c36-756232726efc/channels/EMAIL/open.gif"
