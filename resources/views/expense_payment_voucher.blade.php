    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Expense Payment Voucher</h4>
                    </div>
                    <div class="list_btn">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                ...
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    ...
                    <form id="f1" action="{{ route('submit_expense_payment_voucher') }}" method="post"
                            ...
                            <div class="invoice_cntnt">
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="invoice_col form-group col-lg-4 col-md-4  col-sm-12">
                                        <!-- invoice column -->
                                        <x-account-name-component tabindex="1" name="account"
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="invoice_col form-group col-lg-3 col-md-4  col-sm-12" hidden>
                                        <!-- invoice column -->
