    ...
    <div class="row">
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Approval {{$title}} Journal Voucher</h4>
                    </div>
                    <div class="list_btn list_mul">
                        <a class="mr-3 btn list_link add_more_button" href="{{route('approval_journal_voucher_list')}}"
                           role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng for_voucher"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    ...
                    <form action="{{ route('submit_approval_journal_voucher') }}" method="post"
                          onsubmit="return checkForm()" id="f1">
                        @csrf
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <select name="business_name" class="inputs_up form-control"
                                                        id="business_name">
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input type="text" name="remarks" class="inputs_up form-control"
                                                       id="remarks" placeholder="Remarks" autocomplete="off">
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="voucher_type" class="invoice_type"
                                                               id="simple" value="simple_show" checked>
                                                        Simple
                                                    </label>
                                                </div>
                                ...
                                <div class="invoice_row mt-2 "><!-- invoice row start -->
                                    <div class="invoice_col form-group col-lg-2 col-md-3  col-sm-12" hidden>
                                        <x-account-name-component tabindex="3" name="account_code" class="{{$type}}" id="account_code" title="Account Code" href="{{$route}}"
                                                                  body="{{$array_index}}"/>
                                    </div>
                                    {{--                                        <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12" hidden><!-- invoice column start -->--}}
                                    {{--                                            <div class="invoice_col_bx"><!-- invoice column box start -->--}}
                                    ...
                                    {{--                                                   --}}
                                    {{--                                                    --}}{{--hamad set tab index--}}
                                    {{--                                                    <select tabindex="3" name="account_code" class="inputs_up form-control"--}}
                                    {{--                                                            id="account_code">--}}
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3  col-sm-12">
                                        <x-account-name-component tabindex="2" name="account_name" class="{{$type}}" id="account_name" title="Account Title" href="{{$route}}" body="{{$array_index}}"/>
                                    </div>
                                    {{--                                            <div class="invoice_col_bx"><!-- invoice column box start -->--}}
                                    {{--                                                <div class="required invoice_col_ttl">--}}
                                    ...
                                    {{--                                                        <a href="{{ route('bank_account_registration') }}"--}}
                                    {{--                                                           target="_blank" class="col_short_btn" data-container="body"--}}
                                    {{--                                                           data-toggle="popover"--}}
                                    ...
                                    {{--                                            --}}{{--                                                    hamad set tab index--}}
                                    {{--                                                    <select tabindex ="4" name="account_name" class="inputs_up form-control"--}}
                                    {{--                                                            id="account_name">--}}
                                    ...
                                    <div class="invoice_col  form-group col-lg-2 col-md-3 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                {{--                                                    hamad set tab index--}}
                                                <input tabindex="6" type="text" name="account_remarks"
                                                       class="inputs_up form-control" id="account_remarks"
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                {{--                                                    Hamad set tab index--}}
                                                <select tabindex="7" name="account_type" class="inputs_up form-control"
                                                        id="account_type">
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                {{--                                                    Hamad set tab index--}}
                                                <input tabindex="8" type="text" name="amount"
                                                       class="inputs_up text-right form-control" id="amount"
                                                       placeholder="Amount" min="1" autocomplete="off">
                                                <span id="demo7" class="validate_sign"></span>
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    </div><!-- invoice column end -->

                                    <div class="form-group invoice_col col-lg-2 col-md-4 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_frm_btn_bx">
                                            <button style="display: none;" id="cancel_button" class="invoice_frm_btn btn btn-secondary" onclick="cancel_all()" type="button">
                                                <i class="fa fa-times"></i> Cancel
                                            </button>
                                        </div>
                                        <div class="invoice_frm_btn_bx">
                                            <button tabindex="9" id="first_add_more" class="invoice_frm_btn btn btn-sm btn-info" onclick="add_account()" type="button">
                                        ...
                                        <div class="table-responsive pro_tbl_bx"><!-- product table box start -->
                                            <table class="table table-bordered table-sm" id="category_dynamic_table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="tbl_txt_20"> Posting Reference</th>
                                                    <th class="tbl_txt_33"> Transaction
                                                        Remarks
                                                    </th>
                                                    <th class="tbl_txt_9"> Dr.</th>
                                                    <th class="tbl_srl_9"> Cr.</th>
                                                ...
                                                <tr>
                                                    <td colspan="4" class="text-center">
                                                        <div class="invoice_col_txt">
                                                            ...
                                                            <div class="invoice_col_input">
                                                                <!-- invoice column input start -->
                                                                <input type="text" name="total_debit"
                                                    ...
                                                    <td class="tbl_srl_9">
                                                        <div class="invoice_col_txt">
                                                            ...
                                                            <div class="invoice_col_input">
                                                                <!-- invoice column input start -->
                                                                <input type="number" name="total_credit"
                                                                       class="inputs_up text-right form-control grand-total-field"
                                                                       id="total_credit"
                                                                       data-rule-required="true"
                                                                       data-msg-required="Please Add"
                                    ...
                                    <div class="invoice_col col--lg-12"><!-- invoice column start -->
                                        <div class="invoice_col_txt with_cntr_jstfy for_voucher_btns">
                                            ...
                                            <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                ...
                                                <button class="btn btn-primary session-button" type="button"
                                                        data-toggle="collapse" data-target="#session_accordian"
                                                        aria-expanded="false"
...
@section('scripts')
        ...
        function add_account() {
            ...
            if (flag_submit1) {
                ...
                jQuery("#table_body").append(
                    '<tr id=' + counter + ' class="edit_update"><td class="tbl_srl_9" hidden>' + account_code + '</td><td class="text-left tbl_txt_20">' + account_name_text + '</td><td ' +
                    'class="text-left tbl_txt_20">' + posting_reference_text + '</td><td class="text-left tbl_txt_33">' + remarks_var + '</td><td class="text-left tbl_txt_9">' + dr_amount + '</td><td class="text-right tbl_srl_9">' + cr_amount + '</td><td class="text-right tbl_srl_6"> <div class="edit_update_bx"><a class="edit_link btn btn-sm btn-success" href="#" onclick=edit_account(' + counter + ')><i class="fa fa-edit"></i></a><a href="#" class="delete_link btn btn-sm btn-danger" onclick=delete_account(' + counter + ')><i class="fa fa-trash"></i></a></div></td></tr>');
                ...
                var total_items = $('.edit_update').length;
    ...
    <script>
        function calculate_remaining_amount() {
            ...
            var total_price = $('#total_debit').val();
            var consume_amount = $('#used_amount').val();
            ...
            $('#consume_amount').val(consume_amount);
