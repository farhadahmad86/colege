...
@section('print_cntnt')
    ...
    <table class="table border-0 table-sm">
        ...
        <tr>
            ...
            <th scope="col" align="center" class="text-center align_center tbl_txt_15">Angle Support</th>
        ...
        @forelse($datas as $area)
            ...
            <tr>
                ...
                <td class="align_left text-left edit tbl_txt_15">{{$area->aisc_width_from}}</td>

                <td class="align_left text-left edit tbl_txt_15">{{$area->aisc_width_to}}</td>

                <td class="align_left text-left edit tbl_txt_15">{{$area->aisc_angle_support }}</td>
        ...
        @empty
            <tr>
                <td colspan="11">
                    <center><h3 style="color:#554F4F">No Angle Inch Store Calibration</h3></center>
                </td>
            </tr>
        @endforelse
        </tbody>
