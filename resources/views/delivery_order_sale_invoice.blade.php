...
<div class="row">
    <div class="container-fluid search-filter form-group form_manage">
        <div class="form_header"><!-- form header start -->
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-white get-heading-text">Delivery Order Sale Invoice</h4>
                </div>
        ...
        <div id="invoice_con" class="invoice_con"><!-- invoice container start -->
            <div id="invoice_bx" class="invoice_bx"><!-- invoice box start -->
                <form name="f1" class="f1" id="f1" action="{{ route('submit_delivery_order_sale_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                    @csrf
                    <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                        <div class="invoice_cntnt"><!-- invoice content start -->
                                ...
                                <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                        ...
                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                            <select tabindex="2" autofocus name="account_name" class="inputs_up form-control js-example-basic-multiple"
                            ...
                            <div class="invoice_row" ><!-- invoice row start -->
                                <div class="invoice_col basis_col_14 hidden"><!-- invoice column start -->
                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                        <div class="required invoice_col_ttl"><!-- invoice column title start -->
                                ...
                                <div class="invoice_col basis_col_33" hidden><!-- invoice column start -->
                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                        <div class="required invoice_col_ttl"><!-- invoice column title start -->
                                            <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                data-placement="bottom" data-html="true"
                                ...
                                <div class="invoice_col basis_col_25_2" hidden><!-- invoice column start -->
                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                ...
                                <div class="invoice_col basis_col_25_5" hidden><!-- invoice column start -->
                                    <x-warehouse-component tabindex="7" name="warehouse" id="warehouse" class="refresh_warehouse" title="Warehouse"/>
                                </div>
                            <div class="invoice_row"><!-- invoice row start -->
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 offset-lg-6 offset-md-6"><!-- invoice column start -->
                                        ...
                                        <div class="invoice_col_txt for_invoice_nbr"><!-- invoice column input start -->
                                            <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                ...
                                                <div class="invoice_col_input">
                                                    <input autofocus type="search" list="browsers" name="invoice_nbr_chk" class="inputs_up form-control" id="invoice_nbr_chk"
                                                            placeholder="Check Invoice Number" value="{{ isset($search) ? $search : '' }}" autocomplete="off">
                                ...
                                <div class="form-group col-lg-12"><!-- invoice column start -->
                            ...
                            <div class="invoice_row p-1"><!-- invoice row start -->
                                        <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class=" invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                ...
                                <div class="payment_div invoice_col form-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                        <div class="invoice_col_ttl"><!-- invoice column title start -->
                                            <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                data-placement="bottom" data-html="true"
                            ...
                            <div class="form-group col-lg-12"><!-- invoice row start -->

                                <div class="invoice_row text-center"><!-- invoice column start -->
...
@section('scripts')
    ...
    <script>
        ...
        function add_sale(delivery_order_id, code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                          inclusive_exclusive,
                          counter, product_or_service_status, select_return_warehouse, unit_measurement, unit_measurement_scale_size, rate_per_pack, gross_amount) {
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '</td>' +
                '<td class="tbl_srl_4">' +
                '<input type="text" name="quantity[]" id="quantity' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + '),check_qty(this)"' +
                ' ' +
                'value="' +
                ...
                '<td class="tbl_srl_4">' +
                '<input type="text" name="rate_per_pack[]" onkeyup="unit_rate_changed_live(' + counter + ')" class="inputs_up_tbl" id="rate_per_pack' + counter + '" placeholder="Rate Per Price" ' +
                                        ...
                                        if (table_data == '') {
                                            ...
                                            $.each(data[1], function (index, value) {
                                                ...
                                                add_sale(do_code, parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks,
                                                    rate_after_discount,
                                                    inclusive_exclusive, counter, 0, warehouse_id, unit_measurement, unit_measurement_scale_size, rate_per_pack, gross_amount);
