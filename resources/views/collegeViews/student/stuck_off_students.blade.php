    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text file_name">Stuck Off Students</h4>
                    </div>
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm"
                      action="{{ route('stuck_off_students') }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8">
                                        ...
                                        <p><b>Stuck Off Date:</b> {{$student->struck_off_date}}</p>
                                        <p><b>Created By:</b> {{$student->is_struck_off}}</p>
            ...
            <div class="row">
                ...
                <div class="col-md-9 text-right">
                    <span
                        class="hide_column">{{ $datas->appends(['search' => $search, 'class'=>$search_class, 'section'=>$search_section, 'student_status'=>$search_status, 'roll_no'=>$search_roll_no])
                        ->links() }}</span>
                </div>
            </div>
    ...
    <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog modal-md">
            <div class="modal-content base_clr">
                ...
                <form name="f1" class="f1" id="f1" action="{{ route('change_student_status_active') }}"
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('stuck_off_students') }}',
            url;
