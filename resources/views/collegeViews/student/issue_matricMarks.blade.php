    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text file_name">Issue Matric Marks</h4>
                    </div>
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm"
                      action="{{ route('issue_matricMarks') }}"
...
{{--                            @include('include/print_button')--}}
            ...
            <form name="delete" id="delete" action="{{ route('submit_matricMarks') }}" method="post">
                @csrf
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $data)
                            <tr data-title="{{ $data->full_name }}" data-student_id="{{ $data->id }}">
                                ...
                                <td><input type="text" class="inputs_up form-control" name="matricMarks[]" value="{{$data->marks_10th}}"></td>
