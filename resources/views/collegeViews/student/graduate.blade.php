    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Mark as Graduate</h4>
                    </div>
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('graduate_list') }}"
                           role="button">
            ...
            <form name="f1" class="f1" id="f1" action="{{ route('submit_mark_graduate') }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <x-class-component name="class" id="class"/>
