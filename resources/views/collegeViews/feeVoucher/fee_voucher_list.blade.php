        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Fee Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('fee_voucher_list') }}" name="form1"
                                    ...
                                    <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                        <div class="input_bx">
                                            ...
                                            <select tabindex="5" name="status" class="inputs_up form-control" id="status">
                                                ...
                                                <option value="0" {{ '0' == $search_status ? 'selected="selected"' : '' }}>
                                                    Pending
                                                </option>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        <tr>
                            ...
                            <th tabindex="-1" scope="col" class="tbl_txt_4">
                                Section
                            </th>
                            <th scope="col" class="tbl_amnt_10">
                                Total Amount
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <td class="view" data-id="{{ $voucher->fv_v_no }}" data-reg_no="{{ $voucher->fv_std_reg_no }}" data-status="{{$voucher->fv_status_update}}">
                                    FV-{{ $voucher->fv_v_no }}
                                </td>
                                ...
                                @php
                                    $ip_browser_info = '' . $voucher->fv_ip_adrs . ',' . str_replace(' ', '-', $voucher->fv_brwsr_info) . '';
                                @endphp
                                <td>
                                    {{ $voucher->branch_name }}
                                </td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 text-right">
                        ...
                        'section'=>$search_section, 'status'=>$search_status, 'type'=>$search_type])->links()
                        }}</span>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('fee_voucher_list') }}',
            url;
