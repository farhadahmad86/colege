        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Advance Fee Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('advance_fee_voucher_list') }}" name="form1"
                                    ...
                                    <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                        <div class="input_bx">
                                            ...
                                            <select tabindex="5" name="status" class="inputs_up form-control" id="status">
                                                ...
                                                <option value="1" {{ '1' == $search_status ? 'selected="selected"' : '' }}>
                                                    Pending
                                                </option>
                                                <option value="2" {{ '2' == $search_status ? 'selected="selected"' : '' }}>
                                                    Paid
                                                </option>
                                                <option
                                                    value="3" {{ '3' == $search_status ? 'selected="selected"' : '' }}>
                                                    Reverse
                                                </option>
                                            </select>
                                        </div>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $voucher)
                            @php $per_page_ttl_amnt = +$voucher->afv_total_amount + +$per_page_ttl_amnt; @endphp
                            ...
                            <tr data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <td>
                                    {{ date('d-M-y', strtotime(str_replace('/', '-', $voucher->afv_day_end_date))) }}
                                </td>
                                <td class="view" data-id="{{ $voucher->afv_v_no }}" data-reg_no="{{ $voucher->afv_reg_no }}" data-status="{{$voucher->afv_status}}">
                                    AFV-{{ $voucher->afv_v_no }}
                                </td>
                                <td>
                                    {{ $voucher->roll_no }}
                                </td>
                                ...
                                <td class="align_right text-right">
                                    {{ $voucher->afv_total_amount != 0 ? number_format($voucher->afv_total_amount, 2) : '' }}
                                </td>

                                @php
                                    $ip_browser_info = '' . $voucher->afv_ip_adrs . ',' . str_replace(' ', '-', $voucher->afv_brwsr_info) . '';
                                @endphp
                                <td>
                                    {{ $voucher->branch_name }}
                                </td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 text-right">
                        ...
                        'section'=>$search_section, 'status'=>$search_status])->links()
                        }}</span>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Advance Fee Voucher Detail</h4>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('advance_fee_voucher_list') }}',
            url;
