    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Create Component</h4>
                    </div>
                    <div class="list_btn">
            ...
            <form name="f1" class="f1" id="f1" action="{{ route('store_component') }}" method="post"
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="1" type="text" name="component_name" id="component_name"
                                class="inputs_up form-control" placeholder="Component Name" autofocus
                                data-rule-required="true" data-msg-required="Please Enter Component Name" autocomplete="off"
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="6" type="text" name="amount" class="inputs_up text-right form-control"
                                id="amount" placeholder="Amount" onfocus="this.select();" data-rule-required="true"
                                data-msg-required="Please Enter Dr Account"onkeypress="return allow_only_number_and_decimals(this,event);">
                            <span id="demo1" class="validate_sign"> </span>
                        </div>
                    </div>
                            ...
                            <select tabindex=42 autofocus name="dr_account" class="form-control" data-rule-required="true"
                                ...
                                @foreach ($dr_accounts as $account)
                                    <option value="{{ $account->account_uid }}"
                                        {{ $account->account_uid == old('dr_account') ? 'selected' : '' }}>
                        ...
                        <div class="input_bx">
                            ...
                            <select tabindex=42 autofocus name="cr_account" class="form-control" data-rule-required="true"
                                ...
                                @foreach ($cr_accounts as $account)
                                    <option value="{{ $account->account_uid }}"
                                        {{ $account->account_uid == old('cr_account') ? 'selected' : '' }}>
                                        {{ $account->account_uid }} - {{ $account->account_name }}
                                    </option>
                                @endforeach
                            </select>
