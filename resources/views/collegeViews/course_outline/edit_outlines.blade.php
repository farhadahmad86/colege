        ...
        <div class="container-fluid search-filter form-group form_manage">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                ...
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    <!-- invoice box start -->
                    <form id="f1" action="{{ route('update_outlines') }}" method="post"
                          onsubmit="return checkForm()">
                        @csrf
                        <input type="hidden" value="{{ $outlines->co_id }}" name="co_id">
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                ...
                                <div class="invoice_row my-3">
                                    ...
                                    <div class="invoice_col from_group col-lg-3 col-md-4 col-sm-12">
                                        ...
                                        <select tabindex="1" name="subject_id" class="inputs_up form-control cash_voucher"
                                            ...
                                            @foreach ($subjects as $subject)
                                                <option
                                                    value="{{ $subject->subject_id }}" {{ $subject->subject_id == $outlines->co_subject_id ? 'selected' : '' }}>{{ $subject->subject_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="invoice_col from_group col-lg-3 col-md-4 col-sm-12">
                                        ...
                                        <select name="subject_group" class="inputs_up form-control cash_voucher"
                                            ...
                                            <option value="1" {{$outlines->co_group_id == 1 ? 'selected' : ''}}>First Year</option>
                                            <option value="2" {{$outlines->co_group_id == 2 ? 'selected' : ''}}>Second Year</option>
                                        </select>
                                    </div>
                                    <div class="invoice_col from_group col-lg-3 col-md-4 col-sm-12">
                                        <!-- invoice column -->
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 mt-4">
                                        <div class="custom-checkbox">
                                            <input tabindex="-1" type="checkbox" name="urdu_type" id="urdu_type"
                                                   value="{{ $outlines->co_lang_type }}"
                                                   {{ $outlines->co_lang_type == 1 ? 'checked' : '' }} class="custom-control-input company_info_check_box">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var lang_type = {!! $outlines->co_lang_type !!};
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            let array = JSON.parse(`{!! $outlines->co_outlines !!}`);
            {{--let arrayss = JSON.parse(`{!! json_decode($outlines->co_outlines) !!}`);--}}
            {{--let arrays =JSON.parse `{!! json_decode($outlines->co_outlines) !!}`;--}}
            console.log(array);
                ...
                if (flag_submit1) {
                    ...
                    jQuery("#table_body").append(
                        `   <tr id="${counter}" class="edit_update">
                                <td class="text-center tbl_srl_9">${outline}</td>
