...
@section('content')
    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text file_name">College Wise Attendance Report</h4>
                    </div>
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm"
                      action="{{ route('college_wise_report') . (isset($restore_list) && $restore_list == 1 ? '?restore_list=1' : '') }}"
                    ...
                    <div class="row">
                        ...
                        <!-- Call add button component -->
                            <x-add-button tabindex="9" href="{{ route('college_wise_report') }}"/>
    ...
    @endforeach
                        ...
                        <td>
                            {{$presentCount > 0 ? number_format($presentCount/$students *100,2) : 0}}
                        </td>
                        <td>
                            {{$absentCount}}
                        </td>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('college_wise_report') }}',
            url;
