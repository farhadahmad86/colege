        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Update College</h4>
                        </div>
                    </div>
                </div><!-- form header close -->
                <form name="f1" class="f1" id="f1" action="{{route('update_college')}}" onsubmit="return checkForm()" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="row">
                                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                                    <div class="input_bx">
                                        ...
                                        <label class="required">
                                            ...
                                            Branch Title</label>
                                        <input type="text" name="clg_name" id="clg_name" class="inputs_up form-control"
                                            data-rule-required="true" data-msg-required="Please Enter College"
                                            placeholder="College Title" autofocus value="{{ $request->title }}"
                                            autocomplete="off" />
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                                    <div class="input_bx">
                                        ...
                                        <label class="required">
                                            ...
                                            Branch Limit</label>
                                        <input type="text" name="branch_limit" id="branch_limit" class="inputs_up form-control"
                                            data-rule-required="true" data-msg-required="Please Enter College"
                                            placeholder="College Title" autofocus value="{{ $request->clg_branch_limit }}"
                                            autocomplete="off" />
                                        <span id="demo1" class="validate_sign"> </span>
                                    </div><!-- end input box -->
                                </div>
                                <div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <x-update-image title="College Logo" image="{{ $request->clg_logo }}" />
                                    </div>
                                </div>
                                <input value="{{ $request->clg_id }}" type="hidden" name="clg_id">
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                                    ...
                                    <button type="submit" class="save_button form-control">
