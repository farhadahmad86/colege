...
@section('content')
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            ...
            <form name="f1" class="f1" id="f1" action="{{ route('update_section') }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="1" type="text" name="cs_name" id="cs_name"
                    ...
                    <input value="{{ $request->cs_id }}" type="hidden" name="cs_id">
                </div>
