...
@section('content')
    <form name="f1" class="f1" id="f1" action="{{ route('update_other_attendance') }}" method="post"
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="input_bx">
                                    ...
                                    <select class="form-control form-control-sm" name="dep_id" id="dep_id"
                                        ...
                                        <option value="{{ $alldepartments->dep_id }}"
                                            {{ $alldepartments->dep_id == $request->dep_id ? 'selected' : '' }}>
                                            {{ $alldepartments->dep_title }}</option>
                                        {{-- @endforeach --}}
                                    </select>
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                <div class="input_bx">
                                    ...
                                    <select tabindex="1" autofocus name="teacher_id"
                                        ...
                                        <option value="{{ $allteachers->user_id }}"
                                            {{ $allteachers->user_id == $request->emp_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="input_bx">
                                    ...
                                    <input tabindex="1" type="text" name="date" id="date"
                                        class="inputs_up form-control" placeholder="Enter Date" autofocus
                                        data-rule-required="true" data-msg-required="Please Enter Date" autocomplete="off"
                                        value="{{ $request->la_date }}" readonly />
                                    <span id="demo1" class="validate_sign"> </span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="input_bx">
                                    ...
                                    <div class="custom-control custom-radio mb-10 mt-1">
                                        <input tabindex="12" type="radio" name="lec_attendance"
                                            ...
                                            {{ $request->la_attendance == 'P' ? 'checked' : '' }} checked>
                                    ...
                                    <div class="custom-control custom-radio mb-10 mt-1">
                                        <input tabindex="13" type="radio" name="lec_attendance"
                                            ...
                                            value="A"{{ $request->la_attendance == 'A' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-radio mb-10 mt-1">
                                        <input tabindex="14" type="radio" name="lec_attendance"
                                            ...
                                            value="L"{{ $request->la_attendance == 'L' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-radio mb-10 mt-1">
                                        <input tabindex="14" type="radio" name="lec_attendance"
                                            class="custom-control-input lec_attendance" id="Short_leave"
                                            value="S.L"{{ $request->la_attendance == 'S.L' ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="Short_leave">
                                            Short Leave
                                        </label>
                                    </div>
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                <div class="input_bx" id="leaveRemarksDiv" style="display: none;">
                                    ...
                                    <input tabindex="1" type="text" name="leave_remarks" id="leave_remarks"
                                        ...
                                        autocomplete="off" value="{{ $request->la_leave_remarks }}" />
                                    <span id="demo1" class="validate_sign"> </span>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" name="la_id" value="{{ $request->la_id }}">
                    </div>
                </div>
