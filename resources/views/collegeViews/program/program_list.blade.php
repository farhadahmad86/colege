    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12 text-right form_controls mt-2">
                            ...
                            <x-add-button tabindex="9" href="{{ route('add_program') }}" />
                ...
                <form name="edit" id="edit" action="{{ route('edit_program') }}" method="post">
                    @csrf
                    ...
                    <input name="degree_name" id="degree_name" type="hidden">
                </form>
                    ...
                    <tbody>
                        ...
                        @forelse($datas as $data)
                            <tr
                                ...
                                data-degree_name="{{ $data->degree_name }}" data-degree_id="{{ $data->degree_id }}">
                                <th scope="row">
                                    {{ $sr }}
                                </th>
                                <td class="edit">
                                ...
                                @php
                                    $ip_browser_info = '' . $data->program_ip_adrs . ',' . str_replace(' ', '-', $data->program_brwsr_info) . '';
                                @endphp
                                ...
                                {{-- <td class="text-center hide_column ">
                                    <a data-program_id="{{ $data->program_id }}" class="delete" data-toggle="tooltip"
                                        data-placement="left" title="" data-original-title="Are you sure?">
                                        <i class="fa fa-{{ $data->program_delete_status == 1 ? 'undo' : 'trash' }}"></i>
                                    </a>
                                </td> --}}
                            </tr>
                            @php
...
@section('scripts')
    ...
    <script>
        jQuery(".edit").click(function() {
            ...
            var degree_name = jQuery(this).parent('tr').attr("data-degree_name");
            jQuery("#title").val(title);
            jQuery("#program_id").val(program_id);
            jQuery("#degree_id").val(degree_id);
            jQuery("#degree_name").val(degree_name);
            jQuery("#edit").submit();
        });
