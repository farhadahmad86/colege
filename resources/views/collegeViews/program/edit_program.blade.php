    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Update Program</h4>
                    </div>
                    <div class="list_btn">
            ...
            <form name="f1" class="f1" id="f1" action="{{ route('update_program') }}" method="post"
                            ...
                            <select tabindex="1" autofocus name="degree" class="form-control required" id="degree"
                                ...
                                @foreach ($degree as $degrees)
                                    <option value="{{ $degrees->degree_id }}"
                                        {{ $degrees->degree_id == $request->degree_id ? 'selected' : '' }}>
                                        {{ $degrees->degree_name }}
                                    </option>
                                @endforeach
                            </select>
