        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Transport Delete / Reverse Voucher
                                List</h4>
                        </div>
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('transport_voucher_reverse_list') }}"
                          name="form1"
                            ...
                            <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                <div class="input_bx">
                                    ...
                                    <input tabindex="1" autofocus type="search" list="browsers"
                                           ...
                                           placeholder="Month Search"
                                           value="{{ isset($search_month) ? $search_month : '' }}"
                                           autocomplete="off">
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr>
                                ...
                                <td class="view" data-id="{{ $voucher->tv_v_no }}"
                                    data-reg_no="{{ $voucher->tv_reg_no }}" data-status="{{$voucher->tv_status}}">
                                    TV-{{ $voucher->tv_v_no }}
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    {{ $voucher->tv_status === 0 ? 'Pending' : ($voucher->tv_status === 1 ? 'Paid' : 'Deleted') }}
                                </td>
                                <td>
                                    {{ $voucher->deletedBy }}
                                </td>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('transport_voucher_reverse_list') }}',
            url;
