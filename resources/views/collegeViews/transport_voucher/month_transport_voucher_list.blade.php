        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Month Wise Transport Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('month_transport_voucher_list') }}" name="form1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 srch_brdr_left">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mt-lg-4 text-right">
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr data-toggle="tooltip" data-placement="top" title=""
                                ...
                                @php
                                    $dateString = $voucher->tv_month;
                                    $date = Carbon::createFromFormat('F Y', $dateString);
                            @endphp
                                <td class="view" data-month="{{ $date->month }}" data-year="{{ $voucher->year
                                }}" data-issue_date="{{ $voucher->tv_issue_date }}"> {{ $voucher->tv_month }}
                                </td>
                                <td>
    ...
    <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content base_clr">
                ...
                <div class="modal-body padding: 1.5rem;" id="voucherModalBody">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('month_transport_voucher_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            var issue_date = jQuery(this).attr("data-issue_date");
            $(".modal-body").load('{{ url('month_transport_voucher_items_view_details/view/') }}/' + month + '/' + year + '/' + issue_date, function () {
                $("#myModal").modal({
                    show: true
                });
            });
