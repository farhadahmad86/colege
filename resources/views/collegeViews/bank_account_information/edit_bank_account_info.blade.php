    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Edit Bank Information</h4>
                    </div>
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button" href="{{route('bank_account_info_list')}}" role="button">
            ...
            <form name="f1" class="f1" id="f1" action="{{ route('update_bank_account_info') }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="1" type="text" name="account" id="account"
                                ...
                                data-msg-required="Please Enter Account" autocomplete="off" value="{{ $request->account_no }}" />
                            <span id="demo1" class="validate_sign"> </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="6" type="text" name="branch_code"
                                ...
                                onfocus="this.select();" data-rule-required="true" value="{{ $request->branch_code }}"
                    ...
                    <input type="hidden" value="{{ $request->bi_id }}" name="bi_id">
                </div>
