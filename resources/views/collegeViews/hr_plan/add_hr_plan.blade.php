    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Create Hr Plan</h4>
                    </div>
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('hr_plan_list') }}"
                            role="button">
            ...
            <form name="f1" class="f1" id="f1" action="{{ route('store_hr_plan') }}" method="post"
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="1" type="text" name="hr_plan_extra_leave" id="hr_plan_extra_leave"
                                ...
                                autocomplete="off" value="{{ old('hr_plan_extra_leave') }}" />
                            <span id="demo1" class="validate_sign"> </span>
                        </div><!-- end input box -->
                    </div>
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="1" type="text" name="hr_plan_causual_leave" id="hr_plan_causual_leave"
                                ...
                                autocomplete="off" value="{{ old('hr_plan_causual_leave') }}" />
                            <span id="demo1" class="validate_sign"> </span>
                        </div><!-- end input box -->
                    </div>
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="1" type="text" name="hr_plan_short_leave" id="hr_plan_short_leave"
                                ...
                                autocomplete="off" value="{{ old('hr_plan_short_leave') }}" />
                            <span id="demo1" class="validate_sign"> </span>
                        </div><!-- end input box -->
                    </div>
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="1" type="text" name="hr_plan_half_leave" id="hr_plan_half_leave"
                                class="inputs_up form-control" placeholder="Hr Plan Short Leave" autofocus
                                data-rule-required="true" data-msg-required="Please Enter Hr Plan Short Leave"
                                autocomplete="off" value="{{ old('hr_plan_half_leave') }}" />
                            <span id="demo1" class="validate_sign"> </span>
                        </div><!-- end input box -->
                    </div>
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <textarea tabindex="23" name="hr_plan_description" id="hr_plan_description" class="remarks inputs_up form-control"
                                placeholder="Description" style="height: 107px;">{{ old('hr_plan_description') }}</textarea>
