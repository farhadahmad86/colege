        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Month Wise Custom Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('month_custom_voucher_list') }}" name="form1"
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 text-right">
                        ...
                        'section'=> $search_section])->links() }}</span>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('month_custom_voucher_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            $(".modal-body").load('{{ url('month_custom_voucher_items_view_details/view/') }}/' + id + '/' + class_id + '/' + month + '/' + year + '/' + issue_date, function () {
                $("#myModal").modal({
                    show: true
                });
            });
