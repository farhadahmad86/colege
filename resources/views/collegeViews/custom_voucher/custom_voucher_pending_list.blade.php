        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Custom Voucher Pending List</h4>
                        </div>
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('custom_voucher_pending_list') }}"
                          name="form1"
                                    ...
                                    <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                        <div class="input_bx">
                                            ...
                                            <select tabindex="5" name="type" class="inputs_up form-control" id="type">
                                                ...
                                                <option
                                                    value="1" {{ '1' == $search_type ? 'selected="selected"' : '' }}>
                                                    Regular
                                                </option>
                                                <option
                                                    value="2" {{ '2' == $search_type ? 'selected="selected"' : '' }}>
                                                    Arrears
                                                </option>
                                            </select>
                                        </div>
                    ...
                    <form name="delete" id="delete" action="{{ route('reverse_custom_voucher') }}" method="post">
                        @csrf
                        <input name="cv_id" id="del_cv_id" type="hidden">
                        <input name="cv_v_no" id="del_cv_v_no" type="hidden">
                    </form>
                </div><!-- search form end -->
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <td class="text-center hide_column ">
                                    <a data-cv_id="{{$voucher->cv_id}}" data-cv_v_no="{{$voucher->cv_v_no}}"
                                       class="delete" data-toggle="tooltip" data-placement="left" title=""
                                       data-original-title="Are you sure you want to delete this voucher?">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 text-right">
                        ...
                        'section'=> $search_section, 'type' => $search_type])->links() }}</span>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('custom_voucher_pending_list') }}',
            url;
    ...
    <script>
        $('.delete').on('click', function (event) {
            ...
            var cv_id = jQuery(this).attr("data-cv_id");
            var cv_v_no = jQuery(this).attr("data-cv_v_no");
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    jQuery("#del_cv_id").val(cv_id);
                    jQuery("#del_cv_v_no").val(cv_v_no);
