    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text file_name">Bus Route List</h4>
                    </div>
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm" action="{{ route('route_list') }}" name="form1" id="form1"
                      method="post">
                    <div class="row">
                        @csrf
                        <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                            <label for="search">All Column Search</label>
                            <div class="input_bx">
                        ...
                        <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 text-right form_controls">
                            ...
                            <x-add-button tabindex="9" href="{{ route('add_route') }}"/>
