    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Edit Bus Transport</h4>
                    </div>
                    <div class="list_btn">
            ...
            <form name="f1" class="f1" id="f1" action="{{ route('update_route') }}" method="post"
                  onsubmit="return checkForm()">
                @csrf
                <div class="row">
                    <input type="hidden" value="{{$request->tr_id}}" name="tr_id">
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="3" type="text" name="single_route_amount" id="single_route_amount"
                                   class="form-control"
                                   ...
                                   value="{{ $request->single_route_amount }}"/>
                            <span id="demo1" class="validate_sign"> </span>
                        </div><!-- end input box -->
                    </div>
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="4" type="text" name="double_route_amount" id="double_route_amount"
                                   class="form-control"
                                   ...
                                   value="{{ $request->double_route_amount }}"/>
                            <span id="demo1" class="validate_sign"> </span>
                        </div><!-- end input box -->
                    </div>
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <input tabindex="1" type="text" name="vendor_charge" id="vendor_charge"
                                   class="form-control"
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <div class="input_bx">
                            ...
                            <textarea tabindex="1" type="text" name="remarks" id="remarks"
                                      ...
                                      value="">{{ $request->remarks }}</textarea>
                            <span id="demo1" class="validate_sign"> </span>
                        </div><!-- end input box -->
                    </div>
                </div>
