        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Product Last Purchase Rate Verification</h4>
                        </div>
                ...
                <div
                    ...
                    <form class="highlight prnt_lst_frm" action="{{ route('product_last_purchase_rate_verification') }}" name="form1" id="form1" method="post" autocomplete="off">
                        @csrf
                        <div class="row">
