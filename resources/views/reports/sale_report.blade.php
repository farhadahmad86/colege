    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage" id="">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text file_name">Sale Report</h4>
                    </div>
        ...
        <!-- <div class="search_form {{ !empty($search) || !empty($search_account) || !empty($search_product) || !empty($search_sale_persons) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm" action="{{ route('sale_invoice_list') }}" name="form1"
                ...
                <table class="table table-bordered table-sm" id="fixTable">
                    ...
                    @forelse($datas as $invoice)
                        <tr>
                            ...
                            <td class="tbl_txt_21 fonti">
                                {{ $party_name }}
                            </td>
                            <td class="tbl_txt_21">
                                {{ $invoice->pr_name }}
                            </td>
                            <td class="tbl_txt_11 fonti">
                                {{ $invoice->si_remarks }}
                            </td>
                            <td class="tbl_txt_29 fonti">
                            ...
                            <td class="usr_prfl tbl_txt_8" data-usr_prfl="{{ $invoice->user_id }}"
