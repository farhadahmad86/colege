    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left file_name">
                            <h4 class="text-white get-heading-text">Online Users In Web</h4>
                        </div>
                ...
                <div class="search_form {{ ( !empty($search) || !empty($search_salary_account) || !empty($search_group) || !empty($search_role) || !empty($search_modular_group) || !empty($search_user_type) ) ? '' : 'search_form_hidden' }}">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('force_offline_user_web') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                            ...
                            <form name="online" id="online" action="{{ route('update_force_offline_user_web') }}" method="post">
                                @csrf
                ...
                <form action="{{ route('update_all_force_offline_user_web') }}" method="post">
                    @csrf
