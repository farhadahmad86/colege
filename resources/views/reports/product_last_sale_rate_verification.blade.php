        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Product Last Sale Rate Verification</h4>
                        </div>
                ...
                <div
                    ...
                    <form class="highlight prnt_lst_frm" action="{{ route('product_last_sale_rate_verification') }}" name="form1" id="form1" method="post" autocomplete="off">
                        @csrf
                        <div class="row">
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        <tr>
                            ...
                            @endphp
                            <td>
                                <a class="view" data-transcation_id="{{ $set_invoice_id.'-'.$datas->id}}" data-toggle="modal" data-target="#myModal" style="cursor:pointer; color: #0099ff;">
                ...
                {{--                    <span class="hide_column">{{ $datas->appends(['segmentSr' => $countSeg, 'search'=>$search, 'to'=>$search_to, 'from'=>$search_from, 'product_code'=>$search_product, 'account'=>$search_account ])->links() }}</span>--}}
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('product_last_sale_rate_verification') }}',
            url;
