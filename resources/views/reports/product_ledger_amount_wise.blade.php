            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                    ...
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white get-heading-text">Product Ledger Amount Wise
                    ...
                    {{--                    <div class="search_form {{ ( !empty($search) || !empty($pro_code) || !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}">--}}

                    <div class="search_form m-0 p-0">
                        <form class="highlight prnt_lst_frm" action="{{ route('product_ledger_amount_wise') }}" name="form1" id="form1" method="post" autocomplete="off">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12 form_controls text-right mt-4">
                    ...
                    <div class="table-responsive" id="printTable">
                        <table class="table table-bordered table-sm" id="fixTable">
                            ...
                            @if ($products_details != null)
                                ...
                                {{--                                @endphp--}}
                                {{--                        <tr>--}}
                                {{--                            <td>{{$result->system_date}}</td>--}}
                                {{--                            <td><a class="view" data-transcation_id="{{$result->voucher_code}}" data-toggle="modal" data-target="#myModal" style="cursor:pointer;">{{$result->voucher_code}}</a></td>--}}
                        ...
                        <table class="table table-bordered table-sm" id="fixTable">
                            ...
                            @forelse($datas as $result)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right tbl_amnt_20">
                            ...
                            <tfoot>
                            <tr class="border-0">
                                <th colspan="4" class="border-0 text-right align_right">
                                    Page Total:
                                </th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 text-right">
                            <span
                                class="hide_column"> {{ $datas->appends(['segmentSr' => $countSeg, 'search'=>$search, 'to'=>$search_to, 'from'=>$search_from, 'product_code'=>$search_product ])->links() }}</span>
                        </div>
                    </div>
...
<script type="text/javascript">
    var base = '{{ route('product_ledger_amount_wise') }}',
        url;
