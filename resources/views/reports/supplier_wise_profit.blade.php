            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white get-heading-text">Supplier Wise Profit</h4>
                            </div>
                    ...
                    <div class="search_form m-0 p-0 {{ ( !empty($search) || !empty($search_to) || !empty($search_from) ) ? '' : '' }}">
                        <form class="highlight prnt_lst_frm" action="{{ route('supplier_wise_profit') }}" name="form1" id="form1" method="post">
                                    @csrf
                                    <div class="row">
...
<script type="text/javascript">
    var base = '{{ route('supplier_wise_profit') }}',
        url;
