        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Temp To Purchase Invoice</h4>
                        </div>
                        <div class="list_btn list_mul">
                            <a class="add_btn list_link add_more_button" href="{{ route('trade_purchase_invoice_list') }}" role="button">
                                <i class="fa fa-list"></i>Trade Purchase Invoice
                            </a>
                        </div><!-- list btn -->
                    </div>
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_temp_to_purchase_invoice') }}"
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_80 upper">
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_25 hidden"><!-- invoice column -->
                                                    <x-party-name-component tabindex="2" name="account_code" id="account_code" class="purchase"/>
                                                </div>

                                                {{--                                                <div class="invoice_col basis_col_25" hidden><!-- invoice column start -->--}}
                                                {{--                                                    <div class="invoice_col_bx"><!-- invoice column box start -->--}}
                                                ...
                                                {{--                                                            <select tabindex="1" autofocus name="account_code" class="inputs_up form-control js-example-basic-multiple"--}}
                                                {{--                                                                    data-rule-required="true" data-msg-required="Please Choose Party Code"--}}
                                                {{--                                                                    id="account_code">--}}
                                                ...
                                                <div class="invoice_col basis_col_24 pl-2"><!-- invoice column -->
                                                ...
                                                {{--                                                            <div class="invoice_col_short">--}}
                                                {{--                                                                <!-- invoice column short start -->--}}
                                                {{--                                                                <a href="{{ url('payables_account_registration') }}"--}}
                                                ...
                                                {{--                                                            <select tabindex="2" name="account_name" class="inputs_up form-control js-example-basic-multiple"--}}
                                                ...
                                                {{--                                                            <input tabindex="3"--}}
                                                {{--                                                                   onkeydown="return not_plus_minus(event)"--}}
                                                {{--                                                                   type="text" name="customer_name" class="inputs_up form-control" id="customer_name" placeholder="Party Reference">--}}
                                                {{--                                                        </div><!-- invoice column input end -->--}}
                                                {{--                                                    </div><!-- invoice column box end -->--}}
                                                {{--                                                </div><!-- invoice column end -->--}}
                                                ...
                                                {{--                                                        <div class="invoice_col_input"><!-- invoice column input start -->--}}
                                                {{--                                                            Hamad set tab index--}}
                                                {{--                                                            <select tabindex="4" name="posting_reference" class="inputs_up form-control js-example-basic-multiple"--}}
                                                ...
                                                {{--                                                    </div><!-- invoice column box end -->--}}
                                                {{--                                                </div><!-- invoice column end -->--}}
                                                <div class="invoice_col basis_col_48 pl-2"><!-- invoice column start -->
                                                    <x-remarks-component tabindex="5" name="remarks" id="remarks" title="Remarks"/>
                                                </div>
                                                <div class="invoice_col basis_col_15 pl-2"><!-- invoice column start -->
                                                    <x-remarks-component tabindex="5" name="exp_per" id="exp_per" title="Expence %"/>
                                                </div>
                                                <div class="invoice_col basis_col_15 pl-2"><!-- invoice column start -->
                                                    <x-remarks-component tabindex="5" name="conversion" id="conversion" title="Conversion Rate"/>
                                                </div>
                                                ...
                                                {{--                                                                   onkeydown="return not_plus_minus(event)"--}}
                                                {{--                                                                   name="remarks" class="inputs_up form-control" id="remarks" placeholder="Remarks">--}}
                                                {{--                                                        </div><!-- invoice column input end -->--}}
                                                {{--                                                    </div><!-- invoice column box end -->--}}
                                                {{--                                                </div><!-- invoice column end -->--}}
...
{{--                                                                <input type="hidden" name="invoice_nbr[]" class="inputs_up form-control" id="invoice_nbr" placeholder="Check Invoice Number"--}}
                                            ...
                                            <div class="invoice_row" hidden><!-- invoice row start -->
                                                ...
                                                {{--                                                                </a>--}}
                                                {{--                                                            </div><!-- invoice column short end -->--}}
                                                {{--                                                            <select tabindex="6" name="warehouse" class="inputs_up form-control js-example-basic-multiple" id="warehouse"--}}
                                                {{--                                                            >--}}
                                                        ...
                                                        <div class="pro_tbl_bx"><!-- product table box start -->
                                                            <table class="table table-bordered table-sm gnrl-mrgn-pdng" id="category_dynamic_table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center tbl_srl_4"># </th>
                                                                    ...
                                                                    <th class="text-center tbl_srl_4" hidden>Detail Pack</th>
                                                                    <th class="text-center tbl_srl_6">Pack Size</th>
                                                                    <th class="text-center tbl_srl_4" hidden>DB Qty</th>
                                                                    <th class="text-center tbl_srl_6"> Pack Qty</th>
                                                                    <th class="text-center tbl_srl_6"> Pack Rate</th>
                                                                    <th class="text-center tbl_srl_6"> Loose Qty</th>
                                                                    ...
                                                                    <th class="text-center tbl_srl_4" hidden> UOM</th>
                                                                    <th class="text-center tbl_srl_4" hidden> Trade Offer</th>
                                                                    ...
                                                                    <th class="text-center tbl_srl_4 " hidden> Inclu</th>
...
{{--                                                                    <th class="text-center tbl_srl_6">Actions</th>--}}
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        <div hidden class="invoice_col basis_col_18"><!-- invoice column start -->
...
@section('scripts')
    ...
    <script>
        ...
        var GET_PRODUCTS_ROUTE = '{{ route('ajax_get_json_temp_purchase_invoice') }}';
    </script>
    ...
    @if (Session::get('grnpi_id'))
        <script>


            jQuery("#table_body").html("");

            var id = '{{ Session::get("grnpi_id") }}';
    ...
    <script>
        ...
        jQuery("#check_return_invoice").click(function () {
            ...
            var exp_per = jQuery('#exp_per').val();
            if ((conversion == '') && (exp_per == '')) {
                alert('Please Enter Conversion Rate and Expense %')
            } else {
                ...
                if (n == false) {
                    ...
                    jQuery.ajax({
                        url: "{{route('get_temp_purchase_items_for_purchase')}}",
                        ...
                        success: function (data) {
                            ...
                            if (data[1] != '') {
                                ...
                                jQuery("#invoice_nbr").val(invoice_no);
                                if (data.length !== 0) {
                                    if (table_data == '') {
                                        myArr = [];
                                        // myArr.push(invoice_no);
                                        ...
                                        $.each(data[1], function (index, value) {
                                            ...
                                            var grn_code = counter;//value[item_prefix + '_purchase_invoice_id'];
                                            ...
                                            var conversion_rate = rate * conversion;
                                            var exp_rate = (conversion_rate  * exp_per) / 100;
                                            rate  = +conversion_rate + +exp_rate;
                                            var sale_price = value[item_prefix + '_sale_price'];
                                            var inclusive_rate = 0;
                                            var discount = value[item_prefix + '_discount_per'];
                                            var discount_amount = value[item_prefix + '_discount_amount'];
                                            discount_amount = (discount_amount * conversion).toFixed(2);
    ...
    <script>
        ...
        function add_sale(grn_id, code, name, quantity, bonus_qty, rate, sale_price, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="text-center tbl_srl_6">' +
                '<input type="hidden" name="display_quantity[]" id="display_quantity' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter +
                ')' +
                ',' +
                'tab_within_table(event,' + counter + ')" value="' +
                pack_qty + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);" readonly/>' +pack_qty+
                '</td>' +
                ...
                '<input type="hidden"  name="unit_qty" id="unit_qty' + counter + '" ' + ' placeholder="0" value="' + unit_qty + '" class="inputs_up_tbl"   onkeyup="product_amount_calculation(' +
                counter
                + '),tab_within_table(event,' + counter + ')" ' +
                '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);" readonly/> ' +unit_qty+
                '</td>' +
                ...
                '<input type="hidden" name="bonus[]" id="bonus' + counter + '" placeholder="Bonus" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + '),tab_within_table' +
                '(event,' +
                '' + counter + ')" value="' +
                bonus_qty + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);" ' + bonus_qty_status + ' readonly/> ' + bonus_qty +
                '</td> ' +
                ...
                '<td class="text-center tbl_srl_4"> ' +
                '<input type="hidden" name="product_discount[]" id="product_discount' + counter + '" placeholder="Dis%" class="inputs_up_tbl percentage_textbox" onkeyup="product_amount_calculation(' +
                counter + '),tab_within_table(event,' + counter + ')" ' +
                'value="' + discount + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/> ' +discount+
                '</td> ' +

                '<td class="text-right tbl_srl_7"> ' +
                '<input type="hidden" name="product_discount_amount[]" id="product_discount_amount' + counter + '" placeholder="Dis Amount" value="' + discount_amount + '" class="inputs_up_tbl ' +
                'text-right" ' +
                'readonly/> ' +discount_amount+
                '</td> ' +

                '<td hidden class="text-center tbl_srl_4 "> ' +
                ...
                '<td hidden class="text-right tbl_srl_7 "> ' +
