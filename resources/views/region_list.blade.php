        ...
        <div class="container-fluid search-filter form-group form_manage">
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm"
                    action="{{ route('region_list') . (isset($restore_list) && $restore_list == 1 ? '?restore_list=1' : '') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 text-right form_controls">
                            ...
                            <x-add-button tabindex="9" href="{{ route('add_region') }}" />
                ...
                <table class="table table-bordered table-sm" id="fixTable">
                    ...
                    <tbody>
                        ...
                        @forelse($datas as $data)
                            <tr data-title="{{ $data->reg_title }}" data-remarks="{{ $data->reg_remarks }}"
                                data-region_id="{{ $data->reg_id }}">
                                {{--                                        <td class="edit "> --}}
                                {{--                                            {{$sr}} --}}
                                {{--                                        </td> --}}
                                ...
                                <td class="text-center hide_column ">
                                    <label class="switch">
                                        <input type="checkbox" <?php if ($data->reg_disabled == 0) {
                                            echo 'checked="true"' . ' ' . 'value=' . $data->reg_disabled;
                                        } else {
                                            echo 'value=DISABLE';
                                        } ?> class="enable_disable"
                                            data-id="{{ $data->reg_id }}" {{ $data->reg_disabled == 0 ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>

                                <td class="text-center hide_column ">
                                    <a data-region_id="{{ $data->reg_id }}" class="delete" data-toggle="tooltip"
