    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <form name="f1" class="f1" id="f1" action="{{ route('submit_purchase_return_invoice') }}" onsubmit="return popvalidation()" method="post" autocomplete="off">
                @csrf
                                ...
                                <div class="row">  <!--  new row starts here -->
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <input type="text" name="invoice_no" class="inputs_up form-control" id="invoice_no" placeholder="Invoice number"
...
@section('scripts')
            ...
            if ($(this).is(':checked')) {
                if (this.value == 1) {
                    ...
                    $.each(purchases, function (index, value) {
                            ...
                            // var product_sale_tax_percentage = (selected_amount / 100) * product_sales_tax;
                            // selected_amount = +selected_amount + +product_sale_tax_percentage;
    ...
    <script>
        $('#check').click(function () {
            ...
            jQuery.ajax({
                url: "{{ route('get_purchased_items_for_return') }}",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.length !== 0) {
                        ...
                        var account_code = data[0][prefix + '_party_code'];
                        ...
                        jQuery("#account_code").children("option[value^=" + account_code + "]");
                        ...
                        $.each(data[1], function (index, value) {
                            ...
                            var warehouse = value[item_prefix + '_warehouse_id'];

                            jQuery('#warehouse option[value="' + warehouse + '"]').prop('selected', true);
                            var warehouse_name = jQuery("#warehouse option:selected").text();
                            ...
                            if (value[item_prefix + '_saletax_inclusive'] == 1) {
                                inclusive_exclusive = 'Inclusive';
                                inclusive_exclusive_status = 1;
