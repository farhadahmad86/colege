        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Dispatch List</h4>
                        </div>
                ...
                <div class="search_form {{ ( !empty($search_to) || !empty($search_from) ) ? '' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('dispatch_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                ...
                <span class="hide_column">  {{ $datas->appends(['segmentSr' => $countSeg, 'to'=>$search_to, 'from'=>$search_from])->links() }}</span>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Dispatch Detail</h4>
                    ...
                    <div class="itm_vchr form_manage">
                        <div class="form_header">
                            <h4 class="text-white file_name">
                                <span class="db sml_txt"> Dispatch #: </span>
                            </h4>
                        </div>
