        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Create Dip Reading</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('dip_reading_list') }}" role="button">
                ...
                <form name="f1" class="f1" id="f1" action="{{ route('submit_dip_reading') }}" onsubmit="return validate_form()" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <select tabindex="2" name="tank" class="inputs_up form-control" id="tank" data-rule-required="true" data-msg-required="Please Enter Tank Title">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input tabindex="3" type="text" name="datetime" id="datetime"
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input tabindex="4" type="text" name="dip" id="dip" class="inputs_up form-control"
                                                       placeholder="Dip Reading" data-rule-required="true" data-msg-required="Please Enter Dip Reading"
    ...
    <script>
        function mm_to_litre() {
            ...
            if(dip!='' && tank!=''){
                ...
                jQuery.ajax({
                    url: "dip_reading_mm_to_litre",
                    data:{dip: dip,tank: tank},
                    type: "POST",
                    cache:false,
                    dataType: 'json',
                    success:function(data){
                        ...
                        jQuery("#litre").html("");
                        jQuery("#litre").append('Litre ('+data+')');
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        //alert(jqXHR.responseText);
                       // alert(errorThrown);
