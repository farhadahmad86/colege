            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">PSO Credit Sale Invoice</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                    ...
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white">PSO Credit Sale Invoice</h4>
                            </div>
                            <div class="list_btn">
                                    ...
                                    <div class="row">  <!--  new row starts here -->
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <select name="account" class="inputs_up form-control" id="account">
...
<script>
    ...
    function add_sale() {
     ...
     //   var product_name = document.getElementById("product_name").value;
        ...
        if (flag_submit1) {
            ...
            jQuery("#account").select2("destroy");
            jQuery("#product_name").select2("destroy");
            ...
            var account_name = jQuery("#account option:selected").text();
            ...
            sales[counter] = [selected_code_value, product_name, selected_remarks, qty, selected_rate, selected_amount, nozzle , tank , account, account_name, sale_person,'','',''];

            numberofsales = Object.keys(sales).length;

            jQuery("#table_body").prepend('<tr id=' + counter + '><td >' + account_name + '</td><td > <div class="max_txt">' + product_name + '</div></td><td>' + selected_remarks + '</td><td' +
            ...
            jQuery('#account option[value="' + 0 + '"]').prop('selected', true);
    ...
    function edit_sale(current_item) {
        ...
        jQuery("#account").val(temp_sales[8]);
