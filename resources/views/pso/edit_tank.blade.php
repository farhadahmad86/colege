        ...
        <div
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Edit Tank</h4>
                        </div>
                        <div class="list_btn">
                            <a class="btn list_link add_more_button" href="{{ route('tank_list') }}"
                               role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                        ...
                        <form action="{{ route('update_tank') }}" onsubmit="return popvalidation()" method="post" autocomplete="off">
                            @csrf
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input type="text" name="tank_name"
                                                           ...
                                                           data-msg-required="Please Enter Tank Name" value="{{$tank->t_name}}">
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input type="text" name="capacity"
                                                           ...
                                                           data-msg-required="Please Enter Capacity Name" value="{{$tank->t_capacity}}" onkeypress="return allow_only_number_and_decimals(this,event);">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input type="text" name="remarks" class="inputs_up form-control"
                                                           id="remarks" placeholder="Remarks" value="{{$tank->t_remarks}}">

                                                    <input type="hidden" name="tank_id" id="tank_id" value="{{$tank->t_id}}">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                            ...
                            <input type="hidden" name="data_array" id="data_array">
...
@section('scripts')
    ...
    <script>
        ...
        @forelse($tank_calibrations as $tank_calibration)

            var dip = '{{$tank_calibration->tc_dip}}';
            var volume = '{{$tank_calibration->tc_volume}}';
