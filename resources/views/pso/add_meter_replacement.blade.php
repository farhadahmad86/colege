...
{{--                                    <li class="breadcrumb-item active" aria-current="page">Meter Replacement</li>--}}
{{--                                </ol>--}}
{{--                            </nav>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                        <div class="clearfix">--}}
{{--                            <div class="pull-left">--}}
{{--                                <h4 tabindex="-1" class="text-white">Meter Replacement</h4>--}}
{{--                            </div>--}}
{{--                            <div class="list_btn">--}}
{{--                                <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('meter_replacement_list') }}" role="button">--}}
...
{{--                    <form name="f1" class="f1" id="f1" action="{{ route('submit_meter_replacement') }}" onsubmit="return validate_form()" method="post" autocomplete="off">--}}
{{--                        @csrf--}}
{{--                        <div class="row">--}}
...
{{--                                                        Employee--}}
{{--                                                    </label>--}}
{{--                                                    <select tabindex="1" autofocus name="employee" class="inputs_up form-control" id="employee" autofocus>--}}
...
{{--                                                    <select tabindex="2" name="nozzle" class="inputs_up form-control" id="nozzle" autofocus>--}}
...
{{--                                                    <input tabindex="3" type="text" name="datetime" id="datetime" class="inputs_up form-control datetimepicker"--}}
...
{{--                                            <div class="form-group col-lg-12 col-md-12 col-sm-12">--}}
{{--                                                <div class="input_bx"><!-- start input box -->--}}
{{--                                                    <label class="required">Previous Meter Reading</label>--}}
{{--                                                    <input tabindex="4" type="text" name="pre_reading" id="pre_reading" class="inputs_up form-control"--}}
{{--                                                           placeholder="Previous Meter Reading" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">--}}
...
{{--                                            <div class="form-group col-lg-12 col-md-12 col-sm-12">--}}
{{--                                                <div class="input_bx"><!-- start input box -->--}}
{{--                                                    <label class="required">Current Meter Reading</label>--}}
{{--                                                    <input tabindex="5" type="text" name="cur_reading" id="cur_reading" class="inputs_up form-control"--}}
{{--                                                           placeholder="Current Meter Reading" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">--}}
...
{{--                                                    <textarea tabindex="6" name="remarks" id="remarks" class="inputs_up remarks form-control" placeholder="Remarks"></textarea>--}}
...
{{--                                        </button>--}}
{{--                                        <button tabindex="8" type="submit" name="save" id="save" class="save_button form-control">--}}
...
{{--        var pre_reading = document.getElementById("pre_reading").value;--}}
{{--        var cur_reading = document.getElementById("cur_reading").value;--}}
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Create Meter Replacement</h4>
                        </div>
                        <div class="list_btn">
                            <a class="btn list_link add_more_button" href="{{ route('meter_replacement_list') }}" role="button">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <select name="employee" class="inputs_up form-control" id="employee" autofocus data-rule-required="true" data-msg-required="Please Enter Employee Title">
                                                    <option value="">Select Employee</option>
                                                    @foreach($employees as $employee)
                                                        <option value="{{$employee->user_id}}">{{$employee->user_name}}</option>
                                                    @endforeach
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <select name="nozzle" class="inputs_up form-control" id="nozzle" data-rule-required="true" data-msg-required="Please Enter Nozzle Title">
                                                    <option value="">Select Nozzle</option>
                                                    @foreach($nozzles as $nozzle)
                                                        <option
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input type="text" name="pre_reading" id="pre_reading" class="inputs_up form-control"
                                                       placeholder="Previous Meter Reading" data-rule-required="true" data-msg-required="Please Enter Previous Meter Reading"
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input type="text" name="cur_reading" id="cur_reading" class="inputs_up form-control"
                                                       placeholder="Current Meter Reading" data-rule-required="true" data-msg-required="Please Enter Current Meter Reading"
                                                       oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                                                <span id="demo2" class="validate_sign"> </span>
                                            </div><!-- end input box -->
                                        </div>
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                <label class="">
                                                    ...
                                                    Remarks</label>
                                                <textarea name="remarks" id="remarks" class="inputs_up remarks form-control" style="height: 165px;" placeholder="Remarks"></textarea>
                                                <span id="demo5" class="validate_sign"> </span>
                                            </div><!-- end input box -->
                                        </div>
