            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                    ...
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 tabindex="-1" class="text-white">PSO Sale Invoice</h4>
                            </div>
                            <div class="list_btn">
                                <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('pso_sale_invoice_list') }}" role="button">
                                    ...
                                    <div class="row">  <!--  new row starts here -->
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <select tabindex="1" autofocus name="nozzle" class="inputs_up form-control" id="nozzle">
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input tabindex="2" type="text" name="quantity" class="inputs_up form-control" id="quantity" placeholder="Qty" onfocus="this.select();"
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input tabindex="3" type="text" name="rate" class="inputs_up form-control" id="rate" placeholder="Rate" onkeyup="product_calculation()"
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input tabindex="4" type="text" name="amount" class="inputs_up form-control" id="amount" placeholder="Amount" readonly>
...
{{--                                            <div class="input_bx"><!-- start input box -->--}}
{{--                                                <label class="required">Nozzle</label>--}}
{{--                                                <select tabindex="5" name="nozzle" class="inputs_up form-control" id="nozzle">--}}
{{--                                                    <option value="0">Select Nozzle</option>--}}
{{--                                                    @foreach($nozzles as $nozzle)--}}
{{--                                                        <option value="{{$nozzle->noz_id}}" data-tank="{{$nozzle->noz_tank_id}}" data-pro_code="{{$nozzle->t_product_code}}">--}}
{{--                                                            {{$nozzle->noz_name}}</option>--}}
...
{{--                                        </div>--}}
                                        ...
                                        <div class="form-group col-lg-8 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input tabindex="6" type="text" name="product_remarks" class="inputs_up form-control" id="product_remarks" placeholder="Remarks">
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <select tabindex="7" name="sale_person" class="inputs_up form-control" id="sale_person">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="form_controls">
                                                <button tabindex="8" id="first_add_more" class="save_button form-control" onclick="add_sale()" type="button">
                                                    <i class="fa fa-plus"></i> Add
                                                </button>
                                                <button tabindex="-1" style="display: none; background-color: red !important" id="cancel_button" class="cancel_button form-control" onclick="cancel_all()"
                                                        type="button">
                                ...
                                <div class="row m-0" style="">
                                    ...
                                    <div class="table_div table-responsive table-max-height-500px">
                                        <table class="table table-striped table-bordered m-0" id="category_dynamic_table">
                                            ...
                                            <tr>
                                                <th tabindex="-1" scope="col" class=" wdth_5">Code</th>
                                                <th tabindex="-1" scope="col" class=" wdth_2">Product Name</th>
                                                <th tabindex="-1" scope="col" class=" wdth_5">Remarks</th>
                                                <th tabindex="-1" scope="col" class=" wdth_5">Qty</th>
                                                <th tabindex="-1" scope="col" class=" wdth_5">Rate</th>
                                                <th tabindex="-1" scope="col" class=" wdth_5">Amount</th>
                                                <th tabindex="-1" scope="col" class="text-right wdth_5">Nozzle</th>
                                                <th tabindex="-1" scope="col" class="w-5p text-right wdth_5">Action</th>
                                            </tr>
                                            </thead>
                                            <tbody id="table_body">
                        ...
                        <div class="row"> <!-- lower -->
                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                <div class="form_controls">
                                    <button tabindex="9" type="reset" name="cancel" id="cancel" class="cancel_button form-control">
                                        <i class="fa fa-eraser"></i> Cancel
                                    </button>
                                    <button tabindex="10" type="submit" name="save" id="save" class="save_button form-control" onclick="return popvalidation()">
