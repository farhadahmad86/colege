        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Expense Payment Voucher List</h4>
                        </div>
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr data-toggle="tooltip" data-placement="top" title="" data-original-title="View Journal Voucher">
                                ...
                                <td class="text-center usr_prfl {{ $voucher->ep_status == 'post' ?  : '' }}"
                                    title="Click To Edit Voucher">
                                    @if ($voucher->ep_status == 'post')
                                        <span class="btn btn-sm btn-success">POSTED<span>
                                    @elseif ($voucher->ep_status == 'park')
                                                    <a class="btn btn-sm btn-info" href="{{ route('edit_expense_payment_voucher', $voucher->ep_id) }}"><i
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('expense_payment_voucher_list') }}',
            url;
