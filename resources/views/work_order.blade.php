...
{{--                    <div class="clearfix">--}}
{{--                        <div class="pull-left">--}}
{{--                            <h4 tabindex="-1" class="text-white get-heading-text"> Work Order </h4>--}}
{{--                        </div>--}}
{{--                        <div class="list_btn">--}}
{{--                            <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('work_order.index') }}" role="button">--}}
...
{{--                                                </div><!-- invoice column title end -->--}}
{{--                                                <div class="invoice_col_input"><!-- invoice column input start -->--}}
{{--                                                    <input tabindex="2" type="text" class="inputs_up text-right form-control" name="order_quantity" id="order_quantity" placeholder="Product Quantity"--}}
...
{{--                                                </div><!-- invoice column title end -->--}}
{{--                                                <div class="invoice_col_input"><!-- invoice column input start -->--}}
{{--                                                    <input tabindex="3" type="text" class="inputs_up form-control" name="show_uom_main" id="show_uom_main" placeholder="UOM" readonly--}}
...
{{--                                                                                <th tabindex="-1" class="tbl_txt_30"> Product Remarks</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_6"> UOM</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_10"> Recipe Production Qty</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_10"> Stock Before Production</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_10"> Stock After Production</th>--}}
{{--                                                                            </tr>--}}
{{--                                                                            </thead>--}}
...
{{--                                                                                <th tabindex="-1" class="tbl_srl_9"> Code</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_txt_20"> Title</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_txt_20"> Product Remarks</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_6"> UOM</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_8"> Recipe Production Qty</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_8"> %</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_8"> Reqd. Production Qty</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_8"> Stock Before Production</th>--}}
{{--                                                                                <th tabindex="-1" class="tbl_srl_8"> Stock After Production</th>--}}
{{--                                                                            </tr>--}}
{{--                                                                            </thead>--}}
...
{{--                                                                                <th class="tbl_txt_22"> Product Remarks</th>--}}
{{--                                                                                <th class="tbl_srl_6"> UOM</th>--}}
{{--                                                                                <th class="tbl_srl_10"> Recipe Consumption</th>--}}
{{--                                                                                <th class="tbl_srl_8"> %</th>--}}
{{--                                                                                <th class="tbl_srl_10"> Reqd. Production Qty</th>--}}
{{--                                                                                <th class="tbl_srl_10"> In Hand Stock</th>--}}
{{--                                                                            </tr>--}}
{{--                                                                            </thead>--}}
...
{{--                                                                        <th class="tbl_srl_4"> Sr.</th>--}}
{{--                                                                        <th class="tbl_srl_9"> Code</th>--}}
{{--                                                                        <th class="tbl_txt_15"> Service Title</th>--}}
{{--                                                                        <th class="tbl_txt_15"> Expense Title</th>--}}
{{--                                                                        <th class="tbl_txt_29"> Service Remarks</th>--}}
{{--                                                                        <th class="tbl_srl_6"> Rate</th>--}}
{{--                                                                        <th class="tbl_srl_6"> Quantity</th>--}}
{{--                                                                        <th class="tbl_srl_6"> UOM</th>--}}
{{--                                                                        <th class="tbl_srl_10"> Amount</th>--}}
{{--                                                                    </tr>--}}
{{--                                                                    </thead>--}}
...
{{--                                                                                <th class="tbl_srl_9"> Code</th>--}}
{{--                                                                                <th class="tbl_txt_20"> Title</th>--}}
{{--                                                                                <th class="tbl_txt_30"> Product Remarks</th>--}}
{{--                                                                                <th class="tbl_srl_6"> UOM</th>--}}
{{--                                                                                <th class="tbl_srl_10"> Quantity</th>--}}
{{--                                                                                <th class="tbl_srl_10"> Rate</th>--}}
{{--                                                                                <th class="tbl_srl_10"> Total</th>--}}
{{--                                                                            </tr>--}}
{{--                                                                            </thead>--}}
                                ...
                                <div class="invoice_row"><!-- invoice row start -->
                                    <div class="invoice_col form-group col-lg-2 col-md-4 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                ...
                                                <x-add-refresh-button href="{{ route('product_recipe') }}" id="refresh_account_code"/>

                                                <select tabindex="1" autofocus class="inputs_up form-control" name="pro_recipe" id="pro_recipe" data-method="loadContent" onchange="getRecipe(this);"
                                                        data-rule-required="true" data-msg-required="Please Select Product Recipe">
                                                    <option value="" disabled selected> ---Select Product Recipe---</option>
                                                    @foreach($get_recipies as $get_recipie)
                                                        <option value="{{$get_recipie->recipe_id}}">
                                                            {{$get_recipie->recipe_name}}
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-4 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                <input tabindex="2" type="text" class="inputs_up text-right form-control" name="order_quantity" id="order_quantity" placeholder="Product Quantity"
                                                       min="1" onkeypress="return allow_only_number_and_decimals(this,event);" data-method="orderQuantityChange" onkeyup="orderQuantityChange(this);"
                                                       data-rule-required="true" data-msg-required="Please Enter Order Quantity"/>
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    </div><!-- invoice column end -->
                                    ...
                                    <div class="tab-content mt-4">
                                        ...
                                        <div class="tab-pane fade" id="product_over_head_tab" role="tabpanel">
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div id="departments_show" class="warehouse_box invoice_col form-group col-lg-2 col-md-4 col-sm-12"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl"><!-- invoice column title start -->
                                                            <a data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true"
                                                               data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.cash_voucher.cash_receipt_voucher.code.description')}}</p>">
...
{{--                                                                </a>--}}
                                                ...
                                                <div id="parties_clients_show" class="warehouse_box hide invoice_col form-group col-lg-2 col-md-4 col-sm-12"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl"><!-- invoice column title start -->
                                                            <a data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true"
                                                               data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.cash_voucher.cash_receipt_voucher.code.description')}}</p>">
...
{{--                                                                </a>--}}
                                                ...
                                                <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            ...
                                                            <div class="invoice_col_short"><!-- invoice column short start -->
                                                                <a href="{{ route('account_registration') }}" target="_blank" class="col_short_btn btn btn-sm btn-info" data-container="body" data-toggle="popover"
                                                                   data-trigger="hover" data-placement="bottom" data-html="true"
                                                                   data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                                    <i class="fa fa-plus"></i>
                                                                </a>
                                                ...
                                                <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <input type="text" class="inputs_up text-right form-control" id="ser_rate" placeholder="Service Rate" min="1"
                                                                   onkeypress="return allow_only_number_and_decimals(this,event);" onkeyup="quantityRateMultiply('ser_rate', 'ser_qty', 'ser_amount')"/>
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                </div><!-- invoice column end -->
                                                ...
                                                <div class="invoice_col form-group col-lg-2 col-md-4 col-sm-12"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_txt inline_radio"><!-- invoice column input start -->
                                                            <div class="radio">
                                                                <label>
                                                                    <input type="radio" name="product_rate_type" class="invoice_type" id="last_purchase_rate" value="last_purchase_rate_show" checked
                                                                           onclick="rateChange(this);" data-method="orderQuantityChange">
                                                                    Last Purchase Rate
                                                                </label>
                                                            </div>
                                            ...
                                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt"><!-- invoice content start -->
                                                ...
                                                <div class="invoice_row"><!-- invoice row start -->
                                                    ...
                                                    <div class="invoice_col col-lg-12"><!-- invoice column start -->
                                                        <div class="invoice_col_txt with_cntr_jstfy for_voucher_btns"><!-- invoice column box start -->
                                                            <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                                <button tabindex="6" type="submit" name="save" id="save" class="invoice_frm_btn btn btn-sm btn-success">
                                                                    <i class="fa fa-floppy-o"></i> Save
                                                                </button>
                                                            </div>
                                                        </div><!-- invoice column box end -->
