...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="container-fluid search-filter form-group form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Create Parent Account</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('second_level_chart_of_account_list') }}" role="button">
                ...
                <div class="excel_con gnrl-mrgn-pdng gnrl-blk">
                    <div class="excel_box gnrl-mrgn-pdng gnrl-blk">
                        ...
                        <div class="excel_box_content gnrl-mrgn-pdng gnrl-blk">
                            ...
                            <form action="{{ route('submit_second_level_chart_of_account_excel') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <input tabindex="100" type="file" name="add_create_group_pattern_excel" id="add_create_group_pattern_excel" class="inputs_up form-control-file form-control height-auto"
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                                        <a href="{{ url('public/sample/second_level_group_account/add_create_group_pattern.xlsx') }}" tabindex="-1" type="reset" class="cancel_button btn btn-sm btn-info">
                ...
                <form name="f1" class="f1 mx-auto col-lg-6 col-md-6 col-sm-12 col-xs-12" id="f1" action="{{ route('submit_second_level_chart_of_account') }}" onsubmit="return checkForm()" method="post">
                    @csrf
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <select tabindex=1 autofocus name="head_code" class="inputs_up form-control" id="head_code" autofocus style="width: 100%"  data-rule-required="true" data-msg-required="Please Enter Control Account">
                                            <option value="">Select Control Account</option>
                                            @foreach($first_level_accounts as $first_level_account)
                                                <option value="{{$first_level_account->coa_code}}" {{ $first_level_account->coa_code == old('head_code') ? 'selected="selected"' : '' }}>{{$first_level_account->coa_head_name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input tabindex="2" type="text" name="account_name" id="account_name" class="inputs_up form-control"  data-rule-required="true" data-msg-required="Please Enter Parent Account"
                                               placeholder="Parent Account" autocomplete="off" value="{{old('account_name')}}">
        ...
        config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                            <button tabindex="4" type="reset" name="cancel" id="cancel" class="cancel_button btn btn-sm btn-info">
                                <i class="fa fa-eraser"></i> Cancel
                            </button>
                            <button tabindex="5" type="button" name="save" id="save" class="save_button btn btn-sm btn-success">
                                <i class="fa fa-floppy-o"></i> Save
                            </button>
                        </div>
                    </div>
            ...
            <script type="text/javascript">
                function checkForm() {
                    ...
                    if (check == true) {
                        ...
                        $.ajax({
                            url: "{{route('submit_second_level_chart_of_account')}}",
                            type: "POST",
                            cache: false,
                            dataType: 'json',
                            data: {
