        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Cash Payment Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('cash_payment_voucher_list') }}" name="form1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 mt-4 text-right">

                                    @include('include.clear_search_button')
                                    <!-- Call add button component -->
                                        <x-add-button tabindex="9" href="{{ route('cash_payment_voucher') }}"/>
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr>
                                ...
                                <td class="view" data-id="{{ $voucher->cp_id }}">
                                    CPV-{{ $voucher->cp_id }}
                                </td>
                                <td>
                                    {{ $voucher->cp_remarks }}
                                ...
                                <td>
                                    {!! str_replace('&oS;', '<br />', $voucher->cp_detail_remarks) !!}
                                </td>
                                <td class="text-right">
                                ...
                                <td class="text-center usr_prfl {{ $voucher->cp_status == 'post' ?  : '' }}"
                                >
                                    @if ($voucher->cp_status == 'post')
                                        <span class="btn btn-sm btn-success">POSTED<span>
                                                 @elseif ($voucher->cp_status == 'deleted')
                                                    <span class="btn btn-sm btn-info">Deleted<span>
                                    @elseif ($voucher->cp_status == 'park')
                                                    <a class="btn btn-sm btn-info" href="{{ route('edit_cash_payment_voucher', $voucher->cp_id) }}" title="Click To Edit Voucher"><i
                                                            class="fa fa-edit"></i></a> |

                                                    <a class="btn btn-sm btn-danger" href="{{ route('delete_cash_payment_voucher', $voucher->cp_id) }}" title="Click To Delete Voucher"
                        ...
                        <tfoot>
                        <tr class="border-0">
                            <th colspan="5" align="right" class="border-0 text-right pt-0">
                                Per Page Total:
                            </th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('cash_payment_voucher_list') }}',
            url;
