...
@section('content')
    ...
    <div class="row">
        {{--            edit it--}}
        <div id="main_bg" class="container-fluid search-filter form_manage">
            {{--                form header --}}
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    ...
                    <div class="list_btn list_mul">
                        <a class="add_btn list_link add_more_button" href="{{ route('sale_order_list') }}"
                           role="button">
                            <i class="fa fa-list"></i> Sale Order
                        </a>

                        {{--<a class="add_btn list_link add_more_button"--}}
                        {{--   href="{{ route('sale_tax_sale_invoice_list') }}" role="button">--}}
            ...
            <div id="invoice_con"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    ...
                    {{--form start--}}
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_sale_order') }}"
                            ...
                            <div class="invoice_cntnt"><!-- invoice content start -->
                                ...
                                <div class="invoice_row row"><!-- invoice row start -->
                                    ...
                                    <div class="form-group col-lg-2 col-md-3 col-sm-12" id="filters">
                                        <!-- invoice column start -->
                                        <div class="invoice_col invoice_col col-lg-12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt mt-1" hidden>
                                                    <!-- invoice column input start -->
                                                ...
                                                {{--                                                        auto add--}}
                                                <div class="custom-checkbox float-left pr-5 mr-5">
                                                    <input type="checkbox"
                                                            class="custom-control-input company_info_check_box"
                                ...
                                <div class="invoice_col col-lg-12">
                                    <!-- invoice column start -->
                                    <div class="pro_tbl_con row"><!-- product table container start -->
                                        <div class="table-responsive pro_tbl_bx"><!-- product table box start -->
                                            <table class="table table-sm table-bordered" id="category_dynamic_table">
                                                <thead>
                                                <tr>
                                                    ...
                                                    {{-- new empty--}}
                                                    <th class="tbl_srl_4" hidden> Pack Detail</th>
                        ...
                        <div class="invoice_row row justify-content-center"><!-- invoice row start -->
                            {{--Lower section col 1 --}}
                            <div hidden class="invoice_col form-group col-lg-3 col-md-4 col-sm-12"><!-- invoice column start -->
                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                    <div class="invoice_col_ttl"><!-- invoice column title start -->
                            ...
                            <div class="invoice_col form-group col-lg-3 col-md-4 col-sm-12"><!-- invoice column start -->
                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                    ...
                                    <div class="invoice_col_txt"><!-- invoice column input start -->
                                        ...
                                        <div hidden class="invoice_inline_input_txt">
                                            <!-- invoice inline input text start -->
                        ...
                        <div class="invoice_row row"><!-- invoice row start -->
                            ...
                            <div class="invoice_col basis_col_100 mt-0"><!-- invoice column start -->
                                <div class="invoice_col_txt with_cntr_jstfy">
                                    ...
                                    <div hidden class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
    ...
    <script>
        ...
        function product_amount_calculation(id, newRate = 0) {
            ...
            if (unit_measurement_scale_size == "") {   //if service is entered
                // alert("service code");
                var quantity = unit_qty; //display_quantity change to unit_qty
                gross_amount = unit_qty * rate;
                // alert("service");

                jQuery("#display_quantity" + id).prop("disabled", true);
        ...
        jQuery("#service_name").change(function () {
                ...
                if (!$("#check_multi_warehouse").is(':checked')) {
                    $('input[name="pro_code[]"]').each(function (pro_index) {
                        ...
                        if (pro_code == parent_code) {
                            unit_qty = +jQuery("#unit_qty" + pro_field_id).val() + +unit_qty;
            ...
            add_sale(parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                counter, 1, unit_measurement, "", "", "", "", "", unit_qty);
        ...
        function productChanged(product) {
            ...
            var quantity = 1;//unit_measurement_scale_size * 1;
            var pack_qty = 0;//Math.floor(quantity / unit_measurement_scale_size);//mustafa
            var unit_qty = 1;//(quantity % unit_measurement_scale_size).toFixed(3);
            // var pack_qty=1;
            // var unit_qty=0;
                ...
                if (!$("#check_multi_warehouse").is(':checked')) {
                    $('input[name="pro_code[]"]').each(function (pro_index) {
                        ...
                        if (pro_code == parent_code) {
                            ...
                            pack_qty = 0;//Math.floor(quantity / unit_measurement_scale_size);//mustafa
                            unit_qty = quantity;//(quantity % unit_measurement_scale_size).toFixed(3);
        ...
        function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '</td> <td class="text-right tbl_srl_7" hidden> ' +
