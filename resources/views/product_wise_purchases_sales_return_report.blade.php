                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        $.each(data, function (index, value) {
                            ...
                            jQuery("#table_body").append('<tr><td class="align_center">' + value['pii_product_code'] + '</td><td class="align_left">' + value['pii_product_name'] + '</td><td class="align_right">' + qty + '</td><td class="align_right">' + rate + '</td><td class="align_right">' + discount + '</td><td class="align_right">' + saletax + '</td><td class="align_right">' + amount + '</td><td class="align_left">' + value['pii_remarks'] + '</td></tr>');
