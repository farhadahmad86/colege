    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Delivery Challan Invoice</h4>
                    </div>
                    <div class="list_btn list_mul">
                        <a class="add_btn list_link add_more_button" href="{{ route('delivery_challan_list') }}" role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    ...
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_delivery_challan') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                        @csrf
                        <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                            <div class="invoice_cntnt"><!-- invoice content start -->
                                        ...
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                <div class="invoice_col_short"><!-- invoice column short start -->
                                                    <a href="{{ route('add_product') }}" target="_blank" class="col_short_btn btn btn-sm btn-info" data-container="body" data-toggle="popover" data-trigger="hover"
                                                        data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                        <i class="fa fa-plus"></i>
                                                    </a>
                                                    <a id="refresh_product_code" class="col_short_btn btn btn-sm btn-info" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom"
                                        ...
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                ...
                                                <div class="invoice_col_short"><!-- invoice column short start -->
                                                    ...
                                                    <a id="refresh_product_name" class="col_short_btn btn btn-sm btn-info" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom"
                                                        data-html="true" data-content="{{config('fields_info.about_form_fields.refresh.description')}}">
                                                        <l class="fa fa-refresh"></l>
                                                    </a>
                                                </div><!-- invoice column short end -->
                                    ...
                                    <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                ...
                                                <div class="invoice_col_short"><!-- invoice column short start -->
                                                    <a href="{{ url('product_packages') }}" class="col_short_btn btn btn-sm btn-info" target="_blank" data-container="body" data-toggle="popover" data-trigger="hover"
                                                        data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                        <l class="fa fa-plus"></l>
                                                    </a>
                                                    <a id="refresh_package" class="col_short_btn btn btn-sm btn-info" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom"
                                                        data-html="true" data-content="{{config('fields_info.about_form_fields.refresh.description')}}">
                                                        <l class="fa fa-refresh"></l>
                                                    </a>
                                                </div><!-- invoice column short end -->
                                ...
                                <div class="form-group col-lg-12">
                                    <div class="invoice_row"><!-- invoice row start -->
                                        <div class="invoice_col col-lg-8 col-md-7 col-sm-12"><!-- invoice column start --></div>
                                ...
                                <div class="form-group col-lg-12">
                                    <div class="invoice_row justify-content-center"><!-- invoice row start -->
                                        <div class="invoice_col form-group col-lg-3 col-md-4 col-sm-12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class=" invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.invoice.invoice_type.description')}}</p>
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    <div class="radio float-left mr-1">
                                                        <label>
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="total_items" class="inputs_up form-control text-right total-items-field"  data-rule-required="true" data-msg-required="Add Item" id="total_items" readonly>
                                                        </div>
                                                    </div><!-- invoice inline input text end -->
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
...
@section('scripts')
    ...
    <script>
        ...
        function add_sale(code, name, quantity, bonus_qty, remarks, counter, product_or_service_status, select_return_warehouse, unit_measurement, unit_measurement_scale_size) {
