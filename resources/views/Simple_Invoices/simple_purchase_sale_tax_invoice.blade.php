        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text"> Purchase Tax Invoice</h4>
                        </div>
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk"><!-- invoice box start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_simple_purchase_tax_invoice') }}"
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="container-fluid search-filter invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12 hide_sale_tax">
                                            <!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                    Product Tax
...
@section('scripts')
    ...
    @if (Session::get('pti_id'))

        <script>

            jQuery("#table_body").html("");

            var id = '{{ Session::get("pti_id") }}';
    ...
    <script>
        ...
        function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '.select();" onkeypress="return allow_only_number_and_decimals(this,event);" onfocusout="checkQty(' + counter + ')" value="' + quantity + '"/>' +   /* Changed By Abdullah: old -> return
                ...
                0 + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/>' +   /* Changed By Abdullah: old -> return
                  allowOnlyNumber(event); */
                '</td>' +
                ...
                '<input type="text" name="product_discount_amount[]" tabindex="-1" id="product_discount_amount' + counter + '" placeholder="Dis Amount" value="' + discount_amount + '"onfocus="this.select();" ' +
                'readonly  class="lower_inputs inputs_up_tbl text-right" ' +
                '/> ' +
    ...
    <script>
        ...
        document.addEventListener('keyup', function (event) {
            ...
            if (event.keyCode === 9) {  // means tab
                if ($("#total_inclusive_tax")[0] == $(document.activeElement)[0]) {
                    $("#product").focus();
                }
                event.preventDefault();
            }
