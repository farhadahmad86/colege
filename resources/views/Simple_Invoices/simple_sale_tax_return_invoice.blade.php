    ...
    <div class="row">
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text"> Sale Tax Return Invoice</h4>
                    </div>
                    <div class="list_btn list_mul">
                        <a class="add_btn list_link add_more_button"
                           href="{{ route('sale_tax_sale_return_invoice_list') }}" role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_simple_sale_tax_return_invoice') }}"
...
{{--                                                </div><!-- invoice column box end -->--}}
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="form-group pro_tbl_con"><!-- product table container start -->
                                                <div class="table-responsive pro_tbl_bx"><!-- product table box start -->
                                                    <table class="table table-responsive table-sm gnrl-mrgn-pdng"
                                ...
                                <div class="invoice_row">
                                    <div class="invoice_col basis_col_32 pl-3 payment_div " style="display: none"><!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                <a data-container="body" data-toggle="popover"
                                                   data-trigger="hover"
        ...
        @section('scripts')
            ...
            @if (Session::get('srsi_id'))
                <script>
                    ...
                    $('.modal-body').load('{{ url("simple_sale_tax_sale_return_invoice_list/view/") }}' + '/' + id, function () {
            ...
            <script>
                ...
                function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                    ...
                    jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                        ...
                        '.select();" onkeypress="return allow_only_number_and_decimals(this,event);" onfocusout="checkQty(' + counter + ')" value="' + quantity + '"/>' +
                        '</td>' +
                        ...
                        '</td> ' +
                        '<td hidden class="text-center tbl_srl_4"> <input type="checkbox" name="inclusive_exclusive[]" id="inclusive_exclusive' + counter + '" onclick="product_amount_calculation(' + counter + ')" onkeyup="tab_within_table(event,' + counter + ')"'
