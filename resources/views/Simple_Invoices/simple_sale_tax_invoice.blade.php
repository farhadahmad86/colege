        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text"> Sale Tax Invoice</h4>
                        </div>
                ...
                <div id="invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        ...
                        {{--form start--}}
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_simple_sale_tax_invoice') }}"
                                ...
                                <div class="container-fluid search-filter invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="invoice_row row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col form-group col-lg-10 col-md-9 col-sm-12 upper">
                                            ...
                                            {{--above table row2--}}
                                            <div class="invoice_row row"><!--row2 start -->
                                                <!-- invoice row start -->
                                            ...
                                            <div class="invoice_row row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col col-lg-12"><!-- invoice column start -->
                                                    ...
                                                    <!-- Auto add end -->
                                                        ...
                                                        <div class="custom-checkbox float-left pb-1 mr-4">
                                                            <input type="checkbox" value="1"
                                                                   name="quick_print"
                                                                   class="custom-control-input company_info_check_box"
                                                                   id="quick_print"
                                    ...
                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                        ...
                                        <div class="invoice_col_txt"><!-- invoice column input start -->
                                            ...
                                            <div class="invoice_inline_input_txt">
                                                ...
                                                <div class="invoice_col_input">
                                                    <input type="text" name="disc_percentage" tabindex="9"
                            ...
                            {{-- kio ka hm na nicha aik or Item Discount bnaya hwa ha is lya is ki zrorat ni--}}
                            ...
                            {{--                        <label class="custom-control-label chck_pdng"--}}
                            {{--                               for="round_off"> Auto Round OFF </label>--}}
                            {{--                        <input tabindex="-1" type="hidden" name="round_off_discount"--}}
                            {{--                               id="round_off_discount"/>--}}
                            {{--                    </div>--}}
                            {{--                </div><!-- invoice column input end -->--}}
                            {{--            </div><!-- invoice column box end -->--}}
...
@section('scripts')
    ...
    @if (Session::get('ssi_id'))
        <script>
            jQuery("#table_body").html("");

            var id = '{{ Session::get("ssi_id") }}';
