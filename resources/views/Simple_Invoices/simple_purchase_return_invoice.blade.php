        ...
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk"><!-- invoice box start -->
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_simple_purchase_return_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                        @csrf
    ...
    <script>
        ...
        function add_sale(code, name, display_quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="text-center tbl_srl_4">' +
                '<input type="text" name="quantity[]" value="' + display_quantity + '" id="quantity' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + ')"  onfocus="this' +
                '.select();" onkeypress="return allow_only_number_and_decimals(this,event);" onfocusout="checkQty(' + counter + ')"/>' +
                '</td>' +
                ...
                '<input type="text"  name="unit_qty" id="unit_qty' + counter + '" ' + ' placeholder="0" value="' + display_quantity + '" class="inputs_up_tbl percentage_textbox"   onkeyup="product_amount_calculation(' + counter + '),tab_within_table(event,' + counter + ')" ' +
