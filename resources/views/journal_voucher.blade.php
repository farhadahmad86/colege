    ...
    <div class="container-fluid search-filter form-group form_manage">
        <div class="form_header"><!-- form header start -->
            <div class="clearfix">
                ...
                <div class="list_btn">
                    <a class="btn list_link add_more_button" href="{{route('journal_voucher_list')}}" role="button">
        ...
        <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
            <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                ...
                <form action="{{ route('submit_journal_voucher') }}" id="f1" method="post" onsubmit="return checkForm()">
                    @csrf
                    <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                        <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt"><!-- invoice content start -->
                            ...
                            <div class="invoice_row"><!-- invoice row start -->
                                ...
                                here use class journal_voucher or bank_voucher for get backend query bank account and journal voucher
                                body="0" at the journal voucher and body="1" at the bank voucher use for the query and get the index 0  for journal accounts and index 1 for bank accounts -->
                            ...
                            <!-- use account-name-component
                                make cash account dropdown
                                here use class joural_voucher or bank_voucher for get backend query bank account and journal voucher
                                body="0" at the journal voucher and body="1" at the bank voucher use for the query and get the index 0  for journal accounts and index 1 for bank accounts -->
                                ...
                                <div class="invoice_col form-group col-lg-2 col-md-3  col-sm-12"><!-- invoice column start -->
                                    <div class="invoice_col_txt for_voucher_col_bx"><!-- invoice column box start -->
                                        <div class="invoice_col_txt with_cntr_jstfy">
                                            ...
                                            {{--Hamad set tab index--}}
                                                <button tabindex="7" style="display: none;" id="cancel_button" class="invoice_frm_btn btn btn-sm btn-secondary" onclick="cancel_all()" type="button">
                                                    <i class="fa fa-times"></i> Cancel
                                                </button>
                                            </div>
                                            <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                <button tabindex="6" id="first_add_more" class="invoice_frm_btn btn btn-sm btn-info" onclick="add_account()" type="button">
                ...
                <div class="modal-footer">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form_controls">
                            <button tabindex="-1" type="button" class="btn btn-default btn btn-sm btn-secondary cancel_button" data-dismiss="modal">
                                <i class="fa fa-times"></i> Cancel
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        function add_account() {
            ...
            if (flag_submit1) {
                ...
                jQuery("#total_debit").val(total_dr.toFixed(2));
                jQuery("#total_credit").val(total_cr.toFixed(2));
