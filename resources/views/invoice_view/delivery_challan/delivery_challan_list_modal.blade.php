    ...
    <div id="" class="table-responsive" style="z-index: 9;">
        ...
        <table class="table table-bordered table-sm">
            ...
            <tr class="headings vi_tbl_hdng">
                ...
                <th scope="col" align="center" class="align_left text-left tbl_txt_50">
                    Product Name
                </th>
                {{--                    <th scope="col" align="center" class="text-center align_center tbl_amnt_15">--}}
                {{--                        Remarks--}}
                {{--                    </th>--}}
                <th scope="col" align="center" class="text-center align_center tbl_amnt_18">
                    QTY
                </th>
...
{{--                    <td class="tbl_amnt_20 align_center text-center">--}}
{{--                        DOSI-{!! $siim->status !!}--}}
{{--                    </td>--}}
            ...
            <tr class="border-bottom-1">
                ...
                <td class="text-center align_center">
                    {{ number_format($sim->dc_total_items,3) }}
                </td>
                <td class="text-center align_center">
                </td>
                <td class="text-center align_center">
...
{{--                </td>--}}
    ...
    @if( $type === 'grid')
        ...
        <div class="itm_vchr_rmrks">
            ...
            <iframe style="display: none" id="printf" name="printf" src="{{ route('delivery_challan_items_view_details_pdf_SH',['id'=>$sim->dc_id]) }}" title="W3Schools Free Online Web
            Tutorials">Iframe
            </iframe>
