...
{{--                                                {{ number_format($sim->srsi_product_disc,2) }}--}}
                ...
                <tr class="fieldset-box">
                    <td colspan="6" class="border-0 p-0 chck_pdng">
...
@if( $type === 'grid')
    ...
    <div class="itm_vchr_rmrks">
        ...
        <iframe style="display: none" id="printf" name="printf" src="{{ route('sale_return_saletax_items_view_details_pdf_SH',['id'=>$sim->srsi_id]) }}" title="W3Schools Free Online Web Tutorials">
            Iframe
        </iframe>
