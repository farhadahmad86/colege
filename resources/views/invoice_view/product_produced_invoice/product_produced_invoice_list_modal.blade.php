...
@section('print_cntnt')
        ...
        <table class="table border-0 table-sm m-0">
            ...
            <tr class="bg-transparent">
                ...
                <td class="wdth_50_prcnt p-0 border-0">
                    ...
                    <p class="invoice_para m-0 pt-0">
                        <b> Name: </b>
                        {{ (isset($pim->psa_account_name) && !empty($pim->psa_account_name)) ? $pim->psa_account_name: 'N/A' }}
                    </p>
                    <p class="invoice_para adrs m-0 pt-0">
                        <b> Adrs: </b>
        ...
        <table class="table table-bordered table-sm">
            ...
            @foreach( $piims as $piim )
                @php
                    ...
                    $db_qty = $piim->ps_quantity;
                    $scale_size = $piim->ps_scale_size;
                ...
                <tr class="even pointer">
                    ...
                    <td>
                        {!! str_replace(array("\r\n","\r","\n","\\r","\\n","\\r\\n"),'<br />', $piim->ps_pro_title) !!}
                        @if(!empty($piim->ps_remarks) && isset($piim->ps_remarks))
                            <blockquote>
                                {!! str_replace(array("\r\n","\r","\n","\\r","\\n","\\r\\n"),'<br />', $piim->ps_remarks) !!}
                            </blockquote>
                        @endif
                    ...
                    <td align="right" class="align_right text-right">
                        {!! number_format($piim->ps_amount,2) !!}
                    </td>
    ...
    @if( $type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('product_produced_items_view_details_pdf_SH',['id'=>$pim->psa_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
