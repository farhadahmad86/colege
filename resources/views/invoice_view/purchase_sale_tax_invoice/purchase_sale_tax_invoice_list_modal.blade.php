...
{{--                </td>--}}
                            ...
                            <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tr>
                                        ...
                                        @php
                                            $balance = $pim->psi_grand_total - $pim->psi_cash_paid;
                                        @endphp
                                        <td class="text-right">
    ...
    @if( $type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <iframe style="display: none" id="printf" name="printf" src="{{ route('sale_tax_purchase_items_view_details_pdf_SH',['id'=>$pim->psi_id]) }}" title="W3Schools Free Online Web Tutorials">
                Iframe
            </iframe>
