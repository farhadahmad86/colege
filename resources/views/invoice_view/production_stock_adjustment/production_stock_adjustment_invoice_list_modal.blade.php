    ...
    <div id="" class="table-responsive" style="z-index: 9;">
        ...
        <table class="table table-bordered table-sm">
            ...
            <tr class="headings vi_tbl_hdng">
                ...
                <th scope="col" align="center" class="align_left text-left tbl_txt_34">
                    Product Name
                </th>
            ...
            <tr>
                <th colspan="8" class="text-right align_right">
                    Total:-
                </th>
...
{{--                </td>--}}
    ...
    @if( $type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('production_stock_consumed_produced_items_view_details_pdf_SH',['id'=>$pim->psa_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
