...
@section('print_cntnt')
    ...
    <div id="" class="table-responsive" style="z-index: 9;">
        ...
        <table class="table table-bordered table-sm">
            ...
            <tr class="headings vi_tbl_hdng">
                ...
                <th scope="col" class="tbl_txt_45 ">
                    {{$product_name}}
                </th>
                <th scope="col" class="tbl_amnt_10 ">
                    {{$qty}}
                </th>
                <th class="tbl_amnt_10 ">
                    {{$rate}}
                </th>
    ...
    @if( $type === 'grid')
        ...
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('purchase_items_view_details_pdf_sh',['id'=>$pim->pi_id]) }}" class="text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
                Download
            </a>

            <iframe style="display: none" id="printf" name="printf" src="{{ route('purchase_items_view_details_pdf_sh',['id'=>$pim->pi_id]) }}" title="W3Schools Free Online Web Tutorials">Iframe
            </iframe>
