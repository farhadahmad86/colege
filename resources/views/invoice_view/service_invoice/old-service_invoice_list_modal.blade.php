...
@section('print_cntnt')
    ...
    <div id="" class="table-responsive" style="z-index: 9;">
        ...
        <table class="table table-sm m-0">
            ...
            {{--            <tr>--}}
            {{--                <td colspan="{{ ($sim->sei_invoice_type === 2 || $sim->sei_invoice_type === 3) ? '8' : '6' }}"  class="p-0 border-0">--}}
                                ...
                                <table  class="m-0 p-0 table">
                                    <tr>
                                        ...
                                        <td class="text-right fontS-12">
                                            {{ number_format($sim->sei_product_disc,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng fontS-12 text-right">
                                        ...
                                        <td class="text-right fontS-12">
                                            {{ number_format($sim->sei_round_off_disc,2) }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                                <table  class="m-0 p-0 table">
                                    <tr>
                                        ...
                                        <td class="text-right fontS-12">
                                            {{ number_format($sim->sei_cash_disc_amount,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng fontS-12 text-right">
    ...
    @if( $type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('sale_items_view_details_pdf_sh',['id'=>$sim->sei_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
