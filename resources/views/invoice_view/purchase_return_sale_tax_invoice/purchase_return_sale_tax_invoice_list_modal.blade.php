    ...
    <div id="" class="table-responsive" style="z-index: 9;">
        ...
        <table class="table table-bordered table-sm">
            ...
            @php
                ...
                $totals_discount='Total Discount:';
            ...
            <tr class="headings vi_tbl_hdng">
                ...
                <th scope="col" align="center" class="align_center text-center tbl_txt_28 fonti">
                    {{$product_name}}
                </th>
...
{{--                </th>--}}
                ...
                <th scope="col" align="center" class="text-center align_center tbl_amnt_14 fonti">
                    {{$total_amount}}
                </th>
            </tr>
            ...
            <tbody>
            @php $i = 01; $excluDis = $ttlExcluDis = $ttlIncluDis = $ttlSaleTax = $ttlAmnt = $trade_offerTtl =0;
...
{{--                    </td>--}}
                    ...
                    <td class="align_right text-right">
                        {{ ($piim->inclu_exclu === 1) ? "(In)-" : "(Ex)-" }}{!! number_format($piim->sale_tax_amount,2) !!}
                    </td>
                    <td class="align_right text-right">
...
{{--                                        @php--}}
{{--                                            $total_discount = $trade_offerTtl + $pim->prsi_total_discount--}}
{{--                                        @endphp--}}
                                        <td class="text-right">
...
{{--                                    </tr>--}}
    ...
    @if( $type === 'grid')
        ...
        <div class="itm_vchr_rmrks">
            ...
            <iframe style="display: none" id="printf" name="printf" src="{{ route('return_sale_tax_purchase_items_view_details_pdf_SH',['id'=>$pim->prsi_id]) }}"
