...
<div id="" class="table-responsive" style="z-index: 9;">
    ...
    <table class="table table-bordered table-sm">
        ...
        <tr class="bg-transparent">
            ...
            <td colspan="{{ ($sim->si_invoice_type === 2) ? '6' : '4' }}" class="p-0 border-0 text-right" >
                <h2 class="invoice_hdng">
                    Sale {{ ($sim->si_status !== 'RETURN') ? '' : 'Return' }} Invoice
                </h2>
                <p c0lass="invoice_para m-0">
                    <b> Invoice #: </b>
                    {{ $sim->si_id }}
                </p>
                <p class="invoice_para m-0 pt-5">
                    <b> Date: </b>
                    {{date('d-M-y', strtotime(str_replace('/', '-', $sim->si_day_end_date)))}}
                </p>
        ...
        <tr>
            <td colspan="{{ ($sim->si_invoice_type === 2) ? '8' : '6' }}"  class="p-0 border-0">
                    ...
                    <tr class="bg-transparent" >
                        <td colspan="1"  class="p-0 border-0">
                            <h3 class="invoice_sub_hdng mb-0 mt-0">
                                Billed {{ $sim->si_status == 'PURCHASE' ? 'To' : 'From' }}
                            </h3>
                            <p class="invoice_para m-0 pt-5">
                                <b> Name: </b>
    ...
    <table class="table table-bordered table-sm">
        ...
        <tr class="headings vi_tbl_hdng">
            ...
            <th scope="col" align="center" class="align_left text-left {{ ($sim->si_invoice_type === 2) ? 'pur_in_wdth_2' : 'pur_in_wdth_3' }}">Product Name</th>
            ...
            @endif
            <th scope="col" align="center" class="pur_in_wdth_8 text-center align_center">Excluded {{ ($sim->si_invoice_type === 2) ? 'Sale Tax' : 'Discount' }} </th>
        ...
        <tfoot>
        <tr class="border-0">
            <td colspan="{{ ($sim->si_invoice_type === 2) ? '10' : '7' }}" valign="top" class="p-0 border-0" >
