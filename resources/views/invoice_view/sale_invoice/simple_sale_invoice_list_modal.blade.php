...
@section('print_cntnt')
        ...
        <table class="table table-bordered table-sm">
            <thead>
                ...
                <tr class="headings vi_tbl_hdng">
                    ...
                    <th scope="col" align="center" class="align_left text-left tbl_txt_18 fonti">
                        {{ $product_name }}
                    </th>
    ...
    @if ($type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('sale_items_view_details_pdf_sh', ['id' => $sim->si_id]) }}"
            ...
            <iframe style="display: none" id="printf" name="printf"
                src="{{ route('sale_items_view_details_pdf_sh', ['id' => $sim->si_id]) }}"
