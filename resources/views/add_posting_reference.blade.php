...
@section('content')
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            ...
            <form name="f1" class="f1 mx-auto col-lg-6 col-md-6 col-sm-12 col-xs-12" id="f1" action="{{route('submit_posting_reference')}}" method="post" onsubmit="return checkForm()">
                @csrf
                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                    <div class="input_bx"><!-- start input box -->
                        <label class="required"> Posting Reference Title </label>
                        <input tabindex="1" type="text" name="posting_reference" id="posting_reference" class="inputs_up form-control" placeholder="Posting Reference Title" autofocus
                                data-rule-required="true" data-msg-required="Please Enter Posting Reference" autocomplete="off" value="{{ old('posting_reference') }}"/>
                    ...
                    <div class="input_bx"><!-- start input box -->
                        <label class="">
                            <a  data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.description')}}</p><h6>Benefit</h6><p>{{
                                config('fields_info.about_form_fields.party_registration.general_fields.remarks.benefits')}}</p><h6>Example</h6><p>{{ config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                    <button tabindex="1" type="reset" name="cancel" id="cancel" class="cancel_button btn btn-secondary btn-sm">
                        <i class="fa fa-eraser"></i> Cancel
                    </button>
                    <button tabindex="1" type="submit" name="save" id="save" class="save_button btn btn-success btn-sm">
