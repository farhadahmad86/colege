    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Bank Receipt Voucher</h4>
                    </div>

                    @php
                        $route_name = Route::current()->getName();

                        if ($route_name == 'bank_receipt_voucher') {
                            $route_to = 'bank_receipt_voucher_list';
                        } else {
                            $route_to = 'online_payment_receive_list';
                        }
                    @endphp
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button" href="{{ $route_to }}" role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                ...
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    ...
                    <form id="f1" action="{{ route('submit_bank_receipt_voucher') }}" method="post"
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                ...
                                <div class="invoice_row">
                                    ...
                                    <!-- use account-name-component
                                                       make back account dropdown
                                                       here use class bank_voucher for get backend query bank account
                                                       body="0" use for the query and get the index 0  bank accounts  -->

                                    <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12">
                                        <!-- invoice column -->
                                        <x-account-name-component tabindex="4" name="account" class="bank_voucher"
                                                                  id="account" title="Bank"
                                                                  href="bank_account_registration" body="1"/>
                                    </div>
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="invoice_col basis_col_12" hidden>
                                        <x-account-name-component tabindex="3" name="account_code" class="bank_voucher"
                                    ...
                                    <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <x-account-name-component tabindex="4" name="account_name" class="bank_voucher"
                                                                  id="account_name" title="Account Title"
                                                                  href="receivables_account_registration"
                                                                  body="0"/>
                                    </div>
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="required invoice_col_ttl">
                                                ...
                                                <a tabindex="-1" data-container="body" data-toggle="popover"
                                                   ...
                                                   data-content="<h6>Descriptions</h6><p>{{ config('fields_info.about_form_fields.bank_voucher.bank_receipt_voucher.amount.description') }}</p>">
                                            ...
                                            <div class="invoice_col_input">
                                                ...
                                                <input tabindex="6" type="text" name="amount"
                                                       ...
                                                       placeholder="Amount" onfocus="this.select();"
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="pro_tbl_con for_voucher_tbl col-lg12">
                                        ...
                                        <div class="table-responsive pro_tbl_bx">
                                            ...
                                            <table tabindex="-1"
                                                   class="table table-bordered table-sm" id="category_dynamic_table">
                                                <thead>
                                                <tr>
                                                    <th tabindex="-1" class="tbl_srl_10">
                                                        Code
                                                    </th>
                                                    <th tabindex="-1" class="tbl_srl_20">
                                                        Title
                                                    </th>
                                                    <th tabindex="-1" class="tbl_srl_20">
                                                        Project Reference
                                                    </th>
                                                    <th tabindex="-1" class="tbl_srl_38">
                                                        Transaction Remarks
                                                    </th>
                                                    <th tabindex="-1" class="tbl_srl_12">
                                                        Amount
                                                    </th>
                                                </tr>
                                                </thead>
...
@section('scripts')
    ...
    @if (Session::get('br_id'))
        <script>
            jQuery("#table_body").html("");
            var id = '{{ Session::get('br_id') }}';
