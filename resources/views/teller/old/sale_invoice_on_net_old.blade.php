                    ...
                    <div class="pi_right col-lg-2 col-md-2 ">
                        ...
                        <div class="row form-group lower_dashed side-section"> <!-- lower -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 px-1 w-100 margin-top-10px">
                                <p>
                                    <button class="btn btn-primary session-button" type="button" data-toggle="collapse" data-target="#session_accordian" aria-expanded="false" aria-controls="session_accordian">
                                        Session Detail
                                    </button>
                                </p>
                                <p class="">
