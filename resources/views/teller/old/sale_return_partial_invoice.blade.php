...
<div class="main-container">
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10 return_status">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
            ...
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-blue">Sale Return Partial Invoice</h4>
                </div>
                <a class="btn btn-primary add_more_button" href="sale_return_invoice_list" role="button"><li class="fa fa-list"></li></a>
            </div>

            <form name="f1" class="f1" id="f1" action="submit_sale_return_partial_invoice" onsubmit="return validate_form()"
            ...
            <!-- main row ends here --> <!-- first row ends here -->
                ...
                <div class="row">
                    ...
                    <div class="pi_left col-lg-10 col-md-10 p-0"> <!-- left column starts here  -->
                        ...
                        <div class="row middle-section" style="">  <!--  new row starts here -->
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <div class="input-method m-2">
                                    ...
                                    <button id="first_add_more" class="btn btn-primary" onclick="add_sale()" style="display: none !important;"
                                            type="button">Add
                        ...
                        <div class="row already" style="display: none">
                            <!-- table code starts here -->
                            <div class="table_div table-responsive1">
                                {{--<label>Already Returned</label>--}}
                                <h3>Already Returned</h3>
                                <table class="table table-striped shadowed" id="category_dynamic_table1">
                                    <thead>
                                    <tr>
                                        <th scope="col">Code</th>
                                        <th scope="col">Title</th>
...
<script>
    ...
    function delete_sale(current_item) {
        ...
        if (numberofsales <= 0) {
            ...
            jQuery("#product_code").append('<option value="0">Code</option>');
            jQuery("#product_name").append('<option value="0">Product</option>');
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                $.each(data[1], function (index, value) {
                    ...
                    qty =(qty - data[6][index][0]);

                    // selected_amount=(qty * selected_rate) - product_discount;

                    var amount = (qty * selected_rate) - product_discount;

                    var sale_tax = (amount / 100) * product_sales_tax;
                    selected_amount = +amount + +sale_tax;
                ...
                $.each(data[5], function (index, value) {
                        ...
                        var product_name1 = value['sii_product_name'];
                        var selected_code_value1 = value['sii_product_code'];
                        var qty1 = value['sii_qty'];
                        var selected_product_name1 = value['sii_product_code'];
                        var selected_remarks1 = value['sii_remarks'];
                        var selected_rate1 = value['sii_rate'];
                        var selected_amount1 = value['sii_amount'];
                        var product_sales_tax1 = value['sii_saletax'];
                        var product_discount1 = value['sii_discount'];

                        counter1++;

                        var checkedValue = [];

                        if (product_sales_tax1 == '') {
                            product_sales_tax1 = 0;
                        }
                        if (product_discount1 == '') {
                            product_discount1 = 0;
                        }
                        // if (selected_remarks1 == '') {
                        //     selected_remarks1 = product_name1;
                        // }

                        var sale_tax1 = 0;

                        sale_tax1 = ((((selected_rate1 * qty1) - product_discount1) / 100) * product_sales_tax1);

                        sales1[counter1] = [selected_code_value1, product_name1, selected_remarks1, qty1, selected_rate1, selected_amount1, product_discount1, product_sales_tax1, sale_tax1];

                        jQuery("#table_body1").append('<tr id=' + counter1 + ' style=background-color:#b7aafd;><td>' + selected_code_value1 + '</td><td >' + product_name1 + '</td><td >' + selected_remarks1 + '</td><td >' + qty1 + '</td><td >' + selected_rate1 + '</td><td>' + product_discount1 + '</td><td >' + product_sales_tax1 + '</td><td >' + selected_amount1 + '</td></tr>');

                        jQuery(".already").show();//b7aafd
                        jQuery(".table-responsive").show();
                        // jQuery(".already").attr('display:');

                        var numberofsales1 = Object.keys(sales1).length;
                        if (numberofsales1 <= 0) {
                            jQuery(".already").hide();
                        }
                });
