...
<div class="main-container">
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
            ...
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-blue">On-Cash Sale Invoice</h4>
                </div>
                <a class="btn btn-primary add_more_button" href="sale_invoice_list" role="button"><li class="fa fa-list"></li></a>
            </div>

            <form name="f1" class="f1" id="f1" action="submit_sale_invoice_on_net" onsubmit="return popvalidation()"
                  method="post">
            @csrf
            <!-- main row ends here --> <!-- first row ends here -->
                ...
                <div class="row">
                    ...
                    <div class="pi_left col-lg-10 col-md-10 p-0"> <!-- left column starts here  -->
                        ...
                        {{--<p>--}}
                        {{--<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#session_accordian" aria-expanded="false" aria-controls="session_accordian">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <span id="demo1" class="validate_sign"> </span>
                                            <select name="transaction_type" class="form-control" id="transaction_type" tabindex="1" >
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="machine_card" style="display: none;">
                                    <div class="form-group row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <label class="required">Credit Card Machine</label>
                                            <span id="demo2" class="validate_sign"> </span>
{{--                                            <a style="width: 26px; height: 22px; line-height: 25px; float: right; text-align: center;" href="add_credit_card_machine" class="btn-primary" target="_blank"><li class="fa fa-plus"></li></a>--}}
                                            <select name="machine" class="form-control" id="machine" tabindex="2" style="width: 100%;">
                                                <option value="">Select Machine</option>
                                                @foreach($machines as $machine)
                                                    <option value="{{$machine->ccm_id}}"
                                                            data-bank="{{$machine->ccm_bank_code}}" data-percentage="{{$machine->ccm_percentage}}">{{$machine->ccm_title}}</option>
                                                @endforeach
                                            </select>
...
{{--                                <a style="width: 26px; height: 22px; line-height: 25px; float: right; text-align: center;" href="add_product" class="btn-primary" target="_blank"><li class="fa fa-plus"></li></a>--}}
                                <select name="product_code" class="form-control" id="product_code" tabindex="8" style="width: 100%;">
                                    ...
                                    @foreach($products as $product)
                                        <option value="{{$product->pro_code}}"
                                                data-sale_price="{{$product->pro_average_rate}}">{{$product->pro_code}}</option>
                                    @endforeach
...
{{--                                <a style="width: 26px; height: 22px; line-height: 25px; float: right; text-align: center;" href="add_product" class="btn-primary" target="_blank"><li class="fa fa-plus"></li></a>--}}
                                <select name="product_name" class="form-control" id="product_name" tabindex="9" style="width: 100%;">
                                    ...
                                    @foreach($products as $product)
                                        <option value="{{$product->pro_code}}"
                                                data-sale_price="{{$product->pro_average_rate}}">{{$product->pro_title}}</option>
                                    @endforeach
                            ...
                            <input type="hidden" name="product_sales_tax" class="form-control"
                        ...
                        <!--  <div class="col-lg-1 col-md-1 col-sm-1">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <label class="">Sale Person</label>
                                <span id="demo50" class="validate_sign"></span>
                                <select name="sale_person" class="form-control" id="sale_person" tabindex="15" style="width: 100%;">
                        ...
                        <div class="row form-group lower_dashed side-section"> <!-- lower -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 px-1">
                                ...
                                <input type="number" name="cash_paid" class="form-control cash-received-field" id="cash_paid"
                                       placeholder="0.00" tabindex="16" step="any">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 px-1">
                                ...
                                <input type="text" name="cash_return" class="form-control cash-return-field" id="cash_return"
                                       placeholder="0.00" tabindex="17" step="any" readonly>
                            </div>


                            <div class="col-lg-12 col-md-12 col-sm-12 px-1 w-100 margin-top-10px">
                                <p>
                                    <button class="btn btn-primary session-button" type="button" data-toggle="collapse" data-target="#session_accordian" aria-expanded="false" aria-controls="session_accordian" id="session_btn">
                                        Session Detail
                                    </button>
                                </p>
                                <p class="">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 px-1">
                                            ...
                                            <div style="width: 30%; float: left;">
                                                ...
                                                <input type="number" name="disc_percentage" class="form-control"
                                                       id="disc_percentage" placeholder="" tabindex="17" step="any"
                                                       style="padding: 1px;">
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 px-1">
                                            ...
                                            <div style="width: 30%; float: left;">
                                                ...
                                                <input type="number" name="special_disc_percentage" class="form-control"
                                                       id="special_disc_percentage" placeholder="" tabindex="19" step="any"
                                                       style="padding: 1px;">
                                            </div>
                                            <div style="width: 70%; float: left;">
                            ...
                            {{--<span id="demo16" class="validate_sign"></span>--}}
                            {{--<input type="number" name="total_items" class="form-control" id="total_items"--}}
                            {{--placeholder="" readonly>--}}
                            ...
                            {{--<span id="demo27" class="validate_sign"></span>--}}
                            {{--<input type="number" name="cash_paid" class="form-control" id="cash_paid"--}}
                            {{--placeholder="" tabindex="21" step="any">--}}
