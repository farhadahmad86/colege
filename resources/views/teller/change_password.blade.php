...
<div class="main-container">
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
            ...
            <form name="f1" class="f1" id="f1" action="{{route("teller/submit_change_password")}}" onsubmit="return form_validation()" method="post">
                @csrf
                <div class="row">
    ...
    function form_validation()
    {
        ...
        if (oldpassword == "") {
            ...
            if (!validatepass(oldpassword)) {
                document.getElementById("demo1").innerHTML = "Max.Length (8),One Digit,Uppercase,Lowercase & Special Character";
                //alert_message("Postal code Is Not Valid");
                if (focus_once == 0) {
                    jQuery("#old_password").focus();
                    focus_once = 1;
                }
