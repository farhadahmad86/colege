                        ...
                        <table class="table table-bordered fixed_header" id="fixTable">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" align="center">{{$route == 'teller/approve_cash_receive_list' ? 'Remarks' : 'Reason'}}</th>
                            ...
                            @forelse($cash_receives as $cash_receive)
                                ...
                                <tr>
                                    <td class="align_left">{{$cash_receive->user_name}}</td>
                                    <td class="align_left">{{$cash_receive->ct_amount}}</td>
                                    <td class="align_left">{{$route == 'teller/approve_cash_receive_list' ? $cash_receive->ct_remarks : $cash_receive->ct_reason}}</td>
                                    <td class="align_left">{{$cash_receive->ct_status}}</td>
                                    <td class="align_left">{{date('d/m/Y g:i A', strtotime($cash_receive->ct_receive_datetime))}}</td>
                                </tr>
                                @php
                                    $sr++;
                                @endphp
