            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                    ...
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white get-heading-text file_name">Sale Return Invoice List</h4>
                            </div>
                    ...
                    <div class="search_form {{ ( !empty($search) || !empty($search_account) || !empty($search_product) || !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <form class="prnt_lst_frm" action="{{ route('teller/sale_return_invoice_list') }}" name="form1" id="form1" method="post">
                                    @csrf
                                    <div class="row">
                    ...
                    <div class="table-responsive" id="printTable">
                        <table class="table table-sm" id="fixTable">
                            ...
                            <tr>
                                ...
                                {{--                                    <th scope="col" align="center">Sale Invoice#</th>--}}
                            ...
                            @forelse($datas as $invoice)
                                ...
                                <tr>
                                    ...
                                    <td nowrap class="align_center text-center tbl_amnt_9">
                                        {{date('d-M-y', strtotime(str_replace('/', '-', $invoice->sri_day_end_date)))}}
                                    </td>
                                    <td class="align_center view text-center tbl_amnt_6" data-id="{{$invoice->sri_id}}">
                                        SRI-{{$invoice->sri_id}}
                                    </td>
                                    ...
                                    @php
                                        $ttlPrc = +($invoice->sri_total_price) + +$ttlPrc;
                                    @endphp
                                    <td class="align_right text-right tbl_amnt_10">
                                        {{$invoice->sri_total_price !=0 ? number_format($invoice->sri_total_price,2):''}}
                                    </td>
                                    ...
                                    @php
                                        $cashPaid = +($invoice->sri_cash_paid) + +$cashPaid;
                                    @endphp
                                    <td class="align_right text-right tbl_amnt_10">
                                        {{$invoice->sri_cash_paid !=0 ? number_format($invoice->sri_cash_paid,2):''}}
                                    </td>

                                    @php
                                        $ip_browser_info= ''.$invoice->sri_ip_adrs.','.str_replace(' ','-',$invoice->sri_brwsr_info).'';
                                    @endphp
...
<script>
    ...
    jQuery(".view").click(function () {
        ...
        $('.modal-body').load('{{ url("teller/sale_return_invoice_list/view/") }}' + '/' + id, function () {
