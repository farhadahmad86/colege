        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Bank Payment Voucher List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('bank_payment_voucher_list') }}" name="form1"
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 srch_brdr_left">
                                <div class="row">
                                    ...
                                    <!-- Call add button component -->
                                        <x-add-button tabindex="9" href="{{ route('bank_payment_voucher') }}"/>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $voucher)
                            @php $per_page_ttl_amnt = +$voucher->bp_total_amount + +$per_page_ttl_amnt; @endphp

                            <tr data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="View Bank Payment Voucher">
                                <th scope="row">
                                    {{ $sr }}
                                </th>
                                <td>
                                ...
                                <td class="view" data-id="{{ $voucher->bp_id }}">
                                    BPV-{{ $voucher->bp_id }}
                                </td>
                                <td class="tbl_txt_15">
                                    {{ $voucher->bp_remarks }}
                                ...
                                <td>
                                    {!! str_replace('&oS;', '<br />', $voucher->bp_detail_remarks) !!}
                                </td>
                                <td class="align_right text-right">
                                    {{ $voucher->bp_total_amount != 0 ? number_format($voucher->bp_total_amount, 2) : '' }}
                                </td>
                                ...
                                <td class="text-center {{ $voucher->bp_status == 'post' ? : '' }}"
                                >
                                    @if ($voucher->bp_status == 'post')
                                        <span class="btn btn-sm btn-success">POSTED<span>
                                                 @elseif ($voucher->bp_status == 'deleted')
                                                    <span class="btn btn-sm btn-info">Deleted<span>
                                        @elseif ($voucher->bp_status == 'park')
                                                    <a class="btn btn-sm btn-info" href="{{ route('edit_bank_payment_voucher', $voucher->bp_id) }}" title="Click To Edit Voucher"><i
                                                            class="fa fa-edit"></i></a> |
                                                    <a class="btn btn-sm btn-danger" href="{{ route('delete_bank_payment_voucher', $voucher->bp_id) }}" title="Click To Delete Voucher"
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('bank_payment_voucher_list') }}',
            url;
