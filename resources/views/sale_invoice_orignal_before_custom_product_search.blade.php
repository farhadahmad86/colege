            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        ...
                        <div id="invoice_cls_btn" class="gnrl-mrgn-pdng invoice_cls_btn">
                            <!-- invoice close button start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_sale_invoice') }}"
                              onsubmit="return popvalidation()" method="post" autocomplete="off">
                            @csrf
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_34_5"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class=" invoice_col_ttl"><!-- invoice column title start -->
                                                    <a
                                                        data-container="body" data-toggle="popover" data-trigger="hover"
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    ...
                                                    <div class="ps__search">
                                                        <input type="text" name="product" id="product" class="inputs_up form-control ps__search__input" placeholder="Enter Product"/>
                                                    </div>
                                        ...
                                        <div class="invoice_col"><!-- invoice column start -->
                                            ...
                                            <h6>Example</h6><p>{{config('fields_info.about_form_fields.general_registration.warehouse.warehouse_title.example')}}</p>">
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    ...
                                                    <div class="invoice_col_short"><!-- invoice column short start -->
                                                        <a href="{{ url('add_warehouse') }}" class="col_short_btn"
                                                           target="_blank" data-container="body" data-toggle="popover"
                                                           data-trigger="hover"
                                                           data-placement="bottom" data-html="true"
                                                           data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                        ...
                                        <div class="invoice_col basis_col_21"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    ...
                                                    <select name="service_name" class="inputs_up form-control"
                                                            id="service_name">
                                                        ...
                                                        <div class="invoice_col_txt for_invoice_nbr">
                                                            ...
                                                            <div class="invoice_inline_input_txt">
                                                                ...
                                                                <div class="inline_input_txt_lbl"
                                                                    ...
                                                                    <input type="button" class="invoice_chk_btn"
                                                                           value="check"/>
                                                                </div>
                                                        ...
                                                        <div class="pro_tbl_bx"><!-- product table box start -->
                                                            <table class="table table-bordered table-sm gnrl-mrgn-pdng"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center tbl_txt_17"> Title</th>
                                                                    <th class="text-center tbl_txt_13"> Remarks</th>
                                                                    ...
                                                                    <th class="text-center tbl_srl_10"> Tax Amount</th>
                                                                    <th class="text-center tbl_srl_4">
                                                                        Inc.
                                                                    </th>
                                                    ...
                                                    <div class="invoice_inline_input_txt">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="cash_paid"
                                                                   class="inputs_up form-control text-right"
                                                                   id="cash_paid" placeholder="Invoice Cash Received"
                                                    ...
                                                    <div class="invoice_inline_input_txt">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="cash_return"
                                                                   class="inputs_up form-control text-right"
                                                                   id="cash_return" placeholder="Invoice Party Ledger"
                                                                   readonly>
                                                        </div>
                                                    </div><!-- invoice inline input text end -->
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                            <div class="invoice_col_txt with_cntr_jstfy">
                                                ...
                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                    <button type="submit" class="invoice_frm_btn" name="save" id="save" onclick="return popvalidation()">
                                                        Save (Ctrl+S)
                                                    </button>
