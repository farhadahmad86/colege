    ...
    <div class="row">
        ...
        <div
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <form name="f1" class="f1" id="f1" action="{{ route('update_product_measurement_config') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-2 col-md-2 col-sm-6">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input type="hidden" name="company" value="{{$request->company_id}}">
                                                <input type="text" name="company_name" class="inputs_up form-control" value="{{$request->company_title}}" readonly>
...
{{--                                                </select>--}}
                                        ...
                                        <div class="form-group col-lg-2 col-md-2 col-sm-6">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input type="hidden" name="project" value="{{$request->project_id}}">
                                                <input type="text" name="project_name" class="inputs_up form-control"value="{{$request->project_title}}" readonly>
...
{{--                                                </select>--}}
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input type="text" name="product" class="inputs_up form-control" value="{{$request->product_title}}" readonly>
                                                <input type="hidden" name="product_name" value="{{$request->product_id}}">
                                                {{--                                                <input type="text" name="advertising_title" id="advertising_title" class="inputs_up remarks form-control" placeholder="Advertising Title">--}}
{{--                                                <select tabindex="1" autofocus name="product_name" class="inputs_up form-control"--}}
{{--                                                        id="product_name" autofocus data-rule-required="true"--}}
{{--                                                        data-msg-required="Please Enter Product Title">--}}
{{--                                                    <option value="">Select Product</option>--}}
{{--                                                    @foreach ($products as $product)--}}
{{--                                                        <option--}}
{{--                                                            value="{{ $product->pro_p_code }}" {{ $product->pro_p_code == $request->product_id ? 'selected="selected"' : '' }}>{{ $product->pro_title }}</option>--}}
{{--                                                    @endforeach--}}
...
{{--                                                    <option value="">Select Before Decimal Unit</option>--}}
{{--                                                    @foreach ($units as $unit)--}}
{{--                                                        <option--}}
{{--                                                            value="{{ $unit->unit_id }}" {{ $unit->unit_id == $request->before_id ? 'selected="selected"' : '' }}>{{ $unit->unit_title }}</option>--}}
{{--                                                    @endforeach--}}
...
{{--                                                    @foreach ($units as $unit)--}}
{{--                                                        <option--}}
{{--                                                            value="{{ $unit->unit_id }}" {{ $unit->unit_id == $request->after_id ? 'selected="selected"' : '' }}>{{ $unit->unit_title }}</option>--}}
{{--                                                    @endforeach--}}
...
{{--                                                    @foreach ($units as $unit)--}}
{{--                                                        <option--}}
{{--                                                            value="{{ $unit->unit_id }}" {{ $unit->unit_id == $request->output_id ? 'selected="selected"' : '' }}>{{ $unit->unit_title }}</option>--}}
{{--                                                    @endforeach--}}
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                <label class="">
                                                    ...
                                                    Remarks</label>
                                                <input tabindex="5" type="text" name="remarks" id="remarks" value="{{$request->remarks}}"
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                <div class="custom-control custom-radio mb-10 mt-1">
                                                    <input tabindex="6" type="radio" name="advertising_type"
                                                        ...
                                                        {{ $request->advertising_type == 1  ? 'checked' : '' }}>
                                            ...
                                            <div class="row flr-toggle">
                                                <div class="form-group col-lg-3 col-md-4 col-sm-12 gauge_type">
                                                    <label class="">
                                                        Depth</label>
                                                    <input tabindex="7" type="text" name="depth" id="depth" class="inputs_up form-control" placeholder="Depth" value="{{ $request->depth }}" data-rule-required="true"
                                                ...
                                                <div class="form-group col-lg-4 col-md-4 col-sm-12 gauge_type">
                                                    <label class="">
                                                        Tapa Gauge (KG)</label>
                                                    <input tabindex="8" type="text" name="tapa_gauge" id="tapa_gauge" class="inputs_up form-control" placeholder="Tapa Gauge" value="{{
                                                    $request->tapa_gauge }}" data-rule-required="true"
                                                           data-msg-required="Please Enter Tapa Gauge">
                                                    <span id="demo4" class="validate_sign"> </span>
                                                </div>
                                                <div class="form-group col-lg-5 col-md-4 col-sm-12 gauge_type">
                                                    <label class="">
                                                        Back Sheet Gauge (KG)</label>
                                                    <input tabindex="9" type="text" name="sheet_gauge" id="sheet_gauge" class="inputs_up form-control" placeholder="Back Sheet Gauge" value="{{
                                                        $request->back_sheet_gauge }}" onclick="change_type()" data-rule-required="true"
                                            ...
                                            <div class="input_bx"><!-- start input box -->
                                                <div class="custom-control custom-radio mb-10 mt-1">
                                                    <input tabindex="10" type="radio" name="advertising_type"
                                                           ...
                                                           value="2"{{ $request->advertising_type == 2  ? 'checked' : '' }} onclick="change_type();">
                                                    <label tabindex="11" class="custom-control-label" for="quantity">
                                                        Quantity
                                                    </label>
                                                </div>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="input_bx"><!-- start input box -->
                                                <div class="custom-control custom-radio mb-10 mt-1">
                                                    <input tabindex="12" type="radio" name="advertising_type"
                                                           class="custom-control-input religion" id="dimensional2"
                                                           value="3"{{ $request->advertising_type == 3  ? 'checked' : '' }}>
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <div class="custom-checkbox" style="float: left">
                                                            <input tabindex="13" type="checkbox" name="pre" id="pre"
                                                                   class="custom-control-input company_info_check_box"
                                                                   value="1" {{ $request->pre_survey == 1  ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <div class="custom-checkbox" style="float: left">
                                                            <input tabindex="14" type="checkbox" name="post" id="post"
                                                                   class="custom-control-input company_info_check_box"
                                                                   value="1" {{ $request->post_survey == 1  ? 'checked' : '' }} >
                                                            <label class="custom-control-label chck_pdng" for="post">
                                                                Post Survey
                                                            </label>
                                                        </div>
                                                    </div>
                                ...
                                <input type="hidden" name="id" value="{{$request->pmc_id}}">
                            </div>

                            <div class="form-group row">
                                <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                                    <button tabindex="15" type="reset" name="cancel" id="cancel" class="cancel_button form-control">
                                        <i class="fa fa-eraser"></i> Cancel
                                    </button>
                                    <button tabindex="16" type="submit" name="save" id="save" class="save_button form-control"
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            ...
            //     before_decimal = document.getElementById("before_decimal"),
            //     after_decimal = document.getElementById("after_decimal"),
            //     output_um = document.getElementById("output_um"),
            //     validateInputIdArray = [
            //         product_name.id,
            //         before_decimal.id,
            //         after_decimal.id,
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            var type = '{{ $request->advertising_type }}';
