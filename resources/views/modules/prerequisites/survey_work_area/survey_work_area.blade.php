            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                        ...
                        <form id="f1" action="{{ route('submit_survey_work_area') }}" method="post" onsubmit="return checkForm()">
                            @csrf
                                    ...
                                    <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl">
                                        ...
                                        <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            >
                                                                ...
                                                                @foreach ($order_lists as $order_list)
                                                                    <option
                                                                        value="{{ $order_list->ol_id }}">{{ $order_list->ol_order_title }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_15" id="employee_div">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                ...
                                                <div class="invoice_col basis_col_15" id="supplier_div">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_14">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                ...
                                                <div class="invoice_col basis_col_9">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
...
@section('scripts')
    ...
    <script>
        ...
        $('#franchiseArea').change(function () {
            jQuery("#product_name").select2("destroy");
            if(areas!=''){
                $.each(areas, function (index, value) {
                    jQuery("#product_name option[value=" + value.product_code + "]").attr("disabled", false);
                });
            }
        ...
        function add_working_area() {
            ...
            if (flag_submit1) {
                ...
                jQuery("#product_name option[value=" + product_code + "]").attr("disabled", "true");
        ...
        function reverse_qty(current_item) {
            console.log(areas[current_item]);
            var temp_products = areas[current_item];
...
// console.log(data.total_consume_qty);
        ...
        //             jQuery.ajax({
        //                 url: "get_ser_order_qty",
        //                 data: {service: service, order_list: order_list},
        //                 type: "GET",
        //                 cache: false,
        //                 dataType: 'json',
        //                 success: function (data) {
