        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Edit Batch</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('edit_batch') }}" name="form1" id="form1" method="post">
                                @csrf
...
{{--                                                    @include('include/print_button')--}}
                ...
                <form method="post" action="{{route('update_batch')}}" onsubmit="return checkForm()">
                    ...
                    <div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="input_bx"><!-- start input box -->
                            ...
                            <select tabindex="3" class="inputs_up  form-control" name="batch_name" id="batch_name" data-rule-required="true" data-msg-required="Please Enter Batch Title">
                                <option value="">Select Batch Name</option>

                                @foreach($batches as $batch)
                                    <option
                                        value="{{$batch->bat_id}}" >{{$batch->bat_name}}</option>
                                @endforeach
                            </select>
                            <span id="demo1" class="validate_sign" style="float: right !important"> </span>
                        </div>
