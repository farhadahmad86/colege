        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Update Angle Inch Soter Calibration</h4>
                        </div>
                    </div>
                </div><!-- form header close -->

                <form name="f1" class="f1" id="f1" action="update_angle_calibration" onsubmit="return checkForm()" method="post">
                    @csrf
                    <div class="row">
                        <input type="hidden" name="angle_calibration_id" value="{{ $request->angle_calibration_id }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input tabindex="1" type="text" name="width_from" id="width_from" class="inputs_up form-control" placeholder="Width From" autofocus
                                               data-rule-required="true" data-msg-required="Please Enter Width From" autocomplete="off" value="{{ $request->width_from }}" onkeypress="return allow_only_number_and_decimals(this,event);"/>
                                        <span id="demo1" class="validate_sign"> </span>
                                ...
                                <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input tabindex="1" type="text" name="width_to" id="width_to" class="inputs_up form-control" placeholder="Width To" autofocus
                                               data-rule-required="true" data-msg-required="Please Enter Width To" autocomplete="off" value="{{ $request->width_to }}" onkeypress="return allow_only_number_and_decimals(this,event);"/>
                                        <span id="demo1" class="validate_sign"> </span>
                                ...
                                <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input tabindex="1" type="text" name="angle_support" id="angle_support" class="inputs_up form-control" placeholder="Pipe Center Support" autofocus
                                               data-rule-required="true" data-msg-required="Please Enter Pipe Center Support" autocomplete="off" value="{{ $request->angle_support }}" onkeypress="return allow_only_number_and_decimals(this,event);"/>
                                        <span id="demo1" class="validate_sign"> </span>
                                    </div><!-- end input box -->
                                </div>
    ...
    <script type="text/javascript">
        function checkForm() {
            ...
            let board_type = document.getElementById("board_type"),
                ...
                angle_support = document.getElementById("angle_support"),
