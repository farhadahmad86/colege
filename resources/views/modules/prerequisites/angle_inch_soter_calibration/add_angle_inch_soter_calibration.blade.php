        ...
        <div
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Angel Inch Soter Calibration</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{route('angle_calibration_list')}}" role="button">
                ...
                <form name="f1" class="f1" id="f1" action="{{route('submit_angle_calibration')}}" method="post"
                                ...
                                <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input tabindex="1" type="text" name="angle_support" id="angle_support" class="inputs_up form-control" placeholder="Pipe Center Support" autofocus
                                               data-rule-required="true" data-msg-required="Please Enter Pipe Center Support" autocomplete="off" value="{{ old('angle_support') }}"
                                               onkeypress="return allow_only_number_and_decimals(this,event);"/>
                                        <span id="demo1" class="validate_sign"> </span>
                                    </div><!-- end input box -->
                                </div>
