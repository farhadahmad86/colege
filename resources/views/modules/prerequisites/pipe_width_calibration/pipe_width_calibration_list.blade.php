        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Pipe width Calibration List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('width_calibration_list')}}" name="form1" id="form1" method="post">
                                <div class="row">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                                <div class="form_controls text-center text-lg-left">
                                                    ...
                                                    <a tabindex="5" class="save_button form-control" href="add_width_calibration" role="button">
                                                        <l class="fa fa-plus"></l> Pipe Width Calibration
                                                    </a>
                            ...
                            <form name="edit" id="edit" action="{{ route('edit_width_calibration') }}" method="post">
                                @csrf
                                ...
                                <input name="width_support" id="width_support" type="hidden">
                                <input name="width_calibration_id" id="width_calibration_id" type="hidden">
                                <input name="board_type_id" id="board_type_id" type="hidden">

                            </form>

                            <form name="delete" id="delete" action="{{ route('delete_width_calibration') }}" method="post">
                                @csrf
                                <input name="pwc_id" id="pwc_id" type="hidden">
                            </form>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-sm" id="fixTable">
                        ...
                        @forelse($datas as $data)
                            ...
                            <tr data-width_from="{{$data->pwc_width_from}}" data-width_to="{{$data->pwc_width_to}}" data-width_support="{{$data->pwc_pipe_center_support}}"
                                data-width_calibration_id="{{$data->pwc_id}}" data-board_type_title="{{$data->bt_title}}" data-board_type_id="{{$data->pwc_board_type_id}}">
                                ...
                                <td class="align_left text-left edit tbl_txt_15">
                                    {{$data->pwc_pipe_center_support}}
                                </td>

                                @php
                                    $ip_browser_info= ''.$data->pwc_ip_adrs.','.str_replace(' ','-',$data->pwc_brwsr_info).'';
                                @endphp
                                ...
                                <td class="align_right text-right hide_column tbl_srl_6">
                                    <a data-width_calibration_id="{{$data->pwc_id}}" class="delete"  data-toggle="tooltip" data-placement="left"  title="" data-original-title="Are you sure?">
                                ...
                                {{--                                        <td><input type="checkbox" data-id="{{ $data->pwc_id }}" name="status" class="js-switch" {{ $data->reg_disabled == 0 ?
                                'checked' : '' }}></td>--}}
                            </tr>
                            @php
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#board_type").select2();
        var base = '{{ route('width_calibration_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".edit").click(function () {
            ...
            var width_support = jQuery(this).parent('tr').attr("data-width_support");
            var width_calibration_id = jQuery(this).parent('tr').attr("data-width_calibration_id");
            ...
            jQuery("#width_support").val(width_support);
            jQuery("#width_calibration_id").val(width_calibration_id);
        ...
        $('.delete').on('click', function (event) {
            ...
            var width_calibration_id = jQuery(this).attr("data-width_calibration_id");
            ...
            Swal.fire({
                ...
                if (result.value) {
                    jQuery("#pwc_id").val(width_calibration_id);
