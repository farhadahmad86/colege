        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Survey Pending List</h4>
                        </div>
...
{{--                !empty($search) ||--}}
            <!-- <div class="search_form {{ ( !empty($search_account) || !empty($search_product) || !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('survey_pending_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                <div class="input_bx"><!-- start input box -->
                                                    ...
                                                    <select tabindex="3" class="inputs_up  form-control" name="survey_name" id="survey_name">
                                                        <option value="">Select Surveyor Name</option>
                                                        @foreach($survey_names as $survey_name)
                                                            <option
                                                                value="{{$survey_name->srv_id}}" {{ $survey_name->srv_id == $search_survey_name ? 'selected="selected"' : ''
                                                                }}>{{$survey_name->srv_name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <span id="demo1" class="validate_sign" style="float: right !important"> </span>
                                                </div>
                    ...
                    <div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="input_bx"><!-- start input box -->
                            ...
                            <select tabindex="3" class="inputs_up  form-control" name="designer_name" id="designer_name" data-rule-required="true"
                                ...
                                <option value="" disabled selected>Select Designer Name</option>
                                <option value="00" >No Designer</option>
                                @foreach($designer_names as $designer_name)
                                    <option
                                        value="{{$designer_name->user_id}}">{{$designer_name->user_name}}</option>
                                @endforeach
                            </select>
                            <span id="demo1" class="validate_sign" style="float: right !important"> </span>
                        </div>
                        ...
                        <table class="table table-sm" id="fixTable">
                            ...
                            @forelse($datas as $invoice)
                                ...
                                <tr>
                                    ...
                                    <td class="align_center text-center edit tbl_srl_15">                                    {{$invoice->pro_title}}
                                    </td>
                                ...
                                Detail">
                                    ...
                                    <td class="align_left text-left tbl_txt_5">
                                        ...
                                        <a class="approval ml-2" data-toggle="tooltip" data-placement="left" title="" data-original-title="Are you sure?"
                                           onclick="approve_survey({{$invoice->sri_id}})">
                                            <i class="fa fa-check"></i>
                                        </a>
                                        <span class="px-1">|</span>
                                        <a class="delete" data-toggle="tooltip" data-placement="left" title="" data-original-title="Are you sure?" onclick="dis_approve({{$invoice->sri_id}})">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('survey_pending_list') }}',
            url;
    ...
    {{--    <!-- Bundle: Easiest to use, supports all browsers -->--}}
    {{--    <script src=" {{ asset('public/PptxGenJS/libs/pptxgen.bundle.js') }}"></script>--}}
    <script src=" {{ asset('public/PptxGenJS/dist/pptxgen.bundle.js') }}"></script>

    {{--    <!-- Individual files: Add only what's needed to avoid clobbering loaded libraries -->--}}
    <script src="{{ asset('public/PptxGenJS/libs/jquery.min.js') }}"></script>
    <script src="{{ asset('public/PptxGenJS/libs/jszip.min.js') }}"></script>
    <script src="{{ asset('public/PptxGenJS/dist/pptxgen.min.js') }}"></script>
        ...
        $('#pptbtn').on('click', function () {
            ...
            $('#fixTable tbody>tr').each(function (i, row) {
                ...
                if (i % 3 == 0) {
                    ...
                    var positionXA2 = 6.2;
                    var positionXA3 = 7.4;
                    var ImageBeforeColumn = 9;
                    var ImageAfterColumn = 17;
                    // Before
                    positionY = 1.9;
                    var image_path = rows[ImageBeforeColumn].children[0].href.replace("www.", "");

                    positionX = positionXB1;
                    slide.addImage({hyperlink: {url: rows[ImageBeforeColumn].children[0].href}, path: image_path, x: positionX, y: positionY, w: 5, h: 3});
