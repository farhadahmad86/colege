        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Survey List</h4>
                        </div>
                                        ...
                                        <tr style="padding: 0; margin: 0">
                                            <td style="padding: 0; margin: 0; border:none" class="">
                                                @foreach($imgs[$invoice->sr_id] as $a)
                                                    ...
                                                    <a class="fancybox" data-fancybox-group="gallery" href="{{$a->sri_before_image}}" style="user-select: auto;"> <img class="rounded-circle"
                                                                                                                                                                       src="{{$a->sri_before_image}}"
