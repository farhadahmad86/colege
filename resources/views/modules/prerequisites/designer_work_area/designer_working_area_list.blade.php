        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Designer Working Area List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('designer_working_area_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-2 col-md-6 col-sm-12 col-xs-12">
                                                <div class="input_bx"><!-- start input box -->
                                                    ...
                                                    <select tabindex="3" class="inputs_up form-control cstm_clm_srch" name="company" id="company">
                                                        <option value="">Select Company</option>
                                                        @foreach($companies as $company)
                                                            <option value="{{$company->account_uid}}" {{ $company->account_uid == $search_company ? 'selected="selected"' : ''
                                            ...
                                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                                <div class="form_controls text-center text-lg-left">
                                                    ...
                                                    <a tabindex="7" class="save_button form-control" href="{{ route('designer_working_area') }}" role="button">
                                                        <i class="fa fa-plus"></i> Add Designer Working Area
                                                    </a>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-sm" id="fixTable">
                        ...
                        <tr>
                            ...
                            <th scope="col" align="center" class="text-center align_center tbl_amnt_45">
                                Remarks
                            </th>
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr>
                                ...
                                <td class="align_center text-center tbl_amnt_10">
                                    {{date('d-M-y', strtotime(str_replace('/', '-', $voucher->dwa_day_end_date)))}}
                                </td>
                                <td class="view align_center text-center tbl_amnt_6" data-id="{{$voucher->dwa_id}}">
                                    DWA-{{$voucher->dwa_id}}
                                </td>
                                ...
                                @php
                                    $ip_browser_info= ''.$voucher->dwa_ip_adrs.','.str_replace(' ','-',$voucher->dwa_brwsr_info).'';
                                @endphp
                        ...
                        @empty
                            <tr>
                                <td colspan="11">
                                    <center><h3 style="color:#554F4F">No Designer Work Area</h3></center>
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Designer Working Area Detail</h4>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('designer_working_area_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            $(".modal-body").load('{{ url('designer_working_area_items_view_details/view/') }}/' + id, function () {
                // jQuery(".pre-loader").fadeToggle("medium");
