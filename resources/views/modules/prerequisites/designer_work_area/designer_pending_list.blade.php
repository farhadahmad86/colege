        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Designer Pending List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ ( !empty($search) || !empty($search_account) || !empty($search_product) || !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('designer_pending_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                ...
                <form method="post" action="{{route('designer_approved')}}" >
...
{{--                                    </td>--}}
                                ...
                                Detail">
                                    ...
                                    <td class="align_left text-left tbl_txt_5">
                                        ...
                                        <a class="approval ml-2" data-toggle="tooltip" data-placement="left" title="" data-original-title="Are you sure?"
                                           onclick="approve_design({{$invoice->sri_id}})">
                    ...
                    <button type="submit" class="save_button form-control">Approved</button>
                </form>
                <span
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('designer_pending_list') }}',
            url;
