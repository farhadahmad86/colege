        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Designer List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('designer_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
...
{{--                                                    </button>--}}
                ...
                <form method="post" action="{{route('designer_upload_image')}}" enctype="multipart/form-data" onsubmit="return checkForm()">
                            ...
                            @forelse($datas as $invoice)
                                ...
                                <tr>
                                    <td class="align_center text-center edit tbl_srl_4" hidden>
                                        <input type="hidden" name="image_id[]" value="{{$invoice->sri_id}}" id="{{$invoice->sri_id}}"/>
                                    </td>
                                    ...
                                    <td class="align_left text-left tbl_txt_5">
                                        <input type="file" name="upload_designer_image[]" id="upload_designer_image{{$invoice->sri_id}}" onchange="Filevalidation({{$invoice->sri_id}})">
                                        <p id="size{{$invoice->sri_id}}"></p>
{{--                                        {{$invoice->sri_image_type}}--}}
                                    </td>
                    ...
                    <button type="submit" class="save_button form-control">Save Images</button>
                </form>
                <span
...
<script>
        ...
        Filevalidation = (id) => {
            ...
            const fi = document.getElementById('upload_designer_image'+id);
            ...
            if (fi.files.length > 0) {
                for (const i = 0; i <= fi.files.length - 1; i++) {
                    ...
                    if (file >= 250) {
                        document.getElementById('size'+ id).innerHTML = '<b>'
                            + file + '</b> KB' +' File too Big, please select a file less than 250KB';
                        document.getElementById('size'+ id).style.color = "red";
                        document.getElementById('upload_designer_image'+id).value='';
                        // alert(
