        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Order List Item</h4>
                        </div>
                        <div class="list_btn">
                        ...
                        <form id="f1" action="{{ route('submit_order_list') }}" method="post" onsubmit="return checkForm()">
                            ...
                            <div class="pd-20">
                                ...
                                <div class="row credentials_div">
                                    ...
                                    <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl">
                                        ...
                                        <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <input tabindex="0" type="text" name="order_title" class="inputs_up form-control" id="order_title" data-rule-required="true"
                                                                   data-msg-required="Please
                                                                    Enter Order Title" placeholder="Order Title" readonly>
                                            ...
                                            <div class="invoice_row">
                                                    ...
                                                    <div class="invoice_col_bx">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            >
                                                                ...
                                                                data-parent={{$product->pro_p_code}} data-purchase_price={{$product->pro_sale_price}} data-tax={{$product->pro_tax}}
                                                                data-retailer_dis={{$product->pro_retailer_discount}} data-whole_saler_dis={{$product->pro_whole_seller_discount}} data-loyalty_dis={{$product->pro_loyalty_card_discount}} data-unit={{$product->unit_title}}>{{$product->pro_title}}</option>--}}
                                                                {{--                                                                    @endforeach--}}
                                                            </select>
                                                ...
                                                <div hidden class="invoice_col basis_col_15">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                ...
                                                <div hidden class="invoice_col basis_col_6">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                ...
                                                <div hidden class="invoice_col basis_col_5">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                ...
                                                <div hidden class="invoice_col basis_col_8">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                                ...
                                                                <div class="pro_tbl_bx">
                                                                    ...
                                                                    <table class="table gnrl-mrgn-pdng"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th hidden tabindex="-1" class="text-center tbl_srl_10">
                                                                                Remarks
                                                                            </th>
                                                                            <th hidden tabindex="-1" class="text-center tbl_srl_7">
                                                                                QTY
                                                                            </th>
                                                                            <th hidden tabindex="-1" class="text-center tbl_srl_7">
                                                                                Rate
                                                                            ...
                                                                            <th hidden class="text-center tbl_srl_7">
                                                                                Start Date
                                                                            </th>
                                                                            <th hidden class="text-center tbl_srl_7">
                                                                                End Date
                                    ...
                                    {{--                                    <select multiple id="e1" style="width:100px">--}}
...
@section('scripts')
    ...
    <script>
        ...
        jQuery("#project").change(function () {
            var project = $(this).find(':selected').val();
            var grand_total = $('option:selected', this).attr('data-material_total');
            ...
            var project_nam = jQuery("#project option:selected").text();

            var order_list_title = company_name + '-' + project_nam + '-' + zone_name;
            $('#order_title').val(order_list_title);
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data.products, function (index, value) {
                        add_orders(company_id,company_name,zone_value,zone_name,region_value,region_name,service_value,service_name,order_remarks,value.pro_p_code,value.pro_title,qty,value.unit_title,value.pro_purchase_price,amount,
                            start_date,end_date,pro_ser);
                    ...
                    var pro_ser = 'services';
                    var product_name_value = '';
                    var product_name = '';
                    var uom = '';
                    var ser_option = "<option value='' disabled selected>Select Service</option>";
                    $.each(data.services, function (index, value) {
                        add_orders(company_id,company_name,zone_value,zone_name,region_value,region_name,value.ser_id,value.ser_title,order_remarks,product_name_value,product_name,qty,uom,value
                            .ser_rate,amount,
                            start_date,end_date,pro_ser);
        ...
        function checkForm() {
            ...
            //     if (value.pro_ser == 'products') {
            //         total_products++;
            //     }
            //     if (value.pro_ser == "services") {
            //         total_services++;
            //     }
            //
            // });
            ...
            //     });
            //     alertMessageShow(remaining_amount.id, 'Enter products ');
            //     return false;
            // }
            // if (total_services == 0) {
            //     Swal.fire({
            ...
            //         //footer: '<a href>Why do I have this issue?</a>'
            //     });
            //     alertMessageShow(remaining_amount.id, 'Enter service ');
            //     return false;
            // }
            ...
            //         icon: 'error',
            //         title: 'Oops...',
            //         text: 'Remaining amount not less 0!',
            //         //footer: '<a href>Why do I have this issue?</a>'
            //     });
        ...
        function add_orders(company_id,company_name,zone_value,zone_name,region_value,region_name,service_value,service_name,order_remarks,product_name_value,product_name,qty,uom,rate,amount,
                            start_date,end_date,pro_ser) {
            ...
            if (zone_value == "0" || zone_value == "" || zone_value == "empty") {
            ...
            if (region_value == "0" || region_value == "" || region_value == "empty") {
...
// console.log()
                ...
                jQuery("#table_body").append(
                    ...
                    'tbl_txt_10" hidden>' + order_remarks + '</td><td class="text-left tbl_txt_7" hidden>' + qty + '</td><td class="text-left tbl_txt_7" hidden>' + rate + '</td><td class="text-left tbl_txt_7" hidden>' + uom
                    + '</td><td class="text-left tbl_txt_7" hidden>' + amount
                    + '</td><td class="text-left tbl_txt_7" hidden>' + start_date
                    + '</td><td class="text-right tbl_srl_4">' + end_date +
                    '<div class="edit_update_bx">' +
                    // '<a hidden' +
                    // 'class="edit_link btn btn-sm btn-success" href="#" onclick=edit_order(' + counter + ')><i class="fa fa-edit"></i></a> ' +
                    '<a href="#" class="delete_link btn btn-sm btn-danger" ' +
...
// console.log()
        ...
        $('#region').change(function () {
            ...
            var project = jQuery("#project option:selected").text();
            var region = $(this).val();
            var regions = jQuery("#region option:selected").text();


            var check_array = jQuery("#order_array").val();
            ...
            if (check_array != '') {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        jQuery("#order_array").val('');
                        jQuery("#total_items").val('');
                        jQuery("#total_price").val('');
                        jQuery("#table_body").html(" ");
                        orders = {}
                        // grand_total_calculation();
                        // calculate_remaining_amount();
                        var order_list_title = company + '-' + project + '-' + regions;
                        $('#order_title').val('');
                        $('#order_title').val(order_list_title);
                        get_zone(region);
                    }
...
// console.log(data);$rate
        ...
        function calculate_used_qty() {
            ...
            if (get_array != '') {
                ...
                $.each(make_array, function (index, value) {
                    ...
                    if (value['service_value'] == service) {
                        total_qty = +value['qty'] + +total_qty;
                    }
    ...
    <script>
        $('#qty').keyup(function () {
            ...
            if (remain_qty < 0) {
                document.getElementById('cal_remain_qty').innerHTML = "Due Qty must be greater tha 0."
            } else {
                document.getElementById('cal_remain_qty').innerHTML = "";
            }
        });
    ...
    {{--    select all option in select2 dropdown script--}}
    <script>
