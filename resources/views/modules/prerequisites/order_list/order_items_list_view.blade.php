        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Order Items List View</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('order_items_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                <div class="input_bx"><!-- start input box -->
                                                    ...
                                                    <select tabindex="2" class="inputs_up  form-control" name="project" id="project">
                                            ...
                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                                <div class="form_controls text-center text-lg-left">
                                                    ...
                                                    <a tabindex="9" class="save_button form-control" href="{{ route('order_list') }}" role="button">
                                                        <i class="fa fa-plus"></i> Order Item List
                                                    </a>
                    ...
                    <table class="table table-sm" id="fixTable">
                        ...
                        @forelse($datas as $invoice)
                            ...
                            <tr>
                                ...
                                <td class="align_center text-center tbl_srl_4">
                                    {{$invoice->ol_order_title}}
                                </td>
                                <td nowrap class="align_center text-center tbl_amnt_9">
                                    {{$invoice->account_name}}
                                </td>
                                <td class="align_center text-center view tbl_amnt_6" data-id="{{$invoice->ol_id}}">
                                    OL-{{$invoice->ol_id}}
                                </td>
                                ...
                                @php
                                    $ttlPrc = +($invoice->ol_grand_total) + +$ttlPrc;
                                @endphp
                                ...
                                @php
                                    $ip_browser_info= ''.$invoice->ol_ip_adrs.','.str_replace(' ','-',$invoice->ol_brwsr_info).'';
                                @endphp
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('order_items_list') }}',
            url;
