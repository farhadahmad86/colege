...
{{--                        <h3 class="m-0">--}}
{{--                            Edit Zone--}}
{{--                            <a href="{{ route('zones.create') }}" class="btn btn-sm btn-primary mx-2 float-right">Create</a>--}}
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
        ...
        <div class="form_header"><!-- form header start -->
            <div class="clearfix">
                ...
                <div class="list_btn">
                    <a class="btn list_link add_more_button" href="{{route('zones.list')}}" role="button">
        ...
        <form name="f1" class="f1" id="f1" action="{{route('zones.update', $zone)}}" method="post"
