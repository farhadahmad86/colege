...
{{--        </thead>--}}
{{--        <tbody>--}}
{{--        @forelse ($franchiseAreas as $index => $franchiseArea)--}}
{{--            <tr>--}}
{{--                <th>{{ $index + 1 }}</th>--}}
{{--                <td>{{ $franchiseArea->name }}</td>--}}
{{--                <td>{{ $franchiseArea->bdoName }}</td>--}}
{{--                <td>{{ $franchiseArea->bdoContact }}</td>--}}
{{--                <td>{{ $franchiseArea->moName }}</td>--}}
{{--                <td>{{ $franchiseArea->moContact }}</td>--}}
{{--                <td>{{ $franchiseArea->grid->name }}</td>--}}
{{--                <td>{{ $franchiseArea->city->name }}</td>--}}
{{--                <td>{{ $franchiseArea->zone->name }}</td>--}}
{{--                <td>{{ $franchiseArea->region->name }}</td>--}}
{{--                <td>{{ $franchiseArea->company->name }}</td>--}}
{{--                <td>{{ $franchiseArea->status }}</td>--}}
{{--                <td>--}}
{{--                    <a href="{{ route('franchise-area.edit', $franchiseArea) }}" class="btn btn-sm btn-warning d-inline"><i class="fa fa-edit"></i></a>--}}
{{--                    <form action="{{ route('franchise-area.destroy', $franchiseArea) }}" method="post" class="d-inline">--}}
{{--                        @csrf--}}
{{--                        @method('delete')--}}
...
{{--        @empty--}}
{{--            <tr>--}}
{{--                <th colspan="13" class="text-danger text-center font-weight-bold">No Franchise / Area Available</th>--}}
{{--            </tr>--}}
{{--        @endforelse--}}
{{--        </tbody>--}}
{{--    </table>--}}
{{--    <div class="text-center">--}}
{{--        {{ $franchiseAreas->links() }}--}}
{{--    </div>--}}
{{--</div>--}}
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
    ...
    <div class="table-responsive" id="printTable">
        <table class="table table-sm" id="fixTable">
            ...
            <thead>
            <tr>
                <th scope="col" align="center" class="text-center align_center tbl_srl_3">
                    Sr#
                </th>
            ...
            {{--                @endphp--}}
            @forelse($franchiseAreas as $index => $data)
                ...
                <tr data-title="{{$data->name}}" data-remarks="{{$data->remarks}}"
                    ...
                    <td>
                        <a href="{{ route('franchise-area.edit', $data) }}" class="btn btn-sm btn-warning d-inline"><i class="fa fa-edit"></i></a>
                        <form action="{{ route('franchise-area.destroy', $data) }}" method="post" class="d-inline">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-sm btn-danger d-inline"><i class="fa fa-trash"></i></button>
                        </form>
