...
{{--                <td>--}}
{{--                    <a href="{{ route('companies.edit', $company) }}" class="btn btn-sm btn-warning d-inline"><i class="fa fa-edit"></i></a>--}}
...
{{--        @empty--}}
{{--            <tr>--}}
{{--                <th colspan="4" class="text-danger text-center font-weight-bold">No Company Available</th>--}}
{{--            </tr>--}}
{{--        @endforelse--}}
{{--        </tbody>--}}
{{--    </table>--}}
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
    ...
    <div class="table-responsive" id="printTable">
        <table class="table table-sm" id="fixTable">
            ...
            {{--                @endphp--}}
            @forelse($companies as $index => $data)
                ...
                <tr data-title="{{$data->name}}" data-remarks="{{$data->remarks}}"
                    ...
                    <td>
                        <a href="{{ route('companies.edit', $data) }}" class="btn btn-sm btn-warning d-inline"><i
                                class="fa fa-edit"></i></a>
                        <form action="{{ route('companies.destroy', $data) }}" method="post" class="d-inline">
                            @csrf
                            @method('delete')
