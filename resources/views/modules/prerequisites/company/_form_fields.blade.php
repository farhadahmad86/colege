...
{{--                        </a>--}}
                        Company
                            ...
                            <input type="text" class="inputs_up form-control @error('name') is-invalid @enderror" id="name" name="name"
                                   data-rule-required="true" data-msg-required="Please Enter Company"
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                <div class="input_bx"><!-- start input box -->
                    ...
                    <textarea class="inputs_up remarks form-control @error('remarks') is-invalid @enderror"
                              id="remarks" name="remarks" placeholder="Enter Remarks">{{ $company->remarks }}</textarea>
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                <div class="input_bx"><!-- start input box -->
                    <div class="custom-control custom-checkbox" style="float: left">
                        <input type="checkbox" class="custom-control-input" id="status" name="status" value="{{ $company->getStatus('active') }}" {{ isset($company->status) ? '' : 'checked' }} {{ $company->status === $company->getStatus('active') ? 'checked' : old('status') ? 'checked' : '' }}>
