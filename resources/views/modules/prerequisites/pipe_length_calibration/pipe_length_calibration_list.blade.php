        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Pipe Length Calibration List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('length_calibration_list')}}" name="form1" id="form1" method="post">
                                <div class="row">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                                <div class="form_controls text-center text-lg-left">
                                                    ...
                                                    <a tabindex="5" class="save_button form-control" href="add_length_calibration" role="button">
                                                        <l class="fa fa-plus"></l> Pipe Length Calibration
                                                    </a>
                            ...
                            <form name="edit" id="edit" action="{{ route('edit_length_calibration') }}" method="post">
                                @csrf
                                <input name="board_type_title" id="board_type_title" type="hidden">
                                <input name="length_to" id="length_to" type="hidden">
                                <input name="length_from" id="length_from" type="hidden">
                                <input name="pipe_center_support" id="pipe_center_support" type="hidden">
                                <input name="length_calibration_id" id="length_calibration_id" type="hidden">
                                <input name="board_type_id" id="board_type_id" type="hidden">

                            </form>

                            <form name="delete" id="delete" action="{{ route('delete_length_calibration') }}" method="post">
                                @csrf
                                <input name="plc_id" id="plc_id" type="hidden">
                            </form>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-sm" id="fixTable">
                        ...
                        @forelse($datas as $data)
                            ...
                            <tr data-length_from="{{$data->plc_length_from}}" data-length_to="{{$data->plc_length_to}}" data-pipe_center_support="{{$data->plc_pipe_center_support}}"
                                data-length_calibration_id="{{$data->plc_id}}" data-board_type_title="{{$data->bt_title}}" data-board_type_id="{{$data->plc_board_type_id}}">
                                ...
                                <td class="align_left text-left edit tbl_txt_15">
                                    {{$data->plc_length_from }}
                                </td>
                                <td class="align_left text-left edit tbl_txt_15">
                                    {{$data->plc_length_to}}
                                </td>
                                <td class="align_left text-left edit tbl_txt_15">
                                    {{$data->plc_pipe_center_support}}
                                </td>

                                @php
                                    $ip_browser_info= ''.$data->plc_ip_adrs.','.str_replace(' ','-',$data->plc_brwsr_info).'';
                                @endphp
                                ...
                                <td class="align_right text-right hide_column tbl_srl_6">
                                    <a data-length_calibration_id="{{$data->plc_id}}" class="delete"  data-toggle="tooltip" data-placement="left"  title="" data-original-title="Are you sure?">
                                ...
                                {{--                                        <td><input type="checkbox" data-id="{{ $data->plc_id }}" name="status" class="js-switch" {{ $data->reg_disabled == 0 ?
                                'checked' : '' }}></td>--}}
                            </tr>
                            @php
...
@section('scripts')
    ...
    <script type="text/javascript">
        $('#board_type').select2();
        var base = '{{ route('length_calibration_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".edit").click(function () {
            ...
            var length_from = jQuery(this).parent('tr').attr("data-length_from");
            var length_to = jQuery(this).parent('tr').attr("data-length_to");
            var pipe_center_support = jQuery(this).parent('tr').attr("data-pipe_center_support");
            var length_calibration_id = jQuery(this).parent('tr').attr("data-length_calibration_id");
            ...
            jQuery("#length_from").val(length_from);
            jQuery("#length_to").val(length_to);
            jQuery("#pipe_center_support").val(pipe_center_support);
            jQuery("#length_calibration_id").val(length_calibration_id);
        ...
        $('.delete').on('click', function (event) {
            ...
            var length_calibration_id = jQuery(this).attr("data-length_calibration_id");
            ...
            Swal.fire({
                ...
                if (result.value) {
                    jQuery("#plc_id").val(length_calibration_id);
