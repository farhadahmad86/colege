        ...
        <div
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Create Board Material</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{route('board_material_list')}}" role="button">
                ...
                <form name="f1" class="f1" id="f1" action="{{route('submit_board_material')}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input tabindex="1" type="text" name="board_material_name" id="board_material_name" class="inputs_up form-control" placeholder="Board Material Title" autofocus   data-rule-required="true" data-msg-required="Please Enter Board Material Title" autocomplete="off" value="{{ old('board_material_name') }}"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            let board_material_name = document.getElementById("board_material_name"),
                validateInputIdArray = [
                    board_material_name.id,
                ];
