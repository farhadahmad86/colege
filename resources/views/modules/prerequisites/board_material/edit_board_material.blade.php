        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Update Board Material</h4>
                        </div>
                    </div>
                </div><!-- form header close -->

                <form name="f1" class="f1" id="f1" action="update_board_material" onsubmit="return checkForm()" method="post">
                    @csrf
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input type="text" name="board_material_name" id="board_material_name" class="inputs_up form-control"
                                               data-rule-required="true" data-msg-required="Please Enter Board Material"
                                               placeholder="Board Material Title" autofocus value="{{$request->title}}" autocomplete="off"/>
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                ...
                                <input value="{{$request->board_material_id}}" type="hidden" name="board_material_id">
