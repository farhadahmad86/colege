        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Job Order Invoice List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('purchase_order_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                                <div class="form_controls text-center text-lg-left">
                                                    ...
                                                    <a tabindex="9" class="save_button form-control" href="{{ route('purchase_order') }}" role="button">
                    ...
                    <table class="table table-sm" id="fixTable">
                        ...
                        @forelse($datas as $invoice)
                            ...
                            <tr>
                                ...
                                <td class="align_center text-center view tbl_amnt_6" data-id="{{$invoice->proj_id}}">
                                    PO-{{$invoice->proj_id}}
                                </td>
                                ...
                                <td class="align_left text-center tbl_txt_6">
                                    {{$invoice->proj_start_date}}
                                </td>
                                <td class="align_left text-center tbl_txt_6">
                                    {{$invoice->proj_end_date}}
                                </td>
                                <td class="align_left text-left tbl_txt_11">
                                    {{$invoice->proj_remarks}}
                                </td>
                                <td class="align_left text-left tbl_txt_29">
{{--                                    {!! str_replace(array("\r\n","\r","\n","\\r","\\n","\\r\\n"),'<br />', $invoice->proj_detail_remarks) !!}--}}
                                    {!! str_replace("&oS;",'<br />', $invoice->proj_detail_remarks) !!}
                                </td>
                                @php
                                    $ttlPrc = +($invoice->proj_grand_total) + +$ttlPrc;
                                @endphp
                                <td class="align_right text-right tbl_amnt_5">
                                    {{$invoice->proj_grand_total !=0 ? number_format($invoice->proj_grand_total,2):''}}
                                </td>
...
{{--                                </td>--}}
                                ...
                                @php
                                    $ip_browser_info= ''.$invoice->proj_ip_adrs.','.str_replace(' ','-',$invoice->proj_brwsr_info).'';
                                @endphp
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('purchase_order_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            $('.modal-body').load('{{url("purchase_order_items_view_details/view/") }}'+'/'+id, function(){
