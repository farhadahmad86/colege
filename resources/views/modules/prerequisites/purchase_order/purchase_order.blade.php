        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-0 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Job Order</h4>
                        </div>
                        <div class="list_btn">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng for_voucher"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_purchase_order') }}"
                                                            ...
                                                            <div class="pro_tbl_bx">
                                                                ...
                                                                <table class="table gnrl-mrgn-pdng"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th hidden tabindex="-1" class="text-center tbl_srl_4">
                                                                            Qty
                                                                        </th>
                                                                        <th tabindex="-1" class="text-center tbl_srl_4">
                                                                            UOM
                                                                        ...
                                                                        <th hidden tabindex="-1" class="text-center tbl_srl_6">
                                                                            Rate
                                                                        </th>
                                                                        <th hidden tabindex="-1" class="text-center tbl_srl_4">
                                                                            Dis%
                                                                        ...
                                                                        <th hidden tabindex="-1" class="text-center tbl_srl_4" hidden>
                                                                            Inclu
                                                                        </th>
                                                                        <th hidden tabindex="-1" class="text-center tbl_srl_12">
                                                                            Amount
                                                                        </th>
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="invoice_col basis_col_27" style="margin-top:-7px">
                                                ...
                                                <div class="invoice_row"><!-- invoice row start -->
                                                    ...
                                                    <div hidden class="invoice_col basis_col_100">
                                                        <!-- invoice column start -->
                                                        <div class="invoice_col_bx">
                                                            <!-- invoice column box start -->
                                                            <label class=" invoice_col_ttl">
    ...
    <script>
        ...
        function add_sale(code, name, quantity, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '</td> <td hidden class="text-right tbl_srl_7"> ' +
                ...
                'readonly/> ' +
                '</td> <td hidden class="text-center tbl_srl_4"> ' +
                ...
                '</td> ' +
                '<td hidden class="text-right tbl_srl_10"> ' +
                ...
                '</td> ' +
                '<td hidden class="text-right tbl_srl_12"> ' +
                ...
                '<div class="edit_update_bx"> <div hidden class="inc_dec_con">' +
