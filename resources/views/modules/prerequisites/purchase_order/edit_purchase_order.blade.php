...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-0 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">


                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">(Purchase Order) Edit Job Order</h4>
                        </div>
                        <div class="list_btn">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng for_voucher"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                        <form name="f1" class="f1" id="f1" action="{{ route('update_purchase_order') }}"
                            ...
                            <div class="pd-0">
                                ...
                                <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl">
                                    ...
                                    <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="invoice_col basis_col_24">
                                                ...
                                                <div class="invoice_col_bx">
                                                    ...
                                                    <div class="invoice_col_input">
                                                        ...
                                                        <select tabindex="2" name="project_id"
                                            ...
                                            <div class="invoice_col basis_col_24" >
                                                ...
                                                <div class="invoice_col_bx">
                                                    ...
                                                    <div class="invoice_col_input">
                                                        <!-- invoice column input start -->
                                                        <input tabindex="1" autofocus type="text" name="project_name"
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            <div hidden class="invoice_col basis_col_100 gnrl-mrgn-pdng">
                                                <!-- invoice column start -->
                                                                ...
                                                                <div class="invoice_col_bx for_tabs"><!-- invoice column box start -->
                                                                    ...
                                                                    <div class="invoice_col_txt for_invoice_nbr"><!-- invoice column input start -->
                                                                        <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                                            ...
                                                                            <div class="invoice_col_input">
                                                                                <input type="text" name="invoice_nbr_chk" class="inputs_up form-control" id="invoice_nbr_chk"
                                                                                       placeholder="Enter Po # For Edit">
                                                                            </div>
                                                            ...
                                                            <div class="pro_tbl_bx">
                                                                ...
                                                                <table class="table gnrl-mrgn-pdng"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th tabindex="-1" class="text-center tbl_srl_4" hidden>
                                                                            Inclu
                                                                        </th>
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="invoice_col basis_col_20" hidden>
                                                <!-- invoice column start -->
                                                <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="invoice_col basis_col_100">
                                                ...
                                                <div class="invoice_col_txt with_cntr_jstfy">
                                                    ...
                                                    <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                        <button tabindex="7" type="submit" class="invoice_frm_btn" name="save" id="save"
                                                        >
                                                            Save (Ctrl+S)
                                                        </button>
...
@section('scripts')
    ...
    <script>
        ...
        function product_amount_calculation(id) {
            ...
            var old_quantity = jQuery("#old_quantity" + id).val();
            var quantity = jQuery("#quantity" + id).val();
            if(parseFloat(quantity) < parseFloat(old_quantity) || quantity == ''){
                jQuery("#quantity" + id).val(old_quantity);
        ...
        function grand_total_calculation() {
            ...
            jQuery("#material_amount").val(grand_total.toFixed(2));
            ...
            if (!$("#check_multi_time").is(':checked')) {
                ...
                $('input[name="pro_code[]"]').each(function (pro_index) {
                    ...
                    if (pro_code == parent_code) {
                        old_quantity = +jQuery("#old_quantity" + pro_field_id).val();
                ...
                if (parseFloat(quantity) > 1) {
                    add_sale_readonly(parent_code, name, quantity, old_quantity, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                        inclusive_exclusive,
                        counter, 0, unit_measurement);

                    product_amount_calculation(counter);
                }else{
                    add_sale(parent_code, name, quantity, old_quantity, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        // bonus_qty,
                        add_sale(parent_code, name, quantity, old_quantity,rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
        ...
        // bonus_qty,
        function add_sale(code, name, quantity, old_quantity, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<input type="text" name="old_quantity[]" id="old_quantity' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + ')" value="' +
                old_quantity + '" onfocus="this.select();" onkeypress="return allowOnlyNumber(event);" readonly hidden/>' +
                '</td>' +

                '<td class="text-center tbl_srl_4">' +
                '<input type="text" class="inputs_up_tbl text-right" name="unit_measurement[]" id="unit_measurement' + counter + '" placeholder="UOM" value="' + unit_measurement + '" readonly/>' +
                '</td>' +
                ...
                '</td> ' +
                '<td hidden class="text-center tbl_srl_4"> <input type="checkbox" name="inclusive_exclusive[]" id="inclusive_exclusive' + counter + '" onclick="product_amount_calculation(' +
                counter + ');' +
                ...
                '<td class="text-right tbl_srl_6"> ' +
                '<input type="hidden" name="add_qty[]" id="add_qty' + counter + '" placeholder="QTY" class="inputs_up_tbl text-right lower_inputs" value="' + 1 + '"/> ' +
        ...
        function add_sale_readonly(code, name, quantity, old_quantity, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                                   inclusive_exclusive,
                          counter, product_or_service_status, unit_measurement) {
            ...
            jQuery("#table_body").append('<tr class="edit_update" style="background: #C4D3F5" id="table_row' + counter + '">' +
                '<td class="text-center tbl_srl_4">' + counter + '</td> ' +
                '<td class="text-center tbl_srl_9" hidden>' +
                '<input type="hidden" name="product_or_service_status[]" id="product_or_service_status' + counter + '" placeholder="Status" ' + 'class="inputs_up_tbl lower_inputs" value="' +
                product_or_service_status + '" readonly/>' +
                '<input type="readonly" name="pro_code[]" id="pro_code' + counter + '" placeholder="Code" ' + 'class="inputs_up_tbl lower_inputs" value="' + code + '" readonly/>' +
                '</td> ' +
                '<td class="text-left tbl_txt_17">' +
                '<input style="background: #C4D3F5" type="readonly" name="pro_name[]" id="pro_name' + counter + '" placeholder="Name" ' + 'class="inputs_up_tbl lower_inputs" value="' + name + '" readonly/>' +
                '</td> ' +
                '<td class="text-left tbl_txt_13">' +
                '<input style="background: #C4D3F5" type="readonly" name="product_remarks[]" id="product_remarks' + counter + '" placeholder="Remarks" ' + 'class="inputs_up_tbl lower_inputs" value="' + remarks + '"/>' +
                '</td>' +
                // '<td class="text-left tbl_txt_13" id="warehouse_div_col' + counter + '">' +
                // '</td>' +
                '<td class="text-center tbl_srl_4">' +
                '<input style="background: #C4D3F5" type="readonly" name="quantity[]" id="quantity' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl lower_inputs" onkeyup="product_amount_calculation(' + counter + ')" value="' +
                quantity + '" onfocus="this.select();" onkeypress="return allowOnlyNumber(event);"/>' +
                '</td>' +

                '<td class="text-center tbl_srl_4" hidden>' +
                '<input style="background: #C4D3F5" type="text" name="old_quantity[]" id="old_quantity' + counter + '" placeholder="Qty" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + ')" value="' +
                old_quantity + '" onfocus="this.select();" onkeypress="return allowOnlyNumber(event);" readonly />' +
                '</td>' +

                '<td class="text-center tbl_srl_4">' +
                '<input style="background: #C4D3F5" type="readonly" class="inputs_up_tbl text-right lower_inputs" name="unit_measurement[]" id="unit_measurement' + counter + '" placeholder="UOM" value="' + unit_measurement + '" readonly/>' +
                '</td>' +
                // '<td class="text-center tbl_srl_5"> ' +
                // '<input type="text" name="bonus[]" id="bonus' + counter + '" placeholder="Bonus" ' + 'class="inputs_up_tbl" onkeyup="product_amount_calculation(' + counter + ')" value="' +
                // bonus_qty + '" onfocus="this.select();" onkeypress="return allowOnlyNumber(event);" ' + bonus_qty_status + '/> ' +
                // '</td> ' +
                '<td class="text-right tbl_srl_6"> ' +
                '<input style="background: #C4D3F5" type="readonly" name="rate[]" id="rate' + counter + '" ' + 'placeholder="Rate" class="inputs_up_tbl text-right lower_inputs" onkeyup="product_amount_calculation(' +
                counter
                + ')" value="' +
                rate + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);" readonly />' +
                '<input style="background: #C4D3F5" type="hidden" name="product_inclusive_rate[]" class="inputs_up ' + 'text-right form-control lower_inputs" id="product_inclusive_rate' + counter + '"  value="' + inclusive_rate + '"> ' +
                '</td> ' +
                '<td class="text-center tbl_srl_4"> ' +
                '<input style="background: #C4D3F5" type="readonly" name="product_discount[]" id="product_discount' + counter + '" placeholder="Dis%" class="inputs_up_tbl lower_inputs" onkeyup="product_amount_calculation(' + counter + ')" ' +
                'value="' + discount + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/> ' +
                '</td> <td class="text-right tbl_srl_7"> ' +
                '<input style="background: #C4D3F5" type="readonly" name="product_discount_amount[]" id="product_discount_amount' + counter + '" placeholder="Dis Amount" value="' + discount_amount + '" class="inputs_up_tbl text-right lower_inputs" ' +
                'readonly/> ' +
                '</td> <td class="text-center tbl_srl_4"> ' +
                '<input style="background: #C4D3F5" type="readonly" name="product_sales_tax[]" id="product_sales_tax' + counter + '" placeholder="Tax%" class="inputs_up_tbl lower_inputs" value="' + sales_tax + '" ' +
                'onkeyup="product_amount_calculation(' + counter + ')" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/> ' +
                '</td> ' +
                '<td class="text-right tbl_srl_10"> ' +
                '<input style="background: #C4D3F5" type="readonly" name="product_sale_tax_amount[]" id="product_sale_tax_amount' + counter + '" placeholder="Tax Amount" value="' + sale_tax_amount + '" class="inputs_up_tbl text-right lower_inputs" readonly/> ' +
                '</td> ' +
                '<td hidden class="text-center tbl_srl_4 lower_inputs"> <input type="checkbox" name="inclusive_exclusive[]" id="inclusive_exclusive' + counter + '" onclick="product_amount_calculation(' +
                counter + ');' +
                '"' + inclusive_exclusive_status + ' value="1" /> ' +
                '<input style="background: #C4D3F5" type="hidden" name="inclusive_exclusive_status_value[]" id="inclusive_exclusive_status_value' + counter + '"' + 'value="' + inclusive_exclusive + '"/> ' +
                '</td> ' +
                '<td class="text-right tbl_srl_12"> ' +
                '<input style="background: #C4D3F5" type="readonly" name="amount[]" id="amount' + counter + '" placeholder="Amount" class="inputs_up_tbl text-right lower_inputs" value="' + amount + '" readonly/> ' +
                '</td> ' +

                '<td class="text-right tbl_srl_3">' +
                '<input onfocus="this.select();" type="text" name="add_qty[]" id="add_qty' + counter + '" placeholder="QTY" class="inputs_up_tbl text-right lower_inputs" value="' + 1 + '" onkeypress="return allowOnlyNumber(event);"/> ' +
                '</td> ' +
        ...
        function increase_quantity(current_item) {
            ...
            var add_qty = jQuery("#add_qty" + current_item).val();
            var new_quantity = 1;
            if (previous_qty >= 0) {
                new_quantity = +previous_qty + +add_qty;
            }

            jQuery("#quantity" + current_item).val(new_quantity);
            jQuery("#add_qty" + current_item).val(1);
    ...
    <script>
        jQuery("#project_id").change(function () {
            ...
            var invoice_no = jQuery(this).val();
            ...
            jQuery.ajax({
                url: "get_purchased_items_for_edit",
                ...
                success: function (data) {
                    ...
                    if (data.length !== 0) {
                        ...
                        jQuery("#project_name").val(data[0][prefix + '_project_name']);
                        jQuery("#customer_name").val(data[0][prefix + '_party_reference']);
                        jQuery("#remarks").val(data[0][prefix + '_remarks']);
                        jQuery("#start_date").val(data[0][prefix + '_start_date']);
                        jQuery("#end_date").val(data[0][prefix + '_end_date']);

                        jQuery('#account_name').select2('destroy');
                        jQuery('#account_name option[value="' + data[0][prefix + '_party_uid'] + '"]').prop('selected', true);
                        jQuery('#account_name').select2();
                        ...
                        $.each(data[1], function (index, value) {
                            ...
                            var parent_code = value['code'];

                            var name = value['name'];

                            var product_or_service_status = value['sale_ser_type'];
                            var old_quantity = value['qty'];
                            var quantity = value['qty'];
                            var unit_measurement = '';
                            if (value['uom'] != null) {
                                unit_measurement = value['uom'];
                            }

                            var rate = value['rate'];
                            var inclusive_rate = 0;
                            var discount = '';
                            if (value['discount_per'] != null) {
                                unit_measurement = value['discount_per'];
                            }

                            var discount_amount = 0;
                            var sales_tax = '';
                            if (value['saletax_per'] != null) {
                                unit_measurement = value['saletax_per'];
                            }
                            ...
                            var rate_after_discount = 0;
                            var inclusive_exclusive = value['saletax_inclusive'];

                            var amount = quantity * rate;

                            add_sale_readonly(parent_code, name, quantity, old_quantity, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                                inclusive_exclusive, counter, product_or_service_status, unit_measurement);
