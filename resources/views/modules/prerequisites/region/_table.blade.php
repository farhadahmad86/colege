...
{{--                <td>{{ $region->status }}</td>--}}
{{--                <td>--}}
{{--                    <a href="{{ route('regions.edit', $region) }}" class="btn btn-sm btn-warning d-inline"><i class="fa fa-edit"></i></a>--}}
...
{{--        @empty--}}
{{--            <tr>--}}
{{--                <th colspan="5" class="text-danger text-center font-weight-bold">No Region Available</th>--}}
{{--            </tr>--}}
{{--        @endforelse--}}
{{--        </tbody>--}}
{{--    </table>--}}
...
{{--                <form class="prnt_lst_frm" action="{{ route('regions.index') }}" name="form1" id="form1" method="post">--}}
{{--                    <div class="row">--}}
{{--                        @csrf--}}
...
{{--                                <a class="save_button form-control" href="{{ route('regions.create') }}" role="button">--}}
...
{{--                    --}}{{--                    {{$data->user_name}}--}}
{{--                    --}}{{--                    </td>--}}
{{--                    <td class="align_left text-left edit tbl_txt_8">{{ $data->createdBy->user_name }}</td>--}}
...
{{--                    <td>--}}
{{--                        <a href="{{ route('regions.edit', $data) }}" class="btn btn-sm btn-warning d-inline"><i--}}
{{--                                class="fa fa-edit"></i></a>--}}
{{--                        <form action="{{ route('regions.destroy', $data) }}" method="post" class="d-inline">--}}
{{--                            @csrf--}}
{{--                            @method('delete')--}}
