...
{{--                        <h3 class="m-0">--}}
{{--                            Edit Region--}}
{{--                            <a href="{{ route('regions.create') }}" class="btn btn-sm btn-primary mx-2 float-right">Create</a>--}}
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
    ...
    <div class="form_header"><!-- form header start -->
        <div class="clearfix">
            <div class="pull-left">
                <h4 class="text-white get-heading-text">Update Zone</h4>
            </div>
            <div class="list_btn">
    ...
    <form name="f1" class="f1" id="f1" action="{{route('regions.update', $region)}}" method="post"
