        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Material Budget List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('material_budget_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                                <div class="form_controls text-center text-lg-left">
                                                    ...
                                                    <a tabindex="7" class="save_button form-control" href="{{ route('material_budget') }}" role="button">
                                                        <i class="fa fa-plus"></i> Add Material Budget
                                                    </a>
                    ...
                    <table class="table table-sm" id="fixTable">
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr>
                                ...
                                <td class="view align_center text-center tbl_amnt_6" data-id="{{$voucher->mb_id}}">
                                    MB-{{$voucher->mb_id}}
                                </td>
                                ...
                                @php
                                    $ip_browser_info= ''.$voucher->mb_ip_adrs.','.str_replace(' ','-',$voucher->mb_brwsr_info).'';
                                @endphp
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('material_budget_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            $(".modal-body").load('{{ url('material_budget_items_view_details/view/') }}/' + id, function () {
                // jQuery(".pre-loader").fadeToggle("medium");
