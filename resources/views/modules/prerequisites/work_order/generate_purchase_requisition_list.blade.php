...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name"> Generate Purchase Requisition</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{route('submit_Purchase_Requisition_invoice')}}" name="form1" id="form1" method="get">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                <div class="input_bx"><!-- start input box -->
                                                    ...
                                                    <select tabindex="3" class="inputs_up form-control" name="purchase_order" id="purchase_order">
                                                        <option value="">Select Purchase Order</option>
                                                        @foreach($purchase_orders as $po)
                                                            <option value="{{$po->opo_id}}">{{$po->opo_po_no}}</option>
                                                        @endforeach
                                                    </select>
                                                    <span id="demo1" class="validate_sign" style="float: right !important"> </span>
                                                </div>
                    ...
                    <table class="table table-sm" id="fixTable">
                        ...
                        @forelse($workOrder as $product_recipe)
                            ...
                            <tr data-work_odr_id="{{$product_recipe->work_odr_id}}">
                                ...
                                <td class="align_center text-center tbl_srl_5" >
                                    {{$product_recipe->po_name}}
                                </td>
                                <td class="align_center text-center tbl_srl_8" >
                                    {{$product_recipe->party_name}}
                                </td>
                                {{--                                <td class="align_center text-center tbl_srl_5 view" data-id="{{$product_recipe->work_odr_id}}">--}}
                                {{--                                    {{$product_recipe->work_odr_id}}--}}
                                {{--                                </td>--}}
        ...
        $department_vendor=$product_recipe->department;
                                ...
                                @endphp
                                <td class="align_left text-left tbl_txt_8 edit">
                                    {{$department_vendor}}
                                </td>
                                <td class="align_left text-left tbl_txt_8 edit">
                                ...
                                <td class="align_left usr_prfl text-center tbl_txt_8">
                                    {{$product_recipe->recipe_type=='open_recipe_show' ? 'Open Recipe':'Batch Recipe'}}
                                </td>
                                ...
                                <td class="align_left usr_prfl text-center tbl_txt_8">
                                    {{$product_recipe->odr_pr_status}}
                                </td>


                                <td class="align_left usr_prfl text-center tbl_txt_8">
                                    @if ($product_recipe->odr_pr_status == "Pending" || $product_recipe->odr_pr_status == "Approved")
                                    @else
                                    <a href="{{route('manufacturing_Purchase_Requisition_invoice_create',$product_recipe->odr_id)}}">PR</a>
                                    @endif
                                </td>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg mdl_wdth" role="document">
            <div class="modal-content base_clr">
                ...
                <form action="{{route('move_all_manufacturing_budget_stock')}}" method="post">
                    @csrf
...
@section('scripts')
        ...
        function modaldata(id) {
            ...
            jQuery.ajax({
                ...
                allowOnlyNumber(event); */
                            ...
                            '<td class="text-right tbl_srl_10">' +
                            '<input type="text" name="in_hand_stock[]" class="inputs_up_tbl text-right" id="in_hand_stock' + value.brs_id + '" placeholder="In Hand Stock" value="' + data.qty[index] +
                            ...
                            '" onfocus="this.select();" onkeyup="check_qty(' + value.brs_id +')" onkeypress="return allow_only_number_and_decimals(this,event);"/>' +
                            '</td>' +
    ...
    <script>
        function check_qty(id) {
            ...
            var remain_qty = $('#production_qty' + id).val();
            if (parseFloat(qty) > parseFloat(remain_qty)) {
                $('#move_qty' + id).val('');
                alert('You are increase the Reqd. Production Quantity');
            }
        }
        ...
        function move_qty(id) {
            ...
            if (qty == null || qty == '') {
                ...
                jQuery.ajax({
                    ...
                    data: {id: id, qty: qty, work_order_id: work_order_id, pro_code: pro_code, pro_name: pro_name},
                    type: "POST",
                    cache: false,
                    dataType: 'json',
                    success: function (data) {
