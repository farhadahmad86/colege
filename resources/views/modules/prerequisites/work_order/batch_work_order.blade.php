        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Manufacturing Plan </h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('batch_work_order.index') }}" role="button">
                ...
                <form class="tab-wizard wizard-circle wizard" onsubmit="return checkForm()" name="f1" class="f1" id="f1" action="{{ route('batch_work_order.store') }}" method="post">
                    @csrf
                        ...
                        <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="invoice_row mt-1"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt inline_radio"><!-- invoice column input start -->
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="recipe_select" class="invoice_type" id="open_recipe" value="open_recipe_show" checked>
                                                            Recipe
                                                        </label>
                                                    </div>
                                                    <div class="radio ml-3">
                                                        <label>
                                                            <input type="radio" name="recipe_select" class="invoice_type" id="batch_recipe" value="batch_recipe_show">
                                                            Batch Recipe
                                                        </label>
                                                    </div>
                                        ...
                                        <div id="batch_recipe_show" class="invoice_col basis_col_15 recipe_box hide"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <div class="invoice_col_short"><!-- invoice column short start -->
                                                        <a tabindex="-1" href="{{ route('product_recipe') }}" target="_blank" class="col_short_btn" data-container="body" data-toggle="popover"
                                                    ...
                                                    <select tabindex="1" autofocus class="inputs_up form-control" name="pro_recipe" id="pro_recipe" data-method="loadContent"
                                                            onchange="getRecipe(this);" data-rule-required="true" data-msg-required="Please Select Product Recipe">
                                        ...
                                        <div id="open_recipe_show" class="invoice_col basis_col_15 recipe_box"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="required invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true"
                                                       data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.cash_voucher.cash_receipt_voucher.code.description')}}</p>">
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    ...
                                                    <select tabindex="1" autofocus class="inputs_up form-control" name="pro_open_recipe" id="pro_open_recipe" data-method="loadContent"
                                                            onchange="getRecipe(this);" data-rule-required="true" data-msg-required="Please Select Product Recipe">
                                                        <option value="" disabled selected> ---Select Product Recipe---</option>
                                                        @foreach($get_open_recipies as $get_recipie)
                                                            <option value="{{$get_recipie->recipe_id}}">
                                                                {{$get_recipie->recipe_name}}
                                                            </option>
                                                        @endforeach
...
{{--                                                        </a>--}}
                                                    ...
                                                    <select tabindex="1" autofocus class="inputs_up form-control" name="purchase_order" id="purchase_order"
                                                           data-rule-required="true" data-msg-required="Please Select Purchase Order">
                                                        <option value="" disabled selected> ---Select Purchase Order---</option>
                                                        @foreach($get_purchase_orders as $purchase_order)
                                                            <option value="{{$purchase_order->po_id}}">
                                        ...
                                        <div class="invoice_col basis_col_11"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="2" readonly type="text" class="inputs_up text-right form-control" name="order_quantity" id="order_quantity"
                                                           placeholder="Product Quantity"
                                                           min="1" onkeypress="return allow_only_number_and_decimals(this,event);" data-method="orderQuantityChange"
                                                           onkeyup="orderQuantityChange(this);" data-rule-required="true" data-msg-required="Please Enter Order Quantity"/>
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_col basis_col_6"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="3" type="text" class="inputs_up text-center form-control" name="show_uom_main" id="show_uom_main" placeholder="UOM" readonly
                                                           data-rule-required="true" data-msg-required="Product UOM must require"/>
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_col basis_col_10"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="4" type="text" name="estimated_start_time" class="inputs_up form-control datetimepicker" id="estimate_start_time"
                                                           placeholder="Estimate Start Time" data-rule-required="true" data-msg-required="Please Select Estimated Start Time">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_col basis_col_10"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="5" type="text" name="estimated_end_time" class="inputs_up form-control datetimepicker" id="estimated_end_time"
                                                           placeholder="Estimated End Time" data-rule-required="true" data-msg-required="Please Select Estimated End Time">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_col basis_col_10"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <label tabindex="-1" class="invoice_col_ttl"><!-- invoice column title start -->
                                                    Over Head Total
                                                </label><!-- invoice column title end -->
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    <h5 tabindex="-1" class="grandTotalFont" id="overHeadGrandView">
                                                        0
                                                    </h5>
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        ...
                                        <div class="invoice_col basis_col_11"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    <h5 tabindex="-1" class="grandTotalFont" id="stockCostingGrandView">
                                                        0
                                                    </h5>
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        ...
                                        <div class="invoice_col basis_col_10"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    <h5 tabindex="-1" class="grandTotalFont" id="overHeadPlusStockCosting">
                                                        0
                                                    </h5>
                                                    <input tabindex="-1" type="text" name="overHeadPlusStockCostingTotal" id="overHeadPlusStockCostingTotal" class="inputs_up form-control hidden"/>
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                                    ...
                                    <div class="tab">
                                        <ul class="nav nav-tabs customtab" role="tablist">
                                            ...
                                            <li tabindex="-1" class="nav-item">
                                                <a id="over_head" class="nav-link" data-toggle="tab" href="#product_over_head_tab" role="tab" aria-selected="false">Production Over Head</a>
                                            </li>
                                        </ul>
                                                                ...
                                                                <div class="pro_tbl_con for_voucher_tbl"><!-- product table container start -->
                                                                    <div class="pro_tbl_bx"><!-- product table box start -->
                                                                        <table class="table gnrl-mrgn-pdng" id="category_dynamic_table">
                                                                            <thead>
                                                                            <tr>
                                                                                <th tabindex="-1" class="text-center tbl_srl_4"> Sr.</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_9"> Code</th>
                                                                                <th tabindex="-1" class="text-center tbl_txt_20"> Title</th>
                                                                                <th tabindex="-1" class="text-center tbl_txt_30"> Product Remarks</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_6"> UOM</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_10"> Recipe Production Qty</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_10"> Stock Before Production</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_10"> Stock After Production</th>
                                                                            </tr>
                                                                            </thead>
                                                                    ...
                                                                    <div class="pro_tbl_bx"><!-- product table box start -->
                                                                        <table class="table gnrl-mrgn-pdng" id="category_dynamic_table">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th tabindex="-1" class="text-center tbl_srl_9"> Code</th>
                                                                                <th tabindex="-1" class="text-center tbl_txt_20"> Title</th>
                                                                                <th tabindex="-1" class="text-center tbl_txt_20"> Product Remarks</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_6"> UOM</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_8"> Recipe Production Qty</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_8"> %</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_8"> Reqd. Production Qty</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_8"> Stock Before Production</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_8"> Stock After Production</th>
                                                                            </tr>
                                                                            </thead>
                                                ...
                                                <div class="invoice_row"><!-- invoice row start -->
                                                    ...
                                                    <div id="departments_show" class="warehouse_box invoice_col basis_col_23"><!-- invoice column start -->
                                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                                            ...
                                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                                <div class="invoice_col_short"><!-- invoice column short start -->
                                                                    <a href="{{ route('product_recipe') }}" target="_blank" class="col_short_btn" data-container="body" data-toggle="popover"
                                                ...
                                                <div class="invoice_row"><!-- invoice row start -->
                                                    ...
                                                    <div class="invoice_col basis_col_9"><!-- invoice column start -->
                                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                                            ...
                                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                                <input type="text" class="inputs_up text-right form-control" id="ser_rate" placeholder="Service Rate" min="1"
                                                                       onkeypress="return allow_only_number_and_decimals(this,event);"
                                                                       onkeyup="quantityRateMultiply('ser_rate', 'ser_qty', 'ser_amount')"/>
                                                            </div><!-- invoice column input end -->
                                                        </div><!-- invoice column box end -->
                                                    </div><!-- invoice column end -->
                                                    ...
                                                    <div class="invoice_col basis_col_9"><!-- invoice column start -->
                                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                                            ...
                                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                                <input type="text" class="inputs_up text-right form-control" id="ser_qty" placeholder="Service Qty" min="1"
                                                                       onkeypress="return allow_only_number_and_decimals(this,event);"
                                                                       onkeyup="quantityRateMultiply('ser_rate', 'ser_qty', 'ser_amount')"/>
                                                            </div><!-- invoice column input end -->
                                                        </div><!-- invoice column box end -->
                                                    ...
                                                    <div class="invoice_col basis_col_9"><!-- invoice column start -->
                                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                                            ...
                                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                                <input type="text" class="inputs_up text-right form-control" id="ser_amount" placeholder="Total Amount" min="1"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center tbl_srl_10">
                                                                            <div class="invoice_col_txt"><!-- invoice column box start -->
                                                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                                                    <input type="text" name="ttlAmountForOverHead" id="ttlAmountForOverHead"
                                                    ...
                                                    <div class="invoice_col basis_col_20"><!-- invoice column start -->
                                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                                            ...
                                                            <div class="invoice_col_txt inline_radio"><!-- invoice column input start -->
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="product_rate_type" class="invoice_type" id="last_purchase_rate" value="last_purchase_rate_show"
                                                                               checked onclick="rateChange(this);" data-method="orderQuantityChange">
                                                                        Last Purchase Rate
                                                                    </label>
                                                                </div>
                                                                <div class="radio ml-3">
                                                                    <label>
                                                                        <input type="radio" name="product_rate_type" class="invoice_type" id="average_rate" value="average_rate_show"
                                                                               onclick="rateChange(this);" data-method="orderQuantityChange">
                                                                        Average Rate
                                                                    </label>
                                                                </div>
                                                            </div><!-- invoice column input end -->
                                                                        ...
                                                                        <table class="table gnrl-mrgn-pdng">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-center tbl_srl_10">
                                                                                    <div class="invoice_col_txt"><!-- invoice column box start -->
                                                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                                                            <input type="text" name="rate_type_grand_total" id="rate_type_grand_total"
                                                                                                   class="inputs_up text-right form-control required" placeholder="0.00" readonly
                                                    ...
                                                    <div class="invoice_row"><!-- invoice row start -->
                                                        ...
                                                        <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                                            <div class="invoice_col_txt with_cntr_jstfy for_voucher_btns"><!-- invoice column box start -->
                                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                                    <button tabindex="6" type="submit" name="save" id="save" class="invoice_frm_btn">
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            ...
            let pro_recipe = document.getElementById("pro_open_recipe"),
                batch_pro_recipe = document.getElementById("pro_recipe"),
                purchase_order = document.getElementById("purchase_order"),
                order_quantity = document.getElementById("order_quantity"),
                estimate_start_time = document.getElementById("estimate_start_time"),
                estimated_end_time = document.getElementById("estimated_end_time"),
                // estimated_end_time = document.getElementById("estimated_end_time"),
                validateInputIdArray = [
                    purchase_order.id,
                    order_quantity.id,
                    estimate_start_time.id,
                    estimated_end_time.id,
                    // estimated_end_time.id,
                ];
            // return validateInventoryInputs(validateInputIdArray);
            var checkvalidate = validateInventoryInputs(validateInputIdArray);
            ...
            if (checkvalidate == true) {
                ...
                // alert("check form true ho gaya");
                // // temp
                // $("#party_client_list .select2-choice").css("background", "red");
                // $("#party_client_list .select2-search").css("background-color", "blue");
                // $("#party_client_list .select2-search input").css("background-color", "green");
                // $("#party_client_list .select2-results").css("background-color", "yellow");




                if ($("#department_warehouse").is(":checked")) {
                    // alert("dep check ha");


                    var checkdep = $("#department_list");
                    var emplist = $("#employee_list");

                    if (checkdep.val() == null) {
                        // alert("value dalo pahla");
                        $("#over_head").click();
                        $("#department_list").next().css("background-color", "red");
                        $("#department_list").next().css("color", "white");
                        $("#department_list").next().focus();
                        return false;

                    } else if (emplist.val() == null) {
                        $("#over_head").click();
                        // alert("value dalo pahla");
                        $("#department_list").next().css("background-color", "white");
                        $("#department_list").next().css("color", "black");
                        $("#employee_list").next().css("background-color", "red");
                        $("#employee_list").next().css("color", "white");
                        $("#employee_list").next().focus();
                        return false;
                    } else {
                        // alert("ok")
                        return true;
                    ...
                    // alert("vendor check ha");

                    var checkdep = $("#party_client_list");
                    var emplist = $("#employee_list");
                    ...
                    if (checkdep.val() == "0") {
                        // alert("value dalo pahla");
                        $("#over_head").click();
                        $("#party_client_list").next().css("background-color", "red");
                        $("#party_client_list").next().css("color", "white");
                        $("#party_client_list").next().focus();
                        return false;
                        ...
                        // alert("value dalo pahla");
                        $("#over_head").click();
                        $("#party_client_list").next().css("background-color", "white");
                        $("#party_client_list").next().css("color", "black");
                        $("#employee_list").next().css("background-color", "red");
                        $("#employee_list").next().css("color", "white");
                        $("#employee_list").next().focus();
                        return false;
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("input[name='recipe_select']").change(function () {
                let get_warehouse = $(this).val();

                $(".recipe_box").addClass('hide');
                $("#" + get_warehouse).toggleClass('hide');
            });
        ...
        function getRecipe(e) {
            ...
            var recipe_type = $("input[name='recipe_select']:checked").val();
            ...
            jQuery.ajax({
                url: "{{ route("get_batch_recipe") }}",
                data: {id: recipe_id, recipe_type: recipe_type},
                type: "POST",
                cache: false,
                dataType: 'json',
                success: function (data) {
                    ...
                    $.each(data.get_primary, function (key, value) {
                        ...
                        document.getElementById("order_quantity").value = value.quantity;
