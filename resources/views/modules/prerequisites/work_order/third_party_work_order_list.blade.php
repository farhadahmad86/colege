        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name"> Third Party Work Order List</h4>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                        <div class="input_bx"><!-- start input box -->
                                            ...
                                            <input tabindex="1" autofocus type="search" list="browsers" class="inputs_up form-control all_clm_srch" name="search" id="search" placeholder="Search ..." value="" autocomplete="off">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form_controls text-center">
                                            ...
                                            <a tabindex="8" class="save_button form-control" href="{{ route('third_party_work_order.create') }}" role="button">
                    ...
                    <table class="table table-sm" id="fixTable">
                        ...
                        @forelse($workOrder as $product_recipe)
                            ...
                            <tr data-work_odr_id="{{$product_recipe->work_odr_id}}">
                                <td class="align_center text-center tbl_srl_5 view">
                                                ...
                                                <div class="pro_tbl_bx"><!-- product table box start -->
                                                    <table class="table  gnrl-mrgn-pdng" id="">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right tbl_srl_10"> <input type="text" class="inputs_up_tbl text-right recipe_qty" data-rawpercentval="44" data-ttlquantityid="536035" value="2.200" readonly=""> </td>
                                                            <td class="text-right tbl_srl_8"> <input type="text" class="inputs_up_tbl text-right" id="budget536035rawStock" value="0.440" readonly=""> </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left tbl_txt_18"></td>
                                                            <td class="text-center tbl_srl_6">KG</td>
                                                            <td class="text-right tbl_srl_10"> <input type="text" class="inputs_up_tbl text-right recipe_qty" data-rawpercentval="60" data-ttlquantityid="394723" value="3.000" readonly=""> </td>
                                                            <td class="text-right tbl_srl_8"> <input type="text" class="inputs_up_tbl text-right" id="budget394723rawStock" value="0.600" readonly=""> </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left tbl_txt_18"></td>
                                                            <td class="text-center tbl_srl_6">KG</td>
                                                            <td class="text-right tbl_srl_10"> <input type="text" class="inputs_up_tbl text-right recipe_qty" data-rawpercentval="40" data-ttlquantityid="830309" value="2.000" readonly=""> </td>
                                                            <td class="text-right tbl_srl_8"> <input type="text" class="inputs_up_tbl text-right" id="budget830309rawStock" value="0.400" readonly=""> </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left tbl_txt_18"></td>
                                                            <td class="text-center tbl_srl_6">KG</td>
                                                            <td class="text-right tbl_srl_10"> <input type="text" class="inputs_up_tbl text-right recipe_qty" data-rawpercentval="34" data-ttlquantityid="249399" value="1.700" readonly=""> </td>
                                                            <td class="text-right tbl_srl_8"> <input type="text" class="inputs_up_tbl text-right" id="budget249399rawStock" value="0.340" readonly=""> </td>
                                                            <td class="text-right tbl_srl_10">8.000</td>
                                                            <td class="text-right tbl_srl_8">
                                                                <input type="text" class="inputs_up_tbl text-right" placeholder="Add Quantity" value="">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left tbl_txt_18"></td>
                                                            <td class="text-center tbl_srl_6">KG</td>
                                                            <td class="text-right tbl_srl_10"> <input type="text" class="inputs_up_tbl text-right recipe_qty" data-rawpercentval="30" data-ttlquantityid="142345489079" value="1.500" readonly=""> </td>
                                                            <td class="text-right tbl_srl_8"> <input type="text" class="inputs_up_tbl text-right" id="budget142345489079rawStock" value="0.300" readonly=""> </td>
