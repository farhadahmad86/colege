        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Third Party Batch Work Order</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('third_party_work_order.index') }}" role="button">
                ...
                <form class="tab-wizard wizard-circle wizard" onsubmit="return checkForm()" name="f1" class="f1" id="f1" action="{{ route('third_party_work_order.store') }}" method="post">
                    @csrf
...
{{--                                            </li>--}}
                                            <li tabindex="-1" class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#primary_finished_goods_tab" role="tab" aria-selected="true">Batch Detail</a>
                                            </li>
{{--                                            <li tabindex="-1" class="nav-item">--}}
...
{{--                                            </li>--}}
                                        ...
                                        <div class="tab-content mt-4">
                                            ...
                                            <div class="tab-pane fade show active" id="primary_finished_goods_tab" role="tabpanel">
                                                                    ...
                                                                    <div class="pro_tbl_bx"><!-- product table box start -->
                                                                        <table class="table gnrl-mrgn-pdng" id="category_dynamic_table">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th tabindex="-1" class="text-center tbl_txt_30"> Total Height</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_6"> Total Length</th>
                                                                                <th tabindex="-1" class="text-center tbl_srl_10">Quantity </th>
                                                                            </tr>
                                                                            </thead>
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            ...
            var date1 = $("#estimate_start_time");
            var date2 = $("#estimated_end_time");
            ...
            let pro_recipe = document.getElementById("pro_recipe"),
                ...
                success: function (data) {
                    ...
                    $.each(data.items, function (key, value) {
                        ...
                        let inputValuesArrayPrimary = {
                            code: value.sri_pro_code,
                            title: value.product_name,
                            remarks: value.sri_height,
                            uom: value.sri_total_length,
                            quantity: value.sri_quantity,
                        };
