        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Survey Working Area</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('survey_working_area_list') }}" role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                        ...
                        <form id="f1" action="{{ route('submit_survey_working_area') }}" method="post" onsubmit="return checkForm()">
                            @csrf
                                                    ...
                                                    <div class="invoice_col_bx">
                                                        ...
                                                        <div class="invoice_col_input ">
                                                            ...
                                                            <select tabindex="1" autofocus
                                                                name="project"
                                                                id="project"
                                                                data-rule-required="true" data-msg-required="Please Choose Project Name"
...
{{--                                                                </a>--}}
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_10" id="employee_div">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                ...
                                                <div class="invoice_col basis_col_10" id="supplier_div">
                                                    <!-- invoice column start -->
                                                    <div class="invoice_col_bx">
                                                        <!-- invoice column box start -->
                                                        <div class="required invoice_col_ttl">
                                                ...
                                                <div class="invoice_col basis_col_10">
                                                    ...
                                                    <div class="invoice_col_bx">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <input tabindex="14" type="text" name="end_date" id="end_date" class="inputs_up form-control datepicker1" autocomplete="off" value="" placeholder="End
                                                            Date
                                                             ...
                                                            ...">
                                                        </div><!-- invoice column input end -->
...
//         });
    ...
    <script>
        ...
        function add_working_area() {
            ...
            if (regions == "" && region_value == "undefined") {
            ...
            if (flag_submit1) {
                ...
                jQuery("#table_body").append(
                    ...
                    franchiseArea + '</td><td class="text-left tbl_txt_10" >' + surveyor_type + '</td>' +
                    '<td' +
                    ' class="text-left ' +
                    'tbl_txt_10" >' + shoni + '</td><td class="text-left tbl_txt_10" >' +
                    supervisor + '</td><td class="text-left tbl_txt_10" >' +
                    start_date + '</td><td class="text-left tbl_txt_10">' + end_date + '<div class="edit_update_bx"> <a href="#" class="delete_link btn btn-sm btn-danger" ' +
