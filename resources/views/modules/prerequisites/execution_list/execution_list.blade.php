        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Execution List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('execution_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                        ...
                        @forelse($datas as $invoice)
                            ...
                            <tr>
                                ...
                                <td nowrap="" class="align_left text-left tbl_txt_5">
                                    ...
                                    <a class="fancybox" data-fancybox-group="gallery" href="{{$invoice->sri_executed_image}}"> <img class="media-object rounded-circle no-border-top-radius
                                                                            no-border-bottom-radius avatar avatar-sm pull-up"
                                                                                                                                    src="{{$invoice->sri_executed_image}}" width="30px" height="30px" alt=""></a>
                                    {{--                                        @endforeach--}}
                                </td>
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Execution Image Detail</h4>
        ...
        $('#pptbtn').on('click', function () {
            ...
            $('#fixTable tbody>tr').each(function (i, row) {
                ...
                if (i % 3 == 0) {
                    ...
                    slide.addText('Executed Image',   { x:5.2, y:1.6, w:2, color:'000000', fontSize:12 });
                    ...
                    var executed_image_path = rows[ImageAfterColumn].children[0].href.replace("www.", "");
// console.log(survey_image_path);
// console.log(executed_image_path);
                    ...
                    slide.addImage({hyperlink: {url: rows[ImageAfterColumn].children[0].href}, path: executed_image_path, x: positionX, y: positionY, w:
                            4, h: 3});
...
//                     }
            ...
            pptx.save('Executed_Report_' + strDate);
