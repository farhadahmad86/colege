...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
        ...
        <div class="form_header"><!-- form header start -->
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-white get-heading-text">Update City</h4>
                </div>
                <div class="list_btn">
                    <a class="btn list_link add_more_button" href="{{route('cities.index')}}" role="button">
        ...
        <form name="f1" class="f1" id="f1" action="{{route('cities.update', $city)}}" method="post"
              onsubmit="return checkForm()">
            @include('modules.prerequisites.city._form_fields')
            @method('put')
            <div class="row">
