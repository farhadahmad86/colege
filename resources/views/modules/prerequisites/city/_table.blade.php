...
{{--                <td>{{ $city->status }}</td>--}}
{{--                <td>--}}
{{--                    <a href="{{ route('cities.edit', $city) }}" class="btn btn-sm btn-warning d-inline"><i class="fa fa-edit"></i></a>--}}
...
{{--        @empty--}}
{{--            <tr>--}}
{{--                <th colspan="7" class="text-danger text-center font-weight-bold">No City Available</th>--}}
{{--            </tr>--}}
{{--        @endforelse--}}
{{--        </tbody>--}}
{{--    </table>--}}
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form name="delete" id="delete" action="{{ route('delete_region') }}" method="post">
                    @csrf
                    <input tabindex="-1" name="reg_id" id="reg_id" type="hidden">
                </form>
    ...
    <div class="table-responsive" id="printTable">
        <table class="table table-sm" id="fixTable">
            ...
            <tr>
                ...
                <th scope="col" align="center" class="text-center align_center tbl_txt_17">
                    Title
                </th>
                <th scope="col" align="center" class="text-center align_center tbl_txt_17">
                    Company Name
                </th>
                <th scope="col" align="center" class="text-center align_center tbl_txt_19">
                    Zone Name
                </th>
                <th scope="col" align="center" class="text-center align_center tbl_txt_19">
                    Region Name
            ...
            {{--                @endphp--}}
            {{--            {{array_values($crudCities)}}--}}

            @forelse($cities as $index => $data)
                ...
                <tr data-title="{{$data->name}}" data-remarks="{{$data->remarks}}"
                    ...
                    <td>
                        <a href="{{ route('cities.edit', $data) }}" class="btn btn-sm btn-warning d-inline"><i
                                class="fa fa-edit"></i></a>
                        <form action="{{ route('cities.destroy', $data) }}" method="post" class="d-inline">
                            @csrf
                            @method('delete')
