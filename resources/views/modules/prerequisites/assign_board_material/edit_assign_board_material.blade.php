        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Update Assign Board Material</h4>
                        </div>
                ...
                <div id="invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        ...
                        {{--form start--}}
                        <form name="f1" class="f1" id="f1" action="{{ route('update_assign_board_material',$assign_board_materials->abm_id) }}"
                                                    ...
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <select name="product" tabindex="1"
                                                                    ...
                                                                    a data-msg-required="Please Select Product"
                                                                    class="inputs_up form-control js-example-basic-multiple autofocus2"
                                                                    id="product">
                                                                <option value="" selected disabled>Select product</option>
                                                                @foreach($products as $product)
                                                                    <option value="{{$product->pro_p_code}}" {{ $product->pro_p_code ==
                                                                    $assign_board_materials->abm_product_code ? 'selected="selected"' : ''}}>{{$product->pro_title}}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <select name="board_type" tabindex="1"
                                                                ...
                                                                @foreach($board_types as $board_type)
                                                                    <option value="{{$board_type->bt_id}}" {{ $board_type->bt_id ==
                                                                    $assign_board_materials->abm_board_type ? 'selected="selected"' : ''}}>{{$board_type->bt_title}}</option>
                                                                @endforeach
                                                            </select>
...
@section('scripts')
    ...
    <script>
        ...
        var abc = {{$assign_board_materials_items}}

        $.each(abc, function (index, value) {

            $("#board_material" + value).prop("checked", true);
