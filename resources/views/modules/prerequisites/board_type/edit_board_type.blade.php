        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Update Board Type</h4>
                        </div>
                    </div>
                </div><!-- form header close -->

                <form name="f1" class="f1" id="f1" action="update_board_type" onsubmit="return checkForm()" method="post">
                    @csrf
                    <div class="row">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        <label class="required">
                                           ...
                                           Board Type Title</label>
                                        <input type="text" name="board_type_name" id="board_type_name" class="inputs_up form-control"
                                               data-rule-required="true" data-msg-required="Please Enter Board Type"
                                               placeholder="Board Type Title" autofocus value="{{$request->title}}" autocomplete="off"/>
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                ...
                                <input value="{{$request->board_type_id}}" type="hidden" name="board_type_id">
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            let board_type_name = document.getElementById("board_type_name"),
    ...
    <script type="text/javascript">
        ...
        {
            var board_type_name  = document.getElementById("board_type_name").value;
            var remarks  = document.getElementById("remarks").value;

            var flag_submit = true;
            var focus_once = 0;

            if(board_type_name.trim() == "")
            {
                document.getElementById("demo1").innerHTML = "Required";
                if (focus_once == 0) { jQuery("#board_type_name").focus(); focus_once = 1;}
                flag_submit = false;
            }else{
