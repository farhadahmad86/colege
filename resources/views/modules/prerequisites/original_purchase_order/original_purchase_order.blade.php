        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-0 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Purchase Order</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('original_purchase_order_list') }}" role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng for_voucher"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                        ...
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_original_purchase_order') }}"
                                ...
                                <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl">
                                    ...
                                    <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="invoice_col basis_col_32">
                                                ...
                                                <div class="invoice_col_bx">
                                                    ...
                                                    <div class="invoice_col_input">
                                                        ...
                                                        <input tabindex="1" autofocus type="text" name="po_no"
                                            ...
                                            <div class="invoice_col basis_col_32">
                                                ...
                                                <div class="invoice_col_bx">
                                                    ...
                                                    <div class="invoice_col_input">
                                                        <!-- invoice column input start -->
                                                        <select tabindex="43" name="job_order[]"
                                                                class="inputs_up form-control" data-rule-required="true" data-msg-required="Please Enter Job Order"
                                                                id="job_order" multiple>

                                                            {{--                                                            @foreach($companies as $account)--}}
                                                            {{--                                                                <option--}}
                                                            {{--                                                                    value="{{$account->account_name}}" >{{$account->account_name}}</option>--}}
                                                            {{--                                                            @endforeach--}}
                                                        </select>
                                                    </div><!-- invoice column input end -->
                                                </div><!-- invoice column box end -->
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="invoice_col basis_col_32" hidden>
                                                <!-- invoice column start -->
                                                <div class="invoice_col_bx">
                                                    <!-- invoice column box start -->
                                                    <div class="required invoice_col_ttl">
...
{{--                                                            @endforeach--}}
                                            ...
                                            <div class="invoice_col basis_col_32">
                                                ...
                                                <div class="invoice_col_bx">
                                                    ...
                                                    <div class="invoice_col_input">
                                                        ...
                                                        <select tabindex="8" name="posting_reference"
                                                                class="inputs_up form-control"
                                                                id="posting_reference" data-rule-required="true" data-msg-required="Please Enter Posting Reference">
                                                            <option value="0" >Select Posting Reference</option>

                                                            @foreach ($posting_references as $posting_reference)
                                                                <option
                                                                    value="{{$posting_reference->pr_id}}">{{$posting_reference->pr_name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div><!-- invoice column input end -->
                                                </div><!-- invoice column box end -->
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            <div class="invoice_col basis_col_100 gnrl-mrgn-pdng" hidden>
                                                <!-- invoice column start -->
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            let po_no = document.getElementById("po_no"),
                ...
                job_order = document.getElementById("job_order"),
    ...
    <script>
        jQuery("#account_name").change(function () {
            ...
            var party_code = jQuery('option:selected', this).val();
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    jQuery("#job_order").select2("destroy");

                    var option = "<option value='' disabled>Select Job Order</option>";
                    $.each(data.projects, function (index, value) {
                        option += "<option value='" + value.proj_id + "'>" + value.proj_project_name + "</option>";

                    });
                    jQuery("#job_order").html(" ");
                    jQuery("#job_order").append(option);
                    jQuery("#job_order").select2();
                }
            });
        });

        jQuery("#job_order").change(function () {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    var options = "<option value='' selected>Select Product Code</option>";
                    var option = "<option value='' selected>Select Product Name</option>";
                    $.each(data.products, function (index, value) {

                    option +="<option value='"+value.pro_p_code+ "' data-parent='" +value.pro_p_code+ "' data-sale_price='" +value.pro_sale_price+"' data-tax='" +value.pro_tax+
                "'data-retailer_dis='"+value.pro_retailer_discount+"' data-whole_saler_dis='"+value.pro_whole_seller_discount+"' data-loyalty_dis='"+value.pro_loyalty_card_discount+
                "'data-unit='"+value.unit_title+"'>"+value.pro_title+"</option>";

                    options +="<option value='"+value.pro_p_code+ "' data-parent='" +value.pro_p_code+ "' data-sale_price='" +value.pro_sale_price+"' data-tax='" +value.pro_tax+
                "'data-retailer_dis='"+value.pro_retailer_discount+"' data-whole_saler_dis='"+value.pro_whole_seller_discount+"' data-loyalty_dis='"+value.pro_loyalty_card_discount+
                "'data-unit='"+value.unit_title+"'>"+value.pro_p_code+"</option>";
