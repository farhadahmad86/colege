...
{{--        </thead>--}}
{{--        <tbody>--}}
{{--        @forelse ($grids as $index => $grid)--}}
{{--            <tr>--}}
{{--                <th>{{ $index + 1 }}</th>--}}
{{--                <td>{{ $grid->name }}</td>--}}
{{--                <td>{{ $grid->manager }}</td>--}}
{{--                <td>{{ $grid->contact }}</td>--}}
{{--                <td>{{ $grid->city->name }}</td>--}}
{{--                <td>{{ $grid->zone->name }}</td>--}}
{{--                <td>{{ $grid->region->name }}</td>--}}
{{--                <td>{{ $grid->company->name }}</td>--}}
{{--                <td>{{ $grid->status }}</td>--}}
{{--                <td>--}}
{{--                    <a href="{{ route('grids.edit', $grid) }}" class="btn btn-sm btn-warning d-inline"><i class="fa fa-edit"></i></a>--}}
{{--                    <form action="{{ route('grids.destroy', $grid) }}" method="post" class="d-inline">--}}
{{--                        @csrf--}}
{{--                        @method('delete')--}}
...
{{--        @empty--}}
{{--            <tr>--}}
{{--                <th colspan="10" class="text-danger text-center font-weight-bold">No Grid Available</th>--}}
{{--            </tr>--}}
{{--        @endforelse--}}
{{--        </tbody>--}}
{{--    </table>--}}
        ...
        <table class="table table-sm" id="fixTable">
            ...
            @forelse($grids as $index => $data)
                ...
                <tr data-title="{{$data->name}}" data-remarks="{{$data->remarks}}"
                    ...
                    <td>
                        <a href="{{ route('grids.edit', $data) }}" class="btn btn-sm btn-warning d-inline"><i class="fa fa-edit"></i></a>
                        <form action="{{ route('grids.destroy', $data) }}" method="post" class="d-inline">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-sm btn-danger d-inline"><i class="fa fa-trash"></i></button>
                        </form>
