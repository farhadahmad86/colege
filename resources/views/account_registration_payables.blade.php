            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                    ...
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white get-heading-text">Supplier Registration</h4>
                            </div>
                            <div class="list_btn">
                                <a class="btn list_link add_more_button" href="{{ route('account_receivable_payable_simple_list') }}" role="button">
                    ...
                    <div class="excel_con gnrl-mrgn-pdng gnrl-blk">
                        <div class="excel_box gnrl-mrgn-pdng gnrl-blk">
                            ...
                            <div class="excel_box_content gnrl-mrgn-pdng gnrl-blk">
                                ...
                                <form action="{{ route('submit_payables_account_excel') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="input_bx"><!-- start input box -->
                                                ...
                                                <input tabindex= "-1" type="hidden" name="head_code_excel" value="{{config('global_variables.payable')}}" >
                                                <input tabindex="100" type="file" name="add_client_excel" id="add_client_excel" class="inputs_up form-control-file form-control height-auto"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                                            <a href="{{ url('public/sample/supplier/add_suplier_pattern.xlsx') }}" tabindex="-1" type="reset" class="cancel_button btn btn-sm btn-info">
                    ...
                    <form name="f1" class="f1 mx-auto col-lg-12 col-md-12 col-sm-12 col-xs-12" id="f1" action="{{ route('submit_payables_account') }}" onsubmit="return checkForm()" method="post">
                        @csrf
                                ...
                                <div class="pd-20 bg-white border-radius-4 box-shadow">
                                    <div class="tab">
                                        <ul class="nav nav-tabs customtab double_line_tab" role="tablist">
                                            <li class="nav-item">
                                                <a tabindex= 1 autofocus class="nav-link active text-blue" data-toggle="tab" href="#personal"
                                                   role="tab" aria-selected="true">Personal Info</a>
                                            </li>
                                            <li class="nav-item">
                                                <a tabindex= "-1" class="nav-link text-blue" data-toggle="tab" href="#business" role="tab"
                                                   aria-selected="false">Business Info</a>
                                            </li>
                                            <li class="nav-item">
                                                <a tabindex= "-1" class="nav-link text-blue" data-toggle="tab" href="#credentials" role="tab"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="required">
                                                                    ...
                                                                    Select Region
                                                                    {{-- <a href="{{ route('add_region') }}" class="add_btn" target="_blank">--}}
                                                                    {{--     <l class="fa fa-plus"></l> Add--}}
                                                                    {{-- </a>--}}
                                                                    {{-- <a id="refresh_region" class="add_btn" style="margin-right: 50px;width:65px">--}}
                                                                    {{--   <l class="fa fa-refresh"></l> Refresh--}}
                                                                    {{-- </a>--}}

                                                                </label>
                                                                <select tabindex= "1" autofocus class="inputs_up form-control" name="region" id="region" data-rule-required="true"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="required">
                                                                    ...
                                                                    Select Area
                                                                    {{--<a href="{{ route('add_area') }}" class="add_btn" target="_blank">--}}
                                                                    {{--    <l class="fa fa-plus"></l> Add--}}
                                                                    {{--</a>--}}
                                                                    {{--<a id="refresh_area" class="add_btn" style="margin-right: 50px;width:65px">--}}
                                                                    {{--    <l class="fa fa-refresh"></l> Refresh--}}
                                                                    {{--</a>--}}
                                                                </label>
                                                                <select tabindex= "2" class="inputs_up form-control" name="area" id="area" data-rule-required="true" data-msg-required="Please Enter
                                                                Area Title">
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="required">
                                                                    ...
                                                                    Select Sector
                                                                    <a href="{{ route('add_sector') }}" class="add_btn" target="_blank" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                                        <l class="fa fa-plus"></l>
                                                                    </a>
                                                                    <a id="refresh_sector" class="add_btn" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.refresh.description')}}">
                                                                        <l class="fa fa-refresh"></l>
                                                                    </a>
                                                                </label>

                                                                <select tabindex= "3" class="inputs_up form-control" name="sector" id="sector"  data-rule-required="true" data-msg-required="Please
                                                                Enter Sector Title">
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="required">
                                                                    ...
                                                                    Select Town
                                                                    <a href="{{ route('add_town') }}" class="add_btn" target="_blank" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                                        <l class="fa fa-plus"></l>
                                                                    </a>
                                                                    <a id="refresh_town" class="add_btn" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.refresh.description')}}">
                                                                        <l class="fa fa-refresh"></l>
                                                                    </a>
                                                                </label>
                                                                <select tabindex= "4" class="inputs_up form-control" name="town" id="town"  data-rule-required="true" data-msg-required="Please Enter
                                                                 Town Title">
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="required">
                                                                    ...
                                                                    <a id="refresh_reporting_group" class="add_btn" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.refresh.description')}}">
                                                                        <l class="fa fa-refresh"></l>
                                                                    </a>
                                                                </label>
                                                                <select tabindex= "5" name="group" id="group" class="inputs_up form-control"  data-rule-required="true" data-msg-required="Please
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="required">
                                                                    ...
                                                                    Account Title</label>
                                                                <input tabindex= "6" type="text" name="account_name" id="account_name" class="inputs_up form-control" data-rule-required="true"
                                                                       data-msg-required="Please Enter Account Title"
                                                                       placeholder="Account Title" value="{{old('account_name')}}" onblur="check_name()" autocomplete="off">

                                                                <input tabindex= "-1" type="hidden" name="head_code" value="{{config('global_variables.payable')}}" >
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                ...
                                                                <input tabindex= "7" type="text" name="account_urdu_name" id="account_urdu_name" class="inputs_up form-control ur"
                                                                       data-rule-required="true" data-msg-required="Please Enter Account Title"
                                                                       placeholder="Account Title In Urdu" value="{{old('account_urdu_name')}}" onblur="check_name()" autocomplete="off">
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                                                            <div class="input_bx"><!-- start input box -->
                                                                ...
                                                                <select tabindex= "8" name="sale_person" id="sale_person" class="inputs_up form-control">
                                                                    <option value="">Select Purchaser</option>
                                                                    @foreach($sale_persons as $sale_person)
                                                                        <option value="{{$sale_person->user_id}}" {{ $sale_person->user_id == old('sale_person') ? 'selected="selected"' : '' }}>{{$sale_person->user_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                                {{--                                    <span id="demo5" class="validate_sign"> </span>--}}
                                                            </div><!-- end input box -->
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="">
                                                                    ...
                                                                    Remarks</label>
                                                                <input tabindex= "9" type="text" name="remarks" id="remarks" class="inputs_up form-control"
                                                                       placeholder="Remarks" value="{{old('remarks')}}" autocomplete="off">
                                                                <span id="demo5" class="validate_sign"> </span>
                                                            </div><!-- end input box -->
                                                        </div>
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label>
                                                                    ...
                                                                    CNIC</label>
                                                                <input tabindex= "10" type="text" name="cnic" id="cnic" class="inputs_up cnic form-control"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12" hidden>
                                                            <div class="input_bx"><!-- start input box -->
                                                                ...
                                                                <input tabindex= "13" type="number" name="opening_balance" id="opening_balance" class="inputs_up cnic form-control"
                                                        ...
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="">
                                                                    ...
                                                                    Address</label>
                                                                <input tabindex= "11" type="text" name="address" id="address" class="inputs_up form-control" placeholder="Address"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="required">
                                                                    ...
                                                                    Mobile</label>
                                                                <input tabindex= "12" type="text" name="mobile" id="mobile" class="inputs_up form-control" placeholder="Mobile No."
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label>
                                                                    ...
                                                                    WhatsApp</label>
                                                                <input tabindex= "13" type="text" name="whatsapp" id="whatsapp" class="inputs_up form-control" placeholder="WhatsApp"
                                                        ...
                                                        {{--    </div><!-- end input box -->--}}
                                                        {{--</div>--}}
                                                        <div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12" style="display: none">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <div class="row">
                                                                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                                        <label class="required">
                                                                            ...
                                                                            Credit Limit</label>
                                                                        <input tabindex= "-1" type="text" name="credit_limit" id="credit_limit"
                                                                               class="inputs_up form-control" value="{{old('credit_limit')}}" placeholder="Credit Limit" onkeypress="return allow_only_number_and_decimals(this,event);">
                                                                        <label id="demo100" class="error validate_sign"></label>
                                                                    </div>
                                                                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                                        <div class="custom-checkbox">
                                                                            <input tabindex= "-1" type="checkbox" name="unlimited" id="unlimited" value="1"
                                                                                   class="custom-control-input company_info_check_box" checked>
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                ...
                                                                <div class="custom-control custom-radio mb-10 mt-1">
                                                                    <input tabindex= "-1" type="radio" name="discountType" class="custom-control-input religion" id="discountType1" value="1" checked="">
                                                                    <label class="custom-control-label" for="discountType1">
                                                                        None
                                                                    </label>
                                                                </div>
                                                                <div class="custom-control custom-radio mb-10 mt-1">
                                                                    <input tabindex= "-1" type="radio" name="discountType" class="custom-control-input religion" id="discountType2" value="2">
                                                                    <label class="custom-control-label" for="discountType2">
                                                                        Retailer
                                                                    </label>
                                                                </div>
                                                                <div class="custom-control custom-radio mb-10 mt-1">
                                                                    <input tabindex= "-1" type="radio" name="discountType" class="custom-control-input religion" id="discountType3" value="3">
                                                                    <label class="custom-control-label" for="discountType3">
                                                                        Wholesaler
                                                                    </label>
                                                                </div>
                                                                <div class="custom-control custom-radio mb-10 mt-1">
                                                                    <input tabindex= "-1" type="radio" name="discountType" class="custom-control-input religion" id="discountType4" value="4">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label class="">
                                                                    ...
                                                                    Business Name</label>
                                                                <input tabindex= "17" autofocus type="text" name="print_name" id="print_name" class="inputs_up print_name form-control"
                                                                       placeholder="Business Name" value="{{old('print_name')}}" autocomplete="off">
                                                            </div><!-- end input box -->
                                                        </div>
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label>
                                                                    ...
                                                                    Proprietor</label>
                                                                <input tabindex= "18" type="text" name="proprietor" id="proprietor" class="inputs_up form-control"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label>
                                                                    ...
                                                                    Company Code</label>
                                                                <input tabindex= "19" type="text" name="co_code" id="co_code" class="inputs_up form-control" placeholder="Company Code"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label>
                                                                    ...
                                                                    Phone</label>
                                                                <input tabindex= "20" type="text" name="phone" id="phone" class="inputs_up form-control" placeholder="Phone"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label>
                                                                    ...
                                                                    GST</label>
                                                                <input tabindex= "21" type="text" name="gst" id="gst" class="inputs_up form-control number" placeholder="GST"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                <label>
                                                                    ...
                                                                    NTN</label>
                                                                <input tabindex= "22" type="text" name="ntn" id="ntn" class="inputs_up form-control number" placeholder="NTN"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input_bx"><!-- start input box -->
                                                                ...
                                                                <input tabindex= "23" type="text" name="page_no" id="page_no" class="inputs_up form-control" placeholder="Manual Ledger Number"
...
{{--                                                        </div>--}}
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                                        ...
                                        {{--                                        </button>--}}
                                        <button tabindex= "25" type="submit" name="save" id="save" class="save_button btn btn-sm btn-success"
                                        >
                                            <i class="fa fa-floppy-o"></i> Save
                                        </button>
                                    </div>
                        ...
                        {{--<div class="form-group row">
                            <div class="col-lg-12 col-md-12 col-sm-12 form_controls">
                                ...
                                <button tabindex= "26" type="submit" name="save" id="save" class="save_button btn btn-sm btn-success" onclick="return validate_form()">
                                    <i class="fa fa-floppy-o"></i> Save
                                </button>
                            </div>
                        </div>--}}
...
{{-- end of required input validation --}}
    ...
    <script>
        ...
        function check_name() {
            ...
            var head_code = '{{config('global_variables.payable')}}';
