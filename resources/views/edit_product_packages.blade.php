            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white get-heading-text">Product Packages</h4>
                            </div>
                            <div class="list_btn">
                    ...
                    <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
                        <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                            ...
                            <form name="f1" class="f1" id="f1" action="{{ route('update_product_packages') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                                @csrf
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                            ...
                                            <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input"><!-- invoice column input start -->
                                                        <input type="text" name="package_name" class="inputs_up form-control" id="package_name"
                                                               data-rule-required="true" data-msg-required="Please Enter Package Name"
                                                               placeholder="Package Name" value="{{$product_package->pp_name}}">
                                            ...
                                            <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input"><!-- invoice column input start -->
                                                        <input type="text" name="remarks" class="inputs_up form-control" id="remarks" value="{{$product_package->pp_remarks}}" placeholder="Remarks" />
                                                    </div><!-- invoice column input end -->
                                                </div><!-- invoice column box end -->
                                            </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_row"><!-- invoice row start -->
                                           ...
                                           <div class="invoice_col basis_col_6"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input"><!-- invoice column input start -->
                                                        <input type="text" name="scale_size" class="inputs_up text-right form-control" id="scale_size" placeholder="Scale Size" onfocus="this.select
                                                        ();"
                                                               onkeyup="product_amount_calculation();" onkeypress="return allowOnlyNumber(event);" readonly/>
                                                    </div><!-- invoice column input end -->
                                                </div><!-- invoice column box end -->
                                            </div><!-- invoice column end -->
                                           ...
                                           <div class="invoice_col basis_col_6"><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input"><!-- invoice column input start -->
                                                        <input type="text" name="uom" class="inputs_up text-right form-control" id="uom" placeholder="UOM" onfocus="this.select();"
                                            ...
                                            <div class="invoice_col basis_col_11 hidden" hidden><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input"><!-- invoice column input start -->
                                                        <input type="text" name="product_sales_tax" class="inputs_up text-center form-control" id="product_sales_tax" placeholder="Sale Tax %" onkeyup="product_amount_calculation();" onkeypress="return allow_only_number_and_decimals(this,event);">
                                                    </div><!-- invoice column input end -->
                                                </div><!-- invoice column box end -->
                                            </div><!-- invoice column end -->
                                            ...
                                            <div class="invoice_col basis_col_11 hidden" hidden><!-- invoice column start -->
                                                <div class="invoice_col_bx"><!-- invoice column box start -->
                                                    ...
                                                    <div class="invoice_col_input"><!-- invoice column input start -->
                                                        <input type="text" name="product_discount" class="inputs_up text-right form-control" id="product_discount" placeholder="Discount" onkeyup="product_amount_calculation();" onkeypress="return allow_only_number_and_decimals(this,event);">
                                                    </div><!-- invoice column input end -->
                                                </div><!-- invoice column box end -->
                                            </div><!-- invoice column end -->
                                                            ...
                                                            <div class="pro_tbl_bx"><!-- product table box start -->
                                                                <table class="table gnrl-mrgn-pdng" id="category_dynamic_table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center tbl_txt_22"> Title</th>
                                                                        <th class="text-center tbl_txt_50"> Transaction Remarks</th>
                                                                        <th class="text-center tbl_txt_6"> Qty</th>
                                                                        <th class="text-center tbl_txt_6"> Scale Size</th>
                                                                        <th class="text-center tbl_txt_6"> UOM</th>
                                                                        <th class="text-center tbl_txt_6"> Rate</th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center tbl_srl_12">
                                                                            <div class="invoice_col_txt"><!-- invoice column box start -->
                                                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                                                    <input type="text" name="total_price" class="inputs_up text-right form-control" id="total_price"
                                                                                           data-rule-required="true" data-msg-required="Please Add"
                                                                                           placeholder="0.00" readonly>
                                                                                </div><!-- invoice column input end -->
                                                                            </div><!-- invoice column box end -->
                                ...
                                <input type="hidden" name="package_id" id="package_id" value="{{$product_package->pp_id}}">
    ...
    <script>
        ...
        function add_sale() {
            ...
            if (flag_submit1) {
                ...
                jQuery("#table_body").prepend('<tr id=' + counter + ' class="edit_update"><td class="text-center tbl_srl_9">' + selected_code_value + '</td><td class="text-left tbl_txt_22">' +
                    product_name + '</td><td class="text-left tbl_txt_50">' + remarks_var + '</td><td class="text-right tbl_txt_6">' + qty + '</td><td class="text-right tbl_txt_6">' + selected_scale_size +
                    '</td><td class="text-right tbl_txt_6">' + selected_uom + '</td><td class="text-right tbl_txt_6">' + selected_rate + '</td><td class="text-right tbl_srl_12">' + selected_amount + '<div ' +
                    'class="edit_update_bx"><a class="edit_link btn btn-sm btn-success" href="#" onclick=edit_sale(' + counter + ')><i class="fa fa-edit"></i></a><a href="#" class="delete_link btn btn-sm btn-danger" onclick=delete_sale(' + counter + ')><i class="fa fa-trash"></i></a></div></td></tr>');
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        var product_name = value['ppi_product_name'];
                        var qty = value['ppi_qty'];
                        var selected_remarks = value['ppi_remarks'];
                        var selected_scale_size = value['ppi_scale_size'];
                        var selected_uom = value['ppi_uom'];
                        var selected_rate = value['ppi_rate'];
                        var selected_amount = value['ppi_amount'];
                        ...
                        jQuery("#table_body").prepend('<tr id=' + counter + ' class="edit_update"><td class="text-center tbl_srl_9">' + selected_code_value + '</td><td class="text-left ' +
                            'tbl_txt_22">' + product_name + '</td><td class="text-left tbl_txt_50">' + remarks_var + '</td><td class="text-right tbl_txt_6">' + qty + '</td><td class="text-right ' +
                            'tbl_txt_6">' + selected_scale_size + '</td><td class="text-right tbl_txt_6">' + selected_uom + '</td><td class="text-right tbl_txt_6">' + selected_rate + '</td><td ' +
                            'class="text-right tbl_srl_12">' + selected_amount + '<div class="edit_update_bx"><a class="edit_link btn btn-sm btn-success" href="#" onclick=edit_sale(' + counter + ')><i class="fa fa-edit"></i></a><a href="#" class="delete_link btn btn-sm btn-danger" onclick=delete_sale(' + counter + ')><i class="fa fa-trash"></i></a></div></td></tr>');
                        jQuery("#salesval").val(JSON.stringify(sales));
