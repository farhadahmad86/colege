...
@section('content')
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage" id="">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text file_name">Sale Tax Purchase Invoice List</h4>
                    </div>
            ...
            <form class="highlight prnt_lst_frm" action="{{ route('sale_tax_purchase_invoice_list') }}" name="form1" id="form1" method="post">
                @csrf
                <div class="row">
    ...
    <x-add-button tabindex="9" href="{{ route('simple_purchase_tax_invoice') }}"/>
                    ...
                    @forelse($datas as $invoice)
                        ...
                        <tr>
                            ...
                            <td nowrap class="tbl_amnt_9">
                                {{date('d-M-y', strtotime(str_replace('/', '-', $invoice->psi_day_end_date)))}}
                            </td>
                            <td class=" view tbl_amnt_6" data-id="{{$invoice->psi_id}}">
                                STPI-{{$invoice->psi_id}}
                            </td>
                            ...
                            <td class="align_left text-left tbl_txt_25">
                                {!! str_replace("&oS;",'<br />', $invoice->psi_detail_remarks) !!}
                            </td>
                            @php
                                $ttlPrc = +($invoice->psi_grand_total) + +$ttlPrc;
                            @endphp
                            <td class="align_right text-right tbl_amnt_5">
                                {{$invoice->psi_grand_total !=0 ? number_format($invoice->psi_grand_total,2):''}}
                            </td>
                            ...
                            @php
                                $ip_browser_info= ''.$invoice->psi_ip_adrs.','.str_replace(' ','-',$invoice->psi_brwsr_info).'';
                            @endphp
            ...
            <div class="modal-content base_clr">
                ...
                <div class="modal-footer">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form_controls">
                            <button type="button" class="btn btn-default btn-sm cancel_button" data-dismiss="modal">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('sale_tax_purchase_invoice_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            $('.modal-body').load('{{ url('simple_purchase_items_sale_tax_view_details/view/') }}' + '/' + id, function () {
