        ...
        <div class="container-fluid search-filter form-group form_manage">
            ...
            <div id="invoice_con" class="invoice_con for_voucher">
                ...
                <div id="invoice_bx" class="invoice_bx show_scale show_rotate">
                    <!-- invoice box start -->
                    <form id="f1" action="{{ route('submit_cash_payment_voucher') }}" method="post"
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                ...
                                <div class="invoice_row">
                                    ...
                                    {{-- <x-account-name-component tabindex="4" name="account_name"
                                        class="cash_voucher" id="account_name" title="Account Name"
                                        href="account_registration" body="0" />
                                {{-- </div> --}}
                                    <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12" hidden>
                                        ...
                                        <div class="table-responsive pro_tbl_bx">
                                            ...
                                            <table tabindex="-1" class="table table-bordered table-sm"
                                                ...
                                                <tr>
                                                    ...
                                                    <th tabindex="-1" class="tbl_srl_20">Title</th>
                                                    <th tabindex="-1" class="tbl_srl_20">Posting Reference</th>
                                                    <th tabindex="-1" class="tbl_srl_38">Transaction Remarks</th>
                                                ...
                                                <tbody id="table_body">
                                                <tr>
                                                    <td tabindex="-1" colspan="10">No Account Added</td>
                                                </tr>
                                                </tbody>

                                                <tfoot>
                                                <tr>
                                                    <th tabindex="-1" colspan="3" class="text-right">Total</th>
                                                    <td class="tbl_srl_12">
                ...
                <div class="modal-footer">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form_controls">
                            <button tabindex="-1" type="button" class="btn btn-sm btn-secondary cancel_button"
                                    data-dismiss="modal">
                                <i class="fa fa-times"></i> Cancel
                            </button>
                        </div>
