    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Cash Receipt Voucher</h4>
                    </div>
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button"
                           href="{{ route('cash_receipt_voucher_list') }}" role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                ...
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    <!-- invoice box start -->
                    <form id="f1" action="{{ route('submit_cash_receipt_voucher') }}" method="post"
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="invoice_col from_group col-lg-3 col-md-4 col-sm-12">
                                        <x-account-name-component tabindex="1" name="account" class="cash_voucher"
                                                                  id="account" title="Cash Account"
                                                                  href="account_registration"
                                                                  body="1"/>
                                    </div>

                                    <!-- use remarks-component make remarks text field  -->
                                    <div class="invoice_col from_group col-lg-3 col-md-4 col-sm-12">
                                ...
                                <div class="invoice_row">
                                    ...
                                    <!-- use account-name-component  make cash account dropdown                                                                                         here use class cash_voucher for get backend query cash account                                                                                        body="0" use for the query and get the index 0  cash accounts  -->

                                    <div class="invoice_col basis_col_12" hidden>
                                        <!-- invoice column start -->

                                        <x-account-name-component tabindex="3" name="account_code" class="cash_voucher"
                                    ...
                                    <div class="invoice_col from_group col-lg-3 col-md-4 col-sm-12">
                                        <!-- invoice column -->
                                        <x-account-name-component tabindex="4" name="account_name" class="cash_voucher"
                                                                  id="account_name" title="Account Name"
                                                                  href="receivables_account_registration"
                                                                  body="0"/>
                                    </div>

                                    <!-- use posting-reference-component                                                                                                                      make posting-reference dropdown  -->
...
@section('scripts')
    ...
    <script>
        ...
        function add_account() {
            ...
            if (account_code == 0 || account_code == "0") {
            ...
            if (status == "park" || status == 'post') {
                ...
                document.getElementById('error_status').innerHTML = "Select Voucher Type";
                flag_submit1 = false;
            }

            if (account_name == 0 || account_name == "0") {
