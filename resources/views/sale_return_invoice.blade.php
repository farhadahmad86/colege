            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx"><!-- invoice box start -->
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_sale_return_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                            @csrf
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_bx_scrl"><!-- invoice scroll box start -->
                                <div class="container-fluid search-filter invoice_cntnt"><!-- invoice content start -->
                                    ...
                                    <div class="invoice_row row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_22"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input tabindex="2" type="text" name="customer_name" class="inputs_up form-control" id="customer_name" placeholder="Party Reference">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_col basis_col_22"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
{{--                                                    Hamad set tab index--}}
                                                    <select tabindex="3" name="posting_reference" class="inputs_up form-control js-example-basic-multiple"
                                        ...
                                        <div class="invoice_col basis_col_30"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class=" invoice_col_ttl"><!-- invoice column title start -->
                                                    <a
                                        ...
                                        <div class="invoice_col basis_col_25_2"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    ...
                                                    <div class="invoice_col_short"><!-- invoice column short start -->
                                                        <a href="{{ url('product_packages') }}" class="col_short_btn" target="_blank" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                            <l class="fa fa-plus"></l>
                                                        </a>
                                                        <a id="refresh_package" class="col_short_btn" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.refresh.description')}}">
                                                            <l class="fa fa-refresh"></l>
                                                        </a>
                                                    </div><!-- invoice column short end -->
{{--                                                    Hamad set tab index--}}
                                        ...
                                        <div class="invoice_col basis_col_25_5"><!-- invoice column start -->
                                            <x-warehouse-component tabindex="8" name="warehaouse" id="warehouse" class="refresh_warehouse"/>
                                        </div>
                                    ...
                                    <div class="invoice_row row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt payment_div" style="display: none"><!-- invoice column input start -->
                                        ...
                                        <div class="invoice_col basis_col_23 payment_div" style="display: none"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                       data-placement="bottom" data-html="true"
...
// alert('warehouse');
    ...
    <script>
        ...
        function unit_rate_changed_live(id){
            ...
            var pack_rate_piece = ( jQuery("#rate_per_pack" + id).val() !== 0 || jQuery("#rate_per_pack" + id).val() !== "NaN" || jQuery("#rate_per_pack" + id).val() !== "" ) ? jQuery
        ...
        function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="text-center tbl_srl_4">' +
                '<input type="text" name="rate_per_pack[]" onkeyup="unit_rate_changed_live(' + counter + ')" class="inputs_up_tbl" id="rate_per_pack' + counter + '" placeholder="Rate Per Pack" ' +
