            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white get-heading-text">Update Product Group</h4>
                            </div>
                        </div>
                    </div><!-- form header close -->

                    <form name="f1" class="f1" id="f1" action="{{ route('update_product_group') }}" onsubmit="return checkForm()" method="post">
                        @csrf
                        <div class="row">
                                        ...
                                        <div class="input_bx"><!-- start input box -->
                                            <label class="required">
                                                <a
                                                    ...
                                                    data-placement="bottom" data-html="true" data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.new.Product_Reporting_Group.Product_Handling_Group_Title.description')}}</p>
...
<h6>Example</h6><p>{{config('fields_info.about_form_fields.new.Product_Reporting_Group.Product_Handling_Group_Title.example')}}</p>">
                                            ...
                                            <input type="text" name="group_name" id="group_name" class="inputs_up form-control"
                                                   ...
                                                   placeholder="Product Handling Group Title" autofocus value="{{$request->title}}" autocomplete="off"/>
