    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text">Claim Stock Issue To Party </h4>
                    </div>
                    <div class="list_btn">
                        <a class="btn list_link add_more_button" href="{{ route('claim_stock_issue_to_party_list') }}" role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher">
                ...
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    <!-- invoice box start -->
                    <form name="f1" class="f1" id="f1" action="{{ route('submit_claim_stock_issue_to_party') }}" onsubmit="return checkForm()" method="post">
                        @csrf
                        <div class="invoice_bx_scrl">
                            ...
                            <div class="invoice_cntnt">
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="invoice_col form-group col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                            ...
                                            <div class="invoice_col_input">
                                                ...
                                                <input tabindex="2" type="text" name="purchase_invoice" class="inputs_up form-control" id="purchase_invoice" placeholder="Purchase Invoice #"
                                                        value="{{old('purchase_invoice')}}" onkeypress="return allow_only_number_and_decimals(this,event);">
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12">
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="invoice_col_input">
                                                <!-- invoice column input start -->
                                                <input tabindex="3" type="text" name="sale_return_invoice" class="inputs_up form-control" id="sale_return_invoice" placeholder="Sale Return Invoice"
                                                        value="{{old('sale_return_invoice')}}" onkeypress="return allow_only_number_and_decimals(this,event);">
                                                <span id="demo7" class="validate_sign"></span>
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    </div><!-- invoice column end -->
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12">
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="invoice_col_input">
                                                <!-- invoice column input start -->
                                                {{-- hamad set tab index--}}
                                                <input tabindex="5" type="text" name="remarks" class="inputs_up form-control" id="remarks" placeholder="Remarks" value="{{old('remarks')}}"
                                                        data-rule-required="true" data-msg-required="Please Enter Voucher Remarks">
                                                <span id="demo7" class="validate_sign"></span>
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    </div><!-- invoice column end -->
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12">
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="invoice_col_input">
                                                ...
                                                {{-- Hamad set tab index--}}
                                                <select tabindex="6" name="product_code" class="inputs_up form-control" id="product_code">
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12">
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="invoice_col_input">
                                                ...
                                                <select tabindex="7" name="product_name" class="inputs_up form-control" id="product_name">
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12">
                                        <!-- invoice column start -->
                                        <x-remarks-component tabindex="8" name="product_remarks" id="product_remarks" title="Product Remarks"/>
                                    </div>

                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12">
                                        <!-- invoice column start -->
                                        <x-warehouse-component tabindex="9" name="warehouse" id="warehouse" class="refresh_warehouse" title="Warehouse"/>
                                    </div>

                                    <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12">
                                        <!-- invoice column start -->
                                        <div class="invoice_col_bx">
                                            <!-- invoice column box start -->
                                            <div class="required invoice_col_ttl">
                                            ...
                                            <div class="invoice_col_input">
                                                <!-- invoice column input start -->
                                                <input tabindex="10" type="text" name="quantity" class="inputs_up form-control" value="{{old('quantity')}}" id="quantity"
                                                        placeholder="Qty" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);">
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    </div><!-- invoice column end -->

                                    <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12" hidden>
                                        <!-- invoice column start -->
                                        <div class="invoice_col_bx">
                                            <!-- invoice column box start -->
                                            <div class="required invoice_col_ttl">
                                            ...
                                            <div class="invoice_col_input">
                                                <!-- invoice column input start -->
                                                <input tabindex="10" type="text" name="scale_size" class="inputs_up form-control" value="{{old('scale_size')}}" id="scale_size"
                                                        placeholder="Scale Size" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);">
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    </div><!-- invoice column end -->
                                    ...
                                    <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12" hidden>
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="invoice_col_input">
                                                <!-- invoice column input start -->
                                                <input tabindex="10" type="text" name="uom" class="inputs_up form-control" value="{{old('uom')}}" id="uom" placeholder="UOM"
                                    ...
                                    <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12">
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="invoice_col_input">
                                                <!-- invoice column input start -->
                                                <input tabindex="11" type="text" name="rate" class="inputs_up text-right form-control" id="rate" value="{{old('rate')}}" placeholder="Rate"
                                                        onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);">
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    </div><!-- invoice column end -->
                                    ...
                                    <div class="invoice_col form-group col-lg-1 col-md-3 col-sm-12">
                                        ...
                                        <div class="invoice_col_bx">
                                            ...
                                            <div class="invoice_col_input">
                                                <!-- invoice column input start -->
                                                <input tabindex="12" type="text" name="amount" class="inputs_up text-right form-control" id="amount" placeholder="Amount" value="{{old('amount')}}"
                                                        readonly>
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_col_txt for_voucher_col_bx">
                                            ...
                                            <div class="invoice_col_txt with_cntr_jstfy">
                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                    <button tabindex="14" style="display: none;" id="cancel_button" class="invoice_frm_btn btn btn-sm btn-secondary" onclick="cancel_all()" type="button">
                                                        <i class="fa fa-times"></i> Cancel
                                                    </button>
                                                </div>
                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                    <button tabindex="13" id="first_add_more" class="invoice_frm_btn btn btn-sm btn-info" onclick="add_product()" type="button">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tbl_srl_12">
                                                        <div class="invoice_col_txt">
                                                            ...
                                                            <div class="invoice_col_input">
                                                                <!-- invoice column input start -->
                                                                <input type="text" name="total_price" class="inputs_up text-right form-control grand-total-field" id="total_price"
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="invoice_col col-lg-12">
                                        ...
                                        <div class="invoice_col_txt with_cntr_jstfy for_voucher_btns">
                                            <!-- invoice column box start -->
                                            <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                <button tabindex="14" type="submit" name="save" id="save" class="invoice_frm_btn btn btn-sm btn-success">
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            let party_claim_account = document.getElementById("party_claim_account")
                , remarks = document.getElementById("remarks")
                , total_items = document.getElementById("total_items");
            validateInputIdArray = [
                party_claim_account.id
                , remarks.id
                , total_items.id
                ,];
    ...
    <script>
        ...
        jQuery("#refresh_party_claim").click(function () {
            ...
            jQuery.ajax({
                ...
                , success: function (data) {
                    ...
                    jQuery("#party_claim_account").html(" ");
                    jQuery("#party_claim_account").append(data);
                }
    ...
    <script>
        ...
        function add_product() {
            ...
            if (flag_submit1) {
                ...
                var warehouse_val = jQuery("#warehouse").val();
                ...
                jQuery("#table_body").append(
                    '<tr id=' + counter + ' class="edit_update"><td class="tbl_srl_9">' + selected_code_value + '</td><td class="text-left tbl_txt_20">' + product_name + '</td><td class="text-left tbl_txt_44">' + selected_remarks + '</td><td class="text-left tbl_txt_20">' + warehouse_name + '</td><td class="text-right tbl_srl_6">' + qty + '</td><td class="text-right tbl_srl_12" >' + selected_rate + '</td><td class="text-right tbl_srl_12">' + selected_amount + '<div class="edit_update_bx"><a class="edit_link btn btn-sm btn-success" href="#" onclick=edit_product(' + counter + ')><i class="fa fa-edit"></i></a> <a href="#" class="delete_link btn btn-sm btn-danger" onclick=delete_product(' + counter + ')><i class="fa fa-trash"></i></a></div></td></tr>');
        ...
        function edit_product(current_item) {
            ...
            jQuery("#scale_size").val(temp_products['product_scale_size']);
            jQuery("#uom").val(temp_products['product_uom']);
