        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                ...
                <div class="wizard-content">
                    <form class="tab-wizard wizard-circle wizard" id="f1" action="{{ route('update_product_recipe') }}" method="post"
                    >
                        @csrf
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <input type="text" name="recipe_name" class="inputs_up form-control required" id="recipe_name" placeholder="Recipe Name"  data-rule-required="true" data-msg-required="Please Enter Recipe Name" value="{{ ( isset($product_recipe) && !empty($product_recipe) ) ? $product_recipe->pr_name : ''}}">
                                                ...
                                                <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <input type="text" name="recipe_remarks" class="inputs_up form-control" id="recipe_remarks" placeholder="Recipe Remarks" value="{{ ( isset($product_recipe) && !empty($product_recipe) ) ? $product_recipe->pr_remarks : ''}}">
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                </div><!-- invoice column end -->
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_12"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            ...
                                                            <select class="inputs_up form-control" id="pro_code" onchange="codeTitleChangeMethod(this, 'pro_title', 'pro_uom_raw')">
                                                ...
                                                <div class="invoice_col basis_col_19"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            ...
                                                            <select class="inputs_up form-control" id="pro_title" onchange="codeTitleChangeMethod(this, 'pro_code', 'pro_uom_raw')">
                                                ...
                                                <div class="invoice_col basis_col_11"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <input type="text" class="inputs_up text-right form-control" id="quantity" placeholder="Product Quantity" min="1" onkeypress="return allow_only_number_and_decimals(this,event);" />
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                </div><!-- invoice column end -->
                                                    ...
                                                    <div class="invoice_col_txt for_voucher_col_bx"><!-- invoice column box start -->
                                                        <div class="invoice_col_txt with_cntr_jstfy">
                                                            <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                                <button id="addInventoryForProductRecipe" class="invoice_frm_btn" data-method="create" onclick="addToCartForProductRecipe(this)" type="button">
                                                                    <i class="fa fa-plus"></i> Add
                                                                </button>
                                                            </div>
                                                            <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                                <button id="cancelInventoryForProductRecipe" class="invoice_frm_btn hide" data-method="cancel" onclick="addToCartForProductRecipe(this)" type="button">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center tbl_srl_12">
                                                                                <div class="invoice_col_txt"><!-- invoice column box start -->
                                                                                    <div class="invoice_col_input"><!-- invoice column input start -->
                                                                                        <input type="text" name="ttlQuantityForProductRecipe" class="inputs_up text-right form-control" id="ttlQuantityForProductRecipe" placeholder="0.00" data-rule-required="true" data-msg-required="Please Create Minimum One Inventory" readonly />
                                                                                    </div><!-- invoice column input end -->
                                                                                </div><!-- invoice column box end -->
                                                                            </td>
                                                                        </tr>
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <div class="invoice_col_short"><!-- invoice column short start -->
                                                                <a href="{{ url('add_product') }}" class="col_short_btn" target="_blank" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="{{config('fields_info.about_form_fields.add.description')}}">
                                                                    <i class="fa fa-plus"></i>
                                                                </a>
                                                            ...
                                                            <select name="primary_limited_product_code" class="inputs_up form-control required" id="primary_limited_product_code"  data-rule-required="true" data-msg-required="Please Enter Product Code" onchange="codeTitleChangeMethod(this, 'primary_limited_product_title', 'pro_uom_primary')">
                                                                <option value="" disabled selected>---Select Product Code--- Code</option>

                                                                @foreach ($products as $key=>$product)
                                                                    <option value='{{ $product->pro_p_code }}' data-code='{{ $product->pro_p_code }}' selected="{{ $getPrimary[0]->pro_code == $product->pro_p_code ? 'selected' : ''  }}">
                                                                        {{ $product->pro_p_code }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            ...
                                                            <select name="primary_limited_product_title" class="inputs_up form-control required" id="primary_limited_product_title" data-rule-required="true" data-msg-required="Please Enter Product Title" onchange="codeTitleChangeMethod(this, 'primary_limited_product_code', 'pro_uom_primary')">
                                                                <option value="" disabled selected>---Select Product Title---</option>
                                                                @foreach ($products as $key=>$product)
                                                                    <option value='{{ $product->pro_title }}' data-code='{{ $product->pro_p_code }}' selected="{{ $getPrimary[0]->pro_code == $product->pro_p_code ? 'selected' : ''  }}">
                                                                        {{ $product->pro_title }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="invoice_col basis_col_11"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <input type="text" name="primary_limited_product_quantity" class="inputs_up text-right form-control required" id="primary_limited_product_quantity" placeholder="Product Quantity" min="1" onkeypress="return allow_only_number_and_decimals(this,event);" value="{{ ( isset($getPrimary) && !empty($getPrimary) ) ? $getPrimary[0]->quantity : ''}}"/>
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                </div><!-- invoice column end -->
                                                ...
                                                <div class="invoice_col basis_col_6"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <input type="text" class="inputs_up text-center form-control" id="pro_uom_primary" name="pro_uom_primary" placeholder="Product UOM" readonly  value="{{ ( isset($getPrimary) && !empty($getPrimary) ) ? $getPrimary[0]->pro_uom : ''}}" />
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                </div><!-- invoice column end -->
                                                                    ...
                                                                    <table class="table gnrl-mrgn-pdng" id="category_dynamic_table">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center tbl_srl_12">
                                                                                <div class="invoice_col_txt"><!-- invoice column box start -->
                                                                                    <div class="invoice_col_input"><!-- invoice column input start -->
                                                                                        <input type="text" name="ttlQuantityForFinishedGoods" id="ttlQuantityForFinishedGoods" class="inputs_up text-right form-control required" placeholder="0.00" readonly  data-rule-required="true" data-msg-required="Please Create Minimum One Inventory"/>
                                                                                    </div><!-- invoice column input end -->
                                                                                </div><!-- invoice column box end -->
                                                                            </td>
                                                                        </tr>
                        ...
                        <input value="{{$product_recipe->pr_id}}" type="hidden" name="recipe_id">
