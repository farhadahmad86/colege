            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                    <div class="form_header"><!-- form header start -->
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-white get-heading-text file_name">Illustrated List</h4>
                            </div>
                    ...
                    <div class="search_form">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <form class="prnt_lst_frm" action="{{ route('illustrated_list') . ((isset($restore_list) && $restore_list == 1) ? '?restore_list=1' : '') }}" name="form1" id="form1" method="post">
                                    <div class="row">
                                        @csrf
...
{{--                                                    </label>--}}
                                        ...
                                        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form_controls text-left">
                                                ...
                                                <a tabindex="4" class="save_button form-control" href="{{ route('add_illustrated') }}" role="button">
                                                    <l class="fa fa-plus"></l> Illustrated
                                                </a>
                                ...
                                <form name="edit" id="edit" action="{{ route('edit_illustrated') }}" method="post">
                                    @csrf
                                    <input tabindex="5" name="title" id="title" type="hidden">
                                    <input tabindex="6" name="remarks" id="remarks" type="hidden">
                                    <input tabindex="7" name="illustrated_id" id="illustrated_id" type="hidden">

                                </form>

                                <form name="delete" id="delete" action="{{ route('delete_illustrated') }}" method="post">
                                    @csrf
                                    <input name="ill_id" id="ill_id" type="hidden">
                                </form>
                        ...
                        <table class="table table-sm" id="fixTable">
                            ...
                            @endphp
                                @forelse($datas as $data)
                                    ...
                                    <tr data-title="{{$data->ill_title}}" data-remarks="{{$data->ill_remarks}}" data-ill_id="{{$data->ill_id}}">
                                        ...
                                        @php
                                            $ip_browser_info= ''.$data->ill_ip_adrs.','.str_replace(' ','-',$data->ill_brwsr_info).'';
                                        @endphp
                                        ...
                                        <td class="align_right text-right hide_column tbl_amnt_6">
                                            <label class="switch">
                                                <input type="checkbox" <?php if ($data->ill_disabled == 0) {
                                                    echo 'checked="true"' . ' ' . 'value=' . $data->ill_disabled;
                                                } else {
                                                    echo 'value=DISABLE';
                                                } ?>  class="enable_disable" data-id="{{$data->ill_id}}"
                                                    {{ $data->ill_disabled == 0 ? 'checked' : '' }}>
                                                <span class="slider round"></span>
                                            </label>
                                        </td>

                                        <td class="align_right text-right hide_column tbl_srl_6">
                                            <a data-ill_id="{{$data->ill_id}}" class="delete"  data-toggle="tooltip" data-placement="left"  title="" data-original-title="Are you sure?">
                                                <i class="fa fa-{{$data->ill_delete_status == 1 ? 'undo':'trash'}}"></i>
                                            </a>
                                        </td>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('illustrated_list') }}',
            url;
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.enable_disable').change(function () {
                ...
                let illustrated_Id = $(this).data('id');
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{ route('enable_disable_illustrated') }}',
                    data: {'status': status, 'illustrated_id': illustrated_Id},
    ...
    <script>
        ...
        jQuery(".edit").click(function () {
            ...
            var illustrated_id = jQuery(this).parent('tr').attr("data-ill_id");
         ...
         $('.delete').on('click', function (event) {
                ...
                var ill_id = jQuery(this).attr("data-ill_id");
