        ...
        <div
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Create ImPrint</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('imPrint_list') }}" role="button">
                ...
                <form name="f1" class="f1" id="f1" action="{{ route('submit_imPrint') }}" method="post" onsubmit="return checkForm()">
                    @csrf
                    <div class="row">
