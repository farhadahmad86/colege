        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Approval {{$title}} Journal Voucher Edit</h4>
                        </div>
                        <div class="list_btn">
                            <a class="btn list_link add_more_button" href="{{route('approval_journal_voucher_list')}}" role="button">
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate"><!-- invoice box start -->
                        ...
                        <form action="{{ route('approval_journal_voucher_update') }}" method="post" onsubmit="return checkForm()">
                            @csrf
                                    ...
                                    <div class="invoice_row hidden"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_12"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt inline_radio">
                                                    <!-- invoice column input start -->
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="voucher_type" class="invoice_type"
                                                                   id="simple" value="simple_show">
                                                            Simple
                                                        </label>
                                                    </div>
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_12" hidden><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="required invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                       data-placement="bottom" data-html="true"
                                                       data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.bank_voucher.bank_journal_voucher.code.description')}}</p>">
                                                        <i class="fa fa-info-circle"></i>
                                                    </a>
                                                    Account Code
                                                </div><!-- invoice column title end -->
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <div class="invoice_col_short"><!-- invoice column short start -->
                                                        <a href="{{ route('bank_account_registration') }}" target="_blank" class="col_short_btn" data-container="body" data-toggle="popover"
                                                        ...
                                                        <a id="refresh_account_code" class="col_short_btn" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="bottom"
                                        ...
                                        <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="required invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                       data-placement="bottom" data-html="true"
                                                       data-content="<h6>Descriptions</h6><p>{{config('fields_info.about_form_fields.bank_voucher.bank_journal_voucher.account_title.description')}}</p>">
                                                        <i class="fa fa-info-circle"></i>
                                                    </a>
                                                    Account Title
                                                </div><!-- invoice column title end -->
                                        ...
                                        <div class="invoice_col basis_col_23"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input type="text" name="account_remarks" class="inputs_up form-control" id="account_remarks" placeholder="Remarks" autocomplete="off"/>
                                        ...
                                        <div class="invoice_col basis_col_10"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <select name="account_type" class="inputs_up form-control" id="account_type">
                                        ...
                                        <div class="invoice_col basis_col_11"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input type="text" name="amount" class="inputs_up text-right form-control" id="amount" placeholder="Amount" min="1" autocomplete="off">
                                                        ...
                                                        <div class="pro_tbl_bx"><!-- product table box start -->
                                                            <table class="table gnrl-mrgn-pdng" id="category_dynamic_table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center tbl_txt_20"> Posting Reference</th>
                                                                    <th class="text-center tbl_txt_53"> Transaction Remarks</th>
                                                                    <th class="text-center tbl_txt_9"> Dr.</th>
                                                                    <th class="text-center tbl_srl_9"> Cr.</th>
                                                                </tr>
                                                                </thead>

                                                                <tbody id="table_body">
                                                                @foreach($ajv->approval_journal_voucher_items as $key => $jvi)
                                                                    @php( $key = $key + 1 )
                                                                    <tr id="{{ $key }}" class="edit_update">
                                                                        <td class="text-center tbl_srl_9">{{ $jvi->ajvi_account_id }}</td>
                                                                        <td class="text-left tbl_txt_20">{{ $jvi->ajvi_account_name }}</td>
                                                                        <td class="text-left tbl_txt_20">{{ $jvi->postingReference->pr_name }}</td>
                                                                        <td class="text-left tbl_txt_53">{{ $jvi->ajvi_remarks }}</td>
                                                                        <td class="text-left tbl_txt_9">{{ $jvi->ajvi_type == 'Dr' ? $jvi->ajvi_amount : '' }}</td>
                                                                        <td class="text-right tbl_srl_9">
                                                                            {{ $jvi->ajvi_type == 'Cr' ? $jvi->ajvi_amount : '' }}
                                                                            <div class="edit_update_bx">
                                                                                <a class="edit_link btn btn-sm btn-success" href="#" onclick="edit_account({{ $key }})">
                                                                                    <i class="fa fa-edit"></i>
                                                                                </a>
                                                                                <a href="#" class="delete_link btn btn-sm btn-danger" onclick="delete_account({{ $key }})">
                                                                ...
                                                                <tr>
                                                                    <td colspan="4" class="text-center">
                                                                        <div class="invoice_col_txt"><!-- invoice column box start -->
                                                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                                                <input type="text" name="total_debit" class="inputs_up text-right form-control grand-total-field"
                                                                                       data-rule-required="true" data-msg-required="Please Add"
                                                                                       id="total_debit" value="{{ $ajv->ajv_total_dr }}" placeholder="0.00" readonly/>
                                                                    ...
                                                                    <td class="text-center tbl_srl_9">
                                                                        <div class="invoice_col_txt"><!-- invoice column box start -->
                                                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                                                <input type="number" name="total_credit" class="inputs_up text-right form-control grand-total-field"
                                                                                       data-rule-required="true" data-msg-required="Please Add"
                                                                                       id="total_credit" value="{{ $ajv->ajv_total_cr }}" placeholder="0.00" readonly/>
                                        ...
                                        <div class="invoice_col basis_col_100"><!-- invoice column start -->
                                            <div class="invoice_col_txt with_cntr_jstfy for_voucher_btns"><!-- invoice column box start -->
                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                    ...
                                                    <button class="btn btn-primary session-button" type="button" data-toggle="collapse" data-target="#session_accordian" aria-expanded="false"
                            ...
                            <input type="hidden" name="ajv_id" value="{{ $ajv->ajv_id }}">
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            let total_credit = document.getElementById("total_credit"),
                total_debit = document.getElementById("total_debit"),
    ...
    <script>
        ...
        $(document).ready(function () {
            @foreach($ajv->approval_journal_voucher_items as $key => $ajvi)
                accounts[{{ $key + 1 }}] = [{{ $ajvi->ajvi_account_id }}, '{{ trim($ajvi->ajvi_account_name) }}', {{ $ajvi->ajvi_amount }}, '{{ $ajvi->ajvi_type }}', '{{ $ajvi->ajvi_remarks }}',
                '{{ $ajvi->ajvi_pr_id }}'];

            jQuery("#account_code option[value=" + {{ $ajvi->ajvi_account_id }} +"]").attr("disabled", "true");
            jQuery("#account_name option[value=" + {{ $ajvi->ajvi_account_id }} +"]").attr("disabled", "true");
            @endforeach

                counter = numberofaccounts = Object.keys(accounts).length;
        ...
        function add_account() {
            ...
            if (account_type == 'Dr') {
                ...
                if (parseFloat($("#amount").val()) > parseFloat($("#remainingTotalAmountView").text())) {
                    // alert("stop");

                    $("#demo7").text("Amount must be less than Due Amount");
            ...
            if (flag_submit1) {
                ...
                jQuery("#table_body").append(
                    '<tr id=' + counter + ' class="edit_update"><td class="text-center tbl_srl_9">' + account_code + '</td><td class="text-left tbl_txt_20">' + account_name_text + '</td><td ' +
                    'class="text-left tbl_txt_20">' + posting_reference_text + '</td><td class="text-left tbl_txt_53">' + remarks_var + '</td><td class="text-left tbl_txt_9">' + dr_amount + '</td><td class="text-right tbl_srl_9">' + cr_amount + '<div class="edit_update_bx"><a class="edit_link btn btn-sm btn-success" href="#" onclick=edit_account(' + counter + ')><i class="fa fa-edit"></i></a><a href="#" class="delete_link btn btn-sm btn-danger" onclick=delete_account(' + counter + ')><i class="fa fa-trash"></i></a></div></td></tr>');
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            var voucher_type = "{{$ajv->ajv_voucher_type}}";
            $("input[name=voucher_type][value=" + voucher_type + "]").prop('checked', true);
