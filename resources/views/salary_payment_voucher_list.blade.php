            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                    ...
                    <div class="search_form m-0 p-0">
                                <form class="prnt_lst_frm" action="{{ route('salary_payment_voucher_list') }}" name="form1" id="form1" method="post">
                                    @csrf
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 mt-lg-2">
                                                    <div class="form_controls text-center text-lg-left">
                                                        ...
                                                        <a tabindex="7" class="save_button form-control" href="{{ route('salary_payment_voucher') }}" role="button">
                        ...
                        <table class="table table-bordered table-sm" id="fixTable">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th tabindex="-1" scope="col" class="align_center text-center tbl_txt_15">
                                        Remarks
                                    </th>
                            ...
                            @forelse($datas as $voucher)
                                ...
                                <tr data-toggle="tooltip" data-placement="top" title="" data-original-title="View Journal Voucher">
                                    ...
                                    <td class="view text-center tbl_amnt_10" data-id="{{$voucher->sp_id}}">
                                        SPV-{{$voucher->sp_id}}
                                    </td>
                                    <td class="align_left text-left tbl_txt_15">
                                        {{$voucher->sp_remarks}}
                                    </td>
                                    <td class="align_left text-left tbl_txt_43">
                                        <div class="">
{{--                                            {!! str_replace(array("\r\n","\r","\n","\\r","\\n","\\r\\n"),'<br />', $voucher->sp_detail_remarks) !!}--}}
                            ...
                            <tfoot>
                                <tr class="border-0">
                                    ...
                                    <td class="text-right border-left-0" align="right" style="border-top: 2px solid #000;border-right: 0px solid transparent;">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('salary_payment_voucher_list') }}',
            url;
