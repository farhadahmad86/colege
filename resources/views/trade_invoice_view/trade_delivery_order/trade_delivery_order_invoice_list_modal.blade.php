...
@section('print_cntnt')
    ...
    {{--            <a href="{{ route('delivery_order_items_view_details_pdf_SH',['id'=>$sim->do_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;"> --}}
    {{--                Download --}}
    {{--            </a> --}}
    ...
    @if ($type === 'grid')
        <div class="itm_vchr_rmrks">
            <a href="{{ route('trade_delivery_order_items_view_details_pdf_SH', ['id' => $sim->do_id]) }}"
            ...
            <iframe style="display: none" id="printf" name="printf"
                src="{{ route('trade_delivery_order_items_view_details_pdf_SH', ['id' => $sim->do_id]) }}"
