...
{{--                    </td>--}}
    ...
    @if( $type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('trade_goods_receipt_note_items_view_details_pdf_SH',['id'=>$sim->grn_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
                Download
            </a>

            <iframe style="display: none" id="printf" name="printf" src="{{ route('trade_goods_receipt_note_items_view_details_pdf_SH',['id'=>$sim->grn_id]) }}" title="W3Schools Free Online Web
            Tutorials">Iframe
            </iframe>
