        ...
        <table class="table table-bordered table-sm">
            ...
            <tr class="bg-transparent">
                ...
                <td class="wdth_50_prcnt p-0 border-0">
                    ...
                    <p class="invoice_para">
                        <b> Name: </b>
                        {{ (isset($pim->psi_party_name) && !empty($pim->psi_party_name)) ? $pim->psi_party_name : 'N/A' }}
                    </p>
                    <p class="invoice_para adrs">
                        <b> Adrs: </b>
...
{{--                <td class="text-right align_right">--}}
{{--                    {{ number_format($pim->psi_total_sales_tax,2) }}--}}
{{--                </td>--}}
                <td class="text-right align_right">
                            ...
                            <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                                <table class="table table-bordered table-sm">
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->psi_product_disc,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->psi_round_off_disc,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->psi_cash_disc_amount,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->psi_total_discount,2) }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->psi_inclusive_sales_tax,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->psi_exclusive_sales_tax,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                            ...
                            <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->psi_grand_total,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->psi_cash_paid,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                                        ...
                                        @php
                                            $balances = $pim->psi_grand_total - $pim->psi_cash_paid;
                                        @endphp
                                        <td class="text-right">
    ...
    @if( $type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('trade_sale_tax_purchase_items_view_details_pdf_SH',['id'=>$pim->psi_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
                Download
            </a>

            <iframe style="display: none" id="printf" name="printf" src="{{ route('trade_sale_tax_purchase_items_view_details_pdf_SH',['id'=>$pim->psi_id]) }}" title="W3Schools Free Online Web
            Tutorials">
                Iframe
            </iframe>
        ...
        {{--        <a href="{{ route('sale_tax_purchase_items_view_details_pdf_SH',['id'=>$pim->psi_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">--}}
