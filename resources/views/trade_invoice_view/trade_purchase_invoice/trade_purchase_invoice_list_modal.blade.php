...
{{--                </th>--}}
            ...
            @foreach( $piims as $piim )
                ...
                <tr class="even pointer">
                    ...
                    <td class="tbl_srl_6 align_center text-center">
                        {{ $i }}
                    </td>
...
{{--                    {{ number_format($pim->pi_total_items,3) }}--}}
                </td>
...
{{--                    {{ number_format($ttlExcluDis,2) }}--}}
                </td><td class="text-right align_right">
                            ...
                            <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                                <table class="table table-bordered table-sm">
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->pi_product_disc,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->pi_round_off_disc,2) }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                                <table class="table table-bordered table-sm">
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ number_format($pim->pi_cash_disc_amount,2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="vi_tbl_hdng text-right">
                                        ...
                                        @php $discount_amountTtl = $trade_offerTtl + $pim->pi_total_discount; @endphp
                                        <td class="text-right">
{{--                                            {{ number_format($pim->pi_total_discount,2) }}--}}
                                            {{ number_format($discount_amountTtl,2) }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <tr class="fieldset-box">
                <td colspan="9" class="border-0 p-0 chck_pdng">
    ...
    @if( $type === 'grid')
        ...
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('trade_purchase_items_view_details_pdf_sh',['id'=>$pim->pi_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
                Download
            </a>

            <iframe style="display: none" id="printf" name="printf" src="{{ route('trade_purchase_items_view_details_pdf_sh',['id'=>$pim->pi_id]) }}" title="W3Schools Free Online Web Tutorials">Iframe
            </iframe>
