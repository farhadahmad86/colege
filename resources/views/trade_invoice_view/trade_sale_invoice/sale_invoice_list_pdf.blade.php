...
<div id="" class="table-responsive" style="z-index: 9;">
    ...
    <table class="table table-bordered table-sm">
        ...
        <tr class="headings vi_tbl_hdng">
            ...
            <th scope="col" class="align_left text-left {{ ($sim->si_invoice_type === 2) ? 'pur_in_wdth_2' : 'pur_in_wdth_3' }}">Product Name</th>
            ...
            @endif
            <th scope="col" class="pur_in_wdth_8 text-center">Excluded {{ ($sim->si_invoice_type === 2) ? 'Sale Tax' : 'Discount' }} </th>
                    ...
                    <tr>
                        ...
                        <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                            <table  class="table table-bordered table-sm">
                                <tr>
                                    ...
                                    {{--                                            <label class="vi_tbl_hdng total-items-label text-right">Balance Amount:-</label>--}}
                                    {{--                                        </th>--}}
                                    {{--                                        <td class="text-right >--}}
                        ...
                        <td class="pl-0 pb-0 pr-0 border-0 pts-10">
                            <table  class="table table-bordered table-sm">
                                {{--                                    <tr>--}}
                                {{--                                        <th class="vi_tbl_hdng">--}}
                                {{--                                            <label class="vi_tbl_hdng total-items-label text-right">Gross Total:-</label>--}}
                                {{--                                        </th>--}}
                                {{--                                        <td class="text-right">--}}
