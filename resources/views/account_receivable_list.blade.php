        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Client List</h4>
                        </div>
                ...
                <div
                    class="search_form m-0 p-0 {{ ( !empty($search) || !empty($search_region) || !empty($search_area) || !empty($search_sector) || !empty($search_group) ) ? '' : '' }}">

                    <form class="highlight prnt_lst_frm" action="{{ route('account_receivable_list') }}" name="form1" id="form1" method="post">
                        <div class="row">
                            @csrf
                    ...
                    <table class="table table-bordered table-sm" id="fixTable">
                        ...
                        @forelse($datas as $index=> $account)
                            ...
                            <tr>
                                ...
                                @endphp
                                <td class="align_right text-right tbl_amnt_11">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('account_receivable_list') }}',
            url;
