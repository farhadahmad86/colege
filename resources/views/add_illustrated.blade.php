        ...
        <div
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 tabindex="-1" class="text-white get-heading-text">Create Illustrated</h4>
                        </div>
                        <div class="list_btn">
                            <a tabindex="-1" class="btn list_link add_more_button" href="{{route('illustrated_list')}}" role="button">
                ...
                <form name="f1" class="f1" id="f1" action="{{route('submit_illustrated')}}" method="post"
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <div class="input_bx"><!-- start input box -->
                                        ...
                                        <input tabindex="1" autofocus type="text" name="name" id="name"
                                               ...
                                               placeholder="Name" autofocus data-rule-required="true" data-msg-required="Please Enter Name"
                                               value="{{ old('name') }}"/>
