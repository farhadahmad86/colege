    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Loan Receipt Voucher</h4>
                    </div>
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button"
                           href="{{ route('loan_receipt_voucher_list') }}" role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    <!-- invoice box start -->
                    <form id="f1" action="{{ route('submit_loan_receipt_voucher') }}" method="post"
                                                ...
                                                <select tabindex="1" autofocus name="account"
                                                    ...
                                                    @foreach($loan_accounts as $account)
                                                        <option value="{{$account->account_uid}}"
                                                                data-balance="{{$account->loan_remaining_amount}}"
                                                                data-id="{{$account->loan_id}}"
                                                        >{{$account->account_uid}} -
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Loan Receipt Voucher Detail</h4>
...
@section('scripts')
    ...
    @if (Session::get('lv_id'))
        <script>
            ...
            var id = '{{ Session::get("lrv_id") }}';
            $(".modal-body").load('{{ url('loan_receipt_items_view_details/view/') }}/' + id, function () {
