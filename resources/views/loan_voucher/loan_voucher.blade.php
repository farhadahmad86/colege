    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage">
            <div class="form_header"><!-- form header start -->
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Loan Payment Voucher</h4>
                    </div>
                    <div class="list_btn">
                        <a tabindex="-1" class="btn list_link add_more_button" href="{{ route('loan_voucher_list') }}"
                           role="button">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con for_voucher"><!-- invoice container start -->
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    <!-- invoice box start -->
                    <form id="f1" action="{{ route('submit_loan_voucher') }}" method="post"
                        ...
                        <div class="invoice_bx_scrl"><!-- invoice scroll box start -->
                            <div class="invoice_cntnt"><!-- invoice content start -->
                                <div class="invoice_row"><!-- invoice row start -->
                                    <div class="invoice_col form-group col-lg-4 col-md-4 col-sm-12">
                                        ...
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                ...
                                                <select tabindex="1" autofocus name="account"
                                                        class="inputs_up form-control" id="account"
                                                        data-rule-required="true"
                                                        data-msg-required="Please Enter Cash Account">
                                                    <option value="">Select Loan Account</option>
                                                    @foreach($loan_accounts as $account_account)
                                                        <option value="{{$account_account->account_uid}}"
                                                                data-balance="{{$account_account->balance}}"
                                                                data-approved-amount="{{$account_account->approved_loan_amount}}">{{$account_account->account_uid}}
                                                            -
                                                            {{$account_account->account_name}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="invoice_col form-group col-lg-4 col-md-4 col-sm-12 hidden">
                                        <!-- invoice column start -->
                                        <input class="form-check-input" type="radio" name="status" value="post"
                                               id="post"
                                               checked>
                                    ...
                                    <div
                                        class="project_box project_show invoice_col form-group col-lg-4 col-md-4 col-sm-12">
                                        <!-- invoice column start -->
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                ...
                                <div class="invoice_row"><!-- invoice row start -->
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-4 col-sm-12" hidden>
                                        <!-- invoice column start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                ...
                                                <select tabindex="3" name="account_code" class="inputs_up form-control"
                                                    ...
                                                    @foreach($accounts as $account)
                                                        <option
                                                            value="{{$account->account_uid}}">{{$account->account_uid}}</option>
                                                    @endforeach
                                                </select>
                                            </div><!-- invoice column input end -->
                                        </div><!-- invoice column box end -->
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-4 col-sm-12">
                                        <!-- invoice column start -->
                                        ...
                                        <div class="invoice_col_bx"><!-- invoice column box start -->
                                            ...
                                            <div class="invoice_col_input"><!-- invoice column input start -->
                                                ...
                                                <select tabindex="4" name="account_name" class="inputs_up form-control"
                                                    ...
                                                    @foreach($accounts as $account)
                                                        <option
                                                            value="{{$account->account_uid}}">{{$account->account_uid}}
                                                    ...
                                                    <td tabindex="-1" class="tbl_srl_12">
                                                        <div class="invoice_col_txt"><!-- invoice column box start -->
                                                            <div class="invoice_col_input">
                                                                ...
                                                                <input tabindex="-1" type="text" name="total_amount"
...
@section('scripts')
        ...
        function checkForm() {
            ...
            if (checkValid == true) {
                if (parseFloat(totalAmount.value) <= parseFloat(balance.value)) {
                    ...
                    document.getElementById("bal_error").innerHTML = 'Total Amount Less or Equal To Loan Amount';
    ...
    @if (Session::get('lv_id'))
        <script>
            jQuery("#table_body").html("");
            var id = '{{ Session::get("lv_id") }}';
    ...
    <script>
        jQuery("#account").change(function () {
            ...
            var approved_amount = $('option:selected', this).attr('data-approved-amount');

            $('#balance').val(approved_amount - balance);
            document.getElementById("balanceView").innerHTML = approved_amount - balance;
