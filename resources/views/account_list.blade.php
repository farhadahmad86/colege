        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white file_name get-heading-text">Entry Account List</h4>
                        </div>
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('account_list') .((isset($restore_list) && $restore_list == 1) ? '?restore_list=1' : '') }}" name="form1" id="form1"
                          method="post">
                        @csrf
                        <div class="row">
                            ...
                            @else
                                <tr>
                                    ...
                                    @php
                                       ...
                                       // $deb_bal = +($deb_balance[$index]) + +$deb_bal;
                                        //$cre_bal = +($cre_balance[$index]) + +$cre_bal;
                                    @endphp
                                    <td class="edit">
                                    ...
                                    @if($account->account_type==0)
                                        @if(in_array($account->account_uid,explode(',',config('global_variables.default_account_list'))))
                                            <td class="hide_column "><a>-</a></td>
                                        @else
                                            <td class="hide_column text-center">
                                                <a data-id="{{$account->account_uid}}" data-parent="{{$account->account_parent_code}}" class="delete" style="cursor:pointer;" data-toggle="tooltip"
