        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Bank Receipt Voucher List</h4>
                        </div>
                ...
                <div class="search_form m-0 p-0">
                    <form action="{{ route('bank_receipt_voucher_list') }}" name="form1" id="form1" method="post"
                        class="highlight prnt_lst_frm">
                        @csrf
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                        <div class="input_bx">
                                            ...
                                            <select tabindex="4" name="bank_account" class="inputs_up form-control"
                                                id="bank_account">
                        ...
                        <tbody>
                            ...
                            @forelse($datas as $voucher)
                                ...
                                <tr data-toggle="tooltip" data-placement="top" title=""
                                    data-original-title="View Bank Voucher">
                                    ...
                                    <td class="usr_prfl" data-usr_prfl="{{ $voucher->user_id }}"
                                        data-user_info="{!! $ip_browser_info !!}" title="Click To See User Detail">
                                        {{ $voucher->user_name }}
                                    </td>
                                    <td class="text-center {{ $voucher->br_status == 'post' ?: '' }}">
                                        @if ($voucher->br_status == 'post')
                                            <span class="btn btn-sm btn-success">POSTED<span>
                                                     @elseif ($voucher->br_status == 'deleted')
                                                        <span class="btn btn-sm btn-info">Deleted<span>
                                                @elseif ($voucher->br_status == 'park')
                                                    <a class="btn btn-sm btn-info"
                                                        href="{{ route('edit_bank_receipt_voucher', $voucher->br_id) }}"
                                                        title="Click To Edit Voucher"><i class="fa fa-edit"></i></a> |
                                                    <a class="btn btn-sm btn-danger"
                                                        href="{{ route('delete_bank_receipt_voucher', $voucher->br_id) }}"
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('bank_receipt_voucher_list') }}',
            url;
