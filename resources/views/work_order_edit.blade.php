        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text"> Edit Work Order </h4>
                        </div>
                        <div class="list_btn">
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    ...
                                                    <select class="inputs_up form-control" name="pro_recipe" id="pro_recipe" data-method="loadContent" onchange="getRecipe(this);" data-rule-required="true" data-msg-required="Please Select Product Recipe">
                                                        ...
                                                        @foreach($get_recipies as $get_recipie)
                                                            <option value="{{$get_recipie->recipe_id}}" selected >{{$get_recipie->recipe_name}}</option>
                                                        @endforeach
                                        ...
                                        <div class="invoice_col basis_col_11"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input type="text" class="inputs_up text-right form-control" name="order_quantity" id="order_quantity" placeholder="Product Quantity" min="1" onkeypress="return allow_only_number_and_decimals(this,event);"
                                                           value="{{$workOrder->odr_qty}}"
                                                           data-method="orderQuantityChange" onkeyup="orderQuantityChange(this);"  data-rule-required="true" data-msg-required="Please Enter Order Quantity" />
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_col basis_col_15"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input type="text" name="estimated_start_time" class="inputs_up form-control datetimepicker"
                                                           value="{{$workOrder->odr_estimated_start_time}}"
                                                           id="estimate_start_time" placeholder="Estimate Start Time"  data-rule-required="true" data-msg-required="Please Select Estimated Start Time">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
                                        ...
                                        <div class="invoice_col basis_col_15"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_input"><!-- invoice column input start -->
                                                    <input type="text" name="estimated_end_time" class="inputs_up form-control datetimepicker" id="estimated_end_time" placeholder="Estimated End Time"  data-rule-required="true"
                                                           value="{{$workOrder->odr_estimated_end_time}}"
                                                           data-msg-required="Please Select Estimated End Time">
                                                </div><!-- invoice column input end -->
                                            </div><!-- invoice column box end -->
                                        </div><!-- invoice column end -->
...
<script>
    ...
    $(document).ready(function () {
        ...
        var selectElement = document.querySelector('select[id="pro_recipe"]');

        getRecipe(selectElement);
