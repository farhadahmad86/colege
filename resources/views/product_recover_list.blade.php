        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Product Recover List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ ( !empty($search) || !empty($search_product) || !empty($search_to) || !empty($search_from) ) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    ...
                    <form class="highlight prnt_lst_frm" action="{{ route('product_recover_list') }}" name="form1" id="form1" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Call add button component -->
                                        <x-add-button tabindex="9" href="{{ route('product_recover') }}"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('product_recover_list') }}',
            url;
