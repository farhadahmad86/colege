        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Stock Outward List</h4>
                        </div>
                ...
                <div class="search_form m-0 p-0 {{ ( !empty($search) || !empty($search_to) || !empty($search_from) ) ? '' : '' }}">
                    <form class="highlight prnt_lst_frm" action="{{ route('stock_outward_list') }}" name="form1" id="form1" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <!-- Call add button component -->
                                <x-add-button tabindex="9" href="{{ route('stock_outward') }}"/>
                ...
                <div class="table-responsive" id="printTable">
                    <table class="table table-bordered" id="fixTable">
                        ...
                        <tr>
                            ...
                            <th hidden scope="col" class=" tbl_amnt_10">
                                Sending Date/Time
                            </th>
                        ...
                        @forelse($datas as $delivery_option)
                            ...
                            <tr data-remarks="{{$delivery_option->so_remarks}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="View Delivery Option">
                                ...
                                <td>
                                    {{date('d-M-y g:i a', strtotime(str_replace('/', '-', $delivery_option->so_datetime)))}}
                                </td>
                                @php
                                    $type='';
                                        if($delivery_option->so_type == 'self_collection'){$type='Client Collection';}
                                        else if($delivery_option->so_type == 'company_delivery'){$type='Company Delivery';}
                                ...
                                @endphp
                                <td class="view" data-id="{{$delivery_option->so_id}}" data-do-type="{{$delivery_option->so_type}}">
                                    {{$type}}
                                </td>
                                <td>
                                ...
                                <td class="usd_prfl" data-usd_prfl="{{ $delivery_option->user_id }}" data-user_info="{!! $ip_browser_info !!}"
                        ...
                        @empty
                            <tr>
                                <td colspan="11">
                                    <center><h3 style="color:#554F4F">No Stock Outward</h3></center>
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
                    ...
                    <div class="itm_vchr form_manage">
                        <div class="form_header">
                            <h4 class="text-white file_name">
                                <span class="db sml_txt"> Stock Outward #: </span>
                            </h4>
                        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('stock_outward_list') }}',
            url;
