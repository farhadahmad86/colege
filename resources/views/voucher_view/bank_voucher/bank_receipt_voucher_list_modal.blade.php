...
<div id="" class="table-responsive" style="display: block;max-width: 100%;min-width: 100%;width:100%;padding: 20px 0px;position: relative;z-index: 9;overflow-y: hidden;">
    ...
    <table class="table table-bordered table-sm" id="fixTable" style="background-image: url({{ asset('public/vendors/images/invoice_background.png') }}); background-repeat: no-repeat;background-position: left top;-webkit-background-size: 100% auto;background-size: 100% auto;">
        <thead>
        <tr>
            <td colspan="2">
    ...
    padding: 15px 5px 0;"> Bank Receipt Voucher </h2>
                <p style="color: #000;padding: 0px 5px 0;margin: 0;"> <b> Invoice #: </b>{{ $bnk_rcpt->br_id }} </p>
                <p style="color: #000;padding: 5px 5px 0;margin: 0;"> <b> Date: </b>{{date('d-M-y', strtotime(str_replace('/', '-', $bnk_rcpt->br_day_end_date)))}} </p>
            </td>
        </tr>
        <tr>
        ...
        <tr class="headings" style="background: #a5a5a5;color: #000;">
            ...
            <th scope="col" class="wdth_5 text-left align_left" style="width: 155px;max-width: 155px; min-width: 155px;text-align: left;">Posting Reference</th>
        ...
        <tr class="even pointer">
            ...
            <td class="wdth_5 align_right text-right" style="width: 95px;max-width: 95px; min-width: 95px;text-align: right;"> {!! number_format($item->bri_amount,2) !!} </td>

        </tr>
        @php $i++; $grand_total = +$item->bri_amount + +$grand_total; @endphp
        @endforeach
        ...
        <tr class="border-0">
            <td colspan="4" align="right" class="border-0" style="padding-top: 0;border: 0px solid transparent;text-align: right;">
                <table class="table table-bordered table-sm chk_dmnd" style="background-color: transparent;padding: 0;margin: 0;text-align: right;float: right;">
                    <tfoot>
                    <tr>
                        <td align="right" class="border-right-0" style="padding: 0 15px 0 .45rem;border-right: 0px solid transparent;border-top: 1px solid #000;border-bottom: 2px double #000;">
