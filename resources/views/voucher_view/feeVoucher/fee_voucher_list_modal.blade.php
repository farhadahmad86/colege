    ...
    <div id="" class="table-responsive" style="z-index: 9;">
        ...
        <table class="table table-bordered table-sm" id="">
            ...
            @foreach( $items as $item )
                ...
                @php
                    $vchr_id = $item->fvi_salary_payment_voucher_id;

                    $DR_val = ($vchr_id === $item->fvi_salary_payment_voucher_id) ? $item->fvi_amount : "";
            ...
            @endforeach
                ...
                <tr class="even pointer">
                    ...
                    <td>
                        {{ $fv_acnt_nme->account_uid }} -  {!! $fv_acnt_nme->account_name !!}
                    </td>
        ...
        @if( $type === 'grid')
            <div class="itm_vchr_rmrks">
                ...
                <a href="{{ route('fee_items_view_details_pdf_SH',['id'=>$bnk_pmnt->fv_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
