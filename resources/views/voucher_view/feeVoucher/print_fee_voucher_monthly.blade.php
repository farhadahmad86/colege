        ...
        <div class="container">
            @foreach ($fee_vouchers as $fee_voucher)
                ...
                <div class="voucher">
                    <div id="home">
                        <!-- Bank copy content -->
                        <div class="size" style="margin-top:12px;margin-left: 40px; border-right: 2px solid black;">
                            <div class="row" id="logo-row">
                                ...
                                <div class="" style="text-align: center; margin-top:10px;">
                                    ...
                                    <h5><strong>{{$fee_voucher->fv_month}}</strong></h5>
                                </div>
                            </div>
                                ...
                                <tr>
                                    <td style="width: 65%">
                                        <p><strong>Account#:</strong>
                                            <strong>{{ $college_bank_info->bi_account_no }}</strong>
                                        </p>
                                    </td>
                                    <td style="width: 35%">
                                        <p><strong>Branch
                                                Code:</strong><strong>{{ $college_bank_info->bi_branch_code }}</strong>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div id="home">
                        ...
                        <div class="size" style="margin-top:12px;margin-left: 40px;">
                            <div class="row" id="logo-row">
                                <div class="" style="float:left;">
                                    <div style="margin-top: 4px; margin-left: 3px;">
                                        <img style="height: 60px;" src="{{ $company_info->ci_logo }}" alt="Logo city">
