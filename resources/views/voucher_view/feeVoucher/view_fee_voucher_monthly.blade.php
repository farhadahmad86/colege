...
<body>
    ...
    <iframe style="display: none" id="printf" name="printf"
        src="{{ route('month_fee_items_view_details_pdf_SH', ['id' => $section_id,'class_id' => $class_id,'month'=>$month,'issue_date'=>$issue_date]) }}"
    ...
    @foreach ($fee_vouchers as $fee_voucher)
        ...
        $number = $fee_voucher->fv_total_amount;
        $locale = 'en_US';
                ...
                <div class="size col-xs-4" style="margin-top:12px;margin-left: 40px;border-right: 2px solid black;">
                    <div class="row" id="logo-row">
                        ...
                        <div class="" style="text-align: center; margin-top:10px;">
                            ...
                            <h6><strong>{{$fee_voucher->fv_month}}</strong></h6>
                        </div>
                    </div>
                    ...
                    <table style="line-height:0px">
                        <tr>
                            <td>
                                <p><strong>Account#:</strong> <strong>{{ $college_bank_info->bi_account_no }}</strong>
                                </p>
                            </td>
                            <td style="padding-left: 5px;">
                                <p><strong>Branch
                                        Code:</strong><strong>{{ $college_bank_info->bi_branch_code }}</strong></p>
                            </td>
                        </tr>
                    </table>
