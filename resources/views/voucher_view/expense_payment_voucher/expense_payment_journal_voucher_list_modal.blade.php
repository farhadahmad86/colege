...
{{--                Account No.            </th>--}}
            <th scope="col" class="text-center tbl_txt_28">
                Account Name
            </th>
            <th scope="col" class="text-center tbl_txt_18">
                Posting Reference
            </th>
...
{{--                </td>--}}
            ...
            @php if( $vchr_id !== $item->epi_salary_payment_voucher_id): @endphp
            <tr class="even pointer">
                @php $i++;  @endphp
                <th>
                    {{ $i }}
...
{{--                </td>--}}
                <td>
                    {{ $ep_acnt_nme->account_uid }} - {!! $ep_acnt_nme->account_name !!}
                </td>
                <td>
