            ...
            <div class="voucher">
                <div id="home">
                    ...
                    <div class="size" style="margin-top:12px;margin-left: 40px; border-right: 2px solid black;">
                        ...
                        <p>Account Title: {{ $data['bank_info']->bi_account_title }} </p>
                        <table style="line-height:0px">
                            <tr>
                                <td style="width: 65%">
                                    <p><strong>Account#:</strong>
                                        <strong>{{ $data['bank_info']->bi_account_no }}</strong>
                                    </p>
                                </td>
                                <td style="width: 35%">
                                    <p><strong>Branch
                                            Code:</strong><strong>{{ $data['bank_info']->bi_branch_code }}</strong>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        <p>Branch Name: {{ $data['bank_info']->bi_bank_name }}</p>
                    ...
                    <div class="size" style="margin-top:12px;margin-left: 40px;">
                        <div class="row" id="logo-row">
                            ...
                            <div class="" style="text-align: center; margin-top:10px;">
                                ...
                                <h5><strong>(CASH DEPOSIT SLIP)</strong></h5><h5><strong>{{$transport_voucher->tv_month}}</strong></h5>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 1px">
                            <table class="table">
