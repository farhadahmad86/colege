                ...
                <div class="size col-xs-4" style="margin-top:12px;margin-left: 40px; border-right: 2px solid black;" >
                    <div class="row" id="logo-row">
                        ...
                        <div class="" style="text-align: center; margin-top:10px;">
                            <h4 class="clg_info"><strong>{{ $fee_voucher->clg_name }}</strong></h4>
                    ...
                    <p>Account Title: City College of Science and Commerce </p>
                    <table style="line-height:0px">
                        <tr>
                            <td style="width: 65%">
                                <p><strong>Account#:</strong> <strong>0010060200620020</strong></p>
                            </td>
                            <td style="width: 35%">
                                <p><strong>Branch Code:</strong><strong>0752</strong></p>
                            </td>
                        </tr>
                    </table>
                    <p>Branch Name: Allied Bank Limited (Any Branch)</p>
