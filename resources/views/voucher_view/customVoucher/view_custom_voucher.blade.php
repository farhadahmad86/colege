...
<div class="row" style="">
    <iframe style="display: none" id="printf" name="printf"
            src="{{ route('month_custom_voucher_items_view_details_pdf_SH', ['id' => $section_id,'class_id' => $class_id,'month' => $month,'year' => $year,'issue_date' => $issue_date]) }}"
        ...
        <div id="home">
            <div class="size col-xs-4" style="margin-top:12px;margin-left: 40px;border-right: 2px solid black;">
                ...
                <table style="line-height:0px">
                    <tr>
                        <td>
                            <p><strong>Account#:</strong> <strong>{{ $bank_info->bi_account_no }}</strong>
                            </p>
                        </td>
                        <td style="padding-left: 5px;">
                            <p><strong>Branch
                                    Code:</strong><strong>{{ $bank_info->bi_branch_code }}</strong></p>
                        </td>
                    </tr>
                </table>
