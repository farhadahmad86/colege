            ...
            <div class="voucher">
                <div id="home">
                    ...
                    <div class="size" style="margin-top:12px;margin-left: 40px; border-right: 2px solid black;">
                        ...
                        <p>Account Title: {{ $bank_info->bi_account_title }} </p>
                        <table style="line-height:0px">
                            <tr>
                                <td style="width: 65%">
                                    <p><strong>Account#:</strong>
                                        <strong>{{ $bank_info->bi_account_no }}</strong>
                                    </p>
                                </td>
                                <td style="width: 35%">
                                    <p><strong>Branch
                                            Code:</strong><strong>{{ $bank_info->bi_branch_code }}</strong>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        <p>Branch Name: {{ $bank_info->bi_bank_name }}</p>
