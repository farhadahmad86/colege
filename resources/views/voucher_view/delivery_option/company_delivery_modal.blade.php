    ...
    <div id="" class="table-responsive">
        ...
        <table class="table table-bordered table-sm">
            ...
            <tr class="headings vi_tbl_hdng">
                ...
                <th scope="col" class="text-center align_center tbl_amnt_20">
                    Name
                </th>
                <th scope="col" class="text-center align_center tbl_amnt_72">
                    Remarks
                </th>
            </tr>
            </thead>
            ...
            @foreach( $items as $item )
                <tr class="even pointer">
                    ...
                    <td class="align_center text-center tbl_amnt_20">
                        {{ $item->user_name }}
                    </td>
