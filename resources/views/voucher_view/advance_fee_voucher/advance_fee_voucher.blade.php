...
<div class="row" style="">
        ...
        <div class="size col-xs-4" style="margin-top:12px;margin-left: 40px;border-right: 2px solid black;">
            <div class="row" id="logo-row">
                ...
                <div class="" style="text-align: center; margin-top:10px;">
                    ...
                    <h6><strong>{{ $fee_voucher->branch_name }}</strong></h6>
                    <h6><strong>BANK COPY</strong></h6>
                    <h6><strong>(CASH DEPOSIT SLIP)</strong></h6>
                    <h6>
                        <strong>{{ date('d-M-y', strtotime(str_replace('/', '-', $fee_voucher->afv_created_datetime))) }}</strong>
                    </h6>
                </div>
            </div>
            <div class="row " style="margin-top: 1px">
                <table class="table">
                    ...
                    {{--                            <th class="th-1">--}}
                    {{--                                {{ date('d-M-y', strtotime(str_replace('/', '-', $fee_voucher->fv_created_datetime))) }}--}}
                    {{--                            </th>--}}
    ...
    <!-- Home -->
    @if($fee_voucher->afv_status==1)
        <iframe style="display: none" id="printf" name="printf"
                src="{{ route('adv_fee_items_view_details_pdf_SH', ['id' => $fee_voucher->afv_v_no,'reg_no'=> $fee_voucher->afv_reg_no]) }}"
