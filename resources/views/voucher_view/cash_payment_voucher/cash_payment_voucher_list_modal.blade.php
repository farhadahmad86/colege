...
<div id="" class="table-responsive" style="display: block;max-width: 100%;min-width: 100%;width:100%;padding: 20px 10px;position: relative;z-index: 9;overflow-y: hidden;">
    ...
    <table class="table table-bordered table-sm" id="fixTable">
        ...
        <tr>
            ...
            <td colspan="2" class="p-0 border-0 text-right" style="text-align: right;padding: 0;border: 0px solid transparent;">
                ...
                <p style="padding: 0px 5px 0;margin: 0;"> <b> Invoice #: </b>{{ $csh_pymnt->cp_id }} </p>
                <p style="padding: 5px 5px 0;margin: 0;"> <b> Date: </b>{{date('d-M-y', strtotime(str_replace('/', '-', $csh_pymnt->cp_day_end_date)))}} </p>
            </td>
        </tr>
        <tr>
        ...
        <tr class="headings" style="background: #a5a5a5;color: #000;">
            ...
            <th scope="col" class="wdth_5 text-left " style="width: 155px;max-width: 155px; min-width: 155px;text-align: left;">Posting Reference</th>
        ...
        <tr class="even pointer">
            ...
            <td class="wdth_2 align_left text-left" style="width: 355px;max-width: 355px; min-width: 355px;text-align: left;">
                {!! $item->cpi_account_name !!}
            </td>
            <td class="wdth_2 align_left text-left" style="width: 355px;max-width: 355px; min-width: 355px;text-align: left;">
                {!! $item->pr_name !!}
            </td>

            <td class="wdth_5 align_right text-right" style="width: 95px;max-width: 95px; min-width: 95px;text-align: right;"> {!! number_format($item->cpi_amount,2) !!} </td>

        </tr>
        @php $i++; $grand_total = +$item->cpi_amount + +$grand_total; @endphp
        @endforeach
    ...
    <div class="itm_vchr_rmrks ">
        <a href="{{ route('cash_payment_items_view_details_pdf_SH',['id'=>$csh_pymnt->cp_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
