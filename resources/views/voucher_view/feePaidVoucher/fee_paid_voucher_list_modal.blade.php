    ...
    <div id="" class="table-responsive" style="z-index: 9;">
        ...
        <table class="table table-bordered table-sm" id="">
            ...
            @foreach( $items as $item )
                ...
                @php
                    $vchr_id = $item->fpvi_salary_payment_voucher_id;

                    $DR_val = ($vchr_id === $item->fpvi_salary_payment_voucher_id) ? $item->fpvi_total_amount : "";
                ...
                <tr class="even pointer">
                    ...
                    {{--                <td>--}}
                    {{--                    {{ $item->fpvi_account_id }}--}}
                    {{--                </td>--}}
                    <td>
                        {!! $item->fpvi_account_name !!}
                    </td>
                    <td>
                        {!! $item->pr_name !!}
                    </td>
            ...
            <tr class="even pointer">
                ...
                <td>
                    {{ $fpv_acnt_nme->account_uid }} -  {!! $fpv_acnt_nme->account_name !!}
                </td>
        ...
        @if( $type === 'grid')
            <div class="itm_vchr_rmrks">
                ...
                <a href="{{ route('fee_paid_items_view_details_pdf_SH',['id'=>$fee_voucher->fpv_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
