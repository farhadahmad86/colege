...
{{--                    {!! $item->spi_remarks !!}--}}
    ...
    @if( $type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('salary_payment_items_view_details_single_pdf_SH',['id'=>$slry_pmnt->sp_id]) }}" class="align_right text-center btn btn-sm btn-success" style="float: left;margin-top: 7px;margin-left: 5px;">
                View Detail
            </a>
        </div>
    @endif
