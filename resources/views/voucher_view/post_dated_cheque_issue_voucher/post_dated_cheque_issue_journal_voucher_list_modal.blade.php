...
<div id="" class="table-responsive" style="z-index: 9;">
    ...
    <table class="table table-bordered table-sm">
        ...
        <tr class="headings vi_tbl_hdng">
            ...
            <th scope="col" class="text-center tbl_amnt_10">Account No.
            </th>
            <th scope="col" class="text-center tbl_txt_26">
              Account Name
            </th>
    ...
    @if( $type === 'grid')
        <div class="itm_vchr_rmrks">
            ...
            <a href="{{ route('post_dated_cheque_issue_pdf_SH',['id'=>$pdc->pdc_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
