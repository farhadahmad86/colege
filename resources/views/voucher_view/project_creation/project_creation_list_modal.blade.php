    ...
    <div id="" class="table-responsive">
        ...
        <table class="table table-bordered table-sm">
            ...
            <tr class="headings vi_tbl_hdng">
                ...
                <th scope="col" class="text-center tbl_amnt_10">Product Name
                </th>
        ...
        @if( $type === 'grid')
            <div class="itm_vchr_rmrks">
                <a href="{{ route('project_items_view_details_pdf_SH',['id'=>$jrnl->pc_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
