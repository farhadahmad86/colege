    ...
    <div id="" class="table-responsive">
        ...
        <table class="table table-bordered table-sm" id="">
            ...
            <tr class="headings vi_tbl_hdng">
                ...
                <th scope="col" class="text-center tbl_amnt_10">Expense Account
                </th>
                <th scope="col" class="text-center tbl_txt_25">Account Party
                </th>
            ...
            <tbody>
            @php $i = 1; $grand_total = $ttl_dr = $ttl_cr = 0;@endphp
        ...
        @if( $type === 'grid')
            <div class="itm_vchr_rmrks">
                ...
                <a href="{{ route('expense_items_view_details_pdf_SH',['id'=>$jrnl->ebi_id]) }}" class="align_right text-center btn btn-sm btn-info" style="float: left;margin-top: 7px;">
