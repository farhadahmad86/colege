    ...
    <table class="table border-0 table-sm" style="padding-left: 15px; padding-right: 15px; margin-top:25px">
        ...
        <thead style="border: px solid">
            <tr>
                ...
                <th scope="col" align="center" class="text-center align_center tbl_srl_10" style="border: 1px solid">School Name
                </th>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            @forelse($datas as $item)
                <tr style="font-size: 12px;">
                    ...
                    <td class="align_center text-center" style="border: 1px solid">{{ $item->sch_name }}</td>
                </tr>
                @php
                    $sr++;
                @endphp
