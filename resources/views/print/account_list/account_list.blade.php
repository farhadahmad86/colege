...
@section('print_cntnt')
    ...
    <table class="table border-0 table-sm">
        ...
        <tr>
            ...
            <th scope="col" align="center" class="text-center align_center tbl_txt_18">
                Name
            </th>
        ...
        @forelse($datas as $index=> $account)
            ...
            <tr>
                ...
                <td class="align_right edit text-right tbl_amnt_18">
                    {{$balance[$index]!=0 ? number_format($balance[$index],2):''}}
                </td>

                <td class="align_left edit text-left tbl_txt_8">
                    {{ $account->user_name }}
                </td>
                <td class="text-center align_center edit tbl_txt_10">
                    {{$account->ag_title}}
