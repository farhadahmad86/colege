    ...
    <table class="table border-0 table-sm p-0">
        <tr class="bg-transparent">
            <td class="wdth_25_prcnt p-0 border-0">
                ...
                <p class="invoice_para adrs m-0 pt-0" title="{{isset($company_info) ? $company_info->ci_address : '' }}">
                    <b> Adrs: </b>
            ...
            <td class="wdth_75_prcnt p-0 border-0 text-right align_right">
                ...
                <p class="invoice_para m-0 pt-0">
                    <b> PTCL #: </b>
                    {{(isset($company_info) || !empty($company_info)) ? $company_info->ci_ptcl_number : 'N/A'}}
                </p>
                <p class="invoice_para m-0 pt-0">
                    <b> Email: </b>
