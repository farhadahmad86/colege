...
@section('print_cntnt')
    ...
    <table class="table border-0 table-sm">
        ...
        <tr>
            ...
            <th scope="col" align="center" class="text-center align_center tbl_txt_41">Name</th>
            <th scope="col" align="center" class="text-center align_center tbl_txt_41">Remarks</th>
            <th scope="col" align="center" class="text-center align_center tbl_txt_14">Created By</th>
        </tr>
        </thead>
