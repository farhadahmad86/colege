...
@section('print_cntnt')
    ...
    <table class="table border-0 table-sm">
        ...
        <tr>
            ...
            <th scope="col" align="center" class="align_center text-center tbl_txt_58">
                Detail Remarks
            </th>
        ...
        @forelse($datas as $voucher)
            ...
            <tr>
                ...
                <td class="view align_center text-center tbl_amnt_9" data-id="{{$voucher->ss_id}}">
                    SSV-{{$voucher->ss_id}}
                </td>
                <td class="align_left text-left tbl_txt_58">
                    {!! str_replace(array("\r\n","\r","\n","\\r","\\n","\\r\\n"),'<br />', $voucher->ss_detail_remarks) !!}
                </td>
                @php $per_page_ttl_amnt = +$voucher->ss_total_amount + +$per_page_ttl_amnt; @endphp
                <td class="align_right text-right tbl_amnt_15">
                    {{$voucher->ss_total_amount !=0 ? number_format($voucher->ss_total_amount,2):''}}
                </td>
