        ...
        @forelse($datas as $invoice)
            ...
            <tr>
                ...
                <td nowrap class="align_center text-center tbl_amnt_9">
                    {{ $invoice->sei_day_end_date }}
                </td>
                <td class="align_center text-center view tbl_amnt_6">
                    SEI-{{$invoice->sei_id}}
                </td>
                ...
                <td class="align_right text-right tbl_amnt_10">
                    {{$invoice->sei_cash_paid !=0 ? number_format($invoice->sei_cash_paid,2):''}}
                </td>
