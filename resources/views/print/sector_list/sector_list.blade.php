...
@section('print_cntnt')
    ...
    <table class="table border-0 table-sm">
        ...
        <tr>
            ...
            <th scope="col" align="center" class="text-center align_center tbl_txt_19">Region Name</th>
            <th scope="col" align="center" class="text-center align_center tbl_txt_19">Area Name</th>
            <th scope="col" align="center" class="text-center align_center tbl_txt_19">Sector Name</th>
