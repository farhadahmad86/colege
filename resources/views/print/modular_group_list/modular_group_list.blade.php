...
@section('print_cntnt')
    ...
    <table class="table border-0 table-sm">
        ...
        <tr>
            ...
            <th scope="col" align="center" class="align_center text-center tbl_txt_54">
                Remarks
            </th>
        ...
        @forelse($datas as $group)
            ...
            <tr>
                ...
                <td class="align_left edit text-left tbl_txt_30">
                    {{$group->mg_title}}
                </td>
                <td class="align_left edit text-left tbl_txt_54">
                    {{$group->mg_remarks}}
                </td>
