...
@section('print_cntnt')
    ...
    <table class="table border-0 table-sm">
        ...
        <tr>
            ...
            <th scope="col" align="center" class="align_center text-center tbl_txt_57">
                Detail Remarks
            </th>
        ...
        @forelse($datas as $voucher)
            ...
            <tr>
                ...
                <td class="view align_center text-center tbl_amnt_10" data-id="{{$voucher->sp_id}}">
                    SPV-{{$voucher->sp_id}}
                </td>
                <td class="align_left text-left tbl_txt_57">
