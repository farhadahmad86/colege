...
@section('print_cntnt')
    ...
    <table class="table border-0 table-sm">
        ...
        <tr>
            ...
            <th scope="col" align="center" class="align_center text-center tbl_txt_46">
                Party Name
            </th>
        ...
        @forelse($datas as $invoice)
            ...
            <tr>
                ...
                <td class="align_left text-left tbl_txt_46">
        ...
        <tr class="border-0">
            ...
            <td align="right" class="text-right border-0" align="right">
