    ...
    <div class="row">
        <div class="container-fluid search-filter form-group form_manage" id="">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-white get-heading-text file_name">Bill Of Labour List</h4>
                    </div>
            ...
            <div class="search_form m-0 p-0">
                <form class="highlight prnt_lst_frm" action="{{ route('bill_of_labour_voucher_list') }}" name="form1"
            ...
            <div class="table-responsive" id="printTable">
                <table class="table table-bordered table-sm" id="fixTable">
                    ...
                    <tr>
                        ...
                        <th tabindex="-1" scope="col" align="center"
                            class="tbl_txt_15">
                            Remarks
                        </th>
                    ...
                    @forelse($datas as $voucher)
                        ...
                        <th scope="row" class="edit">
                            ...
                            <td class="view" data-id="{{ $voucher->bl_id }}">
                                BLV-{{ $voucher->bl_id }}
                            </td>
                            <td>
                                {{ $voucher->bl_remarks }}
                            ...
                            <td class="text-center usr_prfl {{ $voucher->bl_status == 'post' ?  : '' }}"
                                title="Click To Edit Voucher">
                                @if ($voucher->bl_status == 'post')
                                    <span class="btn btn-sm btn-success">POSTED<span>
                                @elseif ($voucher->bl_status == 'park')
                                                <a class="btn btn-sm btn-info" href="{{ route('edit_bill_of_labour', $voucher->bl_id) }}"><i
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('bill_of_labour_voucher_list') }}',
            url;
