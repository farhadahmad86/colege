    ...
    <div class="row">
        <div id="main_bg" class="container-fluid search-filter form-group form_manage">
            <div class="form_header">
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 tabindex="-1" class="text-white get-heading-text">Bill Of Labour Voucher</h4>
                    </div>
                    <div class="list_btn">
            ...
            <div id="invoice_con" class="gnrl-mrgn-pdng for_voucher">
                ...
                <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk invoice_bx show_scale show_rotate">
                    <!-- invoice box start -->
                    <form id="f1" action="{{ route('submit_bill_of_labour_voucher') }}" method="post"
                            ...
                            <div class="gnrl-mrgn-pdng gnrl-blk invoice_cntnt">
                                ...
                                <div class="invoice_row">
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3  col-sm-12">
                                        <!-- invoice column -->
                                        <x-account-name-component tabindex="1" name="account" class="payable_receivable"
                                                                  id="account" title="Party"
                                                                  href="receivables_account_registration"
                                                                  body="0"/>
                                    </div>
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3  col-sm-12">
                                        ...
                                        <x-remarks-component tabindex="2" name="remarks" id="remarks"
                                ...
                                <div class="row">
                                    ...
                                    <!-- use account-name-component
                                            ...
                                            here use class payable_receivable for get backend query bank account
                                            body="0" use for the query and get the index 0  payable receivable accounts  -->
                                    <div hidden class="invoice_col form-group col-lg-2 col-md-3  col-sm-12">
                                        <!-- invoice column -->
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3  col-sm-12">
                                        <!-- invoice column start -->
                                        <x-remarks-component tabindex="5" name="account_remarks" id="account_remarks"
                                    ...
                                    <div readonly class="invoice_col form-group col-lg-2 col-md-3  col-sm-12">
                                        <!-- invoice column start -->
                                        <div class="invoice_col_bx">
                                            <!-- invoice column box start -->
                                            <div class="required invoice_col_ttl">
                                    ...
                                    <div class="invoice_col form-group col-lg-2 col-md-3 col-sm-12">
                                        <!-- invoice column start -->
                                        <div class="invoice_col_txt for_voucher_col_bx pt-0">
                                            <!-- invoice column box start -->
                                            <div class="invoice_col_txt with_cntr_jstfy">
                                                <div class="invoice_frm_btn_bx">
                                                    <button tabindex="-1" style="display: none;" id="cancel_button"
                                                            class="invoice_frm_btn btn btn-sm btn-secondary"
                                                            onclick="cancel_all()" type="button"><i
                                                ...
                                                <div class="invoice_frm_btn_bx gnrl-mrgn-pdng gnrl-blk">
                                                    ...
                                                    <button tabindex="10" id="first_add_more"
                                                            ...
                                                            onclick="add_account()" type="button"><i
            ...
            if (flag_submit1) {
                ...
                jQuery("#table_body").append(
                    ...
                    <tr id="${counter}" class="edit_update">
                            <td hidden class="tbl_srl_8">${account_code}</td>
                            ...
                            <td class="text-left tbl_srl_6">${uom_text}</td>
