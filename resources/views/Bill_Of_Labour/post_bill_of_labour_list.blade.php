        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                <div class="form_header">
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Post Bill Of Labour List</h4>
                        </div>
            ...
            <!-- <div class="search_form {{ !empty($search) || !empty($search_to) || !empty($search_from) ? '' : 'search_form_hidden' }}"> -->
                ...
                <div class="search_form m-0 p-0">
                    <form class="highlight prnt_lst_frm" action="{{ route('bill_of_labour_post_voucher_list') }}" name="form1"
                        ...
                        @forelse($datas as $voucher)
                            ...
                            <tr>
                                ...
                                <td class="text-center"
                                    ...
                                    <form method="post" action="{{ route('post_bill_of_labour_voucher',$voucher->bl_id) }}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $voucher->bl_id }}">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('bill_of_labour_post_voucher_list') }}',
            url;
