        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name">Pending Purchase Requisition List</h4>
                        </div>
...
{{--    </script>--}}
    ...
    <script>
        function dis_approve(id) {
            ...
            jQuery.ajax({
                url: "pr_disapprove",
                data: {id: rej_id, work_order_id:work_order_id},
                type: "POST",
                cache: false,
                dataType: 'json',
        ...
        function approve_pr(id) {
            ...
            if (flag_submit1) {
                ...
                jQuery.ajax({
                    url: "pr_approve",
                    data: {id: ap_id, work_order_id:work_order_id},
                    type: "POST",
                    cache: false,
                    dataType: 'json',
                    success: function (data) {
