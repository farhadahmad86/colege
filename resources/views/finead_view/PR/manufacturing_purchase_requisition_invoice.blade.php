        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Manufacturing Purchase Requisition</h4>
                        </div>
                        <div class="list_btn list_mul">
                            ...
                            {{--                            <a class="add_btn list_link add_more_button" href="{{ route('manufacturing_plan_stock_position_list') }}" role="button">--}}
                            {{--                                <i class="fa fa-list"></i> Work Order Stock Position--}}
                            {{--                            </a>--}}
                        </div><!-- list btn -->
                    </div>
                ...
                {{--                <div class="gnrl-mrgn-pdng gnrl-blk invoice_btn_con"><!-- invoice btn con start -->--}}
                {{--                    <div class="gnrl-mrgn-pdng gnrl-blk invoice_btn_bx"><!-- invoice btn box start -->--}}
                {{--                        <div id="invoice_btn" class="gnrl-mrgn-pdng gnrl-blk invoice_btn"><!-- invoice heading start -->--}}
                {{--                            <button class="" id="invoice_btn">--}}
                {{--                                Invoice <i class="icon fa fa-file-text"></i>--}}
                {{--                            </button>--}}
                {{--                        </div><!-- invoice heading end -->--}}
                {{--                    </div><!-- invoice btn box end -->--}}
                {{--                </div><!-- invoice btn con end -->--}}
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk"><!-- invoice box start -->
                        ...
                        {{--                        <div id="invoice_cls_btn" class="gnrl-mrgn-pdng invoice_cls_btn"><!-- invoice close button start -->--}}
                        {{--                            <button type="button" class="">--}}
                        {{--                                <i class="fa fa-times"></i>--}}
                        {{--                            </button>--}}
                        {{--                        </div><!-- invoice close button end -->--}}

                        <form name="f1" class="f1" id="f1" action="{{ route('submit_manufacturing_Purchase_Requisition_invoice') }}" onsubmit="return checkForm()" method="post" autocomplete="off">
                            @csrf
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_80 upper">
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div hidden class="invoice_col basis_col_24"><!-- invoice column start -->
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <input tabindex="3" type="text" name="work_order_id"
                                                                   value="{{$workorder_id}}"
                                                                   class="inputs_up form-control" id="work_order_id"
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <!-- invoice column input start -->
                                                            <input tabindex="3" type="text" name="title"
                                                                   class="inputs_up form-control" id="title"
                                                                   onkeydown="return not_plus_minus(event)"
                                                                   placeholder="PR Title"
                                                                   data-rule-required="true" data-msg-required="Please Select Title"
                                                ...
                                                <div id="departments_show" class="warehouse_box invoice_col basis_col_32"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            ...
                                                            <select name="department_list" id="department_list" class="inputs_up form-control" data-rule-required="true" data-msg-required="Please Select Department">
                                                ...
                                                <div class="invoice_col basis_col_32"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            ...
                                                            <select class="inputs_up form-control" id="employee_list" name="employee_list" data-rule-required="true" data-msg-required="Please Select Employee">
                                            ...
                                            <div class="invoice_row"><!-- invoice row start -->
                                                ...
                                                <div class="invoice_col basis_col_32" hidden><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <select tabindex="4" name="product_code"
                                                ...
                                                <div hidden class="invoice_col basis_col_24">
                                            ...
                                            <h6>Example</h6><p>{{config('fields_info.about_form_fields.general_registration.warehouse.warehouse_title.example')}}</p>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <select tabindex="6" name="warehouse"
                                                            ...
                                                            >
                                                                ...
                                                                @foreach($warehouses as $warehouse)
                                                                    <option
                                                                        value="{{$warehouse->wh_id}}" {{$warehouse->wh_id == 1 ? 'selected':''}}>{{$warehouse->wh_title}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                ...
                                                <div hidden class="invoice_col basis_col_24"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        </div>                                                    <div class="invoice_col_input">
                                                ...
                                                <h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <input tabindex="5" type="text" name="estimated_start_time" id="estimate_start_time" class="inputs_up form-control datepicker1" autocomplete="off" value=""
                                                                   data-rule-required="true" data-msg-required="Please Enter Deadline Date"
                                                                   placeholder="Deadline Date......">                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                </div><!-- invoice column end -->
                                                <div class="invoice_col basis_col_32"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <input tabindex="3" type="text" name="remarks"
                                                                   class="inputs_up form-control" id="remarks"
                                                                   onkeydown="return not_plus_minus(event)"
                                                                   placeholder="Remarks">
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                        ...
                                        <div class="invoice_col basis_col_16" id="filters">
                                            <!-- invoice column start -->
                                    ...
                                    <div class="invoice_row justify-content-end"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_23 hidden" hidden><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    ...
                                                    {{--                                                        </label>--}}
                                                    {{--                                                        <div class="invoice_col_input">--}}
                                                    {{--                                                            <input type="text" name="credit_card_amount_view" class="inputs_up form-control text-right" id="credit_card_amount_view"--}}
                                                    {{--                                                                   placeholder="Credit Card Amount" onkeypress="return allow_only_number_and_decimals(this,event);" onfocus="this.select();" readonly>--}}
                                                    {{--                                                        </div>--}}
                                                    {{--                                                    </div><!-- invoice inline input text end -->--}}
                                            ...
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                ...
                                                <div class="invoice_col_txt"><!-- invoice column input start -->
                                                    ...
                                                    <div class="invoice_inline_input_txt"><!-- invoice inline input text start -->
                                                        ...
                                                        <div class="invoice_col_input">
                                                            <input type="text" name="total_items" class="inputs_up form-control text-right total-items-field lower_style lower_inputs"
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Trade Purchase Return Invoice Detail</h4>
...
@section('scripts')
    ...
    <script type="text/javascript">
        function checkForm() {
            ...
            let title = document.getElementById("title"),
                ...
                employee_list = document.getElementById("employee_list"),
    ...
    @if (Session::get('pri_id'))
        <script>


            jQuery("#table_body").html("");

            var id = '{{ Session::get("pri_id") }}';

            $('.modal-body').load('{{url("trade_purchase_return_items_invoice_list/view/")}}' + '/' + id, function () {
    ...
    <script>
        ...
        function grand_total_calculation_with_disc_amount() {
            ...
            $('input[name="pro_code[]"]').each(function (pro_index) {
                ...
                //nabeel change
                var proQuantity = jQuery("#unit_qty" + pro_field_id).val();
                total_items = total_items + parseFloat(proQuantity);
                console.log(total_items);
            });
        ...
        function productChanged(product) {
            ...
            // add_sale(parent_code, name, display_quantity, remarks, counter, warehouse_id, unit_measurement, main_unit, unit_measurement_scale_size,  unit_qty);


            add_sale(parent_code, name, quantity, remarks,
                counter, 1, unit_measurement, main_unit, unit_measurement_scale_size, unit_qty,);
        ...
        jQuery("#product_code").change(function () {
            ...
            add_sale(parent_code, name, display_quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                counter, 0, 0, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount, 1, "", "");
        ...
        function add_sale(code, name, display_quantity, remarks, counter, select_return_warehouse, unit_measurement, main_unit, unit_measurement_scale_size,  unit_qty){
            ...
            //
            // alert(amount);
            // alert(display_quantity);
            // var pack_qty = Math.round(display_quantity);//mustafa
            ...
            // // alert(pack_qty);
            // alert(after_point_qty.toFixed(3));
            // // alert(unit_qty);
            // var trade_offer = gross_amount - amount - discount_amount; //mustafa
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                // '.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/>' +
                // '</td>' +
                ...
                // pack_qty + '" onfocus="this.select();" onkeypress="return allow_only_number_and_decimals(this,event);"/>' +
                // '</td>' +
                //
                // '<td class="text-center tbl_srl_4">' +
                ...
                '<td class="text-center tbl_srl_4" hidden>' +
                '<input hidden type="hidden" name="unit_measurement[]" id="unit_measurement' + counter + '" class="inputs_up_tbl" placeholder="UOM" value="' + unit_measurement + '" readonly/>' +
                '</td>' +
        ...
        function increase_quantity(current_item) {
            ...
            var previous_qty = jQuery("#unit_qty" + current_item).val();
            var new_quantity = 1;
            if (previous_qty >= 0) {
                new_quantity = +previous_qty + +1;}

            jQuery("#unit_qty" + current_item).val(new_quantity);
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $.each(abc, function (index, value) {
                ...
                var parent_code = value['brs_pro_code'];
                jQuery('#product_name option[value="' + parent_code + '"]').prop('selected', true);
                var name = $("#product_name option:selected").text();
                var display_quantity = value['brs_required_production_qty'];
                ...
                var unit_qty = display_quantity;


                var warehouse_id = 1;

                var remarks = value['brs_pro_remarks'];
                ...
                //     inclusive_exclusive, counter, 0, warehouse_id, unit_measurement, unit_scale_size, rate_per_piece,gross_amount);
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.length !== 0) {
                        ...
                        jQuery("#disc_amount").val(data[0][prefix + '_cash_disc_amount']);
// alert(data[0][prefix + '_cash_disc_amount']);
                        ...
                        $.each(data[1], function (index, value) {
                            ...
                            // var rate_per_piece = (rate / unit_scale_size).toFixed(3);
                            var rate_per_pack = rate * unit_measurement_scale_size;
                            ...
                            add_sale(parent_code, name, display_quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount,
                                inclusive_exclusive, counter, 0, warehouse_id, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount, pack_qty, unit_qty, trade_offer);
