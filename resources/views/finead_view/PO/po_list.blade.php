        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 form_manage" id="">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text file_name"> Purchase Order List</h4>
                        </div>
                ...
                <div class="search_form">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="prnt_lst_frm" action="{{ route('po_invoice_list') }}" name="form1" id="form1" method="post">
                                @csrf
                                <div class="row">
                        ...
                        <table class="table table-sm" id="fixTable">
                            ...
                            @forelse($datas as $invoice)
                                ...
                                <tr>
                                    ...
                                    <td class="align_center text-center edit tbl_srl_6 view" data-id="{{$invoice->po_id}}">
                                        {{$invoice->po_title}}
                                        {{--                                    {{$invoice->projectName}}--}}
                                    </td>

                                    <td class="align_center text-center edit tbl_srl_8">
                                        {{$invoice->po_party_name}}
                                    </td>
                                    <td class="align_center text-center edit tbl_srl_15">
                                        {{$invoice->po_remarks}}
                                    </td>
                                    <td class="align_left text-left tbl_srl_5">
                                        {{$invoice->po_total_items}}
                                    </td>
                                    <td class="align_center text-center edit tbl_srl_8">
                                        {{$invoice->po_total_disc}}
                                    </td>
                                    <td class="align_center text-center edit tbl_srl_8">
                                        {{$invoice->po_grand_total}}
                                    </td>
                                    <td class="align_center text-center tbl_txt_6">
                                        {{ $invoice->po_deadline }}
                                    </td>
                                    <td class="align_center text-center tbl_txt_6">
                                        {{ $invoice->po_created_at }}
                                    </td>
                                    ...
                                    {{--                                           onclick="approve_pr({{$invoice->fpr_id}})">--}}
                                    {{--                                            <i class="fa fa-check"></i>--}}
                                    {{--                                        </a>--}}
                                    {{--                                        <span class="px-1">|</span>--}}
                                    {{--                                        <a class="delete" data-toggle="tooltip" data-placement="left" title="" data-original-title="Are you sure?" onclick="dis_approve({{$invoice->fpr_id}})">--}}
        ...
        <div class="modal-dialog modal-lg mdl_wdth">
            <div class="modal-content base_clr">
                <div class="modal-header">
                    <h4 class="modal-title text-black">Purchase Order Detail</h4>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var base = '{{ route('po_invoice_list') }}',
            url;
    ...
    <script>
        ...
        jQuery(".view").click(function () {
            ...
            $('.modal-body').load('{{url("po_items_invoice_list/view/") }}' + '/' + id, function () {
