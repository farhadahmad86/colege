        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div id="main_bg" class="pd-20 border-radius-4 box-shadow mb-30 form_manage" style="background: #C4D3F5">
                ...
                <div class="form_header"><!-- form header start -->
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-white get-heading-text">Purchase Order Invoice</h4>
                        </div>
                        <div class="list_btn list_mul">
                            <a class="add_btn list_link add_more_button" href="{{ route('trade_purchase_invoice_list') }}"
                               role="button">
                                <i class="fa fa-list"></i> Purchase Order Invoice
                            </a>
                ...
                <div id="invoice_con" class="gnrl-mrgn-pdng invoice_con"><!-- invoice container start -->
                    <div id="invoice_bx" class="gnrl-mrgn-pdng gnrl-blk"><!-- invoice box start -->
                        ...
                        {{--                        sab ma change kr do--}}
                        <form name="f1" class="f1" id="f1" action="{{ route('submit_manufacturing_po_invoice') }}"
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input">
                                                            ...
                                                            <input tabindex="3" type="text" name="pr_id"
                                                                   value="{{$pr_id}}"
                                                                   class="inputs_up form-control" id="pr_id"
...
config('fields_info.about_form_fields.party_registration.general_fields.remarks.example')}}</p><h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                ...
                                                <div class="invoice_col basis_col_24"><!-- invoice column start -->
                                                    <div class="invoice_col_bx"><!-- invoice column box start -->
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <select tabindex="1" autofocus name="account_name" class="inputs_up form-control js-example-basic-multiple"
                                                                    data-rule-required="true" data-msg-required="Please Choose Party"
                                                                    id="account_name" data-rule-required="true" data-msg-required="Please Select Party">
                                                                <option value="0">Select Party</option>
                                                                @foreach($accounts as $account)
                                                ...
                                                <h6>Validation</h6><p>{{config('fields_info.about_form_fields.party_registration.general_fields.remarks.validations') }}</P>">
                                                        ...
                                                        <div class="invoice_col_input"><!-- invoice column input start -->
                                                            <input tabindex="4" type="text" name="estimated_start_time" class="inputs_up form-control datetimepicker" id="estimated_start_time" placeholder="Estimate Start Time"  data-rule-required="true" data-msg-required="Please Select Estimated Start Time">
                                                        </div><!-- invoice column input end -->
                                                    </div><!-- invoice column box end -->
                                                </div><!-- invoice column end -->
                                                <div class="invoice_col basis_col_24"><!-- invoice column start -->
...
{{--                                                                    </th>--}}
                                    ...
                                    <div class="invoice_row"><!-- invoice row start -->
                                        ...
                                        <div class="invoice_col basis_col_23 pl-2"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                       data-placement="bottom" data-html="true"
                                        ...
                                        <div hidden class="invoice_col basis_col_23 pl-2"><!-- invoice column start -->
                                            <div class="invoice_col_bx"><!-- invoice column box start -->
                                                <div class="invoice_col_ttl"><!-- invoice column title start -->
                                                    <a data-container="body" data-toggle="popover" data-trigger="hover"
                                                       data-placement="bottom" data-html="true"
                                        ...
                                        <div class="invoice_col basis_col_27 pl-2"><!-- invoice column start -->
                                            <div class="invoice_row"><!-- invoice row start -->
    ...
    <script type="text/javascript">
        ...
        function checkForm() {
                ...
                let account_name = document.getElementById("account_name"),
                    ...
                    estimated_start_time = document.getElementById("estimated_start_time"),
...
// alert('warehouse');
    ...
    <script>
        ...
        function product_amount_calculation_with_dis_amount(id, newRate = 0) {
            ...
            var check_qty = jQuery("#check_qty" + id).val();
            ...
            if(unit_qty > parseFloat(check_qty)){
                unit_qty=0;
            ...
            var gross_amount = unit_qty * rate;  //mustafa

            var quantity = unit_qty;
            if (quantity == "") {
                quantity = 0;
            }
            ...
            jQuery("#gross_amount" + id).val(gross_amount);
        ...
        function product_amount_calculation(id, newRate = 0) {
            ...
            jQuery("#unit_qty" + id).val(quantity);
        ...
        function productChanged(product) {
            ...
            add_sale(parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                counter, 0, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack, gross_amount,pack_qty,unit_qty);
        ...
        jQuery("#product_code").change(function () {
            ...
            add_sale(parent_code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                counter,0, unit_measurement, main_unit, unit_measurement_scale_size, rate_per_pack ,gross_amount);
        ...
        function add_sale(code, name, quantity, bonus_qty, rate, inclusive_rate, discount, discount_amount, sales_tax, sale_tax_amount, amount, remarks, rate_after_discount, inclusive_exclusive,
                          counter, product_or_service_status,warehouse_id, unit_measurement, main_unit_measurement, unit_measurement_scale_size, rate_per_pack, gross_amount,pack_qty,unit_qty) {
            ...
            jQuery("#table_body").append('<tr class="edit_update" id="table_row' + counter + '">' +
                ...
                '<td class="text-center tbl_srl_4">' +
                '<input type="text"  name="check_qty[]" id="check_qty' + counter + '" ' + ' placeholder="0" value="' + unit_qty + '" class="inputs_up_tbl "   onkeyup="product_amount_calculation(' + counter + '),tab_within_table(event,' + counter + ')" ' +
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            var name = $("#product_name option:selected").text();
            var display_quantity = value[item_prefix + '_due_qty'];
            ...
            var pack_qty = 0;//mustafa



                    var unit_qty = display_quantity;

            var bonus_qty = value['pro_bonus_qty'];
            var warehouse_id = value[item_prefix + '_warehouse_id'];
            var rate = value['pro_purchase_price'];
            ...
            var discount = '';
            // var discount_amount = 0;
            var discount_amount = '';//mustafa

            var sales_tax = 0;
            var sale_tax_amount = 0;
            // var amount = 0;
            var amount = 0;//mustafa
